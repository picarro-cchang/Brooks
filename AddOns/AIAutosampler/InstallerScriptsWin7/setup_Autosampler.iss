...
;
; TODO:
;   1. Is there a way to add custom text to the Welcome page? It should tell the user to disconnect the USB cable
;      before doing the installation.
;
;   2. Need WinXP version. It probably needs to include MSVCRT71.DLL (though really is a system file not local).
...
OutputBaseFileName=setup_Autosampler_win7_{#autosamplerVersion}
DirExistsWarning=no
...
; Program
Source: {#sandboxDir}\host\AIAutosampler\dist\*; DestDir: {app}\AutosamplerExe; Components: program; Flags: recursesubdirs replacesameversion
...
Source: {#sandboxDir}\host\AIAutosampler\HBDS\Coordinator\*; DestDir: {app}\AppConfig\Config\Coordinator; Components: coord\HBDS; Flags: replacesameversion
Source: {#sandboxDir}\host\AIAutosampler\HBDS\CoordinatorLauncher.ini; DestDir: {app}\AppConfig\Config\Utilities; Components: coord\HBDS; Flags: replacesameversion

; HIDS Coordinators and launcher
Source: {#sandboxDir}\host\AIAutosampler\HIDS\Coordinator\*; DestDir: {app}\AppConfig\Config\Coordinator; Components: coord\HIDS; Flags: replacesameversion
Source: {#sandboxDir}\host\AIAutosampler\HIDS\CoordinatorLauncher.ini; DestDir: {app}\AppConfig\Config\Utilities; Components: coord\HIDS; Flags: replacesameversion
