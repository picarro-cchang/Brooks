...
function getData() {
    ...
    var params = {'startPos': CSTATE.startPos, 'alog': CSTATE.alog, 'gmtOffset': CNSNT.gmt_offset, 'varList': '["GPS_ABS_LAT","GPS_ABS_LONG","GPS_FIT","CH4","ValveMask"]'};
        ...
        if (data.result.EPOCH_TIME) {
            ...
            if (n > 0) {
                ...
                if (n > 1) {
                    ...
                    if (CNSNT.prime_view) {
                        $('#concentrationSparkline').sparkline(CSTATE.methaneHistory, {"chartRangeMin": 1.8, "width": "180px", "height": "50px"});
                    } else {
                        $('#concentrationSparkline').html("");
                    }
