#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Sun Feb 27 21:30:58 2011
...
class BuildStationGUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_loglog = wx.StaticText(self.panel_ripple_inputs, -1, "Loglog")
        self.checkbox_loglog = wx.CheckBox(self.panel_ripple_inputs, -1, "")
        ...
        self.Bind(wx.EVT_CHECKBOX, self.onDitherEnable, self.checkbox_loglog)
    ...
    def __do_layout(self):
        ...
        grid_sizer_1_copy_2.Add(self.label_loglog, 0, wx.LEFT|wx.RIGHT, 10)
        grid_sizer_1_copy_2.Add(self.checkbox_loglog, 0, 0, 0)
        ...
        sizer_8.Add(self.button_clear, 0, wx.TOP|wx.BOTTOM, 10)
        sizer_8.Add((20, 20), 1, 0, 0)
        sizer_8.Add(self.button_exit, 0, wx.TOP|wx.BOTTOM, 10)
        sizer_8.Add((20, 20), 1, 0, 0)
