...
if INIT:
    ...
    anCO2 = []
    anCO2.append(Analysis(os.path.join(BASEPATH,r".\NH3\CO2 pressure fit #74 v0_0.ini")))
    lastShift = None
...
RESULT = {"y_parameter":y74,"peak74":peak74,"str74":str74,"freq_offset":offset,"y74":y74,"z74":z74,"v87":v74,
