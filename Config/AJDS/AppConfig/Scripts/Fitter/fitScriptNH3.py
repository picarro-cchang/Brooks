...
if INIT:
    fname = os.path.join(BASEPATH,r"./NH3/spectral library v1_045_AXDS12_E2 0219.ini")
    ...
    anNH3 = []
    anNH3.append(Analysis(os.path.join(BASEPATH,r"./NH3/AXDS-xx water + ammonia v1_1.ini")))
