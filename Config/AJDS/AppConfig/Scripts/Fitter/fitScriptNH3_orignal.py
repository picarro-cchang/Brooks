...
tstart = time.clock()
if d["spectrumId"]==2 and d["numgroups"]>30:            #  spectrumId historically was 0 
...
if (d["spectrumId"]==1 or d["spectrumId"]==4) and d["numgroups"]>19:
