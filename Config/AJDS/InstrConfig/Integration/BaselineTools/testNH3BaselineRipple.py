...
if INIT:
    ...
    analysis = []
    analysis.append(Analysis(os.path.join(BASEPATH,r"./AEDS-xx baseline test.ini")))
...
d.badRingdownFilter("uncorrectedAbsorbance",minVal=0.2,maxVal=20)
d.sparse(maxPoints=50000,width=0.0025,height=1000000.0,xColumn="waveNumber",yColumn="uncorrectedAbsorbance",outlierThreshold=4)
...
RESULT = {'slope_shift':slope_shift,
