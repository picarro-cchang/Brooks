#  Baseline ripple fitter for HCl analyzer
#  21 Jul 2015:  First version
from numpy import * 
import os.path
import time
import cPickle
...
if INIT:
    ...
    analysis = []
    analysis.append(Analysis(os.path.join(BASEPATH,r"./HCl baseline ripple v01.ini")))
...
RESULT = {'amp_ripp_1':amp_ripp_1, 'amp_ripp_2':amp_ripp_2,
          ...
          'base0':base0, 'base1':base1,"hcl_peak":hcl_peak,
