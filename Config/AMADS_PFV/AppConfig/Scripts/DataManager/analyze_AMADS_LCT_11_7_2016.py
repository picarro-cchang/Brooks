...
import random # for the simulation of noise
...
try:
    ...
    if((_DATA_["species"]==4) and (abs(_DATA_["CavityPressure"]-140.0) < 0.2)):
    ...
    _NEW_DATA_["NH3_filter-NH3expavg"] = _NEW_DATA_["NH3_filter"] - _NEW_DATA_["NH3_ExpAvg"]
...
try:   
    ...
    if ((_DATA_["species"]==60)and (abs(_DATA_["CavityPressure"]-140.0) < 0.2)):
    ...
    _NEW_DATA_["HFfilter-HFexpavg"] = _NEW_DATA_["HF_filter] - _PERSISTENT_["previousS_HF"]
