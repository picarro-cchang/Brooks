...
#  2016 0627:  changed naming convention for baseline parameters to allow merger with other fitters
#  2016 0628:  changed coefficients in concentration precalculation for operation at 140 Torr
...
if INIT:
    ...
    anHF.append(Analysis(os.path.join(BASEPATH,r"./MADS/H2O - O2 doublet VC v1_2.ini")))
    ...
    peak77_baseave = instrParams['HF_Baseline_level']
    peak_79 = 0.0
    str_79 = 0.0
    base_79 = 0.0
    y_79 = 0.0
    ...
    peak_82 = 0.0
    str_82 = 0.0
    base_82 = instrParams['HF_Baseline_level']
    y_82 = 0.0
    h2o_conc_60 = 0.0
    h2o_conc_61 = 0.0
    o2_conc = 0.0
...
#   Fit water at 7824.07 wvn, VC
    ...
    if any(cal):
        hf_pzt_mean = mean(d.pztValue[cal])
        hf_pzt_stdev = std(d.pztValue[cal]) 
...
if r != None:
    ...
    if (ignore_count == 0):      
        RESULT = {"base0":base0,"base1":base1,"base77_ave":base77_ave,"y_77":y_77,"y_79":y_79,
              ...
              "hf_pzt_mean":hf_pzt_mean,"hf_pzt_stdev":hf_pzt_stdev}
