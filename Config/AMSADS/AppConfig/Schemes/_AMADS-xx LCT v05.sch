...
goto_start_H2O = [ Row(f_NH3+24*fsr,0,ignore|H2O,NH3_laser,th_NH3) ]

scan_H2O = makeScan(f_NH3,fsr,[
(24,4),(25,5),(26,10),(27,5),(28,2),(29,2),(30,5),(29,2),(28,2),(27,5),(26,10),(25,5),(24,4),(24,1)],cal|H2O,NH3_laser,th_NH3)
...
(-46,2),(-45,2),(-44,2),(-43,5),(-42,10),(-41,5),(-40,2),(-39,2),(-38,4),(-38,1)],cal|O2,HF_laser,th_HF)
scan_O2[-1].subschemeId |= fit

goto_start_HF = [ Row(f_HF-5*fsr,0,ignore|O2,HF_laser,th_HF) ]

scan_HF = makeScan(f_HF,fsr,[(-5,5),(-4,1),(-3,1),(-2,1),(-1,5),(0,20),(1,5),(2,1),(3,1),(4,5)],cal|HF,HF_laser,th_HF,extra1=1)
scan_HF += makeScan(f_HF,fsr,[(4,5),(3,1),(2,1),(1,5),(0,20),(-1,5),(-2,1),(-3,1),(-4,1),(-5,4),(-5,1)],cal|HF,HF_laser,th_HF,extra1=2)
