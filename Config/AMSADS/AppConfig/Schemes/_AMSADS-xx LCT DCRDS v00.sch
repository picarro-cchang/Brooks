...
schemeRows = scan_H2O + goto_start_NH3 + scan_HF + goto_start_O2 + scan_NH3 + scan_O2 + goto_start_HF + scan_NH3 + goto_start_H2O + scan_HF + scanHCl_first + scanHCl + scanHCl + scanHCl + scanHCl_last + scanH2O_a
