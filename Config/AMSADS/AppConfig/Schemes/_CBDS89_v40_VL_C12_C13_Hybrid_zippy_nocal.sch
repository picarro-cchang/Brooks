...
cal_12CO2 =  makeScan(f_12CO2,fsr,[(-5,2),(-4,2),(-3,2),(-2,2),(-1,4),(0,6),(1,4),(2,2),(3,2),(4,2),(5,2)],pztcen|_12CO2_alt,vLaser1)
cal_12CO2 += makeScan(f_12CO2,fsr,[(4,6),(3,2),(2,2),(1,4),(0,6),(-1,4),(-2,2),(-3,2),(-4,3),(-5,2),(-5,1)],pztcen|_12CO2_alt,vLaser1)
...
cal_H2O += makeScan(f_H2O,fsr,[(-10,2),(-9,2),(-8,2),(-7,4),(-6,2),(-5,10),(-4,2),(-3,2),(-2,2),(-1,5),(0,15),(1,5),(2,2),(3,2),(4,2),(5,2),(6,2),(7,2),(8,2),(9,2)],pztcen|H2O,vLaser3)
...
while True:
    ...
    step += 1
cal_H2O += makeScan(f_H2O,fsr,stepAndDwell,pztcen|H2O,vLaser3)
