...
goto_start_HCl = [ Row(f_HCl-3*fsr,0,ignore|H2O,vLaser1) ]
...
scanHCl_last += makeScan(f_HCl,fsr,[(3,5),(2,1),(1,1),(0,10),(-1,1),(-2,1),(-3,5)],cal|H2O,vLaser1)

goto_start_H2O = [ Row(f_HCl-15*fsr,0,ignore|H2O,vLaser1) ]

scanH2O = makeScan(f_HCl,fsr,[(-15,2),(-16,2),(-17,2),(-18,4),(-19,4),(-20,4),(-21,4),(-22,4),(-23,8),(-24,8)],cal|H2O,vLaser1)
scanH2O += makeScan(f_HCl,fsr,[(-23,8),(-22,4),(-21,4),(-20,4),(-19,4),(-18,4),(-17,2),(-16,2),(-15,2)],H2O,vLaser1)

scanH2O.append(Row(f_HCl+baseline_offset*fsr,1,H2O|fit,vLaser1,extra2=1))

schemeRows = goto_start_HCl + scanHCl + scanHCl + scanHCl + scanHCl + scanHCl_last + goto_start_H2O + scanH2O
