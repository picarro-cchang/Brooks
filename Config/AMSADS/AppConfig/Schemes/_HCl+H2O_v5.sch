...
scanHCl = makeScan(f_HCl,fsr,[(-3,5),(-2,1),(-1,1),(0,10),(1,1),(2,1),(3,5)],HCl,vLaser1)
scanHCl += makeScan(f_HCl,fsr,[(3,5),(2,1),(1,1),(0,10),(-1,1),(-2,1),(-3,5)],HCl,vLaser1)
...
scanH2O = scanHCl_first  + scanH2O + scanHCl_last
scanH2O[-1].subschemeId |= fit

#schemeRows = scanHCl
schemeRows = scanH2O + scanHCl + scanHCl + scanHCl + scanHCl + scanHCl 
