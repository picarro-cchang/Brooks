...
if INIT:
    fname = os.path.join(BASEPATH, r"./NH3/spectral library NH3 v4_0.ini")
    ...
    anNH3.append(Analysis(os.path.join(
        BASEPATH, r"./NH3/AADS-xx water + co2 + HC v1_2.ini")))
    anNH3.append(Analysis(os.path.join(
        BASEPATH, r"./NH3/AADS-xx water + co2 + ammonia + HC v1_3.ini")))
    anNH3.append(Analysis(os.path.join(
        BASEPATH, r"./NH3/AADS-xx peak 11 + HC v1_1.ini")))
    anNH3.append(Analysis(os.path.join(
        BASEPATH, r"./NH3/AADS-xx peak 12 + HC v1_1.ini")))
...
#   Fit CO2 and water lines
    ...
    init[1003, 2] = PF_c3h4_conc / 19.55
    ...
    PF_a_c3h4_conc = 19.55 * r[1003, 2]
    PF_a_c2h2_conc = 14.16 * r[1002, 2]
...
#   Ammonia region:  fit peaks 11 and 12 separately
    ...
    init[1002, 2] = PF_a_c2h2_conc / 14.16
    ...
    PF_c3h4_conc = 19.55 * r[1003, 2]
    PF_c2h2_conc = 14.16 * r[1002, 2]
    PF_peak11 = r[11, "peak"]
    PF_peak12 = r[12, "peak"]
