...
if d["spectrumId"] not in [2,4]:
    ...
    RESULT = {"res_a": res_a, "res_11": res_11, "res_12": res_12,
              ...
              "nh3_maxBasePoints": nh3_maxBasePoints, "nh3_meanBasePoints": nh3_meanBasePoints,"nh3_interval": nh3_interval,
