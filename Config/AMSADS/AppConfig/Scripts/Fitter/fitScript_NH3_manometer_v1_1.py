...
if d["spectrumId"] == 1:
    ...
    if r[74, "peak"] < -10 or r[74, "peak"] > 10000:
        ...
        goodLCT = True
    if goodLCT:
        d.fitData["freq"] = fCO2 + fsr * round_(
            (d.fitData["freq"] + co2_adjust - fCO2) / fsr)
...
if not IgnoreThis:
    RESULT = {
        ...
        "pspec": pspec,
        "paveraged": paveraged,
        "pzt2_adjust": pzt2_adjust,
        "pzt2": pzt2,
        "dataGroups": d["ngroups"],
        "dataPoints": d["datapoints"],
        "pzt_per_fsr": pzt_per_fsr,
        "co2_shift": co2_shift,
        "co2_adjust": co2_adjust,
        "fsr_peak74": fsr_peak74,
        "fsr_y74": fsr_y74,
        "fsr_base74": fsr_base74,
        "fsr_str74": fsr_str74,
        "fsr_shift_co2": fsr_shift_co2,
        "co2_ppm": co2_ppm,
