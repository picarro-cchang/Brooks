...
if d["spectrumId"]==62:
    ...
    if r[81,"peak"] < -10 or r[81,"peak"] > 10000: 
        ...
        goodLCT = True
    if goodLCT:
        d.fitData["freq"] = fO2 + fsr*round_((d.fitData["freq"] + o2_adjust - fO2)/fsr)
        ...
        o2_pct = 0.025838*fsr_str81*(140/pspec)            #  From dry air calibration 9. Aug. 2019
...
if not IgnoreThis:    
    RESULT = {"goodLCT":goodLCT,"pspec":pspec,"paveraged":paveraged,"pzt1_adjust":pzt1_adjust,"pzt1":pzt1,
            "dataGroups":d["ngroups"],"dataPoints":d["datapoints"],"pzt_per_fsr":pzt_per_fsr,"fsr_str82":fsr_str82,
            "o2_shift":o2_shift,"o2_adjust":o2_adjust,"fsr_peak81":fsr_peak81,"fsr_y81":fsr_y81,
            "fsr_base81":fsr_base81,"fsr_str81":fsr_str81,"fsr_shift_o2":fsr_shift_o2,"o2_pct":o2_pct,
            "o2_residuals_fsr":o2_residuals_fsr,"o2_pct":o2_pct,"h2o_ppm":h2o_ppm,"fsr_peak82":fsr_peak82,
