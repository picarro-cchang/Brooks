...
#  2013 1107 -  Initialize line centers to match max absorption to increase capture range.

from numpy import arange, mean, std, sqrt, digitize, polyfit, argmax
import os.path

if INIT:
    fname = os.path.join(BASEPATH,r"./CFADS/spectral library CO2_comb v1_2.ini")
