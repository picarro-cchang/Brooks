...
output = []
output.append("# Fitter configuration parameters from CH4 baseline fit "+time.asctime())
output.append("CH4_Baseline_level = %.6f" % arrays['base0']['mean'])
output.append("CH4_Baseline_slope = %.6f" % arrays['base1']['mean'])
output.append("CH4_Sine0_ampl =%.3f" % arrays['amp_ripp_1']['mean'])
output.append("CH4_Sine0_freq = %.6f" % arrays['center_ripp_1']['mean'])
...
output.append("CH4_Sine1_freq = %.6f" % arrays['center_ripp_2']['mean'])
