...
SENSOR_LIST = ["mode_id", "species", "solenoid_valves", "DasTemp", "CavityPressure",
...
if "CO2_H2O" in scanningMode:
    allGood = allGood and resync("co2_conc_dry")
if "CH4" in scanningMode:
    allGood = allGood and resync("ch4_conc")
if "H2O_CH4" in scanningMode:
    allGood = allGood and resync("ch4_conc_dry")
