...
if INIT:
    fname = os.path.join(BASEPATH,r"./spectral library v7_isomethane_20100427.ini")
    loadSpectralLibrary(fname)
    loadPhysicalConstants(fname)
    loadSplineLibrary(fname)

    analysis = []
    analysis.append(Analysis(os.path.join(BASEPATH,r"./CFEDS-xx baseline ripple CBDS-01.ini")))
