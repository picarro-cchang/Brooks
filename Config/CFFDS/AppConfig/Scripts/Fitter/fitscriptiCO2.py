...
#  2013-09-16:  Removed variable y from methane shoulder peak fit.
#               Added Chris's "enriched 13C" fix from 824-CFFDS2010 (work done for Michael Bender)
#  2014-01-30:  Reverted last changes
#  2014-05-02:  Fixed bug - y87 was not initialized
#  2014-08-06:  Changed reporting of SIDs 155 and 156 to prevent miscommunication with "laser aging" fitter
...
if INIT:
    fname = os.path.join(BASEPATH,r"./spectral library_CBDS+CFADS6057_20110308.ini")
    ...
    anCH4.append(Analysis(os.path.join(BASEPATH,r"./CFADS/cFADS-1 CH4 v3_2 20110616.ini")))
...
#                      20110621 rella - replaced peak87_baseave_spec with peak88_baseave_offset*33.558 (33.558 will keep the parameters approx. the same)
#                      20140130 hoffnagle - reverted last change, causes too many problems in integration
