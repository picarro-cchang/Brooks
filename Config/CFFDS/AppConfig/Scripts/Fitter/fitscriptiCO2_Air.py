...
if INIT:
    ...
    fname = os.path.join(BASEPATH,r"../../../InstrConfig/Calibration/InstrCal/FitterConfig_Air.ini")
    ...
    P88_A2 = instrParams['Peak88_quad']
...
peak88_baseave_spec += P88_A2*peak88_baseave*peak87_baseave_spec
