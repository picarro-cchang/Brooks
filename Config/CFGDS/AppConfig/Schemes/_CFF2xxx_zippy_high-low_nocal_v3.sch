...
scan_CH4_high_precision += makeScan(f_CH4_high_precision,fsr,[(8,2),(7,2),(6,2),(5,2),(4,2),(3,2),(2,2),(1,3),(0,17),(-1,3),(-2,2),(-3,2),(-4,2),(-5,2),(-6,2)],pztcen|CH4_high_precision,vLaser3)
...
scan_CH4 += makeScan(f_CH4,fsr,[(4,4),(3,4),(2,4),(1,6),(0,35),(-1,6),(-2,4),(-3,4)],pztcen|CH4,vLaser4)
scan_CH4[-1].subschemeId |= fit

goto_start_H2O = [ Row(f_H2O-5*fsr,0,ignore|H2O,vLaser5) ]
scan_H2O =  makeScan(f_H2O,fsr,[(-5,2),(-4,2),(-3,2),(-2,2),(-1,2),(0,5),(1,2),(2,2),(3,2),(4,2),(5,2)],pztcen|H2O,vLaser5)
...
for i in range(5):
    ...
    schemeRows += scan_13CO2 + scan_CH4 + scan_CH4_high_precision + goto_start_H2O
    for loops in range(2):
        schemeRows += scan_13CO2 + scan_12CO2
