...
#  2012 0418 -  Reduced minSize from 20 to 5 in the cluster algorithm (too many spectra were too sparse)
#  2013 1113 -  Initialize line centers to match max absorption to increase capture range.
...
if INIT:
    ...
    anCO2 = []
    anCO2.append(Analysis(os.path.join(BASEPATH,r"./isoCO2/FSR_R26.ini")))
    anCO2.append(Analysis(os.path.join(BASEPATH,r"./isoCO2/FSR_R28.ini")))
    anCO2.append(Analysis(os.path.join(BASEPATH,r"./isoCO2/FSR_R32.ini")))
    ...
    #out = file("FSR_calibration.txt","w+a")
...
ANALYSIS = []
d = DATA
d.cluster(xColumn='waveNumber',diameter=0.002,minSize=5,minJump=0.012)
...
out = file("FSR_calibration.txt","a")

CO2_refs = [6246.30462,6247.45624,6249.66944,6250.73057,6251.76108,6252.76072,6253.72923,6254.66637,6255.57188]
fitted_refs = []
fitted_centers = []
residuals = []
