...
amp_ripp_1 = numpy.sqrt(r[1000,0]**2+r[1001,0]**2)
amp_ripp_2 = numpy.sqrt(r[1002,0]**2+r[1003,0]**2)
phase_ripp_1 = numpy.arctan2(-r[1001,0],r[1000,0])
phase_ripp_2 = numpy.arctan2(-r[1003,0],r[1002,0])
freq_ripp_1 = r[1000,2]
freq_ripp_2 = r[1002,2]
center_ripp_1 = r[1000,1]
center_ripp_2 = r[1002,1]
base0 = r["base",0]
base1 = r["base",1]
cm_shift = r["base",3]
h2o_peak = r[91,"peak"]
