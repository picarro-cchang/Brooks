...
scan_CO2cal = makeScan(f_CO2,fsr,[(-4,1),(-3,1),(-2,1),(-1,1),(0,6),(1,1),(2,1),(3,1),(4,1)],cal|CO2,vLaserCO2)
...
special1 = (scan_CO2cal + scan_CH4 + scan_H2O)
special2 = (scan_CO2 + scan_CH4cal + scan_H2O)
special3 = (scan_CO2 + scan_CH4 + scan_H2Ocal)
normal = (scan_CO2 + scan_CH4 + scan_H2O)
...
for loops in range(1):
    schemeRows += (special1 + scan_packet + special2 + scan_packet + special3 + scan_packet)
