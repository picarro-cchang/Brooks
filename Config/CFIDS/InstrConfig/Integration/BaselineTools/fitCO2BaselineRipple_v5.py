...
#  31 Mar 2014:  reduced upper limit of fit to exclude lines (H2O and CO2) not in spectral library
...
if INIT:
    ...
    analysis = []
    analysis.append(Analysis(os.path.join(BASEPATH,r"./CBDS-xx baseline ripple 1 frequency.ini")))
    analysis.append(Analysis(os.path.join(BASEPATH,r"./CBDS-xx baseline ripple CBDS-02.ini")))
...
if first_fit:
    ...
    init[88,"strength"] = init[91,"strength"] = 0.0
    init[1000,2] = p0
