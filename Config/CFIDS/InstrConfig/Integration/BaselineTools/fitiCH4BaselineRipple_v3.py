#  Baseline ripple fitter for isotopic CH4 region at 6029 wvn
#  23 Mar 2012:  Improve initial estimate of ripple frequencies using autocorrrelation of baseline
...
if INIT:
    ...
    analysis = []
    analysis.append(Analysis(os.path.join(BASEPATH,r"./FCDS-xx baseline ripple 1frequency.ini")))
    analysis.append(Analysis(os.path.join(BASEPATH,r"./FCDS-xx baseline ripple v02.ini")))
...
if first_fit:
    ...
    init[30,"strength"] = init[33,"strength"] = 0.0
    init[1000,2] = p0
