...
output = []
output.append("# Fitter configuration parameters from CH3D baseline fit "+time.asctime())
output.append("CH4_6023_Baseline_level = %.6f" % arrays['base0']['mean'])
output.append("CH4_6023_Baseline_slope = %.6f" % arrays['base1']['mean'])
output.append("CH4_6023_Sine0_ampl =%.3f" % arrays['amp_ripp_1']['mean'])
output.append("CH4_6023_Sine0_freq = %.3f" % arrays['center_ripp_1']['mean'])
output.append("CH4_6023_Sine0_period = %.6f" % arrays['freq_ripp_1']['mean'])
output.append("CH4_6023_Sine0_phase = %.6f" % arrays['phase_ripp_1']['mean'])
output.append("CH4_6023_Sine1_ampl = %.3f" % arrays['amp_ripp_2']['mean'])
output.append("CH4_6023_Sine1_freq = %.3f" % arrays['center_ripp_2']['mean'])
output.append("CH4_6023_Sine1_period = %.6f" % arrays['freq_ripp_2']['mean'])
output.append("CH4_6023_Sine1_phase = %.6f" % arrays['phase_ripp_2']['mean'])
