...
# CH4 section
#######################################################################
fCH4+8*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4+7*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4+6*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4+5*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4+4*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4+3*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4+2*fsr,     5,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4+fsr,       5,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4,           25, cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4-fsr,       5,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4-2*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4-3*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4-4*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4-5*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4-6*fsr,     3,  cal | pztcen | CH4, vLaser2, threshold = CH4TH
fCH4-5*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4-4*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4-3*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4-2*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4-fsr,       5,  CH4, vLaser2, threshold = CH4TH
fCH4,           25, CH4, vLaser2, threshold = CH4TH
fCH4+fsr,       5,  CH4, vLaser2, threshold = CH4TH
fCH4+2*fsr,     5,  CH4, vLaser2, threshold = CH4TH
fCH4+3*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4+4*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4+5*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4+6*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4+7*fsr,     3,  CH4, vLaser2, threshold = CH4TH
fCH4+8*fsr,     2,  CH4, vLaser2, threshold = CH4TH
fCH4+8*fsr,     1,  fit | CH4, vLaser2, threshold = CH4TH
#######################################################################
...
fCO+2*fsr5,     15, CO, vLaser5, threshold = COTH
#
fCO+2*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+3*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+4*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+5*fsr5,      4, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+6*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+7*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+8*fsr5,      4, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+7*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+6*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+5*fsr5,      4, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+4*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+3*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+2*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO+fsr5,        3, cal | pztcen | CO, vLaser5, threshold = COTH
fCO,            10, cal | pztcen | CO, vLaser5, threshold = COTH
fCO-fsr5,        2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO-2*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO-3*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO-4*fsr5,      2, cal | pztcen | CO, vLaser5, threshold = COTH
fCO-5*fsr5,      4, cal | pztcen | CO, vLaser5, threshold = COTH
