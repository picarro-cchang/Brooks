...
#   Define some frequencies (in wavenumbers) for the autocorrelation routine that sets initial periodicities
...
if INIT:
    ...
    analysis = []
    analysis.append(Analysis(os.path.join(BASEPATH,r"./CKADS-xx baseline ripple 1frequency.ini")))
    analysis.append(Analysis(os.path.join(BASEPATH,r"./CKADS-xx baseline ripple v3.ini")))
...
RESULT = {'amp_ripp_1':amp_ripp_1, 'amp_ripp_2':amp_ripp_2,
          ...
          'co_peak':co_peak,'co_ppm':co_ppm,'h2o_peak':h2o_peak,
