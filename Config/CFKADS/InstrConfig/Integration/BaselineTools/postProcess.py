...
plot(a['data'])
grid(True)
title('H2O Concentration (pct), Mean %.3f, StdDev %.3f' % (3.125*a['mean'],3.125*a['std']))
#subplot(2,1,2)
#a = arrays['peak87']
#plot(a['data'])
#grid(True)
...
output.append("Sine1_freq = %.6f" % arrays['center_ripp_2']['mean'])
