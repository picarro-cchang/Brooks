...
fCO2+5*fsr,     5,  cal | CO2, vLaser1, threshold = CO2TH
fCO2+4*fsr,     3,  cal | CO2, vLaser1, threshold = CO2TH
fCO2+3*fsr,     5,  cal | CO2, vLaser1, threshold = CO2TH
fCO2+2*fsr,     3,  cal | CO2, vLaser1, threshold = CO2TH
fCO2+fsr,       3,  cal | CO2, vLaser1, threshold = CO2TH
fCO2+2*dtop,    3,  CO2, vLaser1, threshold = CO2TH
fCO2+dtop,      3,  CO2, vLaser1, threshold = CO2TH
fCO2,           19, cal | CO2, vLaser1, threshold = CO2TH
fCO2-dtop,      3,  CO2, vLaser1, threshold = CO2TH
fCO2-2*dtop,    3,  CO2, vLaser1, threshold = CO2TH
fCO2-fsr,       3,  cal | CO2, vLaser1, threshold = CO2TH
fCO2-2*fsr,     3,  cal | CO2, vLaser1, threshold = CO2TH
fCO2-3*fsr,     5,  cal | CO2, vLaser1, threshold = CO2TH
fCO2-4*fsr,     3,  cal | CO2, vLaser1, threshold = CO2TH
fCO2-5*fsr,     4,  cal | CO2, vLaser1, threshold = CO2TH
fCO2-5*fsr,     1,  fit | cal | CO2, vLaser1, threshold = CO2TH
#######################################################################
# CH4 section
#######################################################################
fCH4+8*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4+7*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4+6*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4+5*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4+4*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4+3*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4+2*fsr,     5,  cal | CH4, vLaser2, threshold = CH4TH
fCH4+fsr,       5,  cal | CH4, vLaser2, threshold = CH4TH
fCH4,           25, cal | CH4, vLaser2, threshold = CH4TH
fCH4-fsr,       5,  cal | CH4, vLaser2, threshold = CH4TH
fCH4-2*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4-3*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4-4*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4-5*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
fCH4-6*fsr,     3,  cal | CH4, vLaser2, threshold = CH4TH
