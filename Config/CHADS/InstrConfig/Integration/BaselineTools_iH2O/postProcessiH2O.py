...
output.append("H2O_Baseline_slope = %.6f" % arrays['base1']['mean'])
output.append("H2O_Sine0_ampl = %.3f" % arrays['amp_ripp_1']['mean'])
output.append("H2O_Sine0_freq = %.3f" % arrays['center_ripp_1']['mean'])
output.append("H2O_Sine0_period = %.6f" % arrays['freq_ripp_1']['mean'])
output.append("H2O_Sine0_phase = %.6f" % arrays['phase_ripp_1']['mean'])
output.append("H2O_Sine1_ampl = %.3f" % arrays['amp_ripp_2']['mean'])
output.append("H2O_Sine1_freq = %.3f" % arrays['center_ripp_2']['mean'])
output.append("H2O_Sine1_period = %.6f" % arrays['freq_ripp_2']['mean'])
output.append("H2O_Sine1_phase = %.6f" % arrays['phase_ripp_2']['mean'])
