...
H2O_scan = makeScan(f_H2O,fsr,[(-4,2),(-3,2),(-2,2),(-1,3),(0,8),(1,3),(2,2),(3,2)],HDO|pztcen,H2O_Laser)
HDO_scan = makeScan(f_HDO,fsr,[(-3,2),(-2,2),(-1,3),(0,10),(1,3),(2,2),(3,2),(4,2)],HDO|pztcen,HDO_Laser)
