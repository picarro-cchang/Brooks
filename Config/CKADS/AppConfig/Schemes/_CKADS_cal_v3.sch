...
dwell = [60,3,3,3,3,6,3,3,6,3,3,6,3,3,3,3,60,3,3,3,3,4,3,3,4,3,3,4,3,3,3,3,60]

for i in range(len(fsrlist)):
    schemeRows.append(Row(fCO + fsrlist[i]*fsr2, dwell[i], CO | cal, vlaser2))
