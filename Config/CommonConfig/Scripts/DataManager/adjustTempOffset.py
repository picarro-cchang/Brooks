...
def adjustTempOffset():
    ...
    # optional argument: printInfo=True for some debugging output in the DataManager console
    #                    Note: Some Analyzer versions may not support this feature
    _UTILS_["doAdjustTempOffset"](report=_REPORT_, instr=_INSTR_, data=_DATA_, freqConv=_FREQ_CONV_)
