...
scanH2O += makeScan(f_H2O,fsr,[(s,2) for s in range(5,-28,-1)],C2H2a|cal,vLaser1)
scanH2O += makeScan(f_H2O,fsr,[(s,2) for s in range(-27,-21)],C2H2a|cal,vLaser1)
scanH2O += [Row(f_H2O-22*fsr,1,C2H2a|cal|fit,vLaser1)]
...
for row in scanCH4dn: row.subschemeId |= cal
