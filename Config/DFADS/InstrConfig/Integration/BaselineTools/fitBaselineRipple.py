...
if INIT:
    fname = os.path.join(BASEPATH,r"./spectral library DFADS-xx_2009_1208.ini")
    loadSpectralLibrary(fname)
    loadPhysicalConstants(fname)
    loadSplineLibrary(fname)

    analysis = []
    analysis.append(Analysis(os.path.join(BASEPATH,r"./DFADS-xx baseline ripple.ini")))
...
RESULT = {'amp_ripp_1':amp_ripp_1, 'amp_ripp_2':amp_ripp_2,
          ...
          'base0':base0, 'base1':base1, 'base3':base3,
