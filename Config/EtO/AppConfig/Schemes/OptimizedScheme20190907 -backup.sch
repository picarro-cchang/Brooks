...
schemeRows = []
schemeRows.append(Row(f_eto - 167*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto - 166*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto - 165*fsr, 3, ETO, vLaser1))
schemeRows.append(Row(f_eto - 164*fsr, 3, ETO, vLaser1))
schemeRows.append(Row(f_eto - 163*fsr, 3, ETO, vLaser1))
schemeRows.append(Row(f_eto - 162*fsr, 3, ETO, vLaser1))
...
schemeRows.append(Row(f_eto - 101*fsr, 1, ETO, vLaser1))
...
schemeRows.append(Row(f_eto - 43*fsr, 1, ETO, vLaser1))
...
schemeRows.append(Row(f_eto - 11*fsr, 3, ETO, vLaser1))
schemeRows.append(Row(f_eto - 1*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto, 52, ETO, vLaser1))
...
schemeRows.append(Row(f_eto + 72*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto + 73*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto + 74*fsr, 3, ETO, vLaser1))
schemeRows.append(Row(f_eto + 79*fsr, 1, ETO, vLaser1))
...
schemeRows.append(Row(f_eto + 85*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto + 86*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto + 87*fsr, 3, ETO, vLaser1))
schemeRows.append(Row(f_eto + 88*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto + 89*fsr, 1, ETO, vLaser1))
schemeRows.append(Row(f_eto + 91*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto + 92*fsr, 1, ETO, vLaser1))
schemeRows.append(Row(f_eto + 93*fsr, 2, ETO, vLaser1))
schemeRows.append(Row(f_eto + 94*fsr, 3, ETO, vLaser1))
schemeRows.append(Row(f_eto + 95*fsr, 4, ETO, vLaser1))
schemeRows += schemeRows[-2::-1]
schemeRows.append(Row(f_eto - 167*fsr, 2, ETO|fit, vLaser1))
