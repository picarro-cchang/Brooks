...
schemeRows.append(Row(f_eto - 154*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 153*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 152*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 151*fsr, 4, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 150*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 149*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 148*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 147*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 146*fsr, 4, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 145*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 144*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 143*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 142*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 141*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 140*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 139*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 138*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 137*fsr, 5, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 136*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 135*fsr, 5, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 134*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 133*fsr, 1, ETO, vLaser1, redzone))
schemeRows.append(Row(f_eto - 132*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 131*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 130*fsr, 1, ETO, vLaser1, redzone1))
schemeRows.append(Row(f_eto - 129*fsr, 1, ETO, vLaser1, redzone1))
