...
#  Version 1e is specifically for CO2 dilution measurement with PZT centration on water line
...
# CO2 section
#######################################################################
CO2_up = makeScan(fH2O-(Na*fsr+Picarro_offset_a),fsr,[(-5,2),(-4,2),(-3,2),(-2,14),(-1,6),(0,45),(1,6),(2,14),(3,2),(4,2),(5,2)],CO2,vLaser1)
CO2_dn = makeScan(fH2O-(Na*fsr+Picarro_offset_a),fsr,[(5,2),(4,2),(3,2),(2,14),(1,6),(0,45),(-1,6),(-2,14),(-3,2),(-4,2),(-5,1),(-5,1)],CO2|cal,vLaser1)
