...
#for i in range(-170,-160,1):
#    schemeRows.append(Row(f_eto+i*fsr,3,ETO,vLaser1))
#for i in range(-160,-3,1):
#    schemeRows.append(Row(f_eto+i*fsr,3,ETO,vLaser1))
#schemeRows.append(Row(f_eto-3*fsr,5,ETO,vLaser1))
#schemeRows.append(Row(f_eto-2*fsr,10,ETO,vLaser1))
#schemeRows.append(Row(f_eto-1*fsr,20,ETO,vLaser1))
#schemeRows.append(Row(f_eto,50,ETO,vLaser1))
#schemeRows.append(Row(f_eto+1*fsr,20,ETO,vLaser1))
#schemeRows.append(Row(f_eto+2*fsr,10,ETO,vLaser1))
#schemeRows.append(Row(f_eto+3*fsr,5,ETO,vLaser1))
#for i in range(4,97,1):
#    schemeRows.append(Row(f_eto+i*fsr,3,ETO,vLaser1))
