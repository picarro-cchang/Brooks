...
schemeRows.append(Row(f_eto-2*fsr,8,ETO,vLaser1))
schemeRows.append(Row(f_eto-1*fsr,16,ETO,vLaser1))
schemeRows.append(Row(f_eto,40,ETO,vLaser1))
schemeRows.append(Row(f_eto+1*fsr,16,ETO,vLaser1))
schemeRows.append(Row(f_eto+2*fsr,8,ETO,vLaser1))
schemeRows.append(Row(f_eto+3*fsr,2,ETO,vLaser1))
for i in range(4,97,2):
    schemeRows.append(Row(f_eto+i*fsr,1,ETO,vLaser1))
for i in range(96,3,-2):
    schemeRows.append(Row(f_eto+i*fsr,1,ETO,vLaser1))
schemeRows.append(Row(f_eto+3*fsr,2,ETO,vLaser1))
schemeRows.append(Row(f_eto+2*fsr,8,ETO,vLaser1))
schemeRows.append(Row(f_eto+1*fsr,16,ETO,vLaser1))
