...
CH4 = (1.0, 0.0)#(_INSTR_["ch4_conc_slope"],_INSTR_["ch4_conc_intercept"])
CO2 = (1.0, 0.0)#(_INSTR_["co2_conc_slope"],_INSTR_["co2_conc_intercept"])
H2O = (1.0, 0.0)#(_INSTR_["h2o_conc_slope"],_INSTR_["h2o_conc_intercept"])
ETO = (1.0, 0.0)#(_INSTR_["eto_conc_slope"],_INSTR_["eto_conc_intercept"])
NH3 = (1.0, 0.0)#(_INSTR_["nh3_conc_slope"],_INSTR_["nh3_conc_intercept"])

# Import cross-talk and parameters
H2O_to_ETO_lin = 0.0# _INSTR_["H2O_to_ETO_linear"]
H2O_to_ETO_quad = 0.0# _INSTR_["H2O_to_ETO_quadratic"]
CH4_to_ETO_lin = 0.0# _INSTR_["CH4_to_ETO_linear"]
CH4_to_ETO_quad = 0.0# _INSTR_["CH4_to_ETO_quadratic"]
CH4_water_bilin = 0.0# _INSTR_["CH4_water_bilinear"]
CO2_to_ETO_lin = 0.0# _INSTR_["CO2_to_ETO_linear"]
CO2_to_ETO_quad = 0.0# _INSTR_["CO2_to_ETO_quadratic"]
CO2_water_bilin = 0.0# _INSTR_["CO2_water_bilinear"]

H2O_to_NH3_lin = 0.0# _INSTR_["H2O_to_NH3_linear"]
H2O_to_NH3_quad = 0.0# _INSTR_["H2O_to_NH3_quadratic"]
CH4_to_NH3_lin = 0.0# _INSTR_["CH4_to_NH3_linear"]
CO2_to_NH3_lin = 0.0# _INSTR_["CO2_to_NH3_linear"]
        
print "species = ", _DATA_["species"]

if _DATA_["species"] == 181 or _DATA_["species"] == 10: 
    try:
        eto_crosstalk_corrected = _DATA_["eto_ppb"] + _DATA_["ch4_ppm"]*CH4_to_ETO_lin + _DATA_["ch4_ppm"] * _DATA_["ch4_ppm"]*CH4_to_ETO_quad + _DATA_["h2o_pct"]*H2O_to_ETO_lin + _DATA_["h2o_pct"] * _DATA_["h2o_pct"]*H2O_to_ETO_quad + _DATA_["co2_ppm"]*CO2_to_ETO_lin + _DATA_["co2_ppm"] * _DATA_["co2_ppm"]*CO2_to_ETO_quad + _DATA_["ch4_ppm"]*_DATA_["h2o_pct"]*CH4_water_bilin + _DATA_["co2_ppm"]*_DATA_["h2o_pct"]*CO2_water_bilin
        ...
        newOffset = 0.0 ##_FREQ_CONV_.getWlmOffset(1) + adjust
        _PERSISTENT_["wlm_offset"] = newOffset
       ##_FREQ_CONV_.setWlmOffset(1,float(newOffset))
        
        adjust = _DATA_["pzt_adjust"]*PZTgain
        newPZToffset = 0.0 ##_DRIVER_.rdDasReg("PZT_OFFSET_VIRTUAL_LASER1") + adjust
