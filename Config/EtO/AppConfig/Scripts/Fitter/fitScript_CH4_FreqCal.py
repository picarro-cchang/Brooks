...
#                Add R branch lines to frequency calibration to exploit SG-BDR laser
#                Excluded P40 and P28 because of poor S/N and big water interference
...
CO2_refs = [6044.353892,6046.131784,6047.895115,6049.644329,6051.379845,6054.811355,6056.508076,6058.192551,6059.865083,6061.525944,6063.175381,
            6088.835538,6090.294235,6091.740760,6093.174792,6094.595977,6096.003936,6097.398268,6098.778546,6100.144320,6101.495118,6102.830448,6104.149798,6105.452637,6106.738416]
CO2_shifts = [-0.007411,-0.007397,-0.007364,-0.007314,-0.007273,-0.007174,-0.007079,-0.006965,-0.006863,-0.006727,-0.006514,
              -0.006524,-0.006735,-0.006883,-0.006993,-0.007101,-0.007195,-0.007267,-0.007313,-0.007339,-0.007362,-0.007387,-0.007419,-0.007443,-0.007471]
fitted_refs = []
fitted_centers = []
residuals = []
...
if N > 1:
    print2("FSR = %.10f wvn" % lr[0])
    print2("f(0) = %.6f wvn" % lr[1])
    print2("RMS residual = %.6f wvn" % sqrt(rms/N))
else:
