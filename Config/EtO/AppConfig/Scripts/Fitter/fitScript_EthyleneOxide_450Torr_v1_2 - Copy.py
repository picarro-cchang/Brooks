...
#  2019 1113:  Tweaks to line shapes based on cross-talk steps with AVX80-9004
...
if INIT:
    fname = os.path.join(BASEPATH,r"./ETO_450Torr/Spectral library for ETO 6080 wvn 80 C 450 Torr v2.ini")
