...
if INIT:
    ...
    anETO = []
    anETO.append(Analysis(os.path.join(BASEPATH,r"./ETO/ETOwide_v2_FCFY_RemoveBigH2O.ini")))
...
if not IgnoreThis:    
    RESULT = {"pzt_adjust":pzt_adjust,"pzt":pzt,"wlm_adjust":wlm_adjust,
            "base0":base0,"base1":base1,"base2":base2,"nh3_ppb":nh3_ppb,"c2h4_ppb":c2h4_ppb,
