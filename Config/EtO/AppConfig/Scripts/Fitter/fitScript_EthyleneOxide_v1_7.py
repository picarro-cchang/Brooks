...
#  2019 0904:  Added ethylene spline to spectral model
...
if INIT:
    ...
    anETO = []
    anETO.append(Analysis(os.path.join(BASEPATH,r"./ETO/ETOwide_v7_FCFY.ini")))
...
if d["spectrumId"]==181:
    ...
    ### pzt_adjust = wlm_adjust = 0.0 #FD-mod
