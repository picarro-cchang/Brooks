...
if INIT:
    ...
    anCH4 = []
    anCH4.append(Analysis(os.path.join(BASEPATH,r"./ETO/CH4_R6_VCVY_v2.ini")))
    anCH4.append(Analysis(os.path.join(BASEPATH,r"./ETO/CH4_R6_FCFY_v2.ini")))
    anCH4.append(Analysis(os.path.join(BASEPATH,r"./ETO/CH4_R6_VCFY_v2.ini")))
    anCH4.append(Analysis(os.path.join(BASEPATH,r"./ETO/CH4_R6_VCFY2_v2.ini")))
    
    anCO2 = []
    anCO2.append(Analysis(os.path.join(BASEPATH,r"./ETO/CO2_R6_VCFY_v2.ini")))
