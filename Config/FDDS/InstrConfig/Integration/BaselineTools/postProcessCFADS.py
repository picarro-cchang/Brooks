...
fname = 'FitterOutput_CH4.dat'
basename = 'FitterConfig_CFADS'
fp = file(fname,'rb')
results = []
while True:
    try:
...
output.append("CFADS_Sine0_period = %.6f" % arrays['freq_ripp_1']['mean'])
output.append("CFADS_Sine0_phase = %.6f" % arrays['phase_ripp_1']['mean'])
output.append("CFADS_Sine1_ampl = %.3f" % arrays['amp_ripp_2']['mean'])
output.append("CFADS_Sine1_freq = %.3f" % arrays['center_ripp_2']['mean'])
output.append("CFADS_Sine1_period = %.6f" % arrays['freq_ripp_2']['mean'])
output.append("CFADS_Sine1_phase = %.6f" % arrays['phase_ripp_2']['mean'])
