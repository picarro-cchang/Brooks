...
#cal_12CO2 = makeScan(f_12CO2,fsr,[(-4,1),(-3,2),(-1,1),(0,7),(1,2),(3,1),(4,3),(3,2),(1,1),(0,7),(-1,2),(-3,1),(-4,1)],cal|_12CO2,vLaser1)
cal_12CO2 = makeScan(f_12CO2,fsr,[(-4,1),(-3,1),(-1,1),(0,3),(1,1),(3,1),(4,1),(3,1),(1,1),(0,3),(-1,1),(-3,1),(-4,1)],cal|_12CO2,vLaser1)
cal_12CO2[-1].subschemeId |= fit

#cal_13CO2 = makeScan(f_13CO2,fsr,[(4,30),(3,1),(2,2),(1,5),(0,60),(-1,5),(-2,1),(-3,2),(-4,60),(-3,1),(-2,2),(-1,5),(0,60),(1,5),(2,1),(3,2),(4,30)],cal|_13CO2,vLaser2)
cal_13CO2 = makeScan(f_13CO2,fsr,[(4,20),(3,1),(2,1),(1,3),(0,40),(-1,3),(-2,1),(-3,1),(-4,40),(-3,1),(-2,1),(-1,3),(0,40),(1,3),(2,1),(3,1),(4,20)],cal|_13CO2,vLaser2)
