...
cal_13CH4 += makeScan(f_13CH4,fsr,[(2,14),(1,4),(0,32),(-1,2),(-2,4),(-3,14)],cal|_13CH4,vLaser3)
...
cal_H2O =  makeScan(f_H2O,fsr,[(-4,3),(-3,1),(-2,1),(-1,2),(0,6),(1,2),(2,1),(3,1),(4,3)],H2O,vLaser5)
cal_H2O += makeScan(f_H2O,fsr,[(4,3),(3,1),(2,1),(1,2),(0,6),(-1,2),(-2,1),(-3,1),(-4,3)],cal|H2O,vLaser5)
...
scan_H2O = makeScan(f_H2O,fsr,[(-4,2),(-3,2),(-2,2),(-1,2),(0,6),(1,2),(2,2),(3,2),(4,2),(4,2),(3,2),(2,2),(1,2),(0,6),(-1,2),(-2,2),(-3,2),(-4,2)],H2O,vLaser5)
scan_H2O[-1].subschemeId |= fit

schemeRows += cal_13CH4 + cal_12CH4
schemeRows += scan_13CH4 + scan_12CH4
