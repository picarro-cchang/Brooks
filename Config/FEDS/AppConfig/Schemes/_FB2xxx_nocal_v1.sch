...
cal_13CH4 += makeScan(f_13CH4,fsr,[(2,8),(1,8),(0,20),(-1,6),(-2,8),(-3,8)],pztcen|_13CH4,vLaser3)
cal_13CH4[-1].subschemeId |= fit

cal_12CH4 =  makeScan(f_12CH4,fsr,[(4,5),(3,3),(2,3),(1,5),(0,16),(-1,5),(-2,3),(-3,3),(-4,5)],_12CH4,vLaser4)
cal_12CH4 += makeScan(f_12CH4,fsr,[(-4,5),(-3,3),(-2,3),(-1,5),(0,16),(1,5),(2,3),(3,3),(4,5)],pztcen|_12CH4,vLaser4)
