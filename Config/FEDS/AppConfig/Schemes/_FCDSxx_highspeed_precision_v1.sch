...
scan_H2O =  makeScan(f_H2O,fsr,[(-5,1),(-4,1),(-3,1),(-2,1),(-1,2),(0,2),(1,2),(2,1),(3,1),(4,1),(5,1)],cal|pztcen|H2O,vLaser5)
...
schemeRows += scan_CH4_high_precision + scan_13CH4 + goto_start_12CH4
