...
#  STILL NEED TO APPLY CORRECTIONS FROM 6057 REGION INSTEAD OF SID109 
...
if INIT:
    fname = os.path.join(BASEPATH,r"./spectral library_CBDS+CFADS6057.ini")
    ...
    anCH4.append(Analysis(os.path.join(BASEPATH,r"./CFADS/cFADS-1 CH4 v3_1 20110215.ini")))
    anCH4.append(Analysis(os.path.join(BASEPATH,r"./CFADS/cFADS-1 CH4 FC FY v3_1 20110215.ini")))
...
if d["spectrumId"] == 105 and d["numgroups"] >= 7:  # C12O2
...
elif d["spectrumId"] == 106 and d["numgroups"] >= 9:  # C13O2
...
elif d["spectrumId"]==11 and d["numgroups"]>10:   #H2O at 6057.8
...
elif (d["spectrumId"]==25) and (d["numgroups"]>14):
...
#  Polishing step with fixed center and y if line is weak or shift is large
    ...
    ch4_splinemax = r[1002,"peak"]
    ch4_peak_baseavg = ch4_splinemax+CFADS_base-CFADS_base_avg
    ch4_conc_ppmv_final = ch4_peak_baseavg/216.3
    ch4_res = r["std_dev_res"]
...
#  THESE NEED TO BE REEXPRESSED IN TERMS OF CFADS WATER AND METHANE
...
if (ignore_count == 0) and (not ignoreThis):
    RESULT = {"y87_ave":y87_ave,"z87_ave":z87_ave,"shift_87":shift_87,"str_87":str_87,"peak87_baseave":peak87_baseave,"base_87":base_87,"slope_87":slope_87,
              ...
              "peak_92":peak_92,"c2h4_conc":c2h4_conc,"datapoints":d["datapoints"],"datagroups":d["numgroups"],"y_87":y_87,
              ...
              "ch4_adjust":ch4_adjust,"ch4_shift":ch4_shift,"CFADS_ch4_amp":CFADS_ch4_amp,
              "ch4_vy":ch4_vy,"ch4_y_avg":ch4_y_avg,"ch4_splinemax":ch4_splinemax,
