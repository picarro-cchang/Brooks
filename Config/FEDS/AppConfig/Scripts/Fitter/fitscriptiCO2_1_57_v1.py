...
if INIT:
    ...
    fname = os.path.join(BASEPATH,r"./isoCO2/fitter_config.ini")
...
if ((d["spectrumId"] == 0) or (d["spectrumId"] == 105) or (d["spectrumId"] == 106)) and (peak_87 >= 20):
    eps = 1e-14
...
if (ignore_count == 0) and (not ignoreThis):
    RESULT = {"y87_ave":y87_ave,"z87_ave":z87_ave,"shift_87":shift_87,"str_87":str_87,"peak87_baseave":peak87_baseave,"base_87":base_87,"slope_87":slope_87,
              ...
              "peak_92":peak_92,"c2h4_conc":c2h4_conc,"ringdowns":d["datapoints"],"sparsedPoints":d["numgroups"],
              "ratio_i":initial_galratio,"ratio_b":baseave_galratio,"ratio_p":polybaseave_galratio,"polypeak88_baseave":polypeak88_baseave,
              "ch4_spec":ch4_spec,"peak91_spec":peak91_spec,"peak96_spec":peak96_spec,"peak87_baseave_spec":peak87_baseave_spec,"peak88_baseave_spec":peak88_baseave_spec,
