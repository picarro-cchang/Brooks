...
#    anC13O2.append(Analysis(os.path.join(BASEPATH,r"./isoCO2/polynomial fit C13.ini")))
    ...
    c12_base_ave = 870  # Set this to be close to the cavity baseline
    c13_base_ave = 870  # Set this to be close to the cavity baseline
    counter = -25
    lastgood_shift_87 = 0
...
if (ignore_count == 0) and (not ignoreThis):
    RESULT = {"y_87":y_87,"z_87":z_87,"shift_87":shift_87,"str_87":str_87,"peak87_baseave":peak87_baseave,
              ...
              "y_91":y_91,"z_91":z_91,"shift_91":shift_91,"peak_91":peak_91,
              "cm_adjust":cm_adjust,
