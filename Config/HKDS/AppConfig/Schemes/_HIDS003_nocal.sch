...
# Total number of ringdowns remains approximately same; ~9 ringdowns transfered from D peak to O-18 peak.

pkH2_18O  = makeScan(fH2_18O,fsr,[(-6,2),(-5,1),(-4,1),(-3,1),(-2,1),(-1,2),(0,14),(1,2),(2,1),(3,1),(4,2)],H2O|pztcen,vLaserH2_18O)
pkH2_16O  = makeScan(fH2_16O,fsr,[(-4,2),(-3,1),(-2,1),(-1,2),(0,10),(1,2),(2,1),(3,1),(4,2)],H2O|pztcen,vLaserH2_16O)
pkH_D_16O  = makeScan(fH_D_16O,fsr,[(-4,2),(-3,1),(-2,1),(-1,2),(0,12),(1,2),(2,1),(3,1),(4,1),(5,2)],H2O|pztcen,vLaserH_D_16O)
idea1 = pkH2_18O + pkH2_16O + pkH_D_16O
idea2 = deepcopy(idea1[::-1])
idea3 = deepcopy(idea1[::-1])
schemeRows = idea1 + idea2 + idea1 + idea3
