...
if _PERSISTENT_["init"]:
    ...
    _PERSISTENT_["pzt3_offset"] = 32768
    _PERSISTENT_["pzt4_offset"] = 32768
    _PERSISTENT_["pzt5_offset"] = 32768
...
if not good:
    ...
    if _DATA_["spectrum"] == 123: 
        ...
        try:
            ...
            _NEW_DATA_["pzt1_offset"] = newPZToffset
        ...
        try:
            ...
            _NEW_DATA_["pzt2_offset"] = newPZToffset
        ...
        try:
            ...
            newPZToffset = _DRIVER_.rdDasReg("PZT_OFFSET_VIRTUAL_LASER3") + adjust
            while newPZToffset > 45768:
                newPZToffset -= _DATA_["pzt_per_fsr"]
            while newPZToffset < 19768:
                newPZToffset += _DATA_["pzt_per_fsr"]            
            _PERSISTENT_["pzt3_offset"] = newPZToffset
            _NEW_DATA_["pzt3_offset"] = newPZToffset
            _DRIVER_.wrDasReg("PZT_OFFSET_VIRTUAL_LASER3",newPZToffset)
        except:
            pass 
            
        try:
            adjust = _DATA_["pzt4_adjust"]*PZTgain
            newPZToffset = _DRIVER_.rdDasReg("PZT_OFFSET_VIRTUAL_LASER4") + adjust
            while newPZToffset > 45768:
                newPZToffset -= _DATA_["pzt_per_fsr"]
            while newPZToffset < 19768:
                newPZToffset += _DATA_["pzt_per_fsr"]
            _PERSISTENT_["pzt4_offset"] = newPZToffset
            _NEW_DATA_["pzt4_offset"] = newPZToffset
        ...
        try:
            ...
            newPZToffset = _DRIVER_.rdDasReg("PZT_OFFSET_VIRTUAL_LASER5") + adjust
            while newPZToffset > 45768:
                newPZToffset -= _DATA_["pzt_per_fsr"]
            while newPZToffset < 19768:
                newPZToffset += _DATA_["pzt_per_fsr"]
            _PERSISTENT_["pzt5_offset"] = newPZToffset
            _NEW_DATA_["pzt5_offset"] = newPZToffset
            _DRIVER_.wrDasReg("PZT_OFFSET_VIRTUAL_LASER5",newPZToffset)
        except:
            pass 
