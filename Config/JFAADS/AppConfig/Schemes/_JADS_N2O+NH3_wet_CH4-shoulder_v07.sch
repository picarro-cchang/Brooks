...
CH4_HR_up = makeScan(f_CH4_HR,fsr,[(-3,4),(-2,4),(-1,6),(0,35),(1,6),(2,4),(3,4),(4,4)],CH4|pztcen,CH4_laser,th_6057)
CH4_HR_down = makeScan(f_CH4_HR,fsr,[(4,4),(3,4),(2,4),(1,6),(0,35),(-1,6),(-2,4),(-3,4)],CH4|pztcen|cal,CH4_laser,th_6057)
CH4_up[-1].subschemeId |= fit
scan_CH4_HR = CH4_HR_down + CH4_HR_up
scan_CH4_HR.append(Row(f_CO2_HP-4*fsr,0,CO2 | ignore,CO2_laser,th_6057))

scan_CO2_HP = makeScan(f_CO2_HP,fsr,[(-4,6),(-3,2),(-2,2),(-1,4),(0,20),(1,4),(2,2),(3,2),(4,12),(3,2),(2,2),(1,4),(0,20),(-1,4),(-2,2),(-3,2),(-4,6)],CO2_HP|pztcen|cal,CO2_laser,th_6057)
scan_CO2_HP[-1].subschemeId |= fit
scan_CO2_HP.append(Row(f_CH4+8*fsr,0,CH4 | ignore,CH4_laser,th_6057))
...
schemeRows = scan_CH4_HR + scan_N2O + scan_H2O + scan_CO2_HP + scan_N2O
$$$
