...
peak_1a_dry = newValues[xs.indexByName["peak_1a"]] / (1 + (-0.01536255) * h2o + (-8.04039e-4) * h2o**2)
peak_2_dry = newValues[xs.indexByName["peak_2"]]  / (1 + (-0.05225) * h2o + (6.15343E-4) * h2o**2)
ch4_splinemax_dry = newValues[xs.indexByName["ch4_splinemax"]] / (1 + (-0.0130) * h2o + (-3.447E-4) * h2o**2)
