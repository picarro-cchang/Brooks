...
if _PERSISTENT_["init"]:
    ...
    test1["peak_1a"] = _INSTR_["peak2_on_peak1a"]
    test1["peak_41"] = 0
    test1["peak_2"] = 1
    test1["peak15"] = _INSTR_["peak2_on_peak15"]
    test1["peak_4"] = _INSTR_["peak2_on_peak4"]
    test1["ch4_splinemax"] = _INSTR_["peak2_on_ch4splinemax"]
    test1["nh3_conc_ave"] = _INSTR_["peak2_on_nh3concave"]
    ...
    def nonLinCorr(actual):
        ...
        corr[xs.indexByName["peak15"]] = _INSTR_["peak1a_on_peak15_quad"] * actual[xs.indexByName["peak_1a"]]**2
        corr[xs.indexByName["peak_1a"]] = _INSTR_["peak4_peak15_on_peak1a"] * actual[xs.indexByName["peak_4"]]*actual[xs.indexByName["peak15"]]
        corr[xs.indexByName["peak_2"]] = _INSTR_["peak4_peak15_on_peak2"] * actual[xs.indexByName["peak_4"]]*actual[xs.indexByName["peak15"]]
        return corr
