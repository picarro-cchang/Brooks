...
if _PERSISTENT_["init"]:
    influence_of = {"peak_1a":{}, "peak_2":{}, "peak_41":{}, "peak15":{}, "ch4_splinemax":{}, "nh3_conc_ave":{}} 
    ...
    def nonLinCorr(actual):
        ...
        corr[xs.indexByName["peak_1a"]] = 3.30485E-6 * actual[xs.indexByName["peak15"]]**2
        return corr
...
_REPORT_["CO2_HP"] = applyLinear(co2,CO2)
