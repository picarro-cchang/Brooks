...
if INIT:
    ...
    anN2O = []
    anN2O.append(Analysis(os.path.join(BASEPATH,r"./JADS/N2O+CO2+HDO_VC_FY_v1_1.ini")))
    anN2O.append(Analysis(os.path.join(BASEPATH,r"./JADS/N2O_only_w_HDO_v2_1.ini")))
...
if not IgnoreThis:    
    RESULT = {"res_a":res_a,"res_11":res_11,"res_12":res_12,"badshot_nh3":badshot_nh3,
              ...
              "nh3_shift_11":nh3_shift_11,"nh3_shift_12":nh3_shift_11,"y_25":y_25,"splineamp":splineamp,
