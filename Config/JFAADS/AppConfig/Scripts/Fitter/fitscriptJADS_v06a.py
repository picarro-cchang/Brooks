...
if INIT:
    fname = os.path.join(BASEPATH,r"./JADS/JADS spectral library v3_4.ini")
...
if (species == 45 or species == 47):  #  fit N2O only with preset HDO and ammonia
    ...
    init[1003,2] = 0.00108*ch4_amp
    init[4,"y"] = 0.7991+0.0625*h2o_conc  
    #init[4,"center"] = 6562.56059+4.6e-5*(h2o_conc-4.6)
    r = anN2O[1](d,init,deps)
    ANALYSIS.append(r)
    peak_1a = r[1,"peak"]   
    base_1a = r[1,"base"]
    center_hdo = r[4,"center"]
...
if not IgnoreThis:    
    RESULT = {"res_a":res_a,"res_11":res_11,"res_12":res_12,"badshot_nh3":badshot_nh3,
              ...
              "nh3_pzt_mean":nh3_pzt_mean,"nh3_pzt_stdev":nh3_pzt_stdev, "center_hdo":center_hdo}
