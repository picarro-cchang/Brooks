...
#  20161202:  V2.6 has changes from Justin.  
#  20161202   V 2.7 allows WLM to adjust when methane concentration is large
#  20170104   V 2.8 has changes from Justin cleaning up model:data correlation score handling
...
if (d["spectrumId"]==65) and (d["ngroups"]>4):
    ...
    model_vector = r.model.funcList[1](r.model.xModifier(d.fitData["freq"]))+r.model.funcList[2](r.model.xModifier(d.fitData["freq"]))+r.model.funcList[5](r.model.xModifier(d.fitData["freq"]))  # [1] is water spline and [2] is peroxide spline [5] is methane spline
...
if not IgnoreThis:
    RESULT = {"h2o2_ppbv":h2o2_ppbv,"h2o2_shift":h2o2_shift,"h2o2_adjust":h2o2_adjust,
              ...
              "ngroups":d["ngroups"],"rds":d["datapoints"],"Spectrum_Score":spectrum_Score,
