...
if INIT:
    ...
    anH2O2.append(Analysis(os.path.join(BASEPATH,r"./NBDS/NBDSxx H2O + H2O2 basic VY VC v3.ini")))
...
if (d["spectrumId"]==65) and (d["ngroups"]>4):
    ...
    if abs(r["base",3])>0.03 or (r[1000,2]<0.003 and r[1001,2]<0.015):
...
if not IgnoreThis:     
    RESULT = {"h2o2_ppbv":h2o2_ppbv,"h2o2_shift":h2o2_shift,"h2o2_adjust":h2o2_adjust,
              ...
              "pzt_mean":pzt_mean,"pzt_std":pzt_stdev,"vh2o2_ppbv":vh2o2_ppbv,"vh2o2_amp":vh2o2_amp,
              "ngroups":d["ngroups"],"rds":d["datapoints"],"h2o2_correlation":h2o2_correlation,
              "h2o_correlation":h2o_correlation,"h2o2_partial_correlation":h2o2_partial_correlation,"h2o_partial_correlation":h2o_partial_correlation,
              "h2o2_residual_ratio":h2o2_residual_ratio,"h2o_residual_ratio":h2o_residual_ratio,
              "h2o2_partial_residual_ratio":h2o2_partial_residual_ratio,"h2o_partial_residual_ratio":h2o_partial_residual_ratio,
