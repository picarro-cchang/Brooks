...
if (d["spectrumId"]==65) and (d["ngroups"]>4):
    ...
    model_vector = r.model.funcList[1](r.model.xModifier(d.fitData["freq"]))+r.model.funcList[2](r.model.xModifier(d.fitData["freq"]))
...
if not IgnoreThis:     
    RESULT = {"h2o2_ppbv":h2o2_ppbv,"h2o2_shift":h2o2_shift,"h2o2_adjust":h2o2_adjust,
              ...
              "pzt_mean":pzt_mean,"pzt_std":pzt_stdev,"vh2o2_ppbv":vh2o2_ppbv,"vh2o2_amp":vh2o2_amp,"ch4_conc":ch4_conc,
              "ngroups":d["ngroups"],"rds":d["datapoints"],"h2o2_correlation":h2o2_correlation,"h2o_correlation":h2o_correlation,
