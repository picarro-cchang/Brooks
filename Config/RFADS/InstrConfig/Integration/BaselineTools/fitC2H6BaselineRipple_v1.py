#  Baseline ripple fitter for experimental ethane region at 5946 wvn
...
if INIT:
    ...
    analysis = []
    analysis.append(Analysis(os.path.join(BASEPATH,r"./C2H6 baseline ripple 1frequency.ini")))
    analysis.append(Analysis(os.path.join(BASEPATH,r"./C2H6 baseline ripple v01.ini")))
