...
#  2016-07-17:  Added HCl Supersaturation Flag
...
tstart = time.clock()
if d["spectrumId"]==63 and d["ngroups"]>27:
    initialize_Baseline()
...
elif d["spectrumId"]==63 and d["ngroups"]<=27:
    hcl_saturation = 1
...
if (ignore_count ==0) and not IgnoreThis:   # and not bad_baseline:     
    RESULT = {"res":res,"baseline_level":baseline_level,"baseline_slope":baseline_slope,"base70":base70,
              ...
              "bad_baseline":bad_baseline,"pzt_mean":pzt_mean,"pzt_stdev":pzt_stdev,"hcl_saturation":hcl_saturation}
