...
#   Fit water at 7824.07 wvn, VC
    ...
    ANALYSIS.append(r)
    if r[77,"peak"]>2 or r[79,"peak"]>2:
        # fit with variable center if either H2O or HF peak is strong.
    ...
    hf_ppbv = 0.2*peak_77
    hf_ppbv_ave = 0.2*peak77_baseave
    counter += 1
...
RESULT = {"base0":base0,"base1":base1,"base77_ave":base77_ave,
