...
from Host.Common.SharedTypes import RPC_PORT_DRIVER, RPC_PORT_MEAS_SYSTEM, RPC_PORT_SAMPLE_MGR, RPC_PORT_DATA_MANAGER, RPC_PORT_DATALOGGER, RPC_PORT_QUICK_GUI
...
class StateMachine(object):
    ...
    def run(self):
        ...
        CoordinatorScripts.QUICKGUI = self.quickGui
