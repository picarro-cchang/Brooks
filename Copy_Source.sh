...
nonCythonizeIncludeIconFolderList[18]="Host/Utilities/SelfCalibration/*.*"
...
nonCythonizeIncludeIconFolderList[22]="AddOns/DatViewer/*.py"
nonCythonizeIncludeIconFolderList[23]="AddOns/DatViewer/Scripts/*.py"
nonCythonizeIncludeIconFolderList[24]="AddOns/DatViewer/tzlocal/*.py"
nonCythonizeIncludeIconFolderList[25]="AddOns/DatViewer/Manual/*.*"
nonCythonizeIncludeIconFolderList[26]="AddOns/DatViewer/Manual/_images/*.*"
nonCythonizeIncludeIconFolderList[27]="AddOns/DatViewer/Manual/_sources/*.*"
nonCythonizeIncludeIconFolderList[28]="AddOns/DatViewer/Manual/_static/*.*"
