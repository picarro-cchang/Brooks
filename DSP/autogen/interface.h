...
#define INTERFACE_NUMBER_OF_REGISTERS (390)
...
#define RD_DATA_MOVING_COUNT_REGISTER (8)
#define RD_QDMA_DONE_COUNT_REGISTER (9)
#define RD_FITTING_COUNT_REGISTER (10)
#define RD_INITIATED_COUNT_REGISTER (11)
#define ACQ_DONE_COUNT_REGISTER (12)
...
#define LASER1_TEMP_CNTRL_LOCK_STATUS_REGISTER (27)
...
#define LASER1_TEC_PRBS_GENPOLY_REGISTER (46)
#define LASER1_TEC_PRBS_AMPLITUDE_REGISTER (47)
#define LASER1_TEC_PRBS_MEAN_REGISTER (48)
#define LASER1_TEC_MONITOR_REGISTER (49)
#define LASER1_CURRENT_CNTRL_STATE_REGISTER (50)
#define LASER1_MANUAL_COARSE_CURRENT_REGISTER (51)
#define LASER1_MANUAL_FINE_CURRENT_REGISTER (52)
#define LASER1_CURRENT_SWEEP_MIN_REGISTER (53)
#define LASER1_CURRENT_SWEEP_MAX_REGISTER (54)
#define LASER1_CURRENT_SWEEP_INCR_REGISTER (55)
#define LASER1_CURRENT_MONITOR_REGISTER (56)
#define CONVERSION_LASER2_THERM_CONSTA_REGISTER (57)
#define CONVERSION_LASER2_THERM_CONSTB_REGISTER (58)
#define CONVERSION_LASER2_THERM_CONSTC_REGISTER (59)
#define CONVERSION_LASER2_CURRENT_SLOPE_REGISTER (60)
#define CONVERSION_LASER2_CURRENT_OFFSET_REGISTER (61)
#define LASER2_RESISTANCE_REGISTER (62)
#define LASER2_TEMPERATURE_REGISTER (63)
#define LASER2_THERMISTOR_ADC_REGISTER (64)
#define LASER2_TEC_REGISTER (65)
#define LASER2_MANUAL_TEC_REGISTER (66)
#define LASER2_TEMP_CNTRL_STATE_REGISTER (67)
#define LASER2_TEMP_CNTRL_LOCK_STATUS_REGISTER (68)
#define LASER2_TEMP_CNTRL_SETPOINT_REGISTER (69)
#define LASER2_TEMP_CNTRL_USER_SETPOINT_REGISTER (70)
#define LASER2_TEMP_CNTRL_TOLERANCE_REGISTER (71)
#define LASER2_TEMP_CNTRL_SWEEP_MAX_REGISTER (72)
#define LASER2_TEMP_CNTRL_SWEEP_MIN_REGISTER (73)
#define LASER2_TEMP_CNTRL_SWEEP_INCR_REGISTER (74)
#define LASER2_TEMP_CNTRL_H_REGISTER (75)
#define LASER2_TEMP_CNTRL_K_REGISTER (76)
#define LASER2_TEMP_CNTRL_TI_REGISTER (77)
#define LASER2_TEMP_CNTRL_TD_REGISTER (78)
#define LASER2_TEMP_CNTRL_B_REGISTER (79)
#define LASER2_TEMP_CNTRL_C_REGISTER (80)
#define LASER2_TEMP_CNTRL_N_REGISTER (81)
#define LASER2_TEMP_CNTRL_S_REGISTER (82)
#define LASER2_TEMP_CNTRL_FFWD_REGISTER (83)
#define LASER2_TEMP_CNTRL_AMIN_REGISTER (84)
#define LASER2_TEMP_CNTRL_AMAX_REGISTER (85)
#define LASER2_TEMP_CNTRL_IMAX_REGISTER (86)
#define LASER2_TEC_PRBS_GENPOLY_REGISTER (87)
#define LASER2_TEC_PRBS_AMPLITUDE_REGISTER (88)
#define LASER2_TEC_PRBS_MEAN_REGISTER (89)
#define LASER2_TEC_MONITOR_REGISTER (90)
#define LASER2_CURRENT_CNTRL_STATE_REGISTER (91)
#define LASER2_MANUAL_COARSE_CURRENT_REGISTER (92)
#define LASER2_MANUAL_FINE_CURRENT_REGISTER (93)
#define LASER2_CURRENT_SWEEP_MIN_REGISTER (94)
#define LASER2_CURRENT_SWEEP_MAX_REGISTER (95)
#define LASER2_CURRENT_SWEEP_INCR_REGISTER (96)
#define LASER2_CURRENT_MONITOR_REGISTER (97)
#define CONVERSION_LASER3_THERM_CONSTA_REGISTER (98)
#define CONVERSION_LASER3_THERM_CONSTB_REGISTER (99)
#define CONVERSION_LASER3_THERM_CONSTC_REGISTER (100)
#define CONVERSION_LASER3_CURRENT_SLOPE_REGISTER (101)
#define CONVERSION_LASER3_CURRENT_OFFSET_REGISTER (102)
#define LASER3_RESISTANCE_REGISTER (103)
#define LASER3_TEMPERATURE_REGISTER (104)
#define LASER3_THERMISTOR_ADC_REGISTER (105)
#define LASER3_TEC_REGISTER (106)
#define LASER3_MANUAL_TEC_REGISTER (107)
#define LASER3_TEMP_CNTRL_STATE_REGISTER (108)
#define LASER3_TEMP_CNTRL_LOCK_STATUS_REGISTER (109)
#define LASER3_TEMP_CNTRL_SETPOINT_REGISTER (110)
#define LASER3_TEMP_CNTRL_USER_SETPOINT_REGISTER (111)
#define LASER3_TEMP_CNTRL_TOLERANCE_REGISTER (112)
#define LASER3_TEMP_CNTRL_SWEEP_MAX_REGISTER (113)
#define LASER3_TEMP_CNTRL_SWEEP_MIN_REGISTER (114)
#define LASER3_TEMP_CNTRL_SWEEP_INCR_REGISTER (115)
#define LASER3_TEMP_CNTRL_H_REGISTER (116)
#define LASER3_TEMP_CNTRL_K_REGISTER (117)
#define LASER3_TEMP_CNTRL_TI_REGISTER (118)
#define LASER3_TEMP_CNTRL_TD_REGISTER (119)
#define LASER3_TEMP_CNTRL_B_REGISTER (120)
#define LASER3_TEMP_CNTRL_C_REGISTER (121)
#define LASER3_TEMP_CNTRL_N_REGISTER (122)
#define LASER3_TEMP_CNTRL_S_REGISTER (123)
#define LASER3_TEMP_CNTRL_FFWD_REGISTER (124)
#define LASER3_TEMP_CNTRL_AMIN_REGISTER (125)
#define LASER3_TEMP_CNTRL_AMAX_REGISTER (126)
#define LASER3_TEMP_CNTRL_IMAX_REGISTER (127)
#define LASER3_TEC_PRBS_GENPOLY_REGISTER (128)
#define LASER3_TEC_PRBS_AMPLITUDE_REGISTER (129)
#define LASER3_TEC_PRBS_MEAN_REGISTER (130)
#define LASER3_TEC_MONITOR_REGISTER (131)
#define LASER3_CURRENT_CNTRL_STATE_REGISTER (132)
#define LASER3_MANUAL_COARSE_CURRENT_REGISTER (133)
#define LASER3_MANUAL_FINE_CURRENT_REGISTER (134)
#define LASER3_CURRENT_SWEEP_MIN_REGISTER (135)
#define LASER3_CURRENT_SWEEP_MAX_REGISTER (136)
#define LASER3_CURRENT_SWEEP_INCR_REGISTER (137)
#define LASER3_CURRENT_MONITOR_REGISTER (138)
#define CONVERSION_LASER4_THERM_CONSTA_REGISTER (139)
#define CONVERSION_LASER4_THERM_CONSTB_REGISTER (140)
#define CONVERSION_LASER4_THERM_CONSTC_REGISTER (141)
#define CONVERSION_LASER4_CURRENT_SLOPE_REGISTER (142)
#define CONVERSION_LASER4_CURRENT_OFFSET_REGISTER (143)
#define LASER4_RESISTANCE_REGISTER (144)
#define LASER4_TEMPERATURE_REGISTER (145)
#define LASER4_THERMISTOR_ADC_REGISTER (146)
#define LASER4_TEC_REGISTER (147)
#define LASER4_MANUAL_TEC_REGISTER (148)
#define LASER4_TEMP_CNTRL_STATE_REGISTER (149)
#define LASER4_TEMP_CNTRL_LOCK_STATUS_REGISTER (150)
#define LASER4_TEMP_CNTRL_SETPOINT_REGISTER (151)
#define LASER4_TEMP_CNTRL_USER_SETPOINT_REGISTER (152)
#define LASER4_TEMP_CNTRL_TOLERANCE_REGISTER (153)
#define LASER4_TEMP_CNTRL_SWEEP_MAX_REGISTER (154)
#define LASER4_TEMP_CNTRL_SWEEP_MIN_REGISTER (155)
#define LASER4_TEMP_CNTRL_SWEEP_INCR_REGISTER (156)
#define LASER4_TEMP_CNTRL_H_REGISTER (157)
#define LASER4_TEMP_CNTRL_K_REGISTER (158)
#define LASER4_TEMP_CNTRL_TI_REGISTER (159)
#define LASER4_TEMP_CNTRL_TD_REGISTER (160)
#define LASER4_TEMP_CNTRL_B_REGISTER (161)
#define LASER4_TEMP_CNTRL_C_REGISTER (162)
#define LASER4_TEMP_CNTRL_N_REGISTER (163)
#define LASER4_TEMP_CNTRL_S_REGISTER (164)
#define LASER4_TEMP_CNTRL_FFWD_REGISTER (165)
#define LASER4_TEMP_CNTRL_AMIN_REGISTER (166)
#define LASER4_TEMP_CNTRL_AMAX_REGISTER (167)
#define LASER4_TEMP_CNTRL_IMAX_REGISTER (168)
#define LASER4_TEC_PRBS_GENPOLY_REGISTER (169)
#define LASER4_TEC_PRBS_AMPLITUDE_REGISTER (170)
#define LASER4_TEC_PRBS_MEAN_REGISTER (171)
#define LASER4_TEC_MONITOR_REGISTER (172)
#define LASER4_CURRENT_CNTRL_STATE_REGISTER (173)
#define LASER4_MANUAL_COARSE_CURRENT_REGISTER (174)
#define LASER4_MANUAL_FINE_CURRENT_REGISTER (175)
#define LASER4_CURRENT_SWEEP_MIN_REGISTER (176)
#define LASER4_CURRENT_SWEEP_MAX_REGISTER (177)
#define LASER4_CURRENT_SWEEP_INCR_REGISTER (178)
#define LASER4_CURRENT_MONITOR_REGISTER (179)
#define CONVERSION_ETALON_THERM_CONSTA_REGISTER (180)
#define CONVERSION_ETALON_THERM_CONSTB_REGISTER (181)
#define CONVERSION_ETALON_THERM_CONSTC_REGISTER (182)
#define ETALON_RESISTANCE_REGISTER (183)
#define ETALON_TEMPERATURE_REGISTER (184)
#define ETALON_THERMISTOR_ADC_REGISTER (185)
#define CONVERSION_WARM_BOX_THERM_CONSTA_REGISTER (186)
#define CONVERSION_WARM_BOX_THERM_CONSTB_REGISTER (187)
#define CONVERSION_WARM_BOX_THERM_CONSTC_REGISTER (188)
#define WARM_BOX_RESISTANCE_REGISTER (189)
#define WARM_BOX_TEMPERATURE_REGISTER (190)
#define WARM_BOX_THERMISTOR_ADC_REGISTER (191)
#define WARM_BOX_TEC_REGISTER (192)
#define WARM_BOX_MANUAL_TEC_REGISTER (193)
#define WARM_BOX_TEMP_CNTRL_STATE_REGISTER (194)
#define WARM_BOX_TEMP_CNTRL_LOCK_STATUS_REGISTER (195)
#define WARM_BOX_TEMP_CNTRL_SETPOINT_REGISTER (196)
#define WARM_BOX_TEMP_CNTRL_USER_SETPOINT_REGISTER (197)
#define WARM_BOX_TEMP_CNTRL_TOLERANCE_REGISTER (198)
#define WARM_BOX_TEMP_CNTRL_SWEEP_MAX_REGISTER (199)
#define WARM_BOX_TEMP_CNTRL_SWEEP_MIN_REGISTER (200)
#define WARM_BOX_TEMP_CNTRL_SWEEP_INCR_REGISTER (201)
#define WARM_BOX_TEMP_CNTRL_H_REGISTER (202)
#define WARM_BOX_TEMP_CNTRL_K_REGISTER (203)
#define WARM_BOX_TEMP_CNTRL_TI_REGISTER (204)
#define WARM_BOX_TEMP_CNTRL_TD_REGISTER (205)
#define WARM_BOX_TEMP_CNTRL_B_REGISTER (206)
#define WARM_BOX_TEMP_CNTRL_C_REGISTER (207)
#define WARM_BOX_TEMP_CNTRL_N_REGISTER (208)
#define WARM_BOX_TEMP_CNTRL_S_REGISTER (209)
#define WARM_BOX_TEMP_CNTRL_FFWD_REGISTER (210)
#define WARM_BOX_TEMP_CNTRL_AMIN_REGISTER (211)
#define WARM_BOX_TEMP_CNTRL_AMAX_REGISTER (212)
#define WARM_BOX_TEMP_CNTRL_IMAX_REGISTER (213)
#define WARM_BOX_TEC_PRBS_GENPOLY_REGISTER (214)
#define WARM_BOX_TEC_PRBS_AMPLITUDE_REGISTER (215)
#define WARM_BOX_TEC_PRBS_MEAN_REGISTER (216)
#define WARM_BOX_MAX_HEATSINK_TEMP_REGISTER (217)
#define CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTA_REGISTER (218)
#define CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTB_REGISTER (219)
#define CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTC_REGISTER (220)
#define WARM_BOX_HEATSINK_RESISTANCE_REGISTER (221)
#define WARM_BOX_HEATSINK_TEMPERATURE_REGISTER (222)
#define WARM_BOX_HEATSINK_THERMISTOR_ADC_REGISTER (223)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTA_REGISTER (224)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTB_REGISTER (225)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTC_REGISTER (226)
#define HOT_BOX_HEATSINK_RESISTANCE_REGISTER (227)
#define HOT_BOX_HEATSINK_TEMPERATURE_REGISTER (228)
#define HOT_BOX_HEATSINK_ADC_REGISTER (229)
#define CONVERSION_CAVITY_THERM_CONSTA_REGISTER (230)
#define CONVERSION_CAVITY_THERM_CONSTB_REGISTER (231)
#define CONVERSION_CAVITY_THERM_CONSTC_REGISTER (232)
#define CAVITY_RESISTANCE_REGISTER (233)
#define CAVITY_TEMPERATURE_REGISTER (234)
#define CAVITY_THERMISTOR_ADC_REGISTER (235)
#define CAVITY_TEC_REGISTER (236)
#define CAVITY_MANUAL_TEC_REGISTER (237)
#define CAVITY_TEMP_CNTRL_STATE_REGISTER (238)
#define CAVITY_TEMP_CNTRL_LOCK_STATUS_REGISTER (239)
#define CAVITY_TEMP_CNTRL_SETPOINT_REGISTER (240)
#define CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER (241)
#define CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER (242)
#define CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER (243)
#define CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER (244)
#define CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER (245)
#define CAVITY_TEMP_CNTRL_H_REGISTER (246)
#define CAVITY_TEMP_CNTRL_K_REGISTER (247)
#define CAVITY_TEMP_CNTRL_TI_REGISTER (248)
#define CAVITY_TEMP_CNTRL_TD_REGISTER (249)
#define CAVITY_TEMP_CNTRL_B_REGISTER (250)
#define CAVITY_TEMP_CNTRL_C_REGISTER (251)
#define CAVITY_TEMP_CNTRL_N_REGISTER (252)
#define CAVITY_TEMP_CNTRL_S_REGISTER (253)
#define CAVITY_TEMP_CNTRL_FFWD_REGISTER (254)
#define CAVITY_TEMP_CNTRL_AMIN_REGISTER (255)
#define CAVITY_TEMP_CNTRL_AMAX_REGISTER (256)
#define CAVITY_TEMP_CNTRL_IMAX_REGISTER (257)
#define CAVITY_TEC_PRBS_GENPOLY_REGISTER (258)
#define CAVITY_TEC_PRBS_AMPLITUDE_REGISTER (259)
#define CAVITY_TEC_PRBS_MEAN_REGISTER (260)
#define CAVITY_MAX_HEATSINK_TEMP_REGISTER (261)
#define HEATER_CNTRL_STATE_REGISTER (262)
#define HEATER_CNTRL_GAIN_REGISTER (263)
#define HEATER_CNTRL_QUANTIZE_REGISTER (264)
#define HEATER_CNTRL_UBIAS_SLOPE_REGISTER (265)
#define HEATER_CNTRL_UBIAS_OFFSET_REGISTER (266)
#define HEATER_CNTRL_MARK_MIN_REGISTER (267)
#define HEATER_CNTRL_MARK_MAX_REGISTER (268)
#define HEATER_CNTRL_MANUAL_MARK_REGISTER (269)
#define HEATER_CNTRL_MARK_REGISTER (270)
#define CAVITY_PRESSURE_ADC_REGISTER (271)
#define CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER (272)
#define CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER (273)
#define CAVITY_PRESSURE_REGISTER (274)
#define AMBIENT_PRESSURE_ADC_REGISTER (275)
#define CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER (276)
#define CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER (277)
#define AMBIENT_PRESSURE_REGISTER (278)
#define ANALYZER_TUNING_MODE_REGISTER (279)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (280)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (281)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (282)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (283)
#define TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER (284)
#define TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER (285)
#define TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER (286)
#define TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER (287)
#define RDFITTER_MINLOSS_REGISTER (288)
#define RDFITTER_MAXLOSS_REGISTER (289)
#define RDFITTER_LATEST_LOSS_REGISTER (290)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (291)
#define RDFITTER_START_SAMPLE_REGISTER (292)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (293)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (294)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (295)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (296)
#define RDFITTER_META_BACKOFF_REGISTER (297)
#define RDFITTER_META_SAMPLES_REGISTER (298)
#define SPECT_CNTRL_STATE_REGISTER (299)
#define SPECT_CNTRL_MODE_REGISTER (300)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (301)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (302)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (303)
#define SPECT_CNTRL_SCHEME_ROW_REGISTER (304)
#define SPECT_CNTRL_DWELL_COUNT_REGISTER (305)
#define SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER (306)
#define SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER (307)
#define SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER (308)
#define VIRTUAL_LASER_REGISTER (309)
#define PZT_OFFSET_VIRTUAL_LASER1 (310)
#define PZT_OFFSET_VIRTUAL_LASER2 (311)
#define PZT_OFFSET_VIRTUAL_LASER3 (312)
#define PZT_OFFSET_VIRTUAL_LASER4 (313)
#define PZT_OFFSET_VIRTUAL_LASER5 (314)
#define PZT_OFFSET_VIRTUAL_LASER6 (315)
#define PZT_OFFSET_VIRTUAL_LASER7 (316)
#define PZT_OFFSET_VIRTUAL_LASER8 (317)
#define SCHEME_OFFSET_VIRTUAL_LASER1 (318)
#define SCHEME_OFFSET_VIRTUAL_LASER2 (319)
#define SCHEME_OFFSET_VIRTUAL_LASER3 (320)
#define SCHEME_OFFSET_VIRTUAL_LASER4 (321)
#define SCHEME_OFFSET_VIRTUAL_LASER5 (322)
#define SCHEME_OFFSET_VIRTUAL_LASER6 (323)
#define SCHEME_OFFSET_VIRTUAL_LASER7 (324)
#define SCHEME_OFFSET_VIRTUAL_LASER8 (325)
#define VALVE_CNTRL_STATE_REGISTER (326)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (327)
#define VALVE_CNTRL_USER_INLET_VALVE_REGISTER (328)
#define VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER (329)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (330)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (331)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (332)
#define VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER (333)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (334)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (335)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (336)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (337)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (338)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (339)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (340)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (341)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (342)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (343)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (344)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (345)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (346)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (347)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (348)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (349)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (350)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (351)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (352)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (353)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (354)
#define TEC_CNTRL_REGISTER (355)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (356)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (357)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (358)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (359)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (360)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (361)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (362)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (363)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (364)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (365)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (366)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (367)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (368)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (369)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (370)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (371)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (372)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (373)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (374)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (375)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (376)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (377)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (378)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (379)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (380)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (381)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (382)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (383)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (384)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (385)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (386)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (387)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (388)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (389)
