...
#define INTERFACE_NUMBER_OF_REGISTERS (362)
...
#define VALVE_CNTRL_STATE_REGISTER (303)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (304)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (305)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (306)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (307)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (308)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (309)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (310)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (311)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (312)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (313)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (314)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (315)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (316)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (317)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (318)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (319)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (320)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (321)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (322)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (323)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (324)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (325)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (326)
#define TEC_CNTRL_REGISTER (327)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (328)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (329)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (330)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (331)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (332)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (333)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (334)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (335)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (336)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (337)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (338)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (339)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (340)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (341)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (342)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (343)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (344)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (345)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (346)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (347)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (348)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (349)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (350)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (351)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (352)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (353)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (354)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (355)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (356)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (357)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (358)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (359)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (360)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (361)
