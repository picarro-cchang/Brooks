...
#define INTERFACE_NUMBER_OF_REGISTERS (430)
...
#define PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER (419)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER (420)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER (421)
#define PEAK_DETECT_CNTRL_HISTORY_SIZE_REGISTER (422)
#define PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER (423)
#define PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER (424)
#define PEAK_DETECT_CNTRL_RESET_DELAY_REGISTER (425)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (426)
#define PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER (427)
#define PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER (428)
#define PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER (429)
