...
#define STATUS_OK (0)
#define ERROR_CRC_BAD (-1)
#define ERROR_DSP_UNEXPECTED_SEQUENCE_NUMBER (-2)
#define ERROR_HOST_UNEXPECTED_SEQUENCE_NUMBER (-3)
#define ERROR_BAD_COMMAND (-4)
#define ERROR_BAD_NUM_PARAMS (-5)
#define ERROR_OUTSIDE_SHAREDMEM (-6)
#define ERROR_UNKNOWN_REGISTER (-7)
#define ERROR_NOT_READABLE (-8)
#define ERROR_NOT_WRITABLE (-9)
#define ERROR_READ_FAILED (-10)
#define ERROR_WRITE_FAILED (-11)
#define ERROR_INVALID_WHEEL_SLOT (-12)
#define ERROR_OO_WHEEL_ENTRIES (-13)
#define ERROR_BAD_FILTER_COEFF (-14)
...
#define INTERFACE_NUMBER_OF_REGISTERS (186)

#define NOOP_REGISTER (0)
#define COMM_STATUS_REGISTER (1)
#define TIMESTAMP_LSB_REGISTER (2)
#define TIMESTAMP_MSB_REGISTER (3)
#define SCHEDULER_CONTROL_REGISTER (4)
#define LOW_DURATION_REGISTER (5)
#define HIGH_DURATION_REGISTER (6)
#define DAS_TEMPERATURE_REGISTER (7)
#define CONVERSION_LASER1_THERM_CONSTA_REGISTER (8)
#define CONVERSION_LASER1_THERM_CONSTB_REGISTER (9)
#define CONVERSION_LASER1_THERM_CONSTC_REGISTER (10)
#define LASER1_RESISTANCE_REGISTER (11)
#define LASER1_TEMPERATURE_REGISTER (12)
#define LASER1_THERMISTOR_ADC_REGISTER (13)
#define LASER1_TEC_REGISTER (14)
#define LASER1_MANUAL_TEC_REGISTER (15)
#define LASER1_TEMP_CNTRL_STATE_REGISTER (16)
#define LASER1_TEMP_CNTRL_LOCK_STATUS_REGISTER (17)
#define LASER1_TEMP_CNTRL_SETPOINT_REGISTER (18)
#define LASER1_TEMP_CNTRL_USER_SETPOINT_REGISTER (19)
#define LASER1_TEMP_CNTRL_TOLERANCE_REGISTER (20)
#define LASER1_TEMP_CNTRL_SWEEP_MAX_REGISTER (21)
#define LASER1_TEMP_CNTRL_SWEEP_MIN_REGISTER (22)
#define LASER1_TEMP_CNTRL_SWEEP_INCR_REGISTER (23)
#define LASER1_TEMP_CNTRL_H_REGISTER (24)
#define LASER1_TEMP_CNTRL_K_REGISTER (25)
#define LASER1_TEMP_CNTRL_TI_REGISTER (26)
#define LASER1_TEMP_CNTRL_TD_REGISTER (27)
#define LASER1_TEMP_CNTRL_B_REGISTER (28)
#define LASER1_TEMP_CNTRL_C_REGISTER (29)
#define LASER1_TEMP_CNTRL_N_REGISTER (30)
#define LASER1_TEMP_CNTRL_S_REGISTER (31)
#define LASER1_TEMP_CNTRL_FFWD_REGISTER (32)
#define LASER1_TEMP_CNTRL_AMIN_REGISTER (33)
#define LASER1_TEMP_CNTRL_AMAX_REGISTER (34)
#define LASER1_TEMP_CNTRL_IMAX_REGISTER (35)
#define LASER1_TEC_PRBS_GENPOLY_REGISTER (36)
#define LASER1_TEC_PRBS_AMPLITUDE_REGISTER (37)
#define LASER1_TEC_PRBS_MEAN_REGISTER (38)
#define LASER1_CURRENT_CNTRL_STATE_REGISTER (39)
#define LASER1_MANUAL_COARSE_CURRENT_REGISTER (40)
#define LASER1_MANUAL_FINE_CURRENT_REGISTER (41)
#define LASER1_CURRENT_SWEEP_MIN_REGISTER (42)
#define LASER1_CURRENT_SWEEP_MAX_REGISTER (43)
#define LASER1_CURRENT_SWEEP_INCR_REGISTER (44)
#define LASER1_CURRENT_MONITOR_REGISTER (45)
#define CONVERSION_LASER2_THERM_CONSTA_REGISTER (46)
#define CONVERSION_LASER2_THERM_CONSTB_REGISTER (47)
#define CONVERSION_LASER2_THERM_CONSTC_REGISTER (48)
#define LASER2_RESISTANCE_REGISTER (49)
#define LASER2_TEMPERATURE_REGISTER (50)
#define LASER2_THERMISTOR_ADC_REGISTER (51)
#define LASER2_TEC_REGISTER (52)
#define LASER2_MANUAL_TEC_REGISTER (53)
#define LASER2_TEMP_CNTRL_STATE_REGISTER (54)
#define LASER2_TEMP_CNTRL_LOCK_STATUS_REGISTER (55)
#define LASER2_TEMP_CNTRL_SETPOINT_REGISTER (56)
#define LASER2_TEMP_CNTRL_USER_SETPOINT_REGISTER (57)
#define LASER2_TEMP_CNTRL_TOLERANCE_REGISTER (58)
#define LASER2_TEMP_CNTRL_SWEEP_MAX_REGISTER (59)
#define LASER2_TEMP_CNTRL_SWEEP_MIN_REGISTER (60)
#define LASER2_TEMP_CNTRL_SWEEP_INCR_REGISTER (61)
#define LASER2_TEMP_CNTRL_H_REGISTER (62)
#define LASER2_TEMP_CNTRL_K_REGISTER (63)
#define LASER2_TEMP_CNTRL_TI_REGISTER (64)
#define LASER2_TEMP_CNTRL_TD_REGISTER (65)
#define LASER2_TEMP_CNTRL_B_REGISTER (66)
#define LASER2_TEMP_CNTRL_C_REGISTER (67)
#define LASER2_TEMP_CNTRL_N_REGISTER (68)
#define LASER2_TEMP_CNTRL_S_REGISTER (69)
#define LASER2_TEMP_CNTRL_FFWD_REGISTER (70)
#define LASER2_TEMP_CNTRL_AMIN_REGISTER (71)
#define LASER2_TEMP_CNTRL_AMAX_REGISTER (72)
#define LASER2_TEMP_CNTRL_IMAX_REGISTER (73)
#define LASER2_TEC_PRBS_GENPOLY_REGISTER (74)
#define LASER2_TEC_PRBS_AMPLITUDE_REGISTER (75)
#define LASER2_TEC_PRBS_MEAN_REGISTER (76)
#define CONVERSION_LASER3_THERM_CONSTA_REGISTER (77)
#define CONVERSION_LASER3_THERM_CONSTB_REGISTER (78)
#define CONVERSION_LASER3_THERM_CONSTC_REGISTER (79)
#define LASER3_RESISTANCE_REGISTER (80)
#define LASER3_TEMPERATURE_REGISTER (81)
#define LASER3_THERMISTOR_ADC_REGISTER (82)
#define LASER3_TEC_REGISTER (83)
#define LASER3_MANUAL_TEC_REGISTER (84)
#define LASER3_TEMP_CNTRL_STATE_REGISTER (85)
#define LASER3_TEMP_CNTRL_LOCK_STATUS_REGISTER (86)
#define LASER3_TEMP_CNTRL_SETPOINT_REGISTER (87)
#define LASER3_TEMP_CNTRL_USER_SETPOINT_REGISTER (88)
#define LASER3_TEMP_CNTRL_TOLERANCE_REGISTER (89)
#define LASER3_TEMP_CNTRL_SWEEP_MAX_REGISTER (90)
#define LASER3_TEMP_CNTRL_SWEEP_MIN_REGISTER (91)
#define LASER3_TEMP_CNTRL_SWEEP_INCR_REGISTER (92)
#define LASER3_TEMP_CNTRL_H_REGISTER (93)
#define LASER3_TEMP_CNTRL_K_REGISTER (94)
#define LASER3_TEMP_CNTRL_TI_REGISTER (95)
#define LASER3_TEMP_CNTRL_TD_REGISTER (96)
#define LASER3_TEMP_CNTRL_B_REGISTER (97)
#define LASER3_TEMP_CNTRL_C_REGISTER (98)
#define LASER3_TEMP_CNTRL_N_REGISTER (99)
#define LASER3_TEMP_CNTRL_S_REGISTER (100)
#define LASER3_TEMP_CNTRL_FFWD_REGISTER (101)
#define LASER3_TEMP_CNTRL_AMIN_REGISTER (102)
#define LASER3_TEMP_CNTRL_AMAX_REGISTER (103)
#define LASER3_TEMP_CNTRL_IMAX_REGISTER (104)
#define LASER3_TEC_PRBS_GENPOLY_REGISTER (105)
#define LASER3_TEC_PRBS_AMPLITUDE_REGISTER (106)
#define LASER3_TEC_PRBS_MEAN_REGISTER (107)
#define CONVERSION_LASER4_THERM_CONSTA_REGISTER (108)
#define CONVERSION_LASER4_THERM_CONSTB_REGISTER (109)
#define CONVERSION_LASER4_THERM_CONSTC_REGISTER (110)
#define LASER4_RESISTANCE_REGISTER (111)
#define LASER4_TEMPERATURE_REGISTER (112)
#define LASER4_THERMISTOR_ADC_REGISTER (113)
#define LASER4_TEC_REGISTER (114)
#define LASER4_MANUAL_TEC_REGISTER (115)
#define LASER4_TEMP_CNTRL_STATE_REGISTER (116)
#define LASER4_TEMP_CNTRL_LOCK_STATUS_REGISTER (117)
#define LASER4_TEMP_CNTRL_SETPOINT_REGISTER (118)
#define LASER4_TEMP_CNTRL_USER_SETPOINT_REGISTER (119)
#define LASER4_TEMP_CNTRL_TOLERANCE_REGISTER (120)
#define LASER4_TEMP_CNTRL_SWEEP_MAX_REGISTER (121)
#define LASER4_TEMP_CNTRL_SWEEP_MIN_REGISTER (122)
#define LASER4_TEMP_CNTRL_SWEEP_INCR_REGISTER (123)
#define LASER4_TEMP_CNTRL_H_REGISTER (124)
#define LASER4_TEMP_CNTRL_K_REGISTER (125)
#define LASER4_TEMP_CNTRL_TI_REGISTER (126)
#define LASER4_TEMP_CNTRL_TD_REGISTER (127)
#define LASER4_TEMP_CNTRL_B_REGISTER (128)
#define LASER4_TEMP_CNTRL_C_REGISTER (129)
#define LASER4_TEMP_CNTRL_N_REGISTER (130)
#define LASER4_TEMP_CNTRL_S_REGISTER (131)
#define LASER4_TEMP_CNTRL_FFWD_REGISTER (132)
#define LASER4_TEMP_CNTRL_AMIN_REGISTER (133)
#define LASER4_TEMP_CNTRL_AMAX_REGISTER (134)
#define LASER4_TEMP_CNTRL_IMAX_REGISTER (135)
#define LASER4_TEC_PRBS_GENPOLY_REGISTER (136)
#define LASER4_TEC_PRBS_AMPLITUDE_REGISTER (137)
#define LASER4_TEC_PRBS_MEAN_REGISTER (138)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTA_REGISTER (139)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTB_REGISTER (140)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTC_REGISTER (141)
#define HOT_BOX_HEATSINK_RESISTANCE_REGISTER (142)
#define HOT_BOX_HEATSINK_TEMPERATURE_REGISTER (143)
#define HOT_BOX_HEATSINK_ADC_REGISTER (144)
#define CONVERSION_CAVITY_THERM_CONSTA_REGISTER (145)
#define CONVERSION_CAVITY_THERM_CONSTB_REGISTER (146)
#define CONVERSION_CAVITY_THERM_CONSTC_REGISTER (147)
#define CAVITY_RESISTANCE_REGISTER (148)
#define CAVITY_TEMPERATURE_REGISTER (149)
#define CAVITY_THERMISTOR_ADC_REGISTER (150)
#define CAVITY_TEC_REGISTER (151)
#define CAVITY_MANUAL_TEC_REGISTER (152)
#define CAVITY_TEMP_CNTRL_STATE_REGISTER (153)
#define CAVITY_TEMP_CNTRL_LOCK_STATUS_REGISTER (154)
#define CAVITY_TEMP_CNTRL_SETPOINT_REGISTER (155)
#define CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER (156)
#define CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER (157)
#define CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER (158)
#define CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER (159)
#define CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER (160)
#define CAVITY_TEMP_CNTRL_H_REGISTER (161)
#define CAVITY_TEMP_CNTRL_K_REGISTER (162)
#define CAVITY_TEMP_CNTRL_TI_REGISTER (163)
#define CAVITY_TEMP_CNTRL_TD_REGISTER (164)
#define CAVITY_TEMP_CNTRL_B_REGISTER (165)
#define CAVITY_TEMP_CNTRL_C_REGISTER (166)
#define CAVITY_TEMP_CNTRL_N_REGISTER (167)
#define CAVITY_TEMP_CNTRL_S_REGISTER (168)
#define CAVITY_TEMP_CNTRL_FFWD_REGISTER (169)
#define CAVITY_TEMP_CNTRL_AMIN_REGISTER (170)
#define CAVITY_TEMP_CNTRL_AMAX_REGISTER (171)
#define CAVITY_TEMP_CNTRL_IMAX_REGISTER (172)
#define CAVITY_TEC_PRBS_GENPOLY_REGISTER (173)
#define CAVITY_TEC_PRBS_AMPLITUDE_REGISTER (174)
#define CAVITY_TEC_PRBS_MEAN_REGISTER (175)
#define CAVITY_MAX_HEATSINK_TEMP_REGISTER (176)
#define HEATER_CNTRL_STATE_REGISTER (177)
#define HEATER_CNTRL_GAIN_REGISTER (178)
#define HEATER_CNTRL_QUANTIZE_REGISTER (179)
#define HEATER_CNTRL_UBIAS_SLOPE_REGISTER (180)
#define HEATER_CNTRL_UBIAS_OFFSET_REGISTER (181)
#define HEATER_CNTRL_MARK_MIN_REGISTER (182)
#define HEATER_CNTRL_MARK_MAX_REGISTER (183)
#define HEATER_CNTRL_MANUAL_MARK_REGISTER (184)
#define HEATER_CNTRL_MARK_REGISTER (185)
