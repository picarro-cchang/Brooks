...
#define RDSIM_TRIGGER_DIVIDER_REGISTER (8)
#define RD_IRQ_COUNT_REGISTER (9)
#define ACQ_DONE_COUNT_REGISTER (10)
#define DAS_TEMPERATURE_REGISTER (11)
#define LASER_TEC_MONITOR_TEMPERATURE_REGISTER (12)
#define CONVERSION_LASER1_THERM_CONSTA_REGISTER (13)
#define CONVERSION_LASER1_THERM_CONSTB_REGISTER (14)
#define CONVERSION_LASER1_THERM_CONSTC_REGISTER (15)
...
#define LASER2_RESISTANCE_REGISTER (55)
#define LASER2_TEMPERATURE_REGISTER (56)
#define LASER2_THERMISTOR_ADC_REGISTER (57)
#define LASER2_TEC_REGISTER (58)
#define LASER2_MANUAL_TEC_REGISTER (59)
#define LASER2_TEMP_CNTRL_STATE_REGISTER (60)
#define LASER2_TEMP_CNTRL_LOCK_STATUS_REGISTER (61)
#define LASER2_TEMP_CNTRL_SETPOINT_REGISTER (62)
#define LASER2_TEMP_CNTRL_USER_SETPOINT_REGISTER (63)
#define LASER2_TEMP_CNTRL_TOLERANCE_REGISTER (64)
#define LASER2_TEMP_CNTRL_SWEEP_MAX_REGISTER (65)
#define LASER2_TEMP_CNTRL_SWEEP_MIN_REGISTER (66)
#define LASER2_TEMP_CNTRL_SWEEP_INCR_REGISTER (67)
#define LASER2_TEMP_CNTRL_H_REGISTER (68)
#define LASER2_TEMP_CNTRL_K_REGISTER (69)
#define LASER2_TEMP_CNTRL_TI_REGISTER (70)
#define LASER2_TEMP_CNTRL_TD_REGISTER (71)
#define LASER2_TEMP_CNTRL_B_REGISTER (72)
#define LASER2_TEMP_CNTRL_C_REGISTER (73)
#define LASER2_TEMP_CNTRL_N_REGISTER (74)
#define LASER2_TEMP_CNTRL_S_REGISTER (75)
#define LASER2_TEMP_CNTRL_FFWD_REGISTER (76)
#define LASER2_TEMP_CNTRL_AMIN_REGISTER (77)
#define LASER2_TEMP_CNTRL_AMAX_REGISTER (78)
#define LASER2_TEMP_CNTRL_IMAX_REGISTER (79)
#define LASER2_TEC_PRBS_GENPOLY_REGISTER (80)
#define LASER2_TEC_PRBS_AMPLITUDE_REGISTER (81)
#define LASER2_TEC_PRBS_MEAN_REGISTER (82)
#define LASER2_TEC_MONITOR_REGISTER (83)
#define LASER2_CURRENT_CNTRL_STATE_REGISTER (84)
#define LASER2_MANUAL_COARSE_CURRENT_REGISTER (85)
#define LASER2_MANUAL_FINE_CURRENT_REGISTER (86)
#define LASER2_CURRENT_SWEEP_MIN_REGISTER (87)
#define LASER2_CURRENT_SWEEP_MAX_REGISTER (88)
#define LASER2_CURRENT_SWEEP_INCR_REGISTER (89)
#define LASER2_CURRENT_MONITOR_REGISTER (90)
#define CONVERSION_LASER3_THERM_CONSTA_REGISTER (91)
#define CONVERSION_LASER3_THERM_CONSTB_REGISTER (92)
#define CONVERSION_LASER3_THERM_CONSTC_REGISTER (93)
#define LASER3_RESISTANCE_REGISTER (94)
#define LASER3_TEMPERATURE_REGISTER (95)
#define LASER3_THERMISTOR_ADC_REGISTER (96)
#define LASER3_TEC_REGISTER (97)
#define LASER3_MANUAL_TEC_REGISTER (98)
#define LASER3_TEMP_CNTRL_STATE_REGISTER (99)
#define LASER3_TEMP_CNTRL_LOCK_STATUS_REGISTER (100)
#define LASER3_TEMP_CNTRL_SETPOINT_REGISTER (101)
#define LASER3_TEMP_CNTRL_USER_SETPOINT_REGISTER (102)
#define LASER3_TEMP_CNTRL_TOLERANCE_REGISTER (103)
#define LASER3_TEMP_CNTRL_SWEEP_MAX_REGISTER (104)
#define LASER3_TEMP_CNTRL_SWEEP_MIN_REGISTER (105)
#define LASER3_TEMP_CNTRL_SWEEP_INCR_REGISTER (106)
#define LASER3_TEMP_CNTRL_H_REGISTER (107)
#define LASER3_TEMP_CNTRL_K_REGISTER (108)
#define LASER3_TEMP_CNTRL_TI_REGISTER (109)
#define LASER3_TEMP_CNTRL_TD_REGISTER (110)
#define LASER3_TEMP_CNTRL_B_REGISTER (111)
#define LASER3_TEMP_CNTRL_C_REGISTER (112)
#define LASER3_TEMP_CNTRL_N_REGISTER (113)
#define LASER3_TEMP_CNTRL_S_REGISTER (114)
#define LASER3_TEMP_CNTRL_FFWD_REGISTER (115)
#define LASER3_TEMP_CNTRL_AMIN_REGISTER (116)
#define LASER3_TEMP_CNTRL_AMAX_REGISTER (117)
#define LASER3_TEMP_CNTRL_IMAX_REGISTER (118)
#define LASER3_TEC_PRBS_GENPOLY_REGISTER (119)
#define LASER3_TEC_PRBS_AMPLITUDE_REGISTER (120)
#define LASER3_TEC_PRBS_MEAN_REGISTER (121)
#define LASER3_TEC_MONITOR_REGISTER (122)
#define LASER3_CURRENT_CNTRL_STATE_REGISTER (123)
#define LASER3_MANUAL_COARSE_CURRENT_REGISTER (124)
#define LASER3_MANUAL_FINE_CURRENT_REGISTER (125)
#define LASER3_CURRENT_SWEEP_MIN_REGISTER (126)
#define LASER3_CURRENT_SWEEP_MAX_REGISTER (127)
#define LASER3_CURRENT_SWEEP_INCR_REGISTER (128)
#define LASER3_CURRENT_MONITOR_REGISTER (129)
#define CONVERSION_LASER4_THERM_CONSTA_REGISTER (130)
#define CONVERSION_LASER4_THERM_CONSTB_REGISTER (131)
#define CONVERSION_LASER4_THERM_CONSTC_REGISTER (132)
#define LASER4_RESISTANCE_REGISTER (133)
#define LASER4_TEMPERATURE_REGISTER (134)
#define LASER4_THERMISTOR_ADC_REGISTER (135)
#define LASER4_TEC_REGISTER (136)
#define LASER4_MANUAL_TEC_REGISTER (137)
#define LASER4_TEMP_CNTRL_STATE_REGISTER (138)
#define LASER4_TEMP_CNTRL_LOCK_STATUS_REGISTER (139)
#define LASER4_TEMP_CNTRL_SETPOINT_REGISTER (140)
#define LASER4_TEMP_CNTRL_USER_SETPOINT_REGISTER (141)
#define LASER4_TEMP_CNTRL_TOLERANCE_REGISTER (142)
#define LASER4_TEMP_CNTRL_SWEEP_MAX_REGISTER (143)
#define LASER4_TEMP_CNTRL_SWEEP_MIN_REGISTER (144)
#define LASER4_TEMP_CNTRL_SWEEP_INCR_REGISTER (145)
#define LASER4_TEMP_CNTRL_H_REGISTER (146)
#define LASER4_TEMP_CNTRL_K_REGISTER (147)
#define LASER4_TEMP_CNTRL_TI_REGISTER (148)
#define LASER4_TEMP_CNTRL_TD_REGISTER (149)
#define LASER4_TEMP_CNTRL_B_REGISTER (150)
#define LASER4_TEMP_CNTRL_C_REGISTER (151)
#define LASER4_TEMP_CNTRL_N_REGISTER (152)
#define LASER4_TEMP_CNTRL_S_REGISTER (153)
#define LASER4_TEMP_CNTRL_FFWD_REGISTER (154)
#define LASER4_TEMP_CNTRL_AMIN_REGISTER (155)
#define LASER4_TEMP_CNTRL_AMAX_REGISTER (156)
#define LASER4_TEMP_CNTRL_IMAX_REGISTER (157)
#define LASER4_TEC_PRBS_GENPOLY_REGISTER (158)
#define LASER4_TEC_PRBS_AMPLITUDE_REGISTER (159)
#define LASER4_TEC_PRBS_MEAN_REGISTER (160)
#define LASER4_TEC_MONITOR_REGISTER (161)
#define LASER4_CURRENT_CNTRL_STATE_REGISTER (162)
#define LASER4_MANUAL_COARSE_CURRENT_REGISTER (163)
#define LASER4_MANUAL_FINE_CURRENT_REGISTER (164)
#define LASER4_CURRENT_SWEEP_MIN_REGISTER (165)
#define LASER4_CURRENT_SWEEP_MAX_REGISTER (166)
#define LASER4_CURRENT_SWEEP_INCR_REGISTER (167)
#define LASER4_CURRENT_MONITOR_REGISTER (168)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTA_REGISTER (169)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTB_REGISTER (170)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTC_REGISTER (171)
#define HOT_BOX_HEATSINK_RESISTANCE_REGISTER (172)
#define HOT_BOX_HEATSINK_TEMPERATURE_REGISTER (173)
#define HOT_BOX_HEATSINK_ADC_REGISTER (174)
#define CONVERSION_CAVITY_THERM_CONSTA_REGISTER (175)
#define CONVERSION_CAVITY_THERM_CONSTB_REGISTER (176)
#define CONVERSION_CAVITY_THERM_CONSTC_REGISTER (177)
#define CAVITY_RESISTANCE_REGISTER (178)
#define CAVITY_TEMPERATURE_REGISTER (179)
#define CAVITY_THERMISTOR_ADC_REGISTER (180)
#define CAVITY_TEC_REGISTER (181)
#define CAVITY_MANUAL_TEC_REGISTER (182)
#define CAVITY_TEMP_CNTRL_STATE_REGISTER (183)
#define CAVITY_TEMP_CNTRL_LOCK_STATUS_REGISTER (184)
#define CAVITY_TEMP_CNTRL_SETPOINT_REGISTER (185)
#define CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER (186)
#define CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER (187)
#define CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER (188)
#define CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER (189)
#define CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER (190)
#define CAVITY_TEMP_CNTRL_H_REGISTER (191)
#define CAVITY_TEMP_CNTRL_K_REGISTER (192)
#define CAVITY_TEMP_CNTRL_TI_REGISTER (193)
#define CAVITY_TEMP_CNTRL_TD_REGISTER (194)
#define CAVITY_TEMP_CNTRL_B_REGISTER (195)
#define CAVITY_TEMP_CNTRL_C_REGISTER (196)
#define CAVITY_TEMP_CNTRL_N_REGISTER (197)
#define CAVITY_TEMP_CNTRL_S_REGISTER (198)
#define CAVITY_TEMP_CNTRL_FFWD_REGISTER (199)
#define CAVITY_TEMP_CNTRL_AMIN_REGISTER (200)
#define CAVITY_TEMP_CNTRL_AMAX_REGISTER (201)
#define CAVITY_TEMP_CNTRL_IMAX_REGISTER (202)
#define CAVITY_TEC_PRBS_GENPOLY_REGISTER (203)
#define CAVITY_TEC_PRBS_AMPLITUDE_REGISTER (204)
#define CAVITY_TEC_PRBS_MEAN_REGISTER (205)
#define CAVITY_MAX_HEATSINK_TEMP_REGISTER (206)
#define HEATER_CNTRL_STATE_REGISTER (207)
#define HEATER_CNTRL_GAIN_REGISTER (208)
#define HEATER_CNTRL_QUANTIZE_REGISTER (209)
#define HEATER_CNTRL_UBIAS_SLOPE_REGISTER (210)
#define HEATER_CNTRL_UBIAS_OFFSET_REGISTER (211)
#define HEATER_CNTRL_MARK_MIN_REGISTER (212)
#define HEATER_CNTRL_MARK_MAX_REGISTER (213)
#define HEATER_CNTRL_MANUAL_MARK_REGISTER (214)
#define HEATER_CNTRL_MARK_REGISTER (215)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (216)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (217)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (218)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (219)
#define TUNER_UP_SLOPE_REGISTER (220)
#define TUNER_DOWN_SLOPE_REGISTER (221)
#define RD_MINLOSS_REGISTER (222)
#define RD_MAXLOSS_REGISTER (223)
#define RD_LATEST_LOSS_REGISTER (224)
#define RD_IMPROVEMENT_STEPS_REGISTER (225)
#define RD_START_SAMPLE_REGISTER (226)
#define RD_FRACTIONAL_THRESHOLD_REGISTER (227)
#define RD_ABSOLUTE_THRESHOLD_REGISTER (228)
