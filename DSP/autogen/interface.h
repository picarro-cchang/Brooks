...
#define CONVERSION_ETALON_THERM_CONSTA_REGISTER (167)
#define CONVERSION_ETALON_THERM_CONSTB_REGISTER (168)
#define CONVERSION_ETALON_THERM_CONSTC_REGISTER (169)
#define ETALON_RESISTANCE_REGISTER (170)
#define ETALON_TEMPERATURE_REGISTER (171)
#define ETALON_THERMISTOR_ADC_REGISTER (172)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTA_REGISTER (173)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTB_REGISTER (174)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTC_REGISTER (175)
#define HOT_BOX_HEATSINK_RESISTANCE_REGISTER (176)
#define HOT_BOX_HEATSINK_TEMPERATURE_REGISTER (177)
#define HOT_BOX_HEATSINK_ADC_REGISTER (178)
#define CONVERSION_CAVITY_THERM_CONSTA_REGISTER (179)
#define CONVERSION_CAVITY_THERM_CONSTB_REGISTER (180)
#define CONVERSION_CAVITY_THERM_CONSTC_REGISTER (181)
#define CAVITY_RESISTANCE_REGISTER (182)
#define CAVITY_TEMPERATURE_REGISTER (183)
#define CAVITY_THERMISTOR_ADC_REGISTER (184)
#define CAVITY_TEC_REGISTER (185)
#define CAVITY_MANUAL_TEC_REGISTER (186)
#define CAVITY_TEMP_CNTRL_STATE_REGISTER (187)
#define CAVITY_TEMP_CNTRL_LOCK_STATUS_REGISTER (188)
#define CAVITY_TEMP_CNTRL_SETPOINT_REGISTER (189)
#define CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER (190)
#define CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER (191)
#define CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER (192)
#define CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER (193)
#define CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER (194)
#define CAVITY_TEMP_CNTRL_H_REGISTER (195)
#define CAVITY_TEMP_CNTRL_K_REGISTER (196)
#define CAVITY_TEMP_CNTRL_TI_REGISTER (197)
#define CAVITY_TEMP_CNTRL_TD_REGISTER (198)
#define CAVITY_TEMP_CNTRL_B_REGISTER (199)
#define CAVITY_TEMP_CNTRL_C_REGISTER (200)
#define CAVITY_TEMP_CNTRL_N_REGISTER (201)
#define CAVITY_TEMP_CNTRL_S_REGISTER (202)
#define CAVITY_TEMP_CNTRL_FFWD_REGISTER (203)
#define CAVITY_TEMP_CNTRL_AMIN_REGISTER (204)
#define CAVITY_TEMP_CNTRL_AMAX_REGISTER (205)
#define CAVITY_TEMP_CNTRL_IMAX_REGISTER (206)
#define CAVITY_TEC_PRBS_GENPOLY_REGISTER (207)
#define CAVITY_TEC_PRBS_AMPLITUDE_REGISTER (208)
#define CAVITY_TEC_PRBS_MEAN_REGISTER (209)
#define CAVITY_MAX_HEATSINK_TEMP_REGISTER (210)
#define HEATER_CNTRL_STATE_REGISTER (211)
#define HEATER_CNTRL_GAIN_REGISTER (212)
#define HEATER_CNTRL_QUANTIZE_REGISTER (213)
#define HEATER_CNTRL_UBIAS_SLOPE_REGISTER (214)
#define HEATER_CNTRL_UBIAS_OFFSET_REGISTER (215)
#define HEATER_CNTRL_MARK_MIN_REGISTER (216)
#define HEATER_CNTRL_MARK_MAX_REGISTER (217)
#define HEATER_CNTRL_MANUAL_MARK_REGISTER (218)
#define HEATER_CNTRL_MARK_REGISTER (219)
#define CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER (220)
#define CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER (221)
#define CAVITY_PRESSURE_REGISTER (222)
#define CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER (223)
#define CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER (224)
#define AMBIENT_PRESSURE_REGISTER (225)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (226)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (227)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (228)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (229)
#define TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER (230)
#define TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER (231)
#define TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER (232)
#define TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER (233)
#define RDFITTER_MINLOSS_REGISTER (234)
#define RDFITTER_MAXLOSS_REGISTER (235)
#define RDFITTER_LATEST_LOSS_REGISTER (236)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (237)
#define RDFITTER_START_SAMPLE_REGISTER (238)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (239)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (240)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (241)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (242)
#define SPECT_CNTRL_STATE_REGISTER (243)
#define SPECT_CNTRL_MODE_REGISTER (244)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (245)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (246)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (247)
