...
#define PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER (426)
#define PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER (427)
#define PEAK_DETECT_CNTRL_RESET_DELAY_REGISTER (428)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (429)
