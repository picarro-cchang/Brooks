...
#define INTERFACE_NUMBER_OF_REGISTERS (372)
...
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (323)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (324)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (325)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (326)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (327)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (328)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (329)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (330)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (331)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (332)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (333)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (334)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (335)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (336)
#define TEC_CNTRL_REGISTER (337)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (338)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (339)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (340)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (341)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (342)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (343)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (344)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (345)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (346)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (347)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (348)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (349)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (350)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (351)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (352)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (353)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (354)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (355)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (356)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (357)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (358)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (359)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (360)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (361)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (362)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (363)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (364)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (365)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (366)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (367)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (368)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (369)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (370)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (371)
...
#define ACTION_ADC_TO_PRESSURE (60)
#endif
