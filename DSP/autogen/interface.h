...
#define INTERFACE_NUMBER_OF_REGISTERS (398)
...
#define PZT_OFFSET_VIRTUAL_LASER1 (318)
#define PZT_OFFSET_VIRTUAL_LASER2 (319)
#define PZT_OFFSET_VIRTUAL_LASER3 (320)
#define PZT_OFFSET_VIRTUAL_LASER4 (321)
#define PZT_OFFSET_VIRTUAL_LASER5 (322)
#define PZT_OFFSET_VIRTUAL_LASER6 (323)
#define PZT_OFFSET_VIRTUAL_LASER7 (324)
#define PZT_OFFSET_VIRTUAL_LASER8 (325)
#define SCHEME_OFFSET_VIRTUAL_LASER1 (326)
#define SCHEME_OFFSET_VIRTUAL_LASER2 (327)
#define SCHEME_OFFSET_VIRTUAL_LASER3 (328)
#define SCHEME_OFFSET_VIRTUAL_LASER4 (329)
#define SCHEME_OFFSET_VIRTUAL_LASER5 (330)
#define SCHEME_OFFSET_VIRTUAL_LASER6 (331)
#define SCHEME_OFFSET_VIRTUAL_LASER7 (332)
#define SCHEME_OFFSET_VIRTUAL_LASER8 (333)
#define VALVE_CNTRL_STATE_REGISTER (334)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (335)
#define VALVE_CNTRL_USER_INLET_VALVE_REGISTER (336)
#define VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER (337)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (338)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (339)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (340)
#define VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER (341)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (342)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (343)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (344)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (345)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (346)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (347)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (348)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (349)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (350)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (351)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (352)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (353)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (354)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (355)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (356)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (357)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (358)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (359)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (360)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (361)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (362)
#define TEC_CNTRL_REGISTER (363)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (364)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (365)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (366)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (367)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (368)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (369)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (370)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (371)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (372)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (373)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (374)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (375)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (376)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (377)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (378)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (379)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (380)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (381)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (382)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (383)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (384)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (385)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (386)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (387)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (388)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (389)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (390)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (391)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (392)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (393)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (394)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (395)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (396)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (397)
