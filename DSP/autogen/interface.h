...
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (272)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (273)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (274)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (275)
#define TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER (276)
#define TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER (277)
#define TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER (278)
#define TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER (279)
#define RDFITTER_MINLOSS_REGISTER (280)
#define RDFITTER_MAXLOSS_REGISTER (281)
#define RDFITTER_LATEST_LOSS_REGISTER (282)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (283)
#define RDFITTER_START_SAMPLE_REGISTER (284)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (285)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (286)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (287)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (288)
#define SPECT_CNTRL_STATE_REGISTER (289)
#define SPECT_CNTRL_MODE_REGISTER (290)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (291)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (292)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (293)
#define SPECT_CNTRL_SCHEME_ROW_REGISTER (294)
#define SPECT_CNTRL_DWELL_COUNT_REGISTER (295)
#define SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER (296)
#define SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER (297)
#define SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER (298)
#define VIRTUAL_LASER_REGISTER (299)
#define VALVE_CNTRL_STATE_REGISTER (300)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (301)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (302)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (303)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (304)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (305)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (306)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (307)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (308)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (309)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (310)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (311)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (312)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (313)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (314)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (315)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (316)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (317)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (318)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (319)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (320)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (321)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (322)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (323)
#define TEC_CNTRL_REGISTER (324)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (325)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (326)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (327)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (328)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (329)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (330)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (331)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (332)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (333)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (334)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (335)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (336)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (337)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (338)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (339)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (340)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (341)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (342)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (343)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (344)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (345)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (346)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (347)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (348)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (349)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (350)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (351)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (352)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (353)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (354)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (355)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (356)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (357)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (358)
