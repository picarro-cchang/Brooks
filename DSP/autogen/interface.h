...
#define INTERFACE_NUMBER_OF_REGISTERS (356)
...
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (322)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (323)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (324)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (325)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (326)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (327)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (328)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (329)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (330)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (331)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (332)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (333)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (334)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (335)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (336)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (337)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (338)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (339)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (340)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (341)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (342)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (343)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (344)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (345)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (346)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (347)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (348)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (349)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (350)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (351)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (352)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (353)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (354)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (355)
