...
#define INTERFACE_NUMBER_OF_REGISTERS (377)
...
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (321)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (322)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (323)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (324)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (325)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (326)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (327)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (328)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (329)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (330)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (331)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (332)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (333)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (334)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (335)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (336)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (337)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (338)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (339)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (340)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (341)
#define TEC_CNTRL_REGISTER (342)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (343)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (344)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (345)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (346)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (347)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (348)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (349)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (350)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (351)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (352)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (353)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (354)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (355)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (356)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (357)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (358)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (359)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (360)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (361)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (362)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (363)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (364)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (365)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (366)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (367)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (368)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (369)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (370)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (371)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (372)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (373)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (374)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (375)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (376)
