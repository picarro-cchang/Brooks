...
#define FPGA_LASER1_CURRENT_DAC (84) // Laser1 current DAC registers
#define FPGA_LASER2_CURRENT_DAC (87) // Laser2 current DAC registers
#define FPGA_LASER3_CURRENT_DAC (90) // Laser3 current DAC registers
#define FPGA_LASER4_CURRENT_DAC (93) // Laser4 current DAC registers
#define FPGA_RDCOMPARE (96) // Ringdown comparator
