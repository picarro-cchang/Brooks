...
#define INTERFACE_NUMBER_OF_REGISTERS (200)
...
#define CONVERSION_LASER3_THERM_CONSTA_REGISTER (83)
#define CONVERSION_LASER3_THERM_CONSTB_REGISTER (84)
#define CONVERSION_LASER3_THERM_CONSTC_REGISTER (85)
#define LASER3_RESISTANCE_REGISTER (86)
#define LASER3_TEMPERATURE_REGISTER (87)
#define LASER3_THERMISTOR_ADC_REGISTER (88)
#define LASER3_TEC_REGISTER (89)
#define LASER3_MANUAL_TEC_REGISTER (90)
#define LASER3_TEMP_CNTRL_STATE_REGISTER (91)
#define LASER3_TEMP_CNTRL_LOCK_STATUS_REGISTER (92)
#define LASER3_TEMP_CNTRL_SETPOINT_REGISTER (93)
#define LASER3_TEMP_CNTRL_USER_SETPOINT_REGISTER (94)
#define LASER3_TEMP_CNTRL_TOLERANCE_REGISTER (95)
#define LASER3_TEMP_CNTRL_SWEEP_MAX_REGISTER (96)
#define LASER3_TEMP_CNTRL_SWEEP_MIN_REGISTER (97)
#define LASER3_TEMP_CNTRL_SWEEP_INCR_REGISTER (98)
#define LASER3_TEMP_CNTRL_H_REGISTER (99)
#define LASER3_TEMP_CNTRL_K_REGISTER (100)
#define LASER3_TEMP_CNTRL_TI_REGISTER (101)
#define LASER3_TEMP_CNTRL_TD_REGISTER (102)
#define LASER3_TEMP_CNTRL_B_REGISTER (103)
#define LASER3_TEMP_CNTRL_C_REGISTER (104)
#define LASER3_TEMP_CNTRL_N_REGISTER (105)
#define LASER3_TEMP_CNTRL_S_REGISTER (106)
#define LASER3_TEMP_CNTRL_FFWD_REGISTER (107)
#define LASER3_TEMP_CNTRL_AMIN_REGISTER (108)
#define LASER3_TEMP_CNTRL_AMAX_REGISTER (109)
#define LASER3_TEMP_CNTRL_IMAX_REGISTER (110)
#define LASER3_TEC_PRBS_GENPOLY_REGISTER (111)
#define LASER3_TEC_PRBS_AMPLITUDE_REGISTER (112)
#define LASER3_TEC_PRBS_MEAN_REGISTER (113)
#define LASER3_TEC_MONITOR_REGISTER (114)
#define CONVERSION_LASER4_THERM_CONSTA_REGISTER (115)
#define CONVERSION_LASER4_THERM_CONSTB_REGISTER (116)
#define CONVERSION_LASER4_THERM_CONSTC_REGISTER (117)
#define LASER4_RESISTANCE_REGISTER (118)
#define LASER4_TEMPERATURE_REGISTER (119)
#define LASER4_THERMISTOR_ADC_REGISTER (120)
#define LASER4_TEC_REGISTER (121)
#define LASER4_MANUAL_TEC_REGISTER (122)
#define LASER4_TEMP_CNTRL_STATE_REGISTER (123)
#define LASER4_TEMP_CNTRL_LOCK_STATUS_REGISTER (124)
#define LASER4_TEMP_CNTRL_SETPOINT_REGISTER (125)
#define LASER4_TEMP_CNTRL_USER_SETPOINT_REGISTER (126)
#define LASER4_TEMP_CNTRL_TOLERANCE_REGISTER (127)
#define LASER4_TEMP_CNTRL_SWEEP_MAX_REGISTER (128)
#define LASER4_TEMP_CNTRL_SWEEP_MIN_REGISTER (129)
#define LASER4_TEMP_CNTRL_SWEEP_INCR_REGISTER (130)
#define LASER4_TEMP_CNTRL_H_REGISTER (131)
#define LASER4_TEMP_CNTRL_K_REGISTER (132)
#define LASER4_TEMP_CNTRL_TI_REGISTER (133)
#define LASER4_TEMP_CNTRL_TD_REGISTER (134)
#define LASER4_TEMP_CNTRL_B_REGISTER (135)
#define LASER4_TEMP_CNTRL_C_REGISTER (136)
#define LASER4_TEMP_CNTRL_N_REGISTER (137)
#define LASER4_TEMP_CNTRL_S_REGISTER (138)
#define LASER4_TEMP_CNTRL_FFWD_REGISTER (139)
#define LASER4_TEMP_CNTRL_AMIN_REGISTER (140)
#define LASER4_TEMP_CNTRL_AMAX_REGISTER (141)
#define LASER4_TEMP_CNTRL_IMAX_REGISTER (142)
#define LASER4_TEC_PRBS_GENPOLY_REGISTER (143)
#define LASER4_TEC_PRBS_AMPLITUDE_REGISTER (144)
#define LASER4_TEC_PRBS_MEAN_REGISTER (145)
#define LASER4_TEC_MONITOR_REGISTER (146)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTA_REGISTER (147)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTB_REGISTER (148)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTC_REGISTER (149)
#define HOT_BOX_HEATSINK_RESISTANCE_REGISTER (150)
#define HOT_BOX_HEATSINK_TEMPERATURE_REGISTER (151)
#define HOT_BOX_HEATSINK_ADC_REGISTER (152)
#define CONVERSION_CAVITY_THERM_CONSTA_REGISTER (153)
#define CONVERSION_CAVITY_THERM_CONSTB_REGISTER (154)
#define CONVERSION_CAVITY_THERM_CONSTC_REGISTER (155)
#define CAVITY_RESISTANCE_REGISTER (156)
#define CAVITY_TEMPERATURE_REGISTER (157)
#define CAVITY_THERMISTOR_ADC_REGISTER (158)
#define CAVITY_TEC_REGISTER (159)
#define CAVITY_MANUAL_TEC_REGISTER (160)
#define CAVITY_TEMP_CNTRL_STATE_REGISTER (161)
#define CAVITY_TEMP_CNTRL_LOCK_STATUS_REGISTER (162)
#define CAVITY_TEMP_CNTRL_SETPOINT_REGISTER (163)
#define CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER (164)
#define CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER (165)
#define CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER (166)
#define CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER (167)
#define CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER (168)
#define CAVITY_TEMP_CNTRL_H_REGISTER (169)
#define CAVITY_TEMP_CNTRL_K_REGISTER (170)
#define CAVITY_TEMP_CNTRL_TI_REGISTER (171)
#define CAVITY_TEMP_CNTRL_TD_REGISTER (172)
#define CAVITY_TEMP_CNTRL_B_REGISTER (173)
#define CAVITY_TEMP_CNTRL_C_REGISTER (174)
#define CAVITY_TEMP_CNTRL_N_REGISTER (175)
#define CAVITY_TEMP_CNTRL_S_REGISTER (176)
#define CAVITY_TEMP_CNTRL_FFWD_REGISTER (177)
#define CAVITY_TEMP_CNTRL_AMIN_REGISTER (178)
#define CAVITY_TEMP_CNTRL_AMAX_REGISTER (179)
#define CAVITY_TEMP_CNTRL_IMAX_REGISTER (180)
#define CAVITY_TEC_PRBS_GENPOLY_REGISTER (181)
#define CAVITY_TEC_PRBS_AMPLITUDE_REGISTER (182)
#define CAVITY_TEC_PRBS_MEAN_REGISTER (183)
#define CAVITY_MAX_HEATSINK_TEMP_REGISTER (184)
#define HEATER_CNTRL_STATE_REGISTER (185)
#define HEATER_CNTRL_GAIN_REGISTER (186)
#define HEATER_CNTRL_QUANTIZE_REGISTER (187)
#define HEATER_CNTRL_UBIAS_SLOPE_REGISTER (188)
#define HEATER_CNTRL_UBIAS_OFFSET_REGISTER (189)
#define HEATER_CNTRL_MARK_MIN_REGISTER (190)
#define HEATER_CNTRL_MARK_MAX_REGISTER (191)
#define HEATER_CNTRL_MANUAL_MARK_REGISTER (192)
#define HEATER_CNTRL_MARK_REGISTER (193)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (194)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (195)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (196)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (197)
#define TUNER_UP_SLOPE_REGISTER (198)
#define TUNER_DOWN_SLOPE_REGISTER (199)
...
#define ACTION_TUNER_CNTRL_INIT (27)
#define ACTION_TUNER_CNTRL_STEP (28)
#define ACTION_ENV_CHECKER (29)
#define ACTION_PULSE_GENERATOR (30)
#define ACTION_FILTER (31)
#define ACTION_DS1631_READTEMP (32)
#define ACTION_LASER_TEC_IMON (33)
#define ACTION_READ_LASER_TEC_MONITORS (34)
#endif
