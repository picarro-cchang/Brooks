...
#define INTERFACE_NUMBER_OF_REGISTERS (370)
...
#define CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER (266)
#define CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER (267)
#define CAVITY_PRESSURE_REGISTER (268)
#define CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER (269)
#define CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER (270)
#define AMBIENT_PRESSURE_REGISTER (271)
#define ANALYZER_TUNING_MODE_REGISTER (272)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (273)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (274)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (275)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (276)
#define TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER (277)
#define TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER (278)
#define TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER (279)
#define TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER (280)
#define RDFITTER_MINLOSS_REGISTER (281)
#define RDFITTER_MAXLOSS_REGISTER (282)
#define RDFITTER_LATEST_LOSS_REGISTER (283)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (284)
#define RDFITTER_START_SAMPLE_REGISTER (285)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (286)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (287)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (288)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (289)
#define RDFITTER_META_BACKOFF_REGISTER (290)
#define RDFITTER_META_SAMPLES_REGISTER (291)
#define SPECT_CNTRL_STATE_REGISTER (292)
#define SPECT_CNTRL_MODE_REGISTER (293)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (294)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (295)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (296)
#define SPECT_CNTRL_SCHEME_ROW_REGISTER (297)
#define SPECT_CNTRL_DWELL_COUNT_REGISTER (298)
#define SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER (299)
#define SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER (300)
#define SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER (301)
#define VIRTUAL_LASER_REGISTER (302)
#define PZT_OFFSET_VIRTUAL_LASER1 (303)
#define PZT_OFFSET_VIRTUAL_LASER2 (304)
#define PZT_OFFSET_VIRTUAL_LASER3 (305)
#define PZT_OFFSET_VIRTUAL_LASER4 (306)
#define PZT_OFFSET_VIRTUAL_LASER5 (307)
#define PZT_OFFSET_VIRTUAL_LASER6 (308)
#define PZT_OFFSET_VIRTUAL_LASER7 (309)
#define PZT_OFFSET_VIRTUAL_LASER8 (310)
#define VALVE_CNTRL_STATE_REGISTER (311)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (312)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (313)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (314)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (315)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (316)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (317)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (318)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (319)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (320)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (321)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (322)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (323)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (324)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (325)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (326)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (327)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (328)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (329)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (330)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (331)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (332)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (333)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (334)
#define TEC_CNTRL_REGISTER (335)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (336)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (337)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (338)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (339)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (340)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (341)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (342)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (343)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (344)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (345)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (346)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (347)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (348)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (349)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (350)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (351)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (352)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (353)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (354)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (355)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (356)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (357)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (358)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (359)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (360)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (361)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (362)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (363)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (364)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (365)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (366)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (367)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (368)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (369)
