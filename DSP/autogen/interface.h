...
#define INTERFACE_NUMBER_OF_REGISTERS (400)
...
#define RDFITTER_MINLOSS_REGISTER (296)
#define RDFITTER_MAXLOSS_REGISTER (297)
#define RDFITTER_LATEST_LOSS_REGISTER (298)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (299)
#define RDFITTER_START_SAMPLE_REGISTER (300)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (301)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (302)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (303)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (304)
#define RDFITTER_META_BACKOFF_REGISTER (305)
#define RDFITTER_META_SAMPLES_REGISTER (306)
#define SPECT_CNTRL_STATE_REGISTER (307)
#define SPECT_CNTRL_MODE_REGISTER (308)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (309)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (310)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (311)
#define SPECT_CNTRL_SCHEME_ROW_REGISTER (312)
#define SPECT_CNTRL_DWELL_COUNT_REGISTER (313)
#define SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER (314)
#define SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER (315)
#define SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER (316)
#define VIRTUAL_LASER_REGISTER (317)
#define PZT_INCR_PER_CAVITY_FSR (318)
#define PZT_OFFSET_UPDATE_FACTOR (319)
#define PZT_OFFSET_VIRTUAL_LASER1 (320)
#define PZT_OFFSET_VIRTUAL_LASER2 (321)
#define PZT_OFFSET_VIRTUAL_LASER3 (322)
#define PZT_OFFSET_VIRTUAL_LASER4 (323)
#define PZT_OFFSET_VIRTUAL_LASER5 (324)
#define PZT_OFFSET_VIRTUAL_LASER6 (325)
#define PZT_OFFSET_VIRTUAL_LASER7 (326)
#define PZT_OFFSET_VIRTUAL_LASER8 (327)
#define SCHEME_OFFSET_VIRTUAL_LASER1 (328)
#define SCHEME_OFFSET_VIRTUAL_LASER2 (329)
#define SCHEME_OFFSET_VIRTUAL_LASER3 (330)
#define SCHEME_OFFSET_VIRTUAL_LASER4 (331)
#define SCHEME_OFFSET_VIRTUAL_LASER5 (332)
#define SCHEME_OFFSET_VIRTUAL_LASER6 (333)
#define SCHEME_OFFSET_VIRTUAL_LASER7 (334)
#define SCHEME_OFFSET_VIRTUAL_LASER8 (335)
#define VALVE_CNTRL_STATE_REGISTER (336)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (337)
#define VALVE_CNTRL_USER_INLET_VALVE_REGISTER (338)
#define VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER (339)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (340)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (341)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (342)
#define VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER (343)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (344)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (345)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (346)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (347)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (348)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (349)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (350)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (351)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (352)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (353)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (354)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (355)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (356)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (357)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (358)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (359)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (360)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (361)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (362)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (363)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (364)
#define TEC_CNTRL_REGISTER (365)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (366)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (367)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (368)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (369)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (370)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (371)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (372)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (373)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (374)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (375)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (376)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (377)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (378)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (379)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (380)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (381)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (382)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (383)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (384)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (385)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (386)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (387)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (388)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (389)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (390)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (391)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (392)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (393)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (394)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (395)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (396)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (397)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (398)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (399)
