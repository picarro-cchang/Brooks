...
#define PEAK_DETECT_CNTRL_ACTIVE_SIZE_REGISTER (424)
#define PEAK_DETECT_CNTRL_POST_PEAK_SAMPLES_REGISTER (425)
#define PEAK_DETECT_CNTRL_CANCELLING_SAMPLES_REGISTER (426)
#define PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER (427)
#define PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER (428)
#define PEAK_DETECT_CNTRL_RESET_DELAY_REGISTER (429)
#define PEAK_DETECT_CNTRL_PRIMING_DURATION_REGISTER (430)
#define PEAK_DETECT_CNTRL_PURGING_DURATION_REGISTER (431)
#define PEAK_DETECT_CNTRL_REMAINING_TRIGGERED_SAMPLES_REGISTER (432)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (433)
#define PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER (434)
#define PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER (435)
#define PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER (436)
#define PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER (437)
#define PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER (438)
#define PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER (439)
#define PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER (440)
#define PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER (441)
