...
#define INTERFACE_NUMBER_OF_REGISTERS (440)
...
#define PEAK_DETECT_CNTRL_REMAINING_TRIGGERED_SAMPLES_REGISTER (430)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (431)
#define PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER (432)
#define PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER (433)
#define PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER (434)
#define PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER (435)
#define PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER (436)
#define FLOW1_REGISTER (437)
#define CONVERSION_FLOW1_SCALE_REGISTER (438)
#define CONVERSION_FLOW1_OFFSET_REGISTER (439)
