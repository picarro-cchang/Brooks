...
if __name__ == "__main__":
    ...
    myView = View(Item("systemResp",style="custom",show_label=False),
                  ...
                  Item("K",editor=RangeEditor(low=1.0e-4,high=1.0,auto_set=False,enter_set=True,mode='xslider')),
                  ...
                  width=800,height=800,resizable=True,buttons=NoButtons,title="Laser Locking Analyser"
                  )
