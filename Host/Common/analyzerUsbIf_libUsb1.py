...
from ctypes import byref, create_string_buffer, c_ubyte, c_ushort, c_short, c_uint, memmove, sizeof, addressof
...
class AnalyzerUsb(Singleton):
    ...
    def hpidRead(self, result):
        ...
        def _hpidRead():
            ...
            temp = self.handle.bulkRead(DEFAULT_IN_ENDPOINT, nBytes, 5000)
