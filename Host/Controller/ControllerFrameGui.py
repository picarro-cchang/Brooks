#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Fri Jul 24 20:08:50 2009
...
class ControllerFrameGui(wx.Frame):
    ...
    def __do_layout(self):
        ...
        sizer_4.Add(self.laser1Panel, 1, wx.EXPAND, 0)
        self.laser1Pane.SetSizer(sizer_4)
        sizer_5.Add(self.laser2Panel, 1, wx.EXPAND, 0)
        self.laser2Pane.SetSizer(sizer_5)
        sizer_6.Add(self.laser3Panel, 1, wx.EXPAND, 0)
        self.laser3Pane.SetSizer(sizer_6)
        sizer_7.Add(self.laser4Panel, 1, wx.EXPAND, 0)
        self.laser4Pane.SetSizer(sizer_7)
        sizer_8.Add(self.hotBoxPanel, 1, wx.EXPAND, 0)
        self.hotBoxPane.SetSizer(sizer_8)
        sizer_3.Add(self.wlmPanel, 1, wx.EXPAND, 0)
        self.wlmPane.SetSizer(sizer_3)
        sizer_10.Add(self.ringdownPanel, 1, wx.EXPAND, 0)
        self.ringdownPane.SetSizer(sizer_10)
        shellSizer.Add(self.crustPanel, 1, wx.EXPAND, 0)
        self.shellPane.SetSizer(shellSizer)
