#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Fri Nov 11 22:12:26 2011
...
class ControllerFrameGui(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.processedLossPane = wx.Panel(self.topNotebook, -1)
        self.processedLossPanel = ProcessedLossPanel(self.processedLossPane, -1)
    ...
    def __do_layout(self):
        ...
        sizer_12.Add(self.processedLossPanel, 1, wx.EXPAND, 0)
        self.processedLossPane.SetSizer(sizer_12)
        sizer_13.Add(self.statsPanel, 1, wx.EXPAND, 0)
        self.statsPane.SetSizer(sizer_13)
        sizer_14.Add(self.crustPanel, 1, wx.EXPAND, 0)
        self.shellPane.SetSizer(sizer_14)
