#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Wed Sep 30 00:08:39 2009
...
class CommandLogPanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.sizer_10_staticbox = wx.StaticBox(self, -1, "Log")
        self.panel_1 = wx.Panel(self, -1)
        ...
        self.label_1 = wx.StaticText(self.panel_2, -1, "Cal File")
        self.calFileTextCtrl = wx.TextCtrl(self.panel_2, -1, "")
        self.startAcquisitionButton = wx.Button(self.panel_3, -1, "Start Acquisition")
        self.label_2 = wx.StaticText(self.panel_3, -1, "Sequence")
    ...
    def __do_layout(self):
        ...
        sizer_7.Add(self.label_1, 0, wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_7.Add(self.calFileTextCtrl, 1, wx.LEFT|wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_6.Add(sizer_7, 0, wx.EXPAND, 6)
        self.panel_2.SetSizer(sizer_6)
        sizer_2.Add(self.panel_2, 1, wx.LEFT|wx.RIGHT|wx.EXPAND, 25)
        sizer_8.Add(self.startAcquisitionButton, 1, wx.ALL|wx.EXPAND, 5)
        sizer_9.Add(self.label_2, 0, wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_9.Add(self.seqTextCtrl, 1, wx.LEFT|wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        sizer_10.Add(self.logListCtrl, 1, wx.EXPAND, 0)
