#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Sat Aug 29 17:04:50 2009
...
class StatsPanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.button_1 = wx.Button(self.panel_1, -1, "&Start")
        ...
        self.label_2_copy_1 = wx.StaticText(self.panel_1, -1, "Rate (rd/s)", style=wx.ALIGN_RIGHT)
        self.rateTextCtrl = wx.TextCtrl(self.panel_1, -1, "")
        self.label_2_copy_2 = wx.StaticText(self.panel_1, -1, "Freq StdDev (MHz)", style=wx.ALIGN_RIGHT)
        self.freqStdDevTextCtrl = wx.TextCtrl(self.panel_1, -1, "")

        self.__set_properties()
        self.__do_layout()

        self.Bind(wx.EVT_BUTTON, self.onStart, self.button_1)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_1.Add(grid_sizer_1, 1, wx.EXPAND, 0)
        sizer_2.Add(self.button_1, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 10)
        ...
        sizer_2.Add(self.label_2_copy_1, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_2.Add(self.rateTextCtrl, 1, wx.LEFT|wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_2.Add(self.label_2_copy_2, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5)
    ...
    def onStart(self, event): # wxGlade: StatsPanelGui.<event_handler>
