#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Fri Jul 24 19:42:38 2009
...
class WlmPanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.clearButton = wx.Button(self.panel_12, wx.ID_CLEAR, "")
    ...
    def __do_layout(self):
        ...
        sizer_11.Add(self.photocurrentGraph, 1, wx.EXPAND, 0)
        sizer_11.Add(self.ratioGraph, 1, wx.EXPAND, 0)
        sizer_12.Add(self.clearButton, 0, wx.ALL, 10)
        sizer_12.Add((20, 20), 0, wx.EXPAND, 0)
        self.panel_12.SetSizer(sizer_12)
        sizer_11.Add(self.panel_12, 0, wx.EXPAND, 0)
