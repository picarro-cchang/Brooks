...
#
# FILE:
#   Test201002.py tests the G2000 logic board laser TEC drive for laser 1
#
# DESCRIPTION:
#
# SEE ALSO:
...
from Host.MfgUtilities.TestLogicBoardLaserTec import *
...
if __name__ == "__main__":
    ...
    tst = TestLogicBoardLaserTec(tp,1)
    tst.run()
    tp.appendReport()
    tp.makeHTML()