...
#
# FILE:
#   Test204003.py tests the G2000 logic board thermistor processing for laser 4
#
# DESCRIPTION:
#
# SEE ALSO:
...
from Host.MfgUtilities.TestLogicBoardLaserThermistor import *
...
if __name__ == "__main__":
    ...
    tst = TestLogicBoardLaserThermistor(tp,4)
    tst.run()
    tp.appendReport()
    tp.makeHTML()