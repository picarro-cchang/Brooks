...
# -*- coding: ISO-8859-15 -*-
#
# generated by wxGlade 0.6.8 (standalone edition) on Wed Dec 11 11:42:29 2013
#
...
class WlmCalUtilityGui(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.panel_side = wx.Panel(self, wx.ID_ANY)
        self.label_etalon_1 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Etalon 1"))
        self.text_ctrl_etalon_1 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_etalon_1_dark = wx.StaticText(self.panel_side, wx.ID_ANY, _("Etalon 1 Dark Current"))
        self.text_ctrl_etalon_1_dark = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_reference_1 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Reference 1"))
        self.text_ctrl_reference_1 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_reference_1_dark = wx.StaticText(self.panel_side, wx.ID_ANY, _("Reference 1 Dark Current"))
        self.text_ctrl_reference_1_dark = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_etalon_2 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Etalon 2"))
        self.text_ctrl_etalon_2 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_etalon_2_dark = wx.StaticText(self.panel_side, wx.ID_ANY, _("Etalon 2 Dark Current"))
        self.text_ctrl_etalon_2_dark = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_reference_2 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Reference 2"))
        self.text_ctrl_reference_2 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_reference_2_dark = wx.StaticText(self.panel_side, wx.ID_ANY, _("Reference 2 Dark Current"))
        self.text_ctrl_reference_2_dark = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_ratio_1 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Ratio 1"))
        self.text_ctrl_ratio_1 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_ratio_2 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Ratio 2"))
        self.text_ctrl_ratio_2 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_center_1 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Center 1"))
        self.text_ctrl_center_1 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_center_2 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Center 2"))
        self.text_ctrl_center_2 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_scale_1 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Scale 1"))
        self.text_ctrl_scale_1 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_scale_2 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Scale 2"))
        self.text_ctrl_scale_2 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_norm_scale_1 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Normalized Scale 1"))
        self.text_ctrl_norm_scale_1 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_norm_scale_2 = wx.StaticText(self.panel_side, wx.ID_ANY, _("Normalized Scale 2"))
        self.text_ctrl_norm_scale_2 = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_phase_deg = wx.StaticText(self.panel_side, wx.ID_ANY, _("Phase Angle (degrees)"))
        self.text_ctrl_phase_deg = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.label_phase_rad = wx.StaticText(self.panel_side, wx.ID_ANY, _("Phase angle (radians)"))
        self.text_ctrl_phase_rad = wx.TextCtrl(self.panel_side, wx.ID_ANY, "")
        self.panel_spacer_1 = wx.Panel(self.panel_side, wx.ID_ANY)
        self.panel_side_buttons = wx.Panel(self.panel_side, wx.ID_ANY)
        self.button_measure_dark = wx.Button(self.panel_side_buttons, wx.ID_ANY, _("Measure Dark Currents"))
        self.button_clear_data = wx.Button(self.panel_side_buttons, wx.ID_ANY, _("Clear Data"))
        self.button_save = wx.Button(self.panel_side_buttons, wx.ID_ANY, _("Save Data"))
        self.notebook_graphs = wx.Notebook(self, wx.ID_ANY, style=0)
        self.notebook_graphs_ratios = wx.Panel(self.notebook_graphs, wx.ID_ANY)
        self.graph_ratios = GraphPanel(self.notebook_graphs_ratios, wx.ID_ANY)
        self.panel_graph_ratios = wx.Panel(self.notebook_graphs_ratios, wx.ID_ANY)
        ...
        self.Bind(wx.EVT_BUTTON, self.onSaveData, self.button_save)
        # end wxGlade

    def __set_properties(self):
        # begin wxGlade: WlmCalUtilityGui.__set_properties
        self.SetTitle(_("WLM Calibration Utility"))
    ...
    def __do_layout(self):
        ...
        sizer_side_9 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_side_9b = wx.BoxSizer(wx.VERTICAL)
        sizer_side_9a = wx.BoxSizer(wx.VERTICAL)
        sizer_side_8 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_side_8b = wx.BoxSizer(wx.VERTICAL)
        ...
        sizer_side_8a.Add(self.label_norm_scale_1, 0, wx.LEFT, 5)
        sizer_side_8a.Add(self.text_ctrl_norm_scale_1, 0, wx.ALL | wx.EXPAND, 5)
        sizer_side_8.Add(sizer_side_8a, 1, wx.EXPAND, 0)
        sizer_side_8b.Add(self.label_norm_scale_2, 0, wx.LEFT, 5)
        sizer_side_8b.Add(self.text_ctrl_norm_scale_2, 0, wx.ALL | wx.EXPAND, 5)
        sizer_side_8.Add(sizer_side_8b, 1, wx.EXPAND, 0)
        sizer_4.Add(sizer_side_8, 0, wx.EXPAND, 0)
        sizer_side_9a.Add(self.label_phase_deg, 0, wx.LEFT, 5)
        sizer_side_9a.Add(self.text_ctrl_phase_deg, 0, wx.ALL | wx.EXPAND, 5)
        sizer_side_9.Add(sizer_side_9a, 1, wx.EXPAND, 0)
        sizer_side_9b.Add(self.label_phase_rad, 0, wx.LEFT, 5)
        sizer_side_9b.Add(self.text_ctrl_phase_rad, 0, wx.ALL | wx.EXPAND, 5)
        sizer_side_9.Add(sizer_side_9b, 1, wx.EXPAND, 0)
        sizer_4.Add(sizer_side_9, 0, wx.EXPAND, 0)
        ...
        sizer_side_buttons.Add(self.button_save, 0, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_HORIZONTAL, 10)
        ...
        self.notebook_graphs.AddPage(self.notebook_graphs_ratios, _("Ratios"))
    ...
    def onSaveData(self, event):  # wxGlade: WlmCalUtilityGui.<event_handler>
...
if __name__ == "__main__":
    ...
    frame_main = WlmCalUtilityGui(None, wx.ID_ANY, "")
