...
LASER2_RESISTANCE_REGISTER = 54
LASER2_TEMPERATURE_REGISTER = 55
LASER2_THERMISTOR_ADC_REGISTER = 56
LASER2_TEC_REGISTER = 57
LASER2_MANUAL_TEC_REGISTER = 58
LASER2_TEMP_CNTRL_STATE_REGISTER = 59
LASER2_TEMP_CNTRL_LOCK_STATUS_REGISTER = 60
LASER2_TEMP_CNTRL_SETPOINT_REGISTER = 61
LASER2_TEMP_CNTRL_USER_SETPOINT_REGISTER = 62
LASER2_TEMP_CNTRL_TOLERANCE_REGISTER = 63
LASER2_TEMP_CNTRL_SWEEP_MAX_REGISTER = 64
LASER2_TEMP_CNTRL_SWEEP_MIN_REGISTER = 65
LASER2_TEMP_CNTRL_SWEEP_INCR_REGISTER = 66
LASER2_TEMP_CNTRL_H_REGISTER = 67
LASER2_TEMP_CNTRL_K_REGISTER = 68
LASER2_TEMP_CNTRL_TI_REGISTER = 69
LASER2_TEMP_CNTRL_TD_REGISTER = 70
LASER2_TEMP_CNTRL_B_REGISTER = 71
LASER2_TEMP_CNTRL_C_REGISTER = 72
LASER2_TEMP_CNTRL_N_REGISTER = 73
LASER2_TEMP_CNTRL_S_REGISTER = 74
LASER2_TEMP_CNTRL_FFWD_REGISTER = 75
LASER2_TEMP_CNTRL_AMIN_REGISTER = 76
LASER2_TEMP_CNTRL_AMAX_REGISTER = 77
LASER2_TEMP_CNTRL_IMAX_REGISTER = 78
LASER2_TEC_PRBS_GENPOLY_REGISTER = 79
LASER2_TEC_PRBS_AMPLITUDE_REGISTER = 80
LASER2_TEC_PRBS_MEAN_REGISTER = 81
LASER2_TEC_MONITOR_REGISTER = 82
LASER2_CURRENT_CNTRL_STATE_REGISTER = 83
...
CONVERSION_LASER3_THERM_CONSTB_REGISTER = 91
CONVERSION_LASER3_THERM_CONSTC_REGISTER = 92
LASER3_RESISTANCE_REGISTER = 93
LASER3_TEMPERATURE_REGISTER = 94
LASER3_THERMISTOR_ADC_REGISTER = 95
LASER3_TEC_REGISTER = 96
LASER3_MANUAL_TEC_REGISTER = 97
LASER3_TEMP_CNTRL_STATE_REGISTER = 98
LASER3_TEMP_CNTRL_LOCK_STATUS_REGISTER = 99
LASER3_TEMP_CNTRL_SETPOINT_REGISTER = 100
LASER3_TEMP_CNTRL_USER_SETPOINT_REGISTER = 101
LASER3_TEMP_CNTRL_TOLERANCE_REGISTER = 102
LASER3_TEMP_CNTRL_SWEEP_MAX_REGISTER = 103
LASER3_TEMP_CNTRL_SWEEP_MIN_REGISTER = 104
LASER3_TEMP_CNTRL_SWEEP_INCR_REGISTER = 105
LASER3_TEMP_CNTRL_H_REGISTER = 106
LASER3_TEMP_CNTRL_K_REGISTER = 107
LASER3_TEMP_CNTRL_TI_REGISTER = 108
LASER3_TEMP_CNTRL_TD_REGISTER = 109
LASER3_TEMP_CNTRL_B_REGISTER = 110
LASER3_TEMP_CNTRL_C_REGISTER = 111
LASER3_TEMP_CNTRL_N_REGISTER = 112
LASER3_TEMP_CNTRL_S_REGISTER = 113
LASER3_TEMP_CNTRL_FFWD_REGISTER = 114
LASER3_TEMP_CNTRL_AMIN_REGISTER = 115
LASER3_TEMP_CNTRL_AMAX_REGISTER = 116
LASER3_TEMP_CNTRL_IMAX_REGISTER = 117
LASER3_TEC_PRBS_GENPOLY_REGISTER = 118
LASER3_TEC_PRBS_AMPLITUDE_REGISTER = 119
LASER3_TEC_PRBS_MEAN_REGISTER = 120
LASER3_TEC_MONITOR_REGISTER = 121
LASER3_CURRENT_CNTRL_STATE_REGISTER = 122
LASER3_MANUAL_COARSE_CURRENT_REGISTER = 123
LASER3_MANUAL_FINE_CURRENT_REGISTER = 124
LASER3_CURRENT_SWEEP_MIN_REGISTER = 125
LASER3_CURRENT_SWEEP_MAX_REGISTER = 126
LASER3_CURRENT_SWEEP_INCR_REGISTER = 127
LASER3_CURRENT_MONITOR_REGISTER = 128
CONVERSION_LASER4_THERM_CONSTA_REGISTER = 129
CONVERSION_LASER4_THERM_CONSTB_REGISTER = 130
CONVERSION_LASER4_THERM_CONSTC_REGISTER = 131
LASER4_RESISTANCE_REGISTER = 132
LASER4_TEMPERATURE_REGISTER = 133
LASER4_THERMISTOR_ADC_REGISTER = 134
LASER4_TEC_REGISTER = 135
LASER4_MANUAL_TEC_REGISTER = 136
LASER4_TEMP_CNTRL_STATE_REGISTER = 137
LASER4_TEMP_CNTRL_LOCK_STATUS_REGISTER = 138
LASER4_TEMP_CNTRL_SETPOINT_REGISTER = 139
LASER4_TEMP_CNTRL_USER_SETPOINT_REGISTER = 140
LASER4_TEMP_CNTRL_TOLERANCE_REGISTER = 141
LASER4_TEMP_CNTRL_SWEEP_MAX_REGISTER = 142
LASER4_TEMP_CNTRL_SWEEP_MIN_REGISTER = 143
LASER4_TEMP_CNTRL_SWEEP_INCR_REGISTER = 144
LASER4_TEMP_CNTRL_H_REGISTER = 145
LASER4_TEMP_CNTRL_K_REGISTER = 146
LASER4_TEMP_CNTRL_TI_REGISTER = 147
LASER4_TEMP_CNTRL_TD_REGISTER = 148
LASER4_TEMP_CNTRL_B_REGISTER = 149
LASER4_TEMP_CNTRL_C_REGISTER = 150
LASER4_TEMP_CNTRL_N_REGISTER = 151
LASER4_TEMP_CNTRL_S_REGISTER = 152
LASER4_TEMP_CNTRL_FFWD_REGISTER = 153
LASER4_TEMP_CNTRL_AMIN_REGISTER = 154
LASER4_TEMP_CNTRL_AMAX_REGISTER = 155
LASER4_TEMP_CNTRL_IMAX_REGISTER = 156
LASER4_TEC_PRBS_GENPOLY_REGISTER = 157
LASER4_TEC_PRBS_AMPLITUDE_REGISTER = 158
LASER4_TEC_PRBS_MEAN_REGISTER = 159
LASER4_TEC_MONITOR_REGISTER = 160
LASER4_CURRENT_CNTRL_STATE_REGISTER = 161
LASER4_MANUAL_COARSE_CURRENT_REGISTER = 162
LASER4_MANUAL_FINE_CURRENT_REGISTER = 163
LASER4_CURRENT_SWEEP_MIN_REGISTER = 164
LASER4_CURRENT_SWEEP_MAX_REGISTER = 165
LASER4_CURRENT_SWEEP_INCR_REGISTER = 166
LASER4_CURRENT_MONITOR_REGISTER = 167
CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTA_REGISTER = 168
CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTB_REGISTER = 169
CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTC_REGISTER = 170
HOT_BOX_HEATSINK_RESISTANCE_REGISTER = 171
HOT_BOX_HEATSINK_TEMPERATURE_REGISTER = 172
HOT_BOX_HEATSINK_ADC_REGISTER = 173
CONVERSION_CAVITY_THERM_CONSTA_REGISTER = 174
CONVERSION_CAVITY_THERM_CONSTB_REGISTER = 175
CONVERSION_CAVITY_THERM_CONSTC_REGISTER = 176
CAVITY_RESISTANCE_REGISTER = 177
CAVITY_TEMPERATURE_REGISTER = 178
CAVITY_THERMISTOR_ADC_REGISTER = 179
CAVITY_TEC_REGISTER = 180
CAVITY_MANUAL_TEC_REGISTER = 181
CAVITY_TEMP_CNTRL_STATE_REGISTER = 182
CAVITY_TEMP_CNTRL_LOCK_STATUS_REGISTER = 183
CAVITY_TEMP_CNTRL_SETPOINT_REGISTER = 184
CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER = 185
CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER = 186
CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER = 187
CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER = 188
CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER = 189
CAVITY_TEMP_CNTRL_H_REGISTER = 190
CAVITY_TEMP_CNTRL_K_REGISTER = 191
CAVITY_TEMP_CNTRL_TI_REGISTER = 192
CAVITY_TEMP_CNTRL_TD_REGISTER = 193
CAVITY_TEMP_CNTRL_B_REGISTER = 194
CAVITY_TEMP_CNTRL_C_REGISTER = 195
CAVITY_TEMP_CNTRL_N_REGISTER = 196
CAVITY_TEMP_CNTRL_S_REGISTER = 197
CAVITY_TEMP_CNTRL_FFWD_REGISTER = 198
CAVITY_TEMP_CNTRL_AMIN_REGISTER = 199
CAVITY_TEMP_CNTRL_AMAX_REGISTER = 200
CAVITY_TEMP_CNTRL_IMAX_REGISTER = 201
CAVITY_TEC_PRBS_GENPOLY_REGISTER = 202
CAVITY_TEC_PRBS_AMPLITUDE_REGISTER = 203
CAVITY_TEC_PRBS_MEAN_REGISTER = 204
CAVITY_MAX_HEATSINK_TEMP_REGISTER = 205
HEATER_CNTRL_STATE_REGISTER = 206
HEATER_CNTRL_GAIN_REGISTER = 207
HEATER_CNTRL_QUANTIZE_REGISTER = 208
HEATER_CNTRL_UBIAS_SLOPE_REGISTER = 209
HEATER_CNTRL_UBIAS_OFFSET_REGISTER = 210
HEATER_CNTRL_MARK_MIN_REGISTER = 211
HEATER_CNTRL_MARK_MAX_REGISTER = 212
HEATER_CNTRL_MANUAL_MARK_REGISTER = 213
HEATER_CNTRL_MARK_REGISTER = 214
TUNER_SWEEP_RAMP_HIGH_REGISTER = 215
TUNER_SWEEP_RAMP_LOW_REGISTER = 216
TUNER_WINDOW_RAMP_HIGH_REGISTER = 217
...
# Block RDMAN 
RDMAN_CONTROL = 0 # 
RDMAN_CONTROL_RUN_B = 0 #  bit position
RDMAN_CONTROL_RUN_W = 1 #  bit width
RDMAN_CONTROL_CONT_B = 1 #  bit position
RDMAN_CONTROL_CONT_W = 1 #  bit width
RDMAN_CONTROL_START_RD_B = 2 #  bit position
RDMAN_CONTROL_START_RD_W = 1 #  bit width
RDMAN_CONTROL_ABORT_RD_B = 3 #  bit position
RDMAN_CONTROL_ABORT_RD_W = 1 #  bit width
RDMAN_CONTROL_LOCK_ENABLE_B = 4 #  bit position
RDMAN_CONTROL_LOCK_ENABLE_W = 1 #  bit width
RDMAN_CONTROL_UP_SLOPE_ENABLE_B = 5 #  bit position
RDMAN_CONTROL_UP_SLOPE_ENABLE_W = 1 #  bit width
RDMAN_CONTROL_DOWN_SLOPE_ENABLE_B = 6 #  bit position
RDMAN_CONTROL_DOWN_SLOPE_ENABLE_W = 1 #  bit width
RDMAN_CONTROL_BANK0_CLEAR_B = 7 #  bit position
RDMAN_CONTROL_BANK0_CLEAR_W = 1 #  bit width
RDMAN_CONTROL_BANK1_CLEAR_B = 8 #  bit position
RDMAN_CONTROL_BANK1_CLEAR_W = 1 #  bit width
RDMAN_CONTROL_LASER_LOCKED_B = 9 #  bit position
RDMAN_CONTROL_LASER_LOCKED_W = 1 #  bit width
RDMAN_CONTROL_LASER_LOCKER_DONE_B = 10 #  bit position
RDMAN_CONTROL_LASER_LOCKER_DONE_W = 1 #  bit width
RDMAN_CONTROL_RD_IRQ_ACK_B = 11 #  bit position
RDMAN_CONTROL_RD_IRQ_ACK_W = 1 #  bit width
RDMAN_CONTROL_ACQ_DONE_ACK_B = 12 #  bit position
RDMAN_CONTROL_ACQ_DONE_ACK_W = 1 #  bit width

RDMAN_STATUS = 1 # 
RDMAN_STATUS_SHUTDOWN_B = 0 #  bit position
RDMAN_STATUS_SHUTDOWN_W = 1 #  bit width
RDMAN_STATUS_RD_IRQ_B = 1 #  bit position
RDMAN_STATUS_RD_IRQ_W = 1 #  bit width
RDMAN_STATUS_ACQ_DONE_B = 2 #  bit position
RDMAN_STATUS_ACQ_DONE_W = 1 #  bit width
RDMAN_STATUS_BANK_B = 3 #  bit position
RDMAN_STATUS_BANK_W = 1 #  bit width
RDMAN_STATUS_BANK0_IN_USE_B = 4 #  bit position
RDMAN_STATUS_BANK0_IN_USE_W = 1 #  bit width
RDMAN_STATUS_BANK1_IN_USE_B = 5 #  bit position
RDMAN_STATUS_BANK1_IN_USE_W = 1 #  bit width
RDMAN_STATUS_LAPPED_B = 6 #  bit position
RDMAN_STATUS_LAPPED_W = 1 #  bit width
RDMAN_STATUS_WL_LOCKED_B = 7 #  bit position
RDMAN_STATUS_WL_LOCKED_W = 1 #  bit width
RDMAN_STATUS_TIMEOUT_B = 8 #  bit position
RDMAN_STATUS_TIMEOUT_W = 1 #  bit width
...
RDMAN_PARAM6 = 8 # 
RDMAN_PARAM7 = 9 # 
RDMAN_DATA_ADDRCNTR = 10 # 
RDMAN_METADATA_ADDRCNTR = 11 # 
RDMAN_PARAM_ADDRCNTR = 12 # 
RDMAN_DIVISOR = 13 # 
RDMAN_NUM_SAMP = 14 # 
RDMAN_THRESHOLD = 15 # 
RDMAN_LOCK_DURATION = 16 # 
RDMAN_PRECONTROL_DURATION = 17 # 
RDMAN_TIMEOUT_DURATION = 18 # 
RDMAN_TUNER_AT_RINGDOWN = 19 # 
RDMAN_METADATA_ADDR_AT_RINGDOWN = 20 # 
...
__p.append(('float',TUNER_SWEEP_RAMP_HIGH_REGISTER,'Ramp mode upper sweep limit','digU','%.0f',1,1))
__p.append(('float',TUNER_SWEEP_RAMP_LOW_REGISTER,'Ramp mode lower sweep limit','digU','%.0f',1,1))
__p.append(('float',TUNER_WINDOW_RAMP_HIGH_REGISTER,'Ramp mode upper window limit','digU','%.0f',1,1))
__p.append(('float',TUNER_WINDOW_RAMP_LOW_REGISTER,'Ramp mode lower window limit','digU','%.0f',1,1))
__p.append(('float',TUNER_UP_SLOPE_REGISTER,'Tuner up slope','digU','%.0f',1,1))
__p.append(('float',TUNER_DOWN_SLOPE_REGISTER,'Tuner down slope','digU','%.0f',1,1))
