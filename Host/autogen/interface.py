...
STREAM_MemberTypeDict[6] = 'STREAM_WarmBoxTecTemp' # 
STREAM_MemberTypeDict[7] = 'STREAM_CavityTemp' # 
STREAM_MemberTypeDict[8] = 'STREAM_HotBoxTecTemp' # 
...
INTERFACE_NUMBER_OF_REGISTERS = 307
...
CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTA_REGISTER = 186
CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTB_REGISTER = 187
CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTC_REGISTER = 188
WARM_BOX_HEATSINK_RESISTANCE_REGISTER = 189
WARM_BOX_HEATSINK_TEMPERATURE_REGISTER = 190
WARM_BOX_HEATSINK_THERMISTOR_ADC_REGISTER = 191
CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTA_REGISTER = 192
CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTB_REGISTER = 193
CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTC_REGISTER = 194
HOT_BOX_HEATSINK_RESISTANCE_REGISTER = 195
HOT_BOX_HEATSINK_TEMPERATURE_REGISTER = 196
HOT_BOX_HEATSINK_ADC_REGISTER = 197
CONVERSION_CAVITY_THERM_CONSTA_REGISTER = 198
CONVERSION_CAVITY_THERM_CONSTB_REGISTER = 199
CONVERSION_CAVITY_THERM_CONSTC_REGISTER = 200
CAVITY_RESISTANCE_REGISTER = 201
CAVITY_TEMPERATURE_REGISTER = 202
CAVITY_THERMISTOR_ADC_REGISTER = 203
CAVITY_TEC_REGISTER = 204
CAVITY_MANUAL_TEC_REGISTER = 205
CAVITY_TEMP_CNTRL_STATE_REGISTER = 206
CAVITY_TEMP_CNTRL_LOCK_STATUS_REGISTER = 207
CAVITY_TEMP_CNTRL_SETPOINT_REGISTER = 208
CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER = 209
CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER = 210
CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER = 211
CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER = 212
CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER = 213
CAVITY_TEMP_CNTRL_H_REGISTER = 214
CAVITY_TEMP_CNTRL_K_REGISTER = 215
CAVITY_TEMP_CNTRL_TI_REGISTER = 216
CAVITY_TEMP_CNTRL_TD_REGISTER = 217
CAVITY_TEMP_CNTRL_B_REGISTER = 218
CAVITY_TEMP_CNTRL_C_REGISTER = 219
CAVITY_TEMP_CNTRL_N_REGISTER = 220
CAVITY_TEMP_CNTRL_S_REGISTER = 221
CAVITY_TEMP_CNTRL_FFWD_REGISTER = 222
CAVITY_TEMP_CNTRL_AMIN_REGISTER = 223
CAVITY_TEMP_CNTRL_AMAX_REGISTER = 224
CAVITY_TEMP_CNTRL_IMAX_REGISTER = 225
CAVITY_TEC_PRBS_GENPOLY_REGISTER = 226
CAVITY_TEC_PRBS_AMPLITUDE_REGISTER = 227
CAVITY_TEC_PRBS_MEAN_REGISTER = 228
CAVITY_MAX_HEATSINK_TEMP_REGISTER = 229
HEATER_CNTRL_STATE_REGISTER = 230
HEATER_CNTRL_GAIN_REGISTER = 231
HEATER_CNTRL_QUANTIZE_REGISTER = 232
HEATER_CNTRL_UBIAS_SLOPE_REGISTER = 233
HEATER_CNTRL_UBIAS_OFFSET_REGISTER = 234
HEATER_CNTRL_MARK_MIN_REGISTER = 235
HEATER_CNTRL_MARK_MAX_REGISTER = 236
HEATER_CNTRL_MANUAL_MARK_REGISTER = 237
HEATER_CNTRL_MARK_REGISTER = 238
CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER = 239
CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER = 240
CAVITY_PRESSURE_REGISTER = 241
CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER = 242
CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER = 243
AMBIENT_PRESSURE_REGISTER = 244
TUNER_SWEEP_RAMP_HIGH_REGISTER = 245
TUNER_SWEEP_RAMP_LOW_REGISTER = 246
TUNER_WINDOW_RAMP_HIGH_REGISTER = 247
TUNER_WINDOW_RAMP_LOW_REGISTER = 248
TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER = 249
TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER = 250
TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER = 251
TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER = 252
RDFITTER_MINLOSS_REGISTER = 253
RDFITTER_MAXLOSS_REGISTER = 254
RDFITTER_LATEST_LOSS_REGISTER = 255
RDFITTER_IMPROVEMENT_STEPS_REGISTER = 256
RDFITTER_START_SAMPLE_REGISTER = 257
RDFITTER_FRACTIONAL_THRESHOLD_REGISTER = 258
RDFITTER_ABSOLUTE_THRESHOLD_REGISTER = 259
RDFITTER_NUMBER_OF_POINTS_REGISTER = 260
RDFITTER_MAX_E_FOLDINGS_REGISTER = 261
SPECT_CNTRL_STATE_REGISTER = 262
SPECT_CNTRL_MODE_REGISTER = 263
SPECT_CNTRL_ACTIVE_SCHEME_REGISTER = 264
SPECT_CNTRL_NEXT_SCHEME_REGISTER = 265
SPECT_CNTRL_SCHEME_ITER_REGISTER = 266
SPECT_CNTRL_SCHEME_ROW_REGISTER = 267
SPECT_CNTRL_DWELL_COUNT_REGISTER = 268
SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER = 269
SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER = 270
SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER = 271
VIRTUAL_LASER_REGISTER = 272
SENTRY_UPPER_LIMIT_TRIPPED_REGISTER = 273
SENTRY_LOWER_LIMIT_TRIPPED_REGISTER = 274
SENTRY_LASER1_TEMPERATURE_MIN_REGISTER = 275
SENTRY_LASER1_TEMPERATURE_MAX_REGISTER = 276
SENTRY_LASER2_TEMPERATURE_MIN_REGISTER = 277
SENTRY_LASER2_TEMPERATURE_MAX_REGISTER = 278
SENTRY_LASER3_TEMPERATURE_MIN_REGISTER = 279
SENTRY_LASER3_TEMPERATURE_MAX_REGISTER = 280
SENTRY_LASER4_TEMPERATURE_MIN_REGISTER = 281
SENTRY_LASER4_TEMPERATURE_MAX_REGISTER = 282
SENTRY_ETALON_TEMPERATURE_MIN_REGISTER = 283
SENTRY_ETALON_TEMPERATURE_MAX_REGISTER = 284
SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER = 285
SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER = 286
SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER = 287
SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER = 288
SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER = 289
SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER = 290
SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER = 291
SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER = 292
SENTRY_DAS_TEMPERATURE_MIN_REGISTER = 293
SENTRY_DAS_TEMPERATURE_MAX_REGISTER = 294
SENTRY_LASER1_CURRENT_MIN_REGISTER = 295
SENTRY_LASER1_CURRENT_MAX_REGISTER = 296
SENTRY_LASER2_CURRENT_MIN_REGISTER = 297
SENTRY_LASER2_CURRENT_MAX_REGISTER = 298
SENTRY_LASER3_CURRENT_MIN_REGISTER = 299
SENTRY_LASER3_CURRENT_MAX_REGISTER = 300
SENTRY_LASER4_CURRENT_MIN_REGISTER = 301
SENTRY_LASER4_CURRENT_MAX_REGISTER = 302
SENTRY_CAVITY_PRESSURE_MIN_REGISTER = 303
SENTRY_CAVITY_PRESSURE_MAX_REGISTER = 304
SENTRY_AMBIENT_PRESSURE_MIN_REGISTER = 305
SENTRY_AMBIENT_PRESSURE_MAX_REGISTER = 306
...
ACTION_WB_CACHE = 40
ACTION_SCHEDULER_HEARTBEAT = 41
ACTION_SENTRY_INIT = 42
ACTION_PULSE_GENERATOR = 43
ACTION_FILTER = 44
ACTION_DS1631_READTEMP = 45
ACTION_LASER_TEC_IMON = 46
ACTION_READ_LASER_TEC_MONITORS = 47
ACTION_READ_LASER_THERMISTOR_RESISTANCE = 48
ACTION_READ_LASER_CURRENT = 49
