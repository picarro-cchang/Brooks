...
RDMAN_CONTROL_LOCK_ENABLE_B = 4 # Enable frequency locking bit position
RDMAN_CONTROL_LOCK_ENABLE_W = 1 # Enable frequency locking bit width
RDMAN_CONTROL_UP_SLOPE_ENABLE_B = 5 # Allow ring-down on positive tuner slope bit position
RDMAN_CONTROL_UP_SLOPE_ENABLE_W = 1 # Allow ring-down on positive tuner slope bit width
RDMAN_CONTROL_DOWN_SLOPE_ENABLE_B = 6 # Allow ring-down on negative tuner slope bit position
RDMAN_CONTROL_DOWN_SLOPE_ENABLE_W = 1 # Allow ring-down on negative tuner slope bit width
RDMAN_CONTROL_BANK0_CLEAR_B = 7 # Mark bank 0 available for write bit position
RDMAN_CONTROL_BANK0_CLEAR_W = 1 # Mark bank 0 available for write bit width
RDMAN_CONTROL_BANK1_CLEAR_B = 8 # Mark bank 1 available for write bit position
RDMAN_CONTROL_BANK1_CLEAR_W = 1 # Mark bank 1 available for write bit width
RDMAN_CONTROL_RD_IRQ_ACK_B = 9 # Acknowledge ring-down interrupt bit position
...
RDMAN_PARAM0 = 2 # Parameter 0 register
RDMAN_PARAM1 = 3 # Parameter 1 register
RDMAN_PARAM2 = 4 # Parameter 2 register
RDMAN_PARAM3 = 5 # Parameter 3 register
RDMAN_PARAM4 = 6 # Parameter 4 register
