...
INTERFACE_NUMBER_OF_REGISTERS = 398
...
CAVITY_PRESSURE_ADC_REGISTER = 279
CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER = 280
CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER = 281
CAVITY_PRESSURE_REGISTER = 282
AMBIENT_PRESSURE_ADC_REGISTER = 283
CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER = 284
CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER = 285
AMBIENT_PRESSURE_REGISTER = 286
ANALYZER_TUNING_MODE_REGISTER = 287
TUNER_SWEEP_RAMP_HIGH_REGISTER = 288
TUNER_SWEEP_RAMP_LOW_REGISTER = 289
TUNER_WINDOW_RAMP_HIGH_REGISTER = 290
TUNER_WINDOW_RAMP_LOW_REGISTER = 291
TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER = 292
TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER = 293
TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER = 294
TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER = 295
RDFITTER_MINLOSS_REGISTER = 296
RDFITTER_MAXLOSS_REGISTER = 297
RDFITTER_LATEST_LOSS_REGISTER = 298
RDFITTER_IMPROVEMENT_STEPS_REGISTER = 299
RDFITTER_START_SAMPLE_REGISTER = 300
RDFITTER_FRACTIONAL_THRESHOLD_REGISTER = 301
RDFITTER_ABSOLUTE_THRESHOLD_REGISTER = 302
RDFITTER_NUMBER_OF_POINTS_REGISTER = 303
RDFITTER_MAX_E_FOLDINGS_REGISTER = 304
RDFITTER_META_BACKOFF_REGISTER = 305
RDFITTER_META_SAMPLES_REGISTER = 306
SPECT_CNTRL_STATE_REGISTER = 307
SPECT_CNTRL_MODE_REGISTER = 308
SPECT_CNTRL_ACTIVE_SCHEME_REGISTER = 309
SPECT_CNTRL_NEXT_SCHEME_REGISTER = 310
SPECT_CNTRL_SCHEME_ITER_REGISTER = 311
SPECT_CNTRL_SCHEME_ROW_REGISTER = 312
SPECT_CNTRL_DWELL_COUNT_REGISTER = 313
SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER = 314
SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER = 315
SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER = 316
VIRTUAL_LASER_REGISTER = 317
PZT_OFFSET_VIRTUAL_LASER1 = 318
PZT_OFFSET_VIRTUAL_LASER2 = 319
PZT_OFFSET_VIRTUAL_LASER3 = 320
PZT_OFFSET_VIRTUAL_LASER4 = 321
PZT_OFFSET_VIRTUAL_LASER5 = 322
PZT_OFFSET_VIRTUAL_LASER6 = 323
PZT_OFFSET_VIRTUAL_LASER7 = 324
PZT_OFFSET_VIRTUAL_LASER8 = 325
SCHEME_OFFSET_VIRTUAL_LASER1 = 326
SCHEME_OFFSET_VIRTUAL_LASER2 = 327
SCHEME_OFFSET_VIRTUAL_LASER3 = 328
SCHEME_OFFSET_VIRTUAL_LASER4 = 329
SCHEME_OFFSET_VIRTUAL_LASER5 = 330
SCHEME_OFFSET_VIRTUAL_LASER6 = 331
SCHEME_OFFSET_VIRTUAL_LASER7 = 332
SCHEME_OFFSET_VIRTUAL_LASER8 = 333
VALVE_CNTRL_STATE_REGISTER = 334
VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER = 335
VALVE_CNTRL_USER_INLET_VALVE_REGISTER = 336
VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER = 337
VALVE_CNTRL_INLET_VALVE_REGISTER = 338
VALVE_CNTRL_OUTLET_VALVE_REGISTER = 339
VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER = 340
VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER = 341
VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER = 342
VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER = 343
VALVE_CNTRL_INLET_VALVE_MIN_REGISTER = 344
VALVE_CNTRL_INLET_VALVE_MAX_REGISTER = 345
VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER = 346
VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER = 347
VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER = 348
VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER = 349
VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER = 350
VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER = 351
VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER = 352
VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER = 353
VALVE_CNTRL_THRESHOLD_STATE_REGISTER = 354
VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER = 355
VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER = 356
VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER = 357
VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER = 358
VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER = 359
VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER = 360
VALVE_CNTRL_SEQUENCE_STEP_REGISTER = 361
VALVE_CNTRL_SOLENOID_VALVES_REGISTER = 362
TEC_CNTRL_REGISTER = 363
SENTRY_UPPER_LIMIT_TRIPPED_REGISTER = 364
SENTRY_LOWER_LIMIT_TRIPPED_REGISTER = 365
SENTRY_LASER1_TEMPERATURE_MIN_REGISTER = 366
SENTRY_LASER1_TEMPERATURE_MAX_REGISTER = 367
SENTRY_LASER2_TEMPERATURE_MIN_REGISTER = 368
SENTRY_LASER2_TEMPERATURE_MAX_REGISTER = 369
SENTRY_LASER3_TEMPERATURE_MIN_REGISTER = 370
SENTRY_LASER3_TEMPERATURE_MAX_REGISTER = 371
SENTRY_LASER4_TEMPERATURE_MIN_REGISTER = 372
SENTRY_LASER4_TEMPERATURE_MAX_REGISTER = 373
SENTRY_ETALON_TEMPERATURE_MIN_REGISTER = 374
SENTRY_ETALON_TEMPERATURE_MAX_REGISTER = 375
SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER = 376
SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER = 377
SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER = 378
SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER = 379
SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER = 380
SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER = 381
SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER = 382
SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER = 383
SENTRY_DAS_TEMPERATURE_MIN_REGISTER = 384
SENTRY_DAS_TEMPERATURE_MAX_REGISTER = 385
SENTRY_LASER1_CURRENT_MIN_REGISTER = 386
SENTRY_LASER1_CURRENT_MAX_REGISTER = 387
SENTRY_LASER2_CURRENT_MIN_REGISTER = 388
SENTRY_LASER2_CURRENT_MAX_REGISTER = 389
SENTRY_LASER3_CURRENT_MIN_REGISTER = 390
SENTRY_LASER3_CURRENT_MAX_REGISTER = 391
SENTRY_LASER4_CURRENT_MIN_REGISTER = 392
SENTRY_LASER4_CURRENT_MAX_REGISTER = 393
SENTRY_CAVITY_PRESSURE_MIN_REGISTER = 394
SENTRY_CAVITY_PRESSURE_MAX_REGISTER = 395
SENTRY_AMBIENT_PRESSURE_MIN_REGISTER = 396
SENTRY_AMBIENT_PRESSURE_MAX_REGISTER = 397
...
__p.append(('dsp','float',HEATER_TEMP_CNTRL_SWEEP_INCR_REGISTER,'Sweep increment','digU/sample','%.0f',1,1))
