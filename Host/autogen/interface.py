...
registerInfo.append(RegInfo("CAVITY_PRESSURE_ADC_REGISTER",c_uint,0,1.0,"r"))
...
registerInfo.append(RegInfo("AMBIENT_PRESSURE_ADC_REGISTER",c_uint,0,1.0,"r"))
