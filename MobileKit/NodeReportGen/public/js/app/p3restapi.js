    ...
    var p3RestApi = function(initArgs) {
        ...
        var httpRequestFn = function(request_obj, errorCbFn, successCbFn) {
            ...
            if (request_obj.jsonp === true) {
                errorFn = function(xOptions, status_str) {
                    if (errorCbFn) {
        ...
        var getpost = function(type, request_obj, errorCbFn, successCbFn) {
            ...
            switch(type) {
            case "GET":
                my_qryparms_obj = request_obj.qryobj;
                break;
            case "POST":
                my_qryparms_obj = request_obj.dataobj;
                break;
            }

            if (request_obj.hasOwnProperty("existing_tkt")) {
                my_existing_tkt = request_obj.existing_tkt;
            } else {
                my_existing_tkt = true;
            }
