...
class GetPeripheralDataBatch(object):
    ...
    def run(self):
        varList = {'GPS_WS_DIR':'gpsWsPath','GPS_FILE':'gpsFile',
                   ...
                   'COMPASSDELAY':'compassDelay','DIRCORRECTDELAY':'dirCorrectDelay',
        ...
        for secName in self.config:
            ...
            self.dirCorrectDelay = float(self.dirCorrectDelay)
    ...
    def _run(self):
        ...
        self.scriptEnviron = dict(
            ...
            PARAMS={'STATSAVG':self.statsAvg,'ANEMDELAY':self.anemDelay,
                    'COMPASSDELAY':self.compassDelay,'DIRCORRECTDELAY':self.dirCorrectDelay,
