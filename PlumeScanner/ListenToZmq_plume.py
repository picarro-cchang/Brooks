...
import TapeReconstructor as TapeRecon
...
class DataManagerListener(object):
    ...
    def run(self):
        ...
        print "Running..."
        try:
            # TracyT reports this while loop is bailing after a run, should run
            # indefinitely. There must be an exception happening somewhere below.
            while True:
                ...
                if socks.get(self.listenSock) == zmq.POLLIN:
                    ...
                    if self.fp is None:     # If no file is open
                        ...
                        while len(self.dataDeque) > 0:
                            ...
                            if obj["data"]["ValveMask"] == 0:
                                ...
                                TapeRecon.plume_analyzer(self.filename)
                            else:
