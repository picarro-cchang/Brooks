...
Source: {#sandboxDir}\trunk\MobileKit\dist\*; DestDir: {app}\AnalyzerServerExe; Flags: recursesubdirs replacesameversion
...
Name: {userdesktop}\Coordinator Launcher; Filename: {app}\HostExe\CoordinatorLauncher.exe; Parameters: -c ..\AppConfig\Config\Utilities\CoordinatorLauncher.ini; WorkingDir: {app}\HostExe; IconFilename: {app}\HostExe\{#picarroIcon}
...
Name: {userdesktop}\Integration\Integration Tool; Filename: {app}\HostExe\IntegrationTool.exe; Parameters: -c ..\CommonConfig\Config\Utilities\IntegrationTool.ini; WorkingDir: {app}\HostExe; IconFilename: {app}\HostExe\{#integrationIcon}
...
Name: {userdesktop}\Picarro Utilities\Data Recal; Filename: {app}\HostExe\DataRecal.exe; Parameters: -c ..\InstrConfig\Calibration\InstrCal\UserCal.ini; WorkingDir: {app}\HostExe; IconFilename: {app}\HostExe\{#utilitiesIcon}
...
Name: {group}\Coordinator Launcher; Filename: {app}\HostExe\CoordinatorLauncher.exe; Parameters: -c ..\AppConfig\Config\Utilities\CoordinatorLauncher.ini; WorkingDir: {app}\HostExe; IconFilename: {app}\HostExe\{#picarroIcon}
