# RunTool.py
#
# For running a Win7 user migration tool script from the command line. Useful for developing code
...
#
# It is expected that this code is running from Tools\Win7UserMigrationTools folder.
...
def runPythonScript(scriptName):
    ...
    # Get the current dir. Expect that we are in the Tools\Win7UserMigrationTools folder.
    ...
    if curDir.lower() != "win7usermigrationtools":
        print "Not running in expected folder 'Win7UserMigrationTools'!"
        sys.exit(1)
