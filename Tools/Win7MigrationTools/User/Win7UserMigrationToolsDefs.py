...
MIGRATION_DIALOG_CAPTION = "WinXP user migration to Win7: Part %s"

MIGRATION_TOOLS_LOGFILENAME_BASE_1 = "UserMigrationPart1_%Y_%m_%d_%H_%M_%S"
MIGRATION_TOOLS_LOGFILENAME_BASE_2 = "UserMigrationPart2_%Y_%m_%d_%H_%M_%S"
...
MIGRATION_CONFIG_FILENAME = "Win7UserConfig.ini"
