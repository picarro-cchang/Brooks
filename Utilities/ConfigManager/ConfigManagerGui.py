#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Wed Jan 04 11:40:44 2012
...
class ConfigManagerGui(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(11, "&Save\tCtrl-S", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(12, "Save &As...", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(13, "Save All", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        wxglade_tmp_menu.Append(14, "E&xit\tCtrl-Q", "", wx.ITEM_NORMAL)
        ...
        self.Bind(wx.EVT_MENU, self.onSave, id=11)
        self.Bind(wx.EVT_MENU, self.onSaveAs, id=12)
        self.Bind(wx.EVT_MENU, self.onSaveAll, id=13)
