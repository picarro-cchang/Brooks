...
class DataRecalFrame(wx.Frame):
    def __init__(self, dataList, *args, **kwds):
        ...
        self.buttonReset = wx.Button(self.panel3, -1, "Reset", style=wx.BU_EXACTFIT)         
        ...
        self.buttonReset.SetMinSize((60, 20))
        self.buttonReset.SetBackgroundColour(wx.Colour(237, 228, 199))
        self.buttonReset.SetFont(wx.Font(8, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, ""))
    ...
    def doLayout(self):
        ...
        sizerPanel3.Add(self.buttonReset, 1, wx.ALL|wx.EXPAND, 4)
