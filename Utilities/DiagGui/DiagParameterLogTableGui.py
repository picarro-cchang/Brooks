# File Name: DiagParameterLogTableGui.py
# Purpose: This module handles the ParameterLogTable page
#
# File History:
...
####################################################################
#
class ParameterLogTableGui(wx.Panel):
    ...
    def CreateControls(self):
        ...
        list = []
        for table in range(len(Global.DIAG_ParameterTableTypeDict)-1):
            list.append( Global.DIAG_ParameterTableTypeDict[table] )
    ...
    def onUpdateButtonClick(self,parent):
        numEntries = self.diag.DIAG_ReadTableTotal( Global.DIAG_ParamLogTables, self.tableNum )
        self.table = self.diag.DIAG_ReadParameterLogTable( self.tableNum, numEntries, 0 )
...
class GeneralList( wx.ListCtrl ):
    ...
    def SetupList(self):
        ...
        col = 1
        for field in Global.DIAG_ParameterLogStruct._fields_:
