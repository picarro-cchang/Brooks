...
class HostStartupFrame(wx.Frame):
    def __init__(self, taskList, *args, **kwds):
        ...
        self.panel4 = wx.Panel(self, -1, style=wx.TAB_TRAVERSAL|wx.ALWAYS_SHOW_SB)
        ...
        self.labelTitle1.SetFont(wx.Font(15, wx.DEFAULT, wx.NORMAL, wx.BOLD, 0, ""))
        ...
        for idx in range(len(self.taskList)):
            staticText = wx.StaticText(self.panel2, -1, self.taskList[idx].split(".")[0], style=wx.TE_CENTRE)
    ...
    def do_layout(self, checkList = []):
        ...
        for idx in range(len(self.taskList)):
            ...
            if idx in checkList:
                #checkBmp = wx.Bitmap('./Check.ico', wx.BITMAP_TYPE_ICO)
