...
if __name__ == "__main__":
    ...
    timeTaken = [0]
    def onResult(result):
        #d = loads(b64decode(result))
        #print 'success :-) : %s' % d.dtype
