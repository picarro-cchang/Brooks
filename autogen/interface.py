...
INTERFACE_NUMBER_OF_REGISTERS = 430
...
PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER = 419
PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER = 420
PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER = 421
PEAK_DETECT_CNTRL_HISTORY_SIZE_REGISTER = 422
PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER = 423
PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER = 424
PEAK_DETECT_CNTRL_RESET_DELAY_REGISTER = 425
PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER = 426
PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER = 427
PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER = 428
PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER = 429
...
registerByName["PEAK_DETECT_CNTRL_HISTORY_SIZE_REGISTER"] = PEAK_DETECT_CNTRL_HISTORY_SIZE_REGISTER
registerInfo.append(RegInfo("PEAK_DETECT_CNTRL_HISTORY_SIZE_REGISTER",c_uint,1,1.0,"rw"))
...
__p.append(('dsp','float',PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER,'Upper threshold','ppm/cm','%.3f',1,1))
__p.append(('dsp','float',PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER,'Lower Threshold 1','ppm/cm','%.3f',1,1))
__p.append(('dsp','float',PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER,'Lower Threshold 2','ppm/cm','%.3f',1,1))
__p.append(('dsp','uint32',PEAK_DETECT_CNTRL_HISTORY_SIZE_REGISTER,'History buffer length','samples','%d',1,1))
__p.append(('dsp','uint32',PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER,'Condition for triggering','','$%02X',1,1))
