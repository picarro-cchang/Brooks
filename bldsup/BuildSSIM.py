...
INSTALLER_SCRIPTS_DIR = ('src', 'main', 'python', 'AddOns', 'SSIM')
RELEASE_VERSION_FILE = ('src', 'main', 'python', 'AddOns', 'SSIM', 'release_version.py')
INTERNAL_VERSION_FILE = ('src', 'main', 'python', 'AddOns', 'SSIM', 'setup_version.py')
JSON_VERSION_FILE = ('src', 'main', 'python', 'AddOns', 'SSIM', 'version.json')

class BuildSSIM(Builder):
    def __init__(self, project, logger):
        super(BuildSSIM, self).__init__(project, logger)
        logger.info("Instantiating BuildSSIM")

    def initialize(self, product):
        project = self.project
        logger = self.logger
        assert product.lower() == "ssim"
