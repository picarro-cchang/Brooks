...
write_desktop_icon_file("modeSwitcher", "Picarro Mode Switcher", 
                        "bash -c 'cd /Picarro/G2000/Host/Utilities/SupervisorLauncher;python -O SupervisorLauncher.py -v -k -c ../../../AppConfig/Config/Utilites/SupervisorLauncher.ini'",
                        "/Picarro/G2000/Assets/icons/Picarro_icon.ico")
write_desktop_icon_file("startInstrument", "Start Instrument", 
                        "bash -c 'cd /Picarro/G2000/Host/Utilities/SupervisorLauncher;python -O SupervisorLauncher.py -a -c ../../../AppConfig/Config/Utilites/SupervisorLauncher.ini'",
                        "/Picarro/G2000/Assets/icons/Picarro_icon.ico", True)
