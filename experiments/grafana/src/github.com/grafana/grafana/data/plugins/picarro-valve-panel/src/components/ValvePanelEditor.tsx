...
export class ValvePanelEditor extends PureComponent<
  PanelEditorProps<ValvePanelOptions>
> {
  ...
  onNumberOfValvesChange = ({ target }) =>
    this.props.onChange({
      ...this.props.options,
      numberOfValves: Number(target.value),
    });

  onButtonsPerRowChange = (item: SelectOptionItem) => {
    return this.props.onChange({
      ...this.props.options,
      buttonsPerRow: Number(item.value),
    });
  };
        ...
        <div className="gf-form-inline">
          <div className="gf-form">
            ...
            <Select
              ...
              value={this.buttonsPerRowOptions.find(
                e => buttonsPerRow === e.value
              )}
