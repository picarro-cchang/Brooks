...
def get_last_decim(client, measurement):
    rs = client.query("SELECT last_decimation FROM crds_workspace WHERE meas_name='{measurement}' ORDER BY time DESC LIMIT 5".format(
...
print(get_field_keys(client, "crds"))
#
