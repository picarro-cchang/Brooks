                ...
                <div style={{ display: "inline-block", width: "80px" }}>
                    <label>
                        <input type="radio"
                            ...
                            value={textField ? (typeof valueField === 'string' ? datum[valueField] : valueField(datum)) : datum}
...
export default class RadioButtonBlock extends Component<RadioButtonBlockProps, RadioButtonBlockState> {
    ...
    render() {
        ...
        for (i = 0; i < data.length; i += perRow) {
            ...
            items.push(
                <RadioButtonRow name={name} data={rowData} 
                    textField={textField} valueField={valueField}
                    firstIndex={i} selectedIndex={this.state.selectedIndex} 
