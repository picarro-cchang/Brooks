...
export default class ValvePanel extends React.Component<Props, ValvePanelState> {
    unsubscribe: () => void;
                    ...
                    return (
                        <div>
                            <div
                                ...
                                <RadioButtons 
                                    name="opt" data={data} perRow={ buttonsPerRow } 
                                    valueField={"value"} textField={"text"}
                                    selectedValue={this.state.valveMode.toString()}
                                    onChange={(sel: any) => store.dispatch(setValveMode(Number(sel.selectedValue)))} />
                            </div>
                        </div>
                    );
                }}
