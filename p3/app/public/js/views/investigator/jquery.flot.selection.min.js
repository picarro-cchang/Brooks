...
(function ($) {
    function init(plot) {
        ...
        function setSelectionPos(pos, e) {
            ...
            var coordHolder = selection.touch ? e.originalEvent.touches[0] || e.originalEvent.changedTouches[0] : e;
        ...
        plot.hooks.drawOverlay.push(function (plot, ctx) {
            ...
            if (selection.show && selectionIsSane()) {
                ...
                var c = $.color.parse('#000');

                ctx.strokeStyle = c.scale('a', 0.5).toString();
                ctx.lineWidth = 1;
                ctx.lineJoin = "round";
                ctx.fillStyle = c.scale('a', 0.25).toString();
