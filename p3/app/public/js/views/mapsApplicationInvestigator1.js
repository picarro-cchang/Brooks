...
function MapConcPlot(div, map) {
    ...
    controlText.innerHTML = '<span id="concPlot"></span>';
...
function initialize_map() {
    ...
    CSTATE.map.controls[google.maps.ControlPosition.BOTTOM_CENTER].push(CNSNT.mapConcPlotDiv);
...
function updatePath(pdata, clr, etm) {
    ...
    */
    ...
    CSTATE.concMarkers.push(newConcMarker(CSTATE.map, where, size));
    if ('windN' in pdata) {
                ...
                if (restart) repaintData(); // To redraw markers with new offset
                    ...
                    if (n > 1) {
                        ...
                        if (CNSNT.prime_view) {
                            ...
                            $('#concPlot').sparkline(CSTATE.methaneHistory, {"chartRangeMin": 1.8, "width": "130px", "height": "50px"});
