...
exports.updateAccount = function(newData, callback)
{
	accounts.findOne({user:newData.email}, function(e, o){
		...
		o.bio = newData.bio;
		o.user = newData.email;
		o.experimentInfo = newData.experimentInfo;
		o.country = newData.country;
		o.anz = newData.anz;
		o.anzName = newData.anzName;
		o.anzIdentity = newData.anzIdentity;
		if (newData.pass == ''){
...
exports.getAccountByAnzLog = function(anzlog, callback)
{
	accounts.findOne({anzName:anzlog}, function(e, o){ callback(o); });
}
