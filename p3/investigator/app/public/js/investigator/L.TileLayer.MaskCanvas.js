...
L.TileLayer.MaskCanvas = L.TileLayer.Canvas.extend({
	...
	initialize: function (options, data) {
        ...
        this.setData = instrument("setData", this.setData);
        // this._drawPoints = instrument("_drawPoints", this._drawPoints);
        this._draw = instrument("_draw", this._draw);
    },
