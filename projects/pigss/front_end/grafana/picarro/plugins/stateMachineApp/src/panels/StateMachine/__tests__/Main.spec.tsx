...
describe("<Main />", () => {
  ...
  it("Check correct left panel is showing", () => {
    expect(instance.state.plan.panel_to_show).toEqual(0);
    expect(PlanPanelTypes.NONE).toEqual(instance.state.plan.panel_to_show);
    instance.setState({
      ...defaultState,
      plan: {
        panel_to_show: 2
    ...
    expect(instance.state.plan.panel_to_show).toEqual(2);
    instance.setState({
      ...defaultState,
      plan: {
        panel_to_show: 3
    ...
    expect(instance.state.plan.panel_to_show).toEqual(3);
    instance.setState({
      ...defaultState,
      plan: {
        panel_to_show: 4
    ...
    expect(instance.state.plan.panel_to_show).toEqual(4);
    instance.setState({
      ...defaultState
    });
  });
  ...
  it("Modal", async () => {
    ...
    wrapper.setState({
      ...
      modal_info: {
        show: true,
        html:
          "<h2 class='test'>Confirm file overwrite</h2><p>File exists. Overwrite?</p>",
        num_buttons: 2,
        buttons: {
          "1": {
            caption: "OK",
