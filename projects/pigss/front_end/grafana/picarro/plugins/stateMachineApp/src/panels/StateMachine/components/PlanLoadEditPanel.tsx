...
import { PlanLoadPanelEditOptions } from "./../types";
...
class PlanLoadEditPanel extends PureComponent<PlanLoadPanelEditOptions> {
    ...
    renderItem = (index: number, key: ReactText) => (
        ...
        <div className="btn-group d-flex" style={{ marginLeft: "0px" }}>
            ...
            onClick={e => {
                ...
                this.props.getFileName(this.props.plan.plan_files[index+1])
            }}
            style={{ color: "black" }}
            >
