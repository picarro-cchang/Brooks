...
const event2 = { target: {
  ...
  it('onChange event for Bank', () => {
      ...
      expect(mockHandleBankChange.mock.calls[0]).toEqual(["Bank Number Name", "1"]);
    });
    ...
    it('onChange event for Channel 1', () => {
        ...
        expect(mockHandleChannelNameChange.mock.calls[0]).toEqual(["Channel Number Name", "1", 1]);
    ...
    it('onChange event for Channel 2', () => {
        ...
        expect(mockHandleBankChange).toHaveBeenCalled();
        expect(mockHandleChannelNameChange.mock.calls[0]).toEqual(["Channel Number Name", "1", 2]);
        mockHandleChannelNameChange.mockClear();
    });
    it('onChange event for Channel 3', () => {
        wrapper.find('input[name="bank13"]').simulate('change', event2);
        expect(mockHandleBankChange).toHaveBeenCalled();
        expect(mockHandleChannelNameChange.mock.calls[0]).toEqual(["Channel Number Name", "1", 3]);
        mockHandleChannelNameChange.mockClear();
    });
    it('onChange event for Channel 4', () => {
        wrapper.find('input[name="bank14"]').simulate('change', event2);
        expect(mockHandleBankChange).toHaveBeenCalled();
        expect(mockHandleChannelNameChange.mock.calls[0]).toEqual(["Channel Number Name", "1", 4]);
        mockHandleChannelNameChange.mockClear();
    });
    it('onChange event for Channel 5', () => {
        wrapper.find('input[name="bank15"]').simulate('change', event2);
        expect(mockHandleBankChange).toHaveBeenCalled();
        expect(mockHandleChannelNameChange.mock.calls[0]).toEqual(["Channel Number Name", "1", 5]);
        mockHandleChannelNameChange.mockClear();
    });
    it('onChange event for Channel 6', () => {
        wrapper.find('input[name="bank16"]').simulate('change', event2);
        expect(mockHandleBankChange).toHaveBeenCalled();
        expect(mockHandleChannelNameChange.mock.calls[0]).toEqual(["Channel Number Name", "1", 6]);
        mockHandleChannelNameChange.mockClear();
    });
    it('onChange event for Channel 7', () => {
        wrapper.find('input[name="bank17"]').simulate('change', event2);
        expect(mockHandleBankChange).toHaveBeenCalled();
        expect(mockHandleChannelNameChange.mock.calls[0]).toEqual(["Channel Number Name", "1", 7]);
        mockHandleChannelNameChange.mockClear();
    });
    it('onChange event for Channel 8', () => {
        wrapper.find('input[name="bank18"]').simulate('change', event2);
        expect(mockHandleBankChange).toHaveBeenCalled();
        expect(mockHandleChannelNameChange.mock.calls[0]).toEqual(["Channel Number Name", "1", 8]);
        mockHandleChannelNameChange.mockClear();
    });
