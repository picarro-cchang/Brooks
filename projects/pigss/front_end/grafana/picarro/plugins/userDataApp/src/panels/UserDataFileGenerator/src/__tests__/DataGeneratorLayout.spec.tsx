...
describe("<DataGeneratorLayout />", () => {
  ...
  it("onKeysChange", () => {
    ...
    expect(instance.state.keys).toEqual(
      instance.state.keyOptions.filter(x => x.value !== "All")
    );
  });
  ...
  it("onAnalyzersChange", () => {
    ...
    expect(instance.state.analyzers).toEqual(
      instance.state.analyzerOptions.filter(x => x.value !== "All")
    );
  });
  ...
  it("onPortsChange", () => {
    ...
    expect(instance.state.ports).toEqual(
      instance.state.portOptions.filter(x => x.value !== "All")
    );
  });
