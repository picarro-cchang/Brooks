...
#       AppInfo - version number and about info (so we only have to maintain one copy)
#       FigureInteraction - manages user interactions with plots
...
class AppInfo(object):
    def __init__(self):
        ...
        # About Info
        # generic name, components usually override this
        self.about_name = "ChemCorrect(tm)"

        self.about_copyright = "(c) 2011 - 2014 Picarro Inc."
