...
Usage: python primingSetup.py py2exe

Notes: Use python buildPriming.py from the command line, which sets up
...
def _getBuildVersion():
    try:
        ...
        # buildPriming.py (command line script for internal builds)
        try:
...
targetApp = Target(description = "CentrisPumpPriming", # used for the versioninfo resource
                   script = "CentrisPumpPriming.py", # what to build
                   other_resources = [(RT_MANIFEST,
                                      1,
                                      manifest_template % dict(prog="CentrisPumpPriming")
                                      )],
                   ## does this work? was commented out
                   #icon_resources = [(1, "../../../Assets/icons/EnviroSense.ico")],
                   dest_base = "CentrisPumpPriming"
                  )

# End of special Priming setup stuff
################################################################
...
if "PYTHONPATH" not in os.environ:
    ...
    print "Run 'python buildPriming.py' instead to build CentrisPumpPriming from the command line."
    sys.exit(1)
...
data_files = [(".", ["CentrisPumpPriming.ini", "../../../Assets/icons/EnviroSense.ico"]),
...
productName = "Picarro SDM CentrisPumpPriming"
if buildTypeStr != "":
    productName = "Picarro SDM CentrisPumpPriming (%s)" % buildTypeStr
