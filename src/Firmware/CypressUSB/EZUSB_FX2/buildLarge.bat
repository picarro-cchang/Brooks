...
set EZTARGET=C:\Picarro\G2000\SrcCode\CypressUSB
set C51INC=C:\Keil\C51\INC;%EZTARGET%\INC

REM ### Compile code ###
c51 resume.c debug oe code large moddp2 "ot(6,size)"
c51 discon.c debug oe code large moddp2 "ot(6,size)"
c51 delay.c debug oe code large moddp2 "ot(6,size)"
c51 ezregs.c debug oe code large moddp2 "ot(6,size)"
c51 i2c.c debug oe code large moddp2 "ot(6,size)"
c51 get_dscr.c debug oe code large moddp2 "ot(6,size)"
c51 get_infc.c debug oe code large moddp2 "ot(6,size)"
c51 get_strd.c debug oe code large moddp2 "ot(6,size)"
c51 get_cnfg.c debug oe code large moddp2 "ot(6,size)"
c51 i2c_rw.c debug oe code large moddp2 "ot(6,size)"
