...
#
# FILE:
#   Test205004.py tests the G2000 power board inlet valve PWM drive
#
# DESCRIPTION:
#
# SEE ALSO:
...
from Host.MfgUtilities.TestPowerBoardValveDriver2 import TestPowerBoardValveDriver
...
if __name__ == "__main__":
    ...
    tst = TestPowerBoardValveDriver(tp,"Inlet")
    tst.run()
    tp.appendReport()
    tp.makeHTML()