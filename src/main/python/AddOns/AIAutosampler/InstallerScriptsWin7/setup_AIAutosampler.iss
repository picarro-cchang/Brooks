...
; Program
Source: {#distDir}\AIAutosamplerExe\*; DestDir: {app}\AutosamplerExe; Flags: recursesubdirs replacesameversion

; Training module
Source: {#distDir}\Vendor\Applied Instruments\ALS-G\x86\Picarro_Training.exe; DestDir: {app}\AutosamplerExe; Flags: replacesameversion

; USB-COM to Serial Port Driver installer
Source: {#distDir}\Vendor\FTDI\CDM 2.08.30 WHQL Certified\CDM v2.08.30 WHQL Certified.exe; DestDir: {app}\AutosamplerExe; Flags: replacesameversion

; icon files
Source: {#distDir}\Assets\icons\{#utilitiesIcon}; DestDir: {app}\AutosamplerExe; Flags: replacesameversion
