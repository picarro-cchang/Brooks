...
class FigureInteraction(object):
    ...
    def on_right_down(self, event):
        ...
        if self.image_popup_menu is None:
            ...
            if hasattr(self.fig.viewer, "traits_view"):
                viewer = self.fig.viewer
            else:
                viewer = self.fig.viewer.parent
            if "Allan Std Dev" in viewer.traits_view.title:
...
class NotebookHandler(Handler):
    ...
    def _getInOutFileNames(self, extension):
        ...
        if len(self.datDirName) > 0:
            ...
            defaultPath = r"C:\Picarro\G2000\Log\Archive\DataLog_Private"
