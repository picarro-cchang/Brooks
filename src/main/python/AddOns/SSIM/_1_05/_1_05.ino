// SSIM2 Firmware
//
// 2014-04-16: updated for Arduino 1.0.5-r2 library (Wire.receive() -> Wire.read())
//             version now 1.05
//
...
long read_LTC2485(char addr, char config)
{
  ...
  while(1) {
    ...
    if(avail != 4) { 
      ...
      adc_code.by.te3 = Wire.read();
      adc_code.by.te2 = Wire.read(); 
      adc_code.by.te1 = Wire.read();
      adc_code.by.te0 = Wire.read();
