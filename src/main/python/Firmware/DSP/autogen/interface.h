...
#define INTERFACE_NUMBER_OF_REGISTERS (800)
...
#define LASER2_TEMP_CNTRL_FRONT_MIRROR_FFWD_REGISTER (91)
#define LASER2_TEMP_CNTRL_BACK_MIRROR_FFWD_REGISTER (92)
#define LASER2_TEC_PRBS_GENPOLY_REGISTER (93)
#define LASER2_TEC_PRBS_AMPLITUDE_REGISTER (94)
#define LASER2_TEC_PRBS_MEAN_REGISTER (95)
#define LASER2_TEC_MONITOR_REGISTER (96)
#define LASER2_CURRENT_CNTRL_STATE_REGISTER (97)
#define LASER2_MANUAL_COARSE_CURRENT_REGISTER (98)
#define LASER2_MANUAL_FINE_CURRENT_REGISTER (99)
#define LASER2_CURRENT_SWEEP_MIN_REGISTER (100)
#define LASER2_CURRENT_SWEEP_MAX_REGISTER (101)
#define LASER2_CURRENT_SWEEP_INCR_REGISTER (102)
#define LASER2_CURRENT_MONITOR_REGISTER (103)
#define LASER2_EXTRA_COARSE_SCALE_REGISTER (104)
#define LASER2_EXTRA_FINE_SCALE_REGISTER (105)
#define LASER2_EXTRA_OFFSET_REGISTER (106)
#define CONVERSION_LASER3_THERM_CONSTA_REGISTER (107)
#define CONVERSION_LASER3_THERM_CONSTB_REGISTER (108)
#define CONVERSION_LASER3_THERM_CONSTC_REGISTER (109)
#define CONVERSION_LASER3_CURRENT_SLOPE_REGISTER (110)
#define CONVERSION_LASER3_CURRENT_OFFSET_REGISTER (111)
#define LASER3_RESISTANCE_REGISTER (112)
#define LASER3_TEMPERATURE_REGISTER (113)
#define LASER3_THERMISTOR_SERIES_RESISTANCE_REGISTER (114)
#define LASER3_TEC_REGISTER (115)
#define LASER3_MANUAL_TEC_REGISTER (116)
#define LASER3_TEMP_CNTRL_STATE_REGISTER (117)
#define LASER3_TEMP_CNTRL_SETPOINT_REGISTER (118)
#define LASER3_TEMP_CNTRL_USER_SETPOINT_REGISTER (119)
#define LASER3_TEMP_CNTRL_TOLERANCE_REGISTER (120)
#define LASER3_TEMP_CNTRL_SWEEP_MAX_REGISTER (121)
#define LASER3_TEMP_CNTRL_SWEEP_MIN_REGISTER (122)
#define LASER3_TEMP_CNTRL_SWEEP_INCR_REGISTER (123)
#define LASER3_TEMP_CNTRL_H_REGISTER (124)
#define LASER3_TEMP_CNTRL_K_REGISTER (125)
#define LASER3_TEMP_CNTRL_TI_REGISTER (126)
#define LASER3_TEMP_CNTRL_TD_REGISTER (127)
#define LASER3_TEMP_CNTRL_B_REGISTER (128)
#define LASER3_TEMP_CNTRL_C_REGISTER (129)
#define LASER3_TEMP_CNTRL_N_REGISTER (130)
#define LASER3_TEMP_CNTRL_S_REGISTER (131)
#define LASER3_TEMP_CNTRL_FFWD_REGISTER (132)
#define LASER3_TEMP_CNTRL_AMIN_REGISTER (133)
#define LASER3_TEMP_CNTRL_AMAX_REGISTER (134)
#define LASER3_TEMP_CNTRL_IMAX_REGISTER (135)
#define LASER3_TEMP_CNTRL_FRONT_MIRROR_FFWD_REGISTER (136)
#define LASER3_TEMP_CNTRL_BACK_MIRROR_FFWD_REGISTER (137)
#define LASER3_TEC_PRBS_GENPOLY_REGISTER (138)
#define LASER3_TEC_PRBS_AMPLITUDE_REGISTER (139)
#define LASER3_TEC_PRBS_MEAN_REGISTER (140)
#define LASER3_TEC_MONITOR_REGISTER (141)
#define LASER3_CURRENT_CNTRL_STATE_REGISTER (142)
#define LASER3_MANUAL_COARSE_CURRENT_REGISTER (143)
#define LASER3_MANUAL_FINE_CURRENT_REGISTER (144)
#define LASER3_CURRENT_SWEEP_MIN_REGISTER (145)
#define LASER3_CURRENT_SWEEP_MAX_REGISTER (146)
#define LASER3_CURRENT_SWEEP_INCR_REGISTER (147)
#define LASER3_CURRENT_MONITOR_REGISTER (148)
#define LASER3_EXTRA_COARSE_SCALE_REGISTER (149)
#define LASER3_EXTRA_FINE_SCALE_REGISTER (150)
#define LASER3_EXTRA_OFFSET_REGISTER (151)
#define CONVERSION_LASER4_THERM_CONSTA_REGISTER (152)
#define CONVERSION_LASER4_THERM_CONSTB_REGISTER (153)
#define CONVERSION_LASER4_THERM_CONSTC_REGISTER (154)
#define CONVERSION_LASER4_CURRENT_SLOPE_REGISTER (155)
#define CONVERSION_LASER4_CURRENT_OFFSET_REGISTER (156)
#define LASER4_RESISTANCE_REGISTER (157)
#define LASER4_TEMPERATURE_REGISTER (158)
#define LASER4_THERMISTOR_SERIES_RESISTANCE_REGISTER (159)
#define LASER4_TEC_REGISTER (160)
#define LASER4_MANUAL_TEC_REGISTER (161)
#define LASER4_TEMP_CNTRL_STATE_REGISTER (162)
#define LASER4_TEMP_CNTRL_SETPOINT_REGISTER (163)
#define LASER4_TEMP_CNTRL_USER_SETPOINT_REGISTER (164)
#define LASER4_TEMP_CNTRL_TOLERANCE_REGISTER (165)
#define LASER4_TEMP_CNTRL_SWEEP_MAX_REGISTER (166)
#define LASER4_TEMP_CNTRL_SWEEP_MIN_REGISTER (167)
#define LASER4_TEMP_CNTRL_SWEEP_INCR_REGISTER (168)
#define LASER4_TEMP_CNTRL_H_REGISTER (169)
#define LASER4_TEMP_CNTRL_K_REGISTER (170)
#define LASER4_TEMP_CNTRL_TI_REGISTER (171)
#define LASER4_TEMP_CNTRL_TD_REGISTER (172)
#define LASER4_TEMP_CNTRL_B_REGISTER (173)
#define LASER4_TEMP_CNTRL_C_REGISTER (174)
#define LASER4_TEMP_CNTRL_N_REGISTER (175)
#define LASER4_TEMP_CNTRL_S_REGISTER (176)
#define LASER4_TEMP_CNTRL_FFWD_REGISTER (177)
#define LASER4_TEMP_CNTRL_AMIN_REGISTER (178)
#define LASER4_TEMP_CNTRL_AMAX_REGISTER (179)
#define LASER4_TEMP_CNTRL_IMAX_REGISTER (180)
#define LASER4_TEMP_CNTRL_FRONT_MIRROR_FFWD_REGISTER (181)
#define LASER4_TEMP_CNTRL_BACK_MIRROR_FFWD_REGISTER (182)
#define LASER4_TEC_PRBS_GENPOLY_REGISTER (183)
#define LASER4_TEC_PRBS_AMPLITUDE_REGISTER (184)
#define LASER4_TEC_PRBS_MEAN_REGISTER (185)
#define LASER4_TEC_MONITOR_REGISTER (186)
#define LASER4_CURRENT_CNTRL_STATE_REGISTER (187)
#define LASER4_MANUAL_COARSE_CURRENT_REGISTER (188)
#define LASER4_MANUAL_FINE_CURRENT_REGISTER (189)
#define LASER4_CURRENT_SWEEP_MIN_REGISTER (190)
#define LASER4_CURRENT_SWEEP_MAX_REGISTER (191)
#define LASER4_CURRENT_SWEEP_INCR_REGISTER (192)
#define LASER4_CURRENT_MONITOR_REGISTER (193)
#define LASER4_EXTRA_COARSE_SCALE_REGISTER (194)
#define LASER4_EXTRA_FINE_SCALE_REGISTER (195)
#define LASER4_EXTRA_OFFSET_REGISTER (196)
#define CONVERSION_ETALON_THERM_CONSTA_REGISTER (197)
#define CONVERSION_ETALON_THERM_CONSTB_REGISTER (198)
#define CONVERSION_ETALON_THERM_CONSTC_REGISTER (199)
#define ETALON_RESISTANCE_REGISTER (200)
#define ETALON_TEMPERATURE_REGISTER (201)
#define ETALON_THERMISTOR_SERIES_RESISTANCE_REGISTER (202)
#define CONVERSION_WARM_BOX_THERM_CONSTA_REGISTER (203)
#define CONVERSION_WARM_BOX_THERM_CONSTB_REGISTER (204)
#define CONVERSION_WARM_BOX_THERM_CONSTC_REGISTER (205)
#define WARM_BOX_RESISTANCE_REGISTER (206)
#define WARM_BOX_TEMPERATURE_REGISTER (207)
#define WARM_BOX_THERMISTOR_SERIES_RESISTANCE_REGISTER (208)
#define WARM_BOX_TEC_REGISTER (209)
#define WARM_BOX_MANUAL_TEC_REGISTER (210)
#define WARM_BOX_TEMP_CNTRL_STATE_REGISTER (211)
#define WARM_BOX_TEMP_CNTRL_SETPOINT_REGISTER (212)
#define WARM_BOX_TEMP_CNTRL_USER_SETPOINT_REGISTER (213)
#define WARM_BOX_TEMP_CNTRL_TOLERANCE_REGISTER (214)
#define WARM_BOX_TEMP_CNTRL_SWEEP_MAX_REGISTER (215)
#define WARM_BOX_TEMP_CNTRL_SWEEP_MIN_REGISTER (216)
#define WARM_BOX_TEMP_CNTRL_SWEEP_INCR_REGISTER (217)
#define WARM_BOX_TEMP_CNTRL_H_REGISTER (218)
#define WARM_BOX_TEMP_CNTRL_K_REGISTER (219)
#define WARM_BOX_TEMP_CNTRL_TI_REGISTER (220)
#define WARM_BOX_TEMP_CNTRL_TD_REGISTER (221)
#define WARM_BOX_TEMP_CNTRL_B_REGISTER (222)
#define WARM_BOX_TEMP_CNTRL_C_REGISTER (223)
#define WARM_BOX_TEMP_CNTRL_N_REGISTER (224)
#define WARM_BOX_TEMP_CNTRL_S_REGISTER (225)
#define WARM_BOX_TEMP_CNTRL_FFWD_REGISTER (226)
#define WARM_BOX_TEMP_CNTRL_AMIN_REGISTER (227)
#define WARM_BOX_TEMP_CNTRL_AMAX_REGISTER (228)
#define WARM_BOX_TEMP_CNTRL_IMAX_REGISTER (229)
#define WARM_BOX_TEC_PRBS_GENPOLY_REGISTER (230)
#define WARM_BOX_TEC_PRBS_AMPLITUDE_REGISTER (231)
#define WARM_BOX_TEC_PRBS_MEAN_REGISTER (232)
#define WARM_BOX_MAX_HEATSINK_TEMP_REGISTER (233)
#define CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTA_REGISTER (234)
#define CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTB_REGISTER (235)
#define CONVERSION_WARM_BOX_HEATSINK_THERM_CONSTC_REGISTER (236)
#define WARM_BOX_HEATSINK_RESISTANCE_REGISTER (237)
#define WARM_BOX_HEATSINK_TEMPERATURE_REGISTER (238)
#define WARM_BOX_HEATSINK_THERMISTOR_SERIES_RESISTANCE_REGISTER (239)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTA_REGISTER (240)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTB_REGISTER (241)
#define CONVERSION_HOT_BOX_HEATSINK_THERM_CONSTC_REGISTER (242)
#define HOT_BOX_HEATSINK_RESISTANCE_REGISTER (243)
#define HOT_BOX_HEATSINK_TEMPERATURE_REGISTER (244)
#define HOT_BOX_HEATSINK_THERMISTOR_SERIES_RESISTANCE_REGISTER (245)
#define CONVERSION_CAVITY_THERM_CONSTA_REGISTER (246)
#define CONVERSION_CAVITY_THERM_CONSTB_REGISTER (247)
#define CONVERSION_CAVITY_THERM_CONSTC_REGISTER (248)
#define CAVITY_RESISTANCE_REGISTER (249)
#define CAVITY_TEMPERATURE_REGISTER (250)
#define CAVITY_THERMISTOR_SERIES_RESISTANCE_REGISTER (251)
#define CONVERSION_CAVITY_THERM1_CONSTA_REGISTER (252)
#define CONVERSION_CAVITY_THERM1_CONSTB_REGISTER (253)
#define CONVERSION_CAVITY_THERM1_CONSTC_REGISTER (254)
#define CAVITY_RESISTANCE1_REGISTER (255)
#define CAVITY_TEMPERATURE1_REGISTER (256)
#define CAVITY_THERMISTOR1_SERIES_RESISTANCE_REGISTER (257)
#define CONVERSION_CAVITY_THERM2_CONSTA_REGISTER (258)
#define CONVERSION_CAVITY_THERM2_CONSTB_REGISTER (259)
#define CONVERSION_CAVITY_THERM2_CONSTC_REGISTER (260)
#define CAVITY_RESISTANCE2_REGISTER (261)
#define CAVITY_TEMPERATURE2_REGISTER (262)
#define CAVITY_THERMISTOR2_SERIES_RESISTANCE_REGISTER (263)
#define CONVERSION_CAVITY_THERM3_CONSTA_REGISTER (264)
#define CONVERSION_CAVITY_THERM3_CONSTB_REGISTER (265)
#define CONVERSION_CAVITY_THERM3_CONSTC_REGISTER (266)
#define CAVITY_RESISTANCE3_REGISTER (267)
#define CAVITY_TEMPERATURE3_REGISTER (268)
#define CAVITY_THERMISTOR3_SERIES_RESISTANCE_REGISTER (269)
#define CONVERSION_CAVITY_THERM4_CONSTA_REGISTER (270)
#define CONVERSION_CAVITY_THERM4_CONSTB_REGISTER (271)
#define CONVERSION_CAVITY_THERM4_CONSTC_REGISTER (272)
#define CAVITY_RESISTANCE4_REGISTER (273)
#define CAVITY_TEMPERATURE4_REGISTER (274)
#define CAVITY_THERMISTOR4_SERIES_RESISTANCE_REGISTER (275)
#define CONVERSION_CAVITY2_THERM1_CONSTA_REGISTER (276)
#define CONVERSION_CAVITY2_THERM1_CONSTB_REGISTER (277)
#define CONVERSION_CAVITY2_THERM1_CONSTC_REGISTER (278)
#define CAVITY2_RESISTANCE1_REGISTER (279)
#define CAVITY2_TEMPERATURE1_REGISTER (280)
#define CAVITY2_THERMISTOR1_SERIES_RESISTANCE_REGISTER (281)
#define CONVERSION_CAVITY2_THERM2_CONSTA_REGISTER (282)
#define CONVERSION_CAVITY2_THERM2_CONSTB_REGISTER (283)
#define CONVERSION_CAVITY2_THERM2_CONSTC_REGISTER (284)
#define CAVITY2_RESISTANCE2_REGISTER (285)
#define CAVITY2_TEMPERATURE2_REGISTER (286)
#define CAVITY2_THERMISTOR2_SERIES_RESISTANCE_REGISTER (287)
#define CONVERSION_CAVITY2_THERM3_CONSTA_REGISTER (288)
#define CONVERSION_CAVITY2_THERM3_CONSTB_REGISTER (289)
#define CONVERSION_CAVITY2_THERM3_CONSTC_REGISTER (290)
#define CAVITY2_RESISTANCE3_REGISTER (291)
#define CAVITY2_TEMPERATURE3_REGISTER (292)
#define CAVITY2_THERMISTOR3_SERIES_RESISTANCE_REGISTER (293)
#define CONVERSION_CAVITY2_THERM4_CONSTA_REGISTER (294)
#define CONVERSION_CAVITY2_THERM4_CONSTB_REGISTER (295)
#define CONVERSION_CAVITY2_THERM4_CONSTC_REGISTER (296)
#define CAVITY2_RESISTANCE4_REGISTER (297)
#define CAVITY2_TEMPERATURE4_REGISTER (298)
#define CAVITY2_THERMISTOR4_SERIES_RESISTANCE_REGISTER (299)
#define CAVITY_TEC_REGISTER (300)
#define CAVITY_MANUAL_TEC_REGISTER (301)
#define CAVITY_TEMP_CNTRL_STATE_REGISTER (302)
#define CAVITY_TEMP_CNTRL_SETPOINT_REGISTER (303)
#define CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER (304)
#define CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER (305)
#define CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER (306)
#define CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER (307)
#define CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER (308)
#define CAVITY_TEMP_CNTRL_H_REGISTER (309)
#define CAVITY_TEMP_CNTRL_K_REGISTER (310)
#define CAVITY_TEMP_CNTRL_TI_REGISTER (311)
#define CAVITY_TEMP_CNTRL_TD_REGISTER (312)
#define CAVITY_TEMP_CNTRL_B_REGISTER (313)
#define CAVITY_TEMP_CNTRL_C_REGISTER (314)
#define CAVITY_TEMP_CNTRL_N_REGISTER (315)
#define CAVITY_TEMP_CNTRL_S_REGISTER (316)
#define CAVITY_TEMP_CNTRL_FFWD_REGISTER (317)
#define CAVITY_TEMP_CNTRL_AMIN_REGISTER (318)
#define CAVITY_TEMP_CNTRL_AMAX_REGISTER (319)
#define CAVITY_TEMP_CNTRL_IMAX_REGISTER (320)
#define CAVITY_TEC_PRBS_GENPOLY_REGISTER (321)
#define CAVITY_TEC_PRBS_AMPLITUDE_REGISTER (322)
#define CAVITY_TEC_PRBS_MEAN_REGISTER (323)
#define CAVITY_MAX_HEATSINK_TEMP_REGISTER (324)
#define HEATER_MARK_REGISTER (325)
#define HEATER_MANUAL_MARK_REGISTER (326)
#define HEATER_TEMP_CNTRL_STATE_REGISTER (327)
#define HEATER_TEMP_CNTRL_SETPOINT_REGISTER (328)
#define HEATER_TEMP_CNTRL_USER_SETPOINT_REGISTER (329)
#define HEATER_TEMP_CNTRL_TOLERANCE_REGISTER (330)
#define HEATER_TEMP_CNTRL_SWEEP_MAX_REGISTER (331)
#define HEATER_TEMP_CNTRL_SWEEP_MIN_REGISTER (332)
#define HEATER_TEMP_CNTRL_SWEEP_INCR_REGISTER (333)
#define HEATER_TEMP_CNTRL_H_REGISTER (334)
#define HEATER_TEMP_CNTRL_K_REGISTER (335)
#define HEATER_TEMP_CNTRL_TI_REGISTER (336)
#define HEATER_TEMP_CNTRL_TD_REGISTER (337)
#define HEATER_TEMP_CNTRL_B_REGISTER (338)
#define HEATER_TEMP_CNTRL_C_REGISTER (339)
#define HEATER_TEMP_CNTRL_N_REGISTER (340)
#define HEATER_TEMP_CNTRL_S_REGISTER (341)
#define HEATER_TEMP_CNTRL_AMIN_REGISTER (342)
#define HEATER_TEMP_CNTRL_AMAX_REGISTER (343)
#define HEATER_TEMP_CNTRL_IMAX_REGISTER (344)
#define HEATER_PRBS_GENPOLY_REGISTER (345)
#define HEATER_PRBS_AMPLITUDE_REGISTER (346)
#define HEATER_PRBS_MEAN_REGISTER (347)
#define HEATER_CUTOFF_REGISTER (348)
#define CONVERSION_FILTER_HEATER_THERM_CONSTA_REGISTER (349)
#define CONVERSION_FILTER_HEATER_THERM_CONSTB_REGISTER (350)
#define CONVERSION_FILTER_HEATER_THERM_CONSTC_REGISTER (351)
#define FILTER_HEATER_RESISTANCE_REGISTER (352)
#define FILTER_HEATER_TEMPERATURE_REGISTER (353)
#define FILTER_HEATER_THERMISTOR_SERIES_RESISTANCE_REGISTER (354)
#define FILTER_HEATER_REGISTER (355)
#define FILTER_HEATER_MANUAL_REGISTER (356)
#define FILTER_HEATER_TEMP_CNTRL_STATE_REGISTER (357)
#define FILTER_HEATER_TEMP_CNTRL_SETPOINT_REGISTER (358)
#define FILTER_HEATER_TEMP_CNTRL_USER_SETPOINT_REGISTER (359)
#define FILTER_HEATER_TEMP_CNTRL_TOLERANCE_REGISTER (360)
#define FILTER_HEATER_TEMP_CNTRL_SWEEP_MAX_REGISTER (361)
#define FILTER_HEATER_TEMP_CNTRL_SWEEP_MIN_REGISTER (362)
#define FILTER_HEATER_TEMP_CNTRL_SWEEP_INCR_REGISTER (363)
#define FILTER_HEATER_TEMP_CNTRL_H_REGISTER (364)
#define FILTER_HEATER_TEMP_CNTRL_K_REGISTER (365)
#define FILTER_HEATER_TEMP_CNTRL_TI_REGISTER (366)
#define FILTER_HEATER_TEMP_CNTRL_TD_REGISTER (367)
#define FILTER_HEATER_TEMP_CNTRL_B_REGISTER (368)
#define FILTER_HEATER_TEMP_CNTRL_C_REGISTER (369)
#define FILTER_HEATER_TEMP_CNTRL_N_REGISTER (370)
#define FILTER_HEATER_TEMP_CNTRL_S_REGISTER (371)
#define FILTER_HEATER_TEMP_CNTRL_FFWD_REGISTER (372)
#define FILTER_HEATER_TEMP_CNTRL_AMIN_REGISTER (373)
#define FILTER_HEATER_TEMP_CNTRL_AMAX_REGISTER (374)
#define FILTER_HEATER_TEMP_CNTRL_IMAX_REGISTER (375)
#define FILTER_HEATER_PRBS_GENPOLY_REGISTER (376)
#define FILTER_HEATER_PRBS_AMPLITUDE_REGISTER (377)
#define FILTER_HEATER_PRBS_MEAN_REGISTER (378)
#define FILTER_HEATER_MONITOR_REGISTER (379)
#define CAVITY_PRESSURE_ADC_REGISTER (380)
#define CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER (381)
#define CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER (382)
#define CAVITY_PRESSURE_REGISTER (383)
#define AMBIENT_PRESSURE_ADC_REGISTER (384)
#define CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER (385)
#define CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER (386)
#define AMBIENT_PRESSURE_REGISTER (387)
#define CAVITY2_PRESSURE_ADC_REGISTER (388)
#define CONVERSION_CAVITY2_PRESSURE_SCALING_REGISTER (389)
#define CONVERSION_CAVITY2_PRESSURE_OFFSET_REGISTER (390)
#define CAVITY2_PRESSURE_REGISTER (391)
#define AMBIENT2_PRESSURE_ADC_REGISTER (392)
#define CONVERSION_AMBIENT2_PRESSURE_SCALING_REGISTER (393)
#define CONVERSION_AMBIENT2_PRESSURE_OFFSET_REGISTER (394)
#define AMBIENT2_PRESSURE_REGISTER (395)
#define ANALYZER_TUNING_MODE_REGISTER (396)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (397)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (398)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (399)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (400)
#define TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER (401)
#define TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER (402)
#define TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER (403)
#define TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER (404)
#define TUNER_DITHER_MEDIAN_COUNT_REGISTER (405)
#define RDFITTER_MINLOSS_REGISTER (406)
#define RDFITTER_MAXLOSS_REGISTER (407)
#define RDFITTER_LATEST_LOSS_REGISTER (408)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (409)
#define RDFITTER_START_SAMPLE_REGISTER (410)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (411)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (412)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (413)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (414)
#define RDFITTER_META_BACKOFF_REGISTER (415)
#define RDFITTER_META_SAMPLES_REGISTER (416)
#define SPECT_CNTRL_STATE_REGISTER (417)
#define SPECT_CNTRL_MODE_REGISTER (418)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (419)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (420)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (421)
#define SPECT_CNTRL_SCHEME_ROW_REGISTER (422)
#define SPECT_CNTRL_DWELL_COUNT_REGISTER (423)
#define SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER (424)
#define SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER (425)
#define SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER (426)
#define VIRTUAL_LASER_REGISTER (427)
#define PZT_INCR_PER_CAVITY_FSR (428)
#define PZT_OFFSET_UPDATE_FACTOR (429)
#define PZT_OFFSET_VIRTUAL_LASER1 (430)
#define PZT_OFFSET_VIRTUAL_LASER2 (431)
#define PZT_OFFSET_VIRTUAL_LASER3 (432)
#define PZT_OFFSET_VIRTUAL_LASER4 (433)
#define PZT_OFFSET_VIRTUAL_LASER5 (434)
#define PZT_OFFSET_VIRTUAL_LASER6 (435)
#define PZT_OFFSET_VIRTUAL_LASER7 (436)
#define PZT_OFFSET_VIRTUAL_LASER8 (437)
#define SCHEME_OFFSET_VIRTUAL_LASER1 (438)
#define SCHEME_OFFSET_VIRTUAL_LASER2 (439)
#define SCHEME_OFFSET_VIRTUAL_LASER3 (440)
#define SCHEME_OFFSET_VIRTUAL_LASER4 (441)
#define SCHEME_OFFSET_VIRTUAL_LASER5 (442)
#define SCHEME_OFFSET_VIRTUAL_LASER6 (443)
#define SCHEME_OFFSET_VIRTUAL_LASER7 (444)
#define SCHEME_OFFSET_VIRTUAL_LASER8 (445)
#define THRESHOLD_FACTOR_VIRTUAL_LASER1 (446)
#define THRESHOLD_FACTOR_VIRTUAL_LASER2 (447)
#define THRESHOLD_FACTOR_VIRTUAL_LASER3 (448)
#define THRESHOLD_FACTOR_VIRTUAL_LASER4 (449)
#define THRESHOLD_FACTOR_VIRTUAL_LASER5 (450)
#define THRESHOLD_FACTOR_VIRTUAL_LASER6 (451)
#define THRESHOLD_FACTOR_VIRTUAL_LASER7 (452)
#define THRESHOLD_FACTOR_VIRTUAL_LASER8 (453)
#define SCHEME_THRESHOLD_BASE (454)
#define VALVE_CNTRL_STATE_REGISTER (455)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (456)
#define VALVE_CNTRL_USER_INLET_VALVE_REGISTER (457)
#define VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER (458)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (459)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (460)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (461)
#define VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER (462)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (463)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (464)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (465)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (466)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (467)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (468)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (469)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (470)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (471)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (472)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (473)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (474)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (475)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (476)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (477)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (478)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (479)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (480)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (481)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (482)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (483)
#define VALVE_CNTRL_MPV_POSITION_REGISTER (484)
#define TEC_CNTRL_REGISTER (485)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (486)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (487)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (488)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (489)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (490)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (491)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (492)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (493)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (494)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (495)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (496)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (497)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (498)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (499)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (500)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (501)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (502)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (503)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (504)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (505)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (506)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (507)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (508)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (509)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (510)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (511)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (512)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (513)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (514)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (515)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (516)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (517)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (518)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (519)
#define SENTRY_FILTER_HEATER_TEMPERATURE_MIN_REGISTER (520)
#define SENTRY_FILTER_HEATER_TEMPERATURE_MAX_REGISTER (521)
#define FAN_CNTRL_STATE_REGISTER (522)
#define FAN_CNTRL_TEMPERATURE_REGISTER (523)
#define KEEP_ALIVE_REGISTER (524)
#define LOSS_BUFFER_0_REGISTER (525)
#define LOSS_BUFFER_1_REGISTER (526)
#define LOSS_BUFFER_2_REGISTER (527)
#define LOSS_BUFFER_3_REGISTER (528)
#define LOSS_BUFFER_4_REGISTER (529)
#define LOSS_BUFFER_5_REGISTER (530)
#define LOSS_BUFFER_6_REGISTER (531)
#define LOSS_BUFFER_7_REGISTER (532)
#define PROCESSED_LOSS_1_REGISTER (533)
#define PROCESSED_LOSS_2_REGISTER (534)
#define PROCESSED_LOSS_3_REGISTER (535)
#define PROCESSED_LOSS_4_REGISTER (536)
#define PEAK_DETECT_CNTRL_STATE_REGISTER (537)
#define PEAK_DETECT_CNTRL_BACKGROUND_SAMPLES_REGISTER (538)
#define PEAK_DETECT_CNTRL_BACKGROUND_REGISTER (539)
#define PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER (540)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER (541)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER (542)
#define PEAK_DETECT_CNTRL_THRESHOLD_FACTOR_REGISTER (543)
#define PEAK_DETECT_CNTRL_ACTIVE_SIZE_REGISTER (544)
#define PEAK_DETECT_CNTRL_POST_PEAK_SAMPLES_REGISTER (545)
#define PEAK_DETECT_CNTRL_CANCELLING_SAMPLES_REGISTER (546)
#define PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER (547)
#define PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER (548)
#define PEAK_DETECT_CNTRL_TRIGGERED_DURATION_REGISTER (549)
#define PEAK_DETECT_CNTRL_TRANSITIONING_DURATION_REGISTER (550)
#define PEAK_DETECT_CNTRL_TRANSITIONING_HOLDOFF_REGISTER (551)
#define PEAK_DETECT_CNTRL_HOLDING_MAX_LOSS_REGISTER (552)
#define PEAK_DETECT_CNTRL_HOLDING_DURATION_REGISTER (553)
#define PEAK_DETECT_CNTRL_PRIMING_DURATION_REGISTER (554)
#define PEAK_DETECT_CNTRL_PURGING_DURATION_REGISTER (555)
#define PEAK_DETECT_CNTRL_REMAINING_SAMPLES_REGISTER (556)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (557)
#define PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER (558)
#define PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER (559)
#define PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER (560)
#define PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER (561)
#define PEAK_DETECT_CNTRL_HOLDING_VALVE_MASK_AND_VALUE_REGISTER (562)
#define PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER (563)
#define PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER (564)
#define PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER (565)
#define PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER (566)
#define PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER (567)
#define FLOW1_REGISTER (568)
#define CONVERSION_FLOW1_SCALE_REGISTER (569)
#define CONVERSION_FLOW1_OFFSET_REGISTER (570)
#define RDD_BALANCE_REGISTER (571)
#define RDD_GAIN_REGISTER (572)
#define FLOW_CNTRL_STATE_REGISTER (573)
#define FLOW_CNTRL_SETPOINT_REGISTER (574)
#define FLOW_CNTRL_GAIN_REGISTER (575)
#define FLOW_0_SETPOINT_REGISTER (576)
#define FLOW_1_SETPOINT_REGISTER (577)
#define FLOW_2_SETPOINT_REGISTER (578)
#define FLOW_3_SETPOINT_REGISTER (579)
#define BATTERY_MONITOR_STATUS_REGISTER (580)
#define BATTERY_MONITOR_CHARGE_REGISTER (581)
#define BATTERY_MONITOR_VOLTAGE_REGISTER (582)
#define BATTERY_MONITOR_CURRENT_REGISTER (583)
#define BATTERY_MONITOR_TEMPERATURE_REGISTER (584)
#define ACCELEROMETER_X_REGISTER (585)
#define ACCELEROMETER_Y_REGISTER (586)
#define ACCELEROMETER_Z_REGISTER (587)
#define CAVITY2_TEMPERATURE_REGISTER (588)
#define RDD2_BALANCE_REGISTER (589)
#define RDD2_GAIN_REGISTER (590)
#define SGDBR_A_CNTRL_STATE_REGISTER (591)
#define SGDBR_A_CNTRL_FRONT_MIRROR_REGISTER (592)
#define SGDBR_A_CNTRL_BACK_MIRROR_REGISTER (593)
#define SGDBR_A_CNTRL_GAIN_REGISTER (594)
#define SGDBR_A_CNTRL_SOA_REGISTER (595)
#define SGDBR_A_CNTRL_COARSE_PHASE_REGISTER (596)
#define SGDBR_A_CNTRL_FINE_PHASE_REGISTER (597)
#define SGDBR_A_CNTRL_CHIRP_REGISTER (598)
#define SGDBR_A_CNTRL_SPARE_DAC_REGISTER (599)
#define SGDBR_A_CNTRL_RD_CONFIG_REGISTER (600)
#define SGDBR_A_CNTRL_PULSE_FRONT_STEP_REGISTER (601)
#define SGDBR_A_CNTRL_PULSE_BACK_STEP_REGISTER (602)
#define SGDBR_A_CNTRL_PULSE_PHASE_STEP_REGISTER (603)
#define SGDBR_A_CNTRL_PULSE_SOA_STEP_REGISTER (604)
#define SGDBR_A_CNTRL_PULSE_SEMI_PERIOD_REGISTER (605)
#define SGDBR_A_CNTRL_PULSE_TEMP_AMPLITUDE_REGISTER (606)
#define SGDBR_A_CNTRL_PULSE_TEMP_PEAK_TO_PEAK_REGISTER (607)
#define SGDBR_A_CNTRL_FRONT_TO_SOA_COEFF_REGISTER (608)
#define SGDBR_A_CNTRL_BACK_TO_SOA_COEFF_REGISTER (609)
#define SGDBR_A_CNTRL_PHASE_TO_SOA_COEFF_REGISTER (610)
#define SGDBR_A_CNTRL_MIRROR_DEAD_ZONE_REGISTER (611)
#define SGDBR_A_CNTRL_MINIMUM_SOA_REGISTER (612)
#define SGDBR_B_CNTRL_STATE_REGISTER (613)
#define SGDBR_B_CNTRL_FRONT_MIRROR_REGISTER (614)
#define SGDBR_B_CNTRL_BACK_MIRROR_REGISTER (615)
#define SGDBR_B_CNTRL_GAIN_REGISTER (616)
#define SGDBR_B_CNTRL_SOA_REGISTER (617)
#define SGDBR_B_CNTRL_COARSE_PHASE_REGISTER (618)
#define SGDBR_B_CNTRL_FINE_PHASE_REGISTER (619)
#define SGDBR_B_CNTRL_CHIRP_REGISTER (620)
#define SGDBR_B_CNTRL_SPARE_DAC_REGISTER (621)
#define SGDBR_B_CNTRL_RD_CONFIG_REGISTER (622)
#define SGDBR_B_CNTRL_PULSE_FRONT_STEP_REGISTER (623)
#define SGDBR_B_CNTRL_PULSE_BACK_STEP_REGISTER (624)
#define SGDBR_B_CNTRL_PULSE_PHASE_STEP_REGISTER (625)
#define SGDBR_B_CNTRL_PULSE_SOA_STEP_REGISTER (626)
#define SGDBR_B_CNTRL_PULSE_SEMI_PERIOD_REGISTER (627)
#define SGDBR_B_CNTRL_PULSE_TEMP_AMPLITUDE_REGISTER (628)
#define SGDBR_B_CNTRL_PULSE_TEMP_PEAK_TO_PEAK_REGISTER (629)
#define SGDBR_B_CNTRL_FRONT_TO_SOA_COEFF_REGISTER (630)
#define SGDBR_B_CNTRL_BACK_TO_SOA_COEFF_REGISTER (631)
#define SGDBR_B_CNTRL_PHASE_TO_SOA_COEFF_REGISTER (632)
#define SGDBR_B_CNTRL_MIRROR_DEAD_ZONE_REGISTER (633)
#define SGDBR_B_CNTRL_MINIMUM_SOA_REGISTER (634)
#define SGDBR_C_CNTRL_STATE_REGISTER (635)
#define SGDBR_C_CNTRL_FRONT_MIRROR_REGISTER (636)
#define SGDBR_C_CNTRL_BACK_MIRROR_REGISTER (637)
#define SGDBR_C_CNTRL_GAIN_REGISTER (638)
#define SGDBR_C_CNTRL_SOA_REGISTER (639)
#define SGDBR_C_CNTRL_COARSE_PHASE_REGISTER (640)
#define SGDBR_C_CNTRL_FINE_PHASE_REGISTER (641)
#define SGDBR_C_CNTRL_CHIRP_REGISTER (642)
#define SGDBR_C_CNTRL_SPARE_DAC_REGISTER (643)
#define SGDBR_C_CNTRL_RD_CONFIG_REGISTER (644)
#define SGDBR_C_CNTRL_PULSE_FRONT_STEP_REGISTER (645)
#define SGDBR_C_CNTRL_PULSE_BACK_STEP_REGISTER (646)
#define SGDBR_C_CNTRL_PULSE_PHASE_STEP_REGISTER (647)
#define SGDBR_C_CNTRL_PULSE_SOA_STEP_REGISTER (648)
#define SGDBR_C_CNTRL_PULSE_SEMI_PERIOD_REGISTER (649)
#define SGDBR_C_CNTRL_PULSE_TEMP_AMPLITUDE_REGISTER (650)
#define SGDBR_C_CNTRL_PULSE_TEMP_PEAK_TO_PEAK_REGISTER (651)
#define SGDBR_C_CNTRL_FRONT_TO_SOA_COEFF_REGISTER (652)
#define SGDBR_C_CNTRL_BACK_TO_SOA_COEFF_REGISTER (653)
#define SGDBR_C_CNTRL_PHASE_TO_SOA_COEFF_REGISTER (654)
#define SGDBR_C_CNTRL_MIRROR_DEAD_ZONE_REGISTER (655)
#define SGDBR_C_CNTRL_MINIMUM_SOA_REGISTER (656)
#define SGDBR_D_CNTRL_STATE_REGISTER (657)
#define SGDBR_D_CNTRL_FRONT_MIRROR_REGISTER (658)
#define SGDBR_D_CNTRL_BACK_MIRROR_REGISTER (659)
#define SGDBR_D_CNTRL_GAIN_REGISTER (660)
#define SGDBR_D_CNTRL_SOA_REGISTER (661)
#define SGDBR_D_CNTRL_COARSE_PHASE_REGISTER (662)
#define SGDBR_D_CNTRL_FINE_PHASE_REGISTER (663)
#define SGDBR_D_CNTRL_CHIRP_REGISTER (664)
#define SGDBR_D_CNTRL_SPARE_DAC_REGISTER (665)
#define SGDBR_D_CNTRL_RD_CONFIG_REGISTER (666)
#define SGDBR_D_CNTRL_PULSE_FRONT_STEP_REGISTER (667)
#define SGDBR_D_CNTRL_PULSE_BACK_STEP_REGISTER (668)
#define SGDBR_D_CNTRL_PULSE_PHASE_STEP_REGISTER (669)
#define SGDBR_D_CNTRL_PULSE_SOA_STEP_REGISTER (670)
#define SGDBR_D_CNTRL_PULSE_SEMI_PERIOD_REGISTER (671)
#define SGDBR_D_CNTRL_PULSE_TEMP_AMPLITUDE_REGISTER (672)
#define SGDBR_D_CNTRL_PULSE_TEMP_PEAK_TO_PEAK_REGISTER (673)
#define SGDBR_D_CNTRL_FRONT_TO_SOA_COEFF_REGISTER (674)
#define SGDBR_D_CNTRL_BACK_TO_SOA_COEFF_REGISTER (675)
#define SGDBR_D_CNTRL_PHASE_TO_SOA_COEFF_REGISTER (676)
#define SGDBR_D_CNTRL_MIRROR_DEAD_ZONE_REGISTER (677)
#define SGDBR_D_CNTRL_MINIMUM_SOA_REGISTER (678)
...
#define SOA1_TEC_VOLTAGE_MONITOR_REGISTER (686)
#define SOA1_TEMPERATURE_MONITOR_REGISTER (687)
#define SOA1_TEC_REGISTER (688)
#define SOA1_MANUAL_TEC_REGISTER (689)
#define SOA1_TEMP_CNTRL_STATE_REGISTER (690)
#define SOA1_TEMP_CNTRL_SETPOINT_REGISTER (691)
#define SOA1_TEMP_CNTRL_TOLERANCE_REGISTER (692)
#define SOA1_TEMP_CNTRL_SWEEP_MAX_REGISTER (693)
#define SOA1_TEMP_CNTRL_SWEEP_MIN_REGISTER (694)
#define SOA1_TEMP_CNTRL_SWEEP_INCR_REGISTER (695)
#define SOA1_TEMP_CNTRL_H_REGISTER (696)
#define SOA1_TEMP_CNTRL_K_REGISTER (697)
#define SOA1_TEMP_CNTRL_TI_REGISTER (698)
#define SOA1_TEMP_CNTRL_TD_REGISTER (699)
#define SOA1_TEMP_CNTRL_B_REGISTER (700)
#define SOA1_TEMP_CNTRL_C_REGISTER (701)
#define SOA1_TEMP_CNTRL_N_REGISTER (702)
#define SOA1_TEMP_CNTRL_S_REGISTER (703)
#define SOA1_TEMP_CNTRL_AMIN_REGISTER (704)
#define SOA1_TEMP_CNTRL_AMAX_REGISTER (705)
#define SOA1_TEMP_CNTRL_IMAX_REGISTER (706)
#define SOA1_TEC_PRBS_GENPOLY_REGISTER (707)
#define SOA1_TEC_PRBS_AMPLITUDE_REGISTER (708)
#define SOA1_TEC_PRBS_MEAN_REGISTER (709)
#define SOA2_TEC_REGISTER (710)
#define SOA2_MANUAL_TEC_REGISTER (711)
#define SOA2_TEMP_CNTRL_STATE_REGISTER (712)
#define SOA2_TEMP_CNTRL_SETPOINT_REGISTER (713)
#define SOA2_TEMP_CNTRL_TOLERANCE_REGISTER (714)
#define SOA2_TEMP_CNTRL_SWEEP_MAX_REGISTER (715)
#define SOA2_TEMP_CNTRL_SWEEP_MIN_REGISTER (716)
#define SOA2_TEMP_CNTRL_SWEEP_INCR_REGISTER (717)
#define SOA2_CURRENT_SETPOINT_REGISTER (718)
#define SOA2_TEMP_CNTRL_USER_SETPOINT_REGISTER (719)
#define SOA2_TEC_CURRENT_MONITOR_REGISTER (720)
#define SOA2_TEC_VOLTAGE_MONITOR_REGISTER (721)
#define SOA2_TEMPERATURE_MONITOR_REGISTER (722)
#define SOA2_TEMP_CNTRL_H_REGISTER (723)
#define SOA2_TEMP_CNTRL_K_REGISTER (724)
#define SOA2_TEMP_CNTRL_TI_REGISTER (725)
#define SOA2_TEMP_CNTRL_TD_REGISTER (726)
#define SOA2_TEMP_CNTRL_B_REGISTER (727)
#define SOA2_TEMP_CNTRL_C_REGISTER (728)
#define SOA2_TEMP_CNTRL_N_REGISTER (729)
#define SOA2_TEMP_CNTRL_S_REGISTER (730)
#define SOA2_TEMP_CNTRL_AMIN_REGISTER (731)
#define SOA2_TEMP_CNTRL_AMAX_REGISTER (732)
#define SOA2_TEMP_CNTRL_IMAX_REGISTER (733)
#define SOA2_TEC_PRBS_GENPOLY_REGISTER (734)
#define SOA2_TEC_PRBS_AMPLITUDE_REGISTER (735)
#define SOA2_TEC_PRBS_MEAN_REGISTER (736)
#define SOA3_TEC_REGISTER (737)
#define SOA3_MANUAL_TEC_REGISTER (738)
#define SOA3_TEMP_CNTRL_STATE_REGISTER (739)
#define SOA3_TEMP_CNTRL_SETPOINT_REGISTER (740)
#define SOA3_TEMP_CNTRL_TOLERANCE_REGISTER (741)
#define SOA3_TEMP_CNTRL_SWEEP_MAX_REGISTER (742)
#define SOA3_TEMP_CNTRL_SWEEP_MIN_REGISTER (743)
#define SOA3_TEMP_CNTRL_SWEEP_INCR_REGISTER (744)
#define SOA3_CURRENT_SETPOINT_REGISTER (745)
#define SOA3_TEMP_CNTRL_USER_SETPOINT_REGISTER (746)
#define SOA3_TEC_CURRENT_MONITOR_REGISTER (747)
#define SOA3_TEC_VOLTAGE_MONITOR_REGISTER (748)
#define SOA3_TEMPERATURE_MONITOR_REGISTER (749)
#define SOA3_TEMP_CNTRL_H_REGISTER (750)
#define SOA3_TEMP_CNTRL_K_REGISTER (751)
#define SOA3_TEMP_CNTRL_TI_REGISTER (752)
#define SOA3_TEMP_CNTRL_TD_REGISTER (753)
#define SOA3_TEMP_CNTRL_B_REGISTER (754)
#define SOA3_TEMP_CNTRL_C_REGISTER (755)
#define SOA3_TEMP_CNTRL_N_REGISTER (756)
#define SOA3_TEMP_CNTRL_S_REGISTER (757)
#define SOA3_TEMP_CNTRL_AMIN_REGISTER (758)
#define SOA3_TEMP_CNTRL_AMAX_REGISTER (759)
#define SOA3_TEMP_CNTRL_IMAX_REGISTER (760)
#define SOA3_TEC_PRBS_GENPOLY_REGISTER (761)
#define SOA3_TEC_PRBS_AMPLITUDE_REGISTER (762)
#define SOA3_TEC_PRBS_MEAN_REGISTER (763)
#define SOA4_TEC_REGISTER (764)
#define SOA4_MANUAL_TEC_REGISTER (765)
#define SOA4_TEMP_CNTRL_STATE_REGISTER (766)
#define SOA4_TEMP_CNTRL_SETPOINT_REGISTER (767)
#define SOA4_TEMP_CNTRL_TOLERANCE_REGISTER (768)
#define SOA4_TEMP_CNTRL_SWEEP_MAX_REGISTER (769)
#define SOA4_TEMP_CNTRL_SWEEP_MIN_REGISTER (770)
#define SOA4_TEMP_CNTRL_SWEEP_INCR_REGISTER (771)
#define SOA4_CURRENT_SETPOINT_REGISTER (772)
#define SOA4_TEMP_CNTRL_USER_SETPOINT_REGISTER (773)
#define SOA4_TEC_CURRENT_MONITOR_REGISTER (774)
#define SOA4_TEC_VOLTAGE_MONITOR_REGISTER (775)
#define SOA4_TEMPERATURE_MONITOR_REGISTER (776)
#define SOA4_TEMP_CNTRL_H_REGISTER (777)
#define SOA4_TEMP_CNTRL_K_REGISTER (778)
#define SOA4_TEMP_CNTRL_TI_REGISTER (779)
#define SOA4_TEMP_CNTRL_TD_REGISTER (780)
#define SOA4_TEMP_CNTRL_B_REGISTER (781)
#define SOA4_TEMP_CNTRL_C_REGISTER (782)
#define SOA4_TEMP_CNTRL_N_REGISTER (783)
#define SOA4_TEMP_CNTRL_S_REGISTER (784)
#define SOA4_TEMP_CNTRL_AMIN_REGISTER (785)
#define SOA4_TEMP_CNTRL_AMAX_REGISTER (786)
#define SOA4_TEMP_CNTRL_IMAX_REGISTER (787)
#define SOA4_TEC_PRBS_GENPOLY_REGISTER (788)
#define SOA4_TEC_PRBS_AMPLITUDE_REGISTER (789)
#define SOA4_TEC_PRBS_MEAN_REGISTER (790)
#define SOA_ENABLE_MASK_REGISTER (791)
#define PZT_CNTRL_STATE_REGISTER (792)
#define PZT_CNTRL_WLM_ANGLE_MODULUS (793)
#define PZT_CNTRL_UPDATE_TIME_CONSTANT (794)
#define PZT_CNTRL_SCALE_FACTOR (795)
#define PZT_CNTRL_UPDATE_CLAMP (796)
#define PZT_CNTRL_FLATTENING_FACTOR (797)
#define PZT_CNTRL_REFERENCE_CENTERING_FACTOR (798)
#define PZT_CNTRL_SHIFT (799)
...
#define SOA1_CURRENT 39
#define SOA1_CONTROL 40
#define SOA1_TEC 41
#define SOA1_MONITOR 42
#define SOA2_CURRENT 43
#define SOA2_CONTROL 44
#define SOA2_TEC 45
#define SOA2_MONITOR 46
#define SOA3_CURRENT 47
#define SOA3_CONTROL 48
#define SOA3_TEC 49
#define SOA3_MONITOR 50
#define SOA4_CURRENT 51
#define SOA4_CONTROL 52
#define SOA4_TEC 53
#define SOA4_MONITOR 54
#define CHAIN0_MUX 55
#define CHAIN1_MUX 56
...
#define FPGA_SGDBRCURRENTSOURCE_C (183) // SGDBR current source C
#define FPGA_SGDBRCURRENTSOURCE_D (189) // SGDBR current source D
#define FPGA_SGDBRMANAGER (195) // SGDBR manager
...
#define ACTION_SGDBR_C_SET_CURRENTS (101)
#define ACTION_SGDBR_D_SET_CURRENTS (102)
#define ACTION_SOA_CNTRL_SOA1_INIT (103)
#define ACTION_SOA_CNTRL_SOA1_STEP (104)
#define ACTION_SOA_CNTRL_SOA2_INIT (105)
#define ACTION_SOA_CNTRL_SOA2_STEP (106)
#define ACTION_SOA_CNTRL_SOA3_INIT (107)
#define ACTION_SOA_CNTRL_SOA3_STEP (108)
#define ACTION_SOA_CNTRL_SOA4_INIT (109)
#define ACTION_SOA_CNTRL_SOA4_STEP (110)
#define ACTION_READ_SOA_MONITOR (111)
#define ACTION_SET_SOA_CURRENT (112)
#define ACTION_SET_SOA_TEMPERATURE (113)
#define ACTION_SET_SOA_CONTROL (114)
#define ACTION_SET_SOA_TEC (115)
#define ACTION_TEMP_CNTRL_SOA1_INIT (116)
#define ACTION_TEMP_CNTRL_SOA1_STEP (117)
#define ACTION_TEMP_CNTRL_SOA2_INIT (118)
#define ACTION_TEMP_CNTRL_SOA2_STEP (119)
#define ACTION_TEMP_CNTRL_SOA3_INIT (120)
#define ACTION_TEMP_CNTRL_SOA3_STEP (121)
#define ACTION_TEMP_CNTRL_SOA4_INIT (122)
#define ACTION_TEMP_CNTRL_SOA4_STEP (123)
#define ACTION_CONVERT_SOA_TEC_CURRENT (124)
