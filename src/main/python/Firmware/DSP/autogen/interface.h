...
#define INTERFACE_NUMBER_OF_REGISTERS (461)
...
#define LASER2_THERMISTOR_SERIES_RESISTANCE_REGISTER (63)
...
#define LASER3_THERMISTOR_SERIES_RESISTANCE_REGISTER (103)
...
#define LASER4_THERMISTOR_SERIES_RESISTANCE_REGISTER (143)
...
#define ETALON_THERMISTOR_SERIES_RESISTANCE_REGISTER (181)
...
#define WARM_BOX_THERMISTOR_SERIES_RESISTANCE_REGISTER (187)
...
#define WARM_BOX_HEATSINK_THERMISTOR_SERIES_RESISTANCE_REGISTER (218)
...
#define HOT_BOX_HEATSINK_THERMISTOR_SERIES_RESISTANCE_REGISTER (224)
...
#define CAVITY_THERMISTOR_SERIES_RESISTANCE_REGISTER (230)
...
#define HEATER_CUTOFF_REGISTER (279)
#define CAVITY_PRESSURE_ADC_REGISTER (280)
#define CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER (281)
#define CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER (282)
#define CAVITY_PRESSURE_REGISTER (283)
#define AMBIENT_PRESSURE_ADC_REGISTER (284)
#define CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER (285)
#define CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER (286)
#define AMBIENT_PRESSURE_REGISTER (287)
#define ANALYZER_TUNING_MODE_REGISTER (288)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (289)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (290)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (291)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (292)
#define TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER (293)
#define TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER (294)
#define TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER (295)
#define TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER (296)
#define TUNER_DITHER_MEDIAN_COUNT_REGISTER (297)
#define RDFITTER_MINLOSS_REGISTER (298)
#define RDFITTER_MAXLOSS_REGISTER (299)
#define RDFITTER_LATEST_LOSS_REGISTER (300)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (301)
#define RDFITTER_START_SAMPLE_REGISTER (302)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (303)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (304)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (305)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (306)
#define RDFITTER_META_BACKOFF_REGISTER (307)
#define RDFITTER_META_SAMPLES_REGISTER (308)
#define SPECT_CNTRL_STATE_REGISTER (309)
#define SPECT_CNTRL_MODE_REGISTER (310)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (311)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (312)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (313)
#define SPECT_CNTRL_SCHEME_ROW_REGISTER (314)
#define SPECT_CNTRL_DWELL_COUNT_REGISTER (315)
#define SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER (316)
#define SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER (317)
#define SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER (318)
#define VIRTUAL_LASER_REGISTER (319)
#define PZT_INCR_PER_CAVITY_FSR (320)
#define PZT_OFFSET_UPDATE_FACTOR (321)
#define PZT_OFFSET_VIRTUAL_LASER1 (322)
#define PZT_OFFSET_VIRTUAL_LASER2 (323)
#define PZT_OFFSET_VIRTUAL_LASER3 (324)
#define PZT_OFFSET_VIRTUAL_LASER4 (325)
#define PZT_OFFSET_VIRTUAL_LASER5 (326)
#define PZT_OFFSET_VIRTUAL_LASER6 (327)
#define PZT_OFFSET_VIRTUAL_LASER7 (328)
#define PZT_OFFSET_VIRTUAL_LASER8 (329)
#define SCHEME_OFFSET_VIRTUAL_LASER1 (330)
#define SCHEME_OFFSET_VIRTUAL_LASER2 (331)
#define SCHEME_OFFSET_VIRTUAL_LASER3 (332)
#define SCHEME_OFFSET_VIRTUAL_LASER4 (333)
#define SCHEME_OFFSET_VIRTUAL_LASER5 (334)
#define SCHEME_OFFSET_VIRTUAL_LASER6 (335)
#define SCHEME_OFFSET_VIRTUAL_LASER7 (336)
#define SCHEME_OFFSET_VIRTUAL_LASER8 (337)
#define VALVE_CNTRL_STATE_REGISTER (338)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (339)
#define VALVE_CNTRL_USER_INLET_VALVE_REGISTER (340)
#define VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER (341)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (342)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (343)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (344)
#define VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER (345)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (346)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (347)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (348)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (349)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (350)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (351)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (352)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (353)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (354)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (355)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (356)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (357)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (358)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (359)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (360)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (361)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (362)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (363)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (364)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (365)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (366)
#define VALVE_CNTRL_MPV_POSITION_REGISTER (367)
#define TEC_CNTRL_REGISTER (368)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (369)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (370)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (371)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (372)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (373)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (374)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (375)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (376)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (377)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (378)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (379)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (380)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (381)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (382)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (383)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (384)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (385)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (386)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (387)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (388)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (389)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (390)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (391)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (392)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (393)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (394)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (395)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (396)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (397)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (398)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (399)
...
#define PEAK_DETECT_CNTRL_STATE_REGISTER (418)
#define PEAK_DETECT_CNTRL_BACKGROUND_SAMPLES_REGISTER (419)
#define PEAK_DETECT_CNTRL_BACKGROUND_REGISTER (420)
#define PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER (421)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER (422)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER (423)
#define PEAK_DETECT_CNTRL_THRESHOLD_FACTOR_REGISTER (424)
#define PEAK_DETECT_CNTRL_ACTIVE_SIZE_REGISTER (425)
#define PEAK_DETECT_CNTRL_POST_PEAK_SAMPLES_REGISTER (426)
#define PEAK_DETECT_CNTRL_CANCELLING_SAMPLES_REGISTER (427)
#define PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER (428)
#define PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER (429)
#define PEAK_DETECT_CNTRL_TRIGGERED_DURATION_REGISTER (430)
#define PEAK_DETECT_CNTRL_TRANSITIONING_DURATION_REGISTER (431)
#define PEAK_DETECT_CNTRL_TRANSITIONING_HOLDOFF_REGISTER (432)
#define PEAK_DETECT_CNTRL_HOLDING_MAX_LOSS_REGISTER (433)
#define PEAK_DETECT_CNTRL_HOLDING_DURATION_REGISTER (434)
#define PEAK_DETECT_CNTRL_PRIMING_DURATION_REGISTER (435)
#define PEAK_DETECT_CNTRL_PURGING_DURATION_REGISTER (436)
#define PEAK_DETECT_CNTRL_REMAINING_SAMPLES_REGISTER (437)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (438)
#define PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER (439)
#define PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER (440)
#define PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER (441)
#define PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER (442)
#define PEAK_DETECT_CNTRL_HOLDING_VALVE_MASK_AND_VALUE_REGISTER (443)
#define PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER (444)
#define PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER (445)
#define PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER (446)
#define PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER (447)
#define PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER (448)
#define FLOW1_REGISTER (449)
#define CONVERSION_FLOW1_SCALE_REGISTER (450)
#define CONVERSION_FLOW1_OFFSET_REGISTER (451)
#define RDD_BALANCE_REGISTER (452)
#define RDD_GAIN_REGISTER (453)
#define FLOW_CNTRL_STATE_REGISTER (454)
#define FLOW_CNTRL_SETPOINT_REGISTER (455)
#define FLOW_CNTRL_GAIN_REGISTER (456)
#define FLOW_0_SETPOINT_REGISTER (457)
#define FLOW_1_SETPOINT_REGISTER (458)
#define FLOW_2_SETPOINT_REGISTER (459)
#define FLOW_3_SETPOINT_REGISTER (460)
...
#define HOT_BOX_HEATSINK_THERMISTOR_ADC 17
...
#define ACTION_UPDATE_FROM_SIMULATORS (9)
#define ACTION_STEP_SIMULATORS (10)
