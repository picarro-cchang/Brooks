...
#define INTERFACE_NUMBER_OF_REGISTERS (505)
...
#define CAVITY_PRESSURE_ADC_REGISTER (316)
#define CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER (317)
#define CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER (318)
#define CAVITY_PRESSURE_REGISTER (319)
#define AMBIENT_PRESSURE_ADC_REGISTER (320)
#define CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER (321)
#define CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER (322)
#define AMBIENT_PRESSURE_REGISTER (323)
#define ANALYZER_TUNING_MODE_REGISTER (324)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (325)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (326)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (327)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (328)
#define TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER (329)
#define TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER (330)
#define TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER (331)
#define TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER (332)
#define TUNER_DITHER_MEDIAN_COUNT_REGISTER (333)
#define RDFITTER_MINLOSS_REGISTER (334)
#define RDFITTER_MAXLOSS_REGISTER (335)
#define RDFITTER_LATEST_LOSS_REGISTER (336)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (337)
#define RDFITTER_START_SAMPLE_REGISTER (338)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (339)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (340)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (341)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (342)
#define RDFITTER_META_BACKOFF_REGISTER (343)
#define RDFITTER_META_SAMPLES_REGISTER (344)
#define SPECT_CNTRL_STATE_REGISTER (345)
#define SPECT_CNTRL_MODE_REGISTER (346)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (347)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (348)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (349)
#define SPECT_CNTRL_SCHEME_ROW_REGISTER (350)
#define SPECT_CNTRL_DWELL_COUNT_REGISTER (351)
#define SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER (352)
#define SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER (353)
#define SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER (354)
#define VIRTUAL_LASER_REGISTER (355)
#define PZT_INCR_PER_CAVITY_FSR (356)
#define PZT_OFFSET_UPDATE_FACTOR (357)
#define PZT_OFFSET_VIRTUAL_LASER1 (358)
#define PZT_OFFSET_VIRTUAL_LASER2 (359)
#define PZT_OFFSET_VIRTUAL_LASER3 (360)
#define PZT_OFFSET_VIRTUAL_LASER4 (361)
#define PZT_OFFSET_VIRTUAL_LASER5 (362)
#define PZT_OFFSET_VIRTUAL_LASER6 (363)
#define PZT_OFFSET_VIRTUAL_LASER7 (364)
#define PZT_OFFSET_VIRTUAL_LASER8 (365)
#define SCHEME_OFFSET_VIRTUAL_LASER1 (366)
#define SCHEME_OFFSET_VIRTUAL_LASER2 (367)
#define SCHEME_OFFSET_VIRTUAL_LASER3 (368)
#define SCHEME_OFFSET_VIRTUAL_LASER4 (369)
#define SCHEME_OFFSET_VIRTUAL_LASER5 (370)
#define SCHEME_OFFSET_VIRTUAL_LASER6 (371)
#define SCHEME_OFFSET_VIRTUAL_LASER7 (372)
#define SCHEME_OFFSET_VIRTUAL_LASER8 (373)
#define VALVE_CNTRL_STATE_REGISTER (374)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (375)
#define VALVE_CNTRL_USER_INLET_VALVE_REGISTER (376)
#define VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER (377)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (378)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (379)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (380)
#define VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER (381)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (382)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (383)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (384)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (385)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (386)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (387)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (388)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (389)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (390)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (391)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (392)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (393)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (394)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (395)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (396)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (397)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (398)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (399)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (400)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (401)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (402)
#define VALVE_CNTRL_MPV_POSITION_REGISTER (403)
#define TEC_CNTRL_REGISTER (404)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (405)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (406)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (407)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (408)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (409)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (410)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (411)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (412)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (413)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (414)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (415)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (416)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (417)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (418)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (419)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (420)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (421)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (422)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (423)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (424)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (425)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (426)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (427)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (428)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (429)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (430)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (431)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (432)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (433)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (434)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (435)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (436)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (437)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (438)
#define FAN_CNTRL_STATE_REGISTER (439)
#define FAN_CNTRL_TEMPERATURE_REGISTER (440)
#define KEEP_ALIVE_REGISTER (441)
#define LOSS_BUFFER_0_REGISTER (442)
#define LOSS_BUFFER_1_REGISTER (443)
#define LOSS_BUFFER_2_REGISTER (444)
#define LOSS_BUFFER_3_REGISTER (445)
#define LOSS_BUFFER_4_REGISTER (446)
#define LOSS_BUFFER_5_REGISTER (447)
#define LOSS_BUFFER_6_REGISTER (448)
#define LOSS_BUFFER_7_REGISTER (449)
#define PROCESSED_LOSS_1_REGISTER (450)
#define PROCESSED_LOSS_2_REGISTER (451)
#define PROCESSED_LOSS_3_REGISTER (452)
#define PROCESSED_LOSS_4_REGISTER (453)
#define PEAK_DETECT_CNTRL_STATE_REGISTER (454)
#define PEAK_DETECT_CNTRL_BACKGROUND_SAMPLES_REGISTER (455)
#define PEAK_DETECT_CNTRL_BACKGROUND_REGISTER (456)
#define PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER (457)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER (458)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER (459)
#define PEAK_DETECT_CNTRL_THRESHOLD_FACTOR_REGISTER (460)
#define PEAK_DETECT_CNTRL_ACTIVE_SIZE_REGISTER (461)
#define PEAK_DETECT_CNTRL_POST_PEAK_SAMPLES_REGISTER (462)
#define PEAK_DETECT_CNTRL_CANCELLING_SAMPLES_REGISTER (463)
#define PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER (464)
#define PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER (465)
#define PEAK_DETECT_CNTRL_TRIGGERED_DURATION_REGISTER (466)
#define PEAK_DETECT_CNTRL_TRANSITIONING_DURATION_REGISTER (467)
#define PEAK_DETECT_CNTRL_TRANSITIONING_HOLDOFF_REGISTER (468)
#define PEAK_DETECT_CNTRL_HOLDING_MAX_LOSS_REGISTER (469)
#define PEAK_DETECT_CNTRL_HOLDING_DURATION_REGISTER (470)
#define PEAK_DETECT_CNTRL_PRIMING_DURATION_REGISTER (471)
#define PEAK_DETECT_CNTRL_PURGING_DURATION_REGISTER (472)
#define PEAK_DETECT_CNTRL_REMAINING_SAMPLES_REGISTER (473)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (474)
#define PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER (475)
#define PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER (476)
#define PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER (477)
#define PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER (478)
#define PEAK_DETECT_CNTRL_HOLDING_VALVE_MASK_AND_VALUE_REGISTER (479)
#define PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER (480)
#define PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER (481)
#define PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER (482)
#define PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER (483)
#define PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER (484)
#define FLOW1_REGISTER (485)
#define CONVERSION_FLOW1_SCALE_REGISTER (486)
#define CONVERSION_FLOW1_OFFSET_REGISTER (487)
#define RDD_BALANCE_REGISTER (488)
#define RDD_GAIN_REGISTER (489)
#define FLOW_CNTRL_STATE_REGISTER (490)
#define FLOW_CNTRL_SETPOINT_REGISTER (491)
#define FLOW_CNTRL_GAIN_REGISTER (492)
#define FLOW_0_SETPOINT_REGISTER (493)
#define FLOW_1_SETPOINT_REGISTER (494)
#define FLOW_2_SETPOINT_REGISTER (495)
#define FLOW_3_SETPOINT_REGISTER (496)
#define BATTERY_MONITOR_STATUS_REGISTER (497)
#define BATTERY_MONITOR_CHARGE_REGISTER (498)
#define BATTERY_MONITOR_VOLTAGE_REGISTER (499)
#define BATTERY_MONITOR_CURRENT_REGISTER (500)
#define BATTERY_MONITOR_TEMPERATURE_REGISTER (501)
#define ACCELEROMETER_X_REGISTER (502)
#define ACCELEROMETER_Y_REGISTER (503)
#define ACCELEROMETER_Z_REGISTER (504)
...
#define HOT_BOX_HEATSINK_THERMISTOR_ADC 24
#define RDD_POTENTIOMETERS 25
#define FLOW1_SENSOR 26
#define DAS_TEMP_SENSOR 27
#define VALVE_PUMP_TEC_PORT 28
#define ANALOG_INTERFACE 29
#define BATTERY_MONITOR 30
...
#define FPGA_TWGEN (93) // Tuner waveform generator
#define FPGA_INJECT (102) // Optical Injection Subsystem
#define FPGA_WLMSIM (128) // WLM Simulator
#define FPGA_DYNAMICPWM_INLET (137) // Inlet proportional valve dynamic PWM
#define FPGA_DYNAMICPWM_OUTLET (142) // Outlet proportional valve dynamic PWM
#define FPGA_SCALER (147) // Scaler for PZT waveform
#define FPGA_LASERCURRENTGENERATOR (148) // Laser current generator
