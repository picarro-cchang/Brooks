...
#define INTERFACE_NUMBER_OF_REGISTERS (798)
...
#define SOA1_CURRENT_SETPOINT_REGISTER (681)
#define SOA1_TEMP_CNTRL_USER_SETPOINT_REGISTER (682)
#define SOA1_TEC_CURRENT_MONITOR_REGISTER (683)
#define SOA1_TEC_VOLTAGE_MONITOR_REGISTER (684)
#define SOA1_TEMPERATURE_MONITOR_REGISTER (685)
#define SOA1_TEC_REGISTER (686)
#define SOA1_MANUAL_TEC_REGISTER (687)
#define SOA1_TEMP_CNTRL_STATE_REGISTER (688)
#define SOA1_TEMP_CNTRL_SETPOINT_REGISTER (689)
#define SOA1_TEMP_CNTRL_TOLERANCE_REGISTER (690)
#define SOA1_TEMP_CNTRL_SWEEP_MAX_REGISTER (691)
#define SOA1_TEMP_CNTRL_SWEEP_MIN_REGISTER (692)
#define SOA1_TEMP_CNTRL_SWEEP_INCR_REGISTER (693)
#define SOA1_TEMP_CNTRL_H_REGISTER (694)
#define SOA1_TEMP_CNTRL_K_REGISTER (695)
#define SOA1_TEMP_CNTRL_TI_REGISTER (696)
#define SOA1_TEMP_CNTRL_TD_REGISTER (697)
#define SOA1_TEMP_CNTRL_B_REGISTER (698)
#define SOA1_TEMP_CNTRL_C_REGISTER (699)
#define SOA1_TEMP_CNTRL_N_REGISTER (700)
#define SOA1_TEMP_CNTRL_S_REGISTER (701)
#define SOA1_TEMP_CNTRL_AMIN_REGISTER (702)
#define SOA1_TEMP_CNTRL_AMAX_REGISTER (703)
#define SOA1_TEMP_CNTRL_IMAX_REGISTER (704)
#define SOA1_TEC_PRBS_GENPOLY_REGISTER (705)
#define SOA1_TEC_PRBS_AMPLITUDE_REGISTER (706)
#define SOA1_TEC_PRBS_MEAN_REGISTER (707)
#define SOA2_TEC_REGISTER (708)
#define SOA2_MANUAL_TEC_REGISTER (709)
#define SOA2_TEMP_CNTRL_STATE_REGISTER (710)
#define SOA2_TEMP_CNTRL_SETPOINT_REGISTER (711)
#define SOA2_TEMP_CNTRL_TOLERANCE_REGISTER (712)
#define SOA2_TEMP_CNTRL_SWEEP_MAX_REGISTER (713)
#define SOA2_TEMP_CNTRL_SWEEP_MIN_REGISTER (714)
#define SOA2_TEMP_CNTRL_SWEEP_INCR_REGISTER (715)
#define SOA2_CURRENT_SETPOINT_REGISTER (716)
#define SOA2_TEMP_CNTRL_USER_SETPOINT_REGISTER (717)
#define SOA2_TEC_CURRENT_MONITOR_REGISTER (718)
#define SOA2_TEC_VOLTAGE_MONITOR_REGISTER (719)
#define SOA2_TEMPERATURE_MONITOR_REGISTER (720)
#define SOA2_TEMP_CNTRL_H_REGISTER (721)
#define SOA2_TEMP_CNTRL_K_REGISTER (722)
#define SOA2_TEMP_CNTRL_TI_REGISTER (723)
#define SOA2_TEMP_CNTRL_TD_REGISTER (724)
#define SOA2_TEMP_CNTRL_B_REGISTER (725)
#define SOA2_TEMP_CNTRL_C_REGISTER (726)
#define SOA2_TEMP_CNTRL_N_REGISTER (727)
#define SOA2_TEMP_CNTRL_S_REGISTER (728)
#define SOA2_TEMP_CNTRL_AMIN_REGISTER (729)
#define SOA2_TEMP_CNTRL_AMAX_REGISTER (730)
#define SOA2_TEMP_CNTRL_IMAX_REGISTER (731)
#define SOA2_TEC_PRBS_GENPOLY_REGISTER (732)
#define SOA2_TEC_PRBS_AMPLITUDE_REGISTER (733)
#define SOA2_TEC_PRBS_MEAN_REGISTER (734)
#define SOA3_TEC_REGISTER (735)
#define SOA3_MANUAL_TEC_REGISTER (736)
#define SOA3_TEMP_CNTRL_STATE_REGISTER (737)
#define SOA3_TEMP_CNTRL_SETPOINT_REGISTER (738)
#define SOA3_TEMP_CNTRL_TOLERANCE_REGISTER (739)
#define SOA3_TEMP_CNTRL_SWEEP_MAX_REGISTER (740)
#define SOA3_TEMP_CNTRL_SWEEP_MIN_REGISTER (741)
#define SOA3_TEMP_CNTRL_SWEEP_INCR_REGISTER (742)
#define SOA3_CURRENT_SETPOINT_REGISTER (743)
#define SOA3_TEMP_CNTRL_USER_SETPOINT_REGISTER (744)
#define SOA3_TEC_CURRENT_MONITOR_REGISTER (745)
#define SOA3_TEC_VOLTAGE_MONITOR_REGISTER (746)
#define SOA3_TEMPERATURE_MONITOR_REGISTER (747)
#define SOA3_TEMP_CNTRL_H_REGISTER (748)
#define SOA3_TEMP_CNTRL_K_REGISTER (749)
#define SOA3_TEMP_CNTRL_TI_REGISTER (750)
#define SOA3_TEMP_CNTRL_TD_REGISTER (751)
#define SOA3_TEMP_CNTRL_B_REGISTER (752)
#define SOA3_TEMP_CNTRL_C_REGISTER (753)
#define SOA3_TEMP_CNTRL_N_REGISTER (754)
#define SOA3_TEMP_CNTRL_S_REGISTER (755)
#define SOA3_TEMP_CNTRL_AMIN_REGISTER (756)
#define SOA3_TEMP_CNTRL_AMAX_REGISTER (757)
#define SOA3_TEMP_CNTRL_IMAX_REGISTER (758)
#define SOA3_TEC_PRBS_GENPOLY_REGISTER (759)
#define SOA3_TEC_PRBS_AMPLITUDE_REGISTER (760)
#define SOA3_TEC_PRBS_MEAN_REGISTER (761)
#define SOA4_TEC_REGISTER (762)
#define SOA4_MANUAL_TEC_REGISTER (763)
#define SOA4_TEMP_CNTRL_STATE_REGISTER (764)
#define SOA4_TEMP_CNTRL_SETPOINT_REGISTER (765)
#define SOA4_TEMP_CNTRL_TOLERANCE_REGISTER (766)
#define SOA4_TEMP_CNTRL_SWEEP_MAX_REGISTER (767)
#define SOA4_TEMP_CNTRL_SWEEP_MIN_REGISTER (768)
#define SOA4_TEMP_CNTRL_SWEEP_INCR_REGISTER (769)
#define SOA4_CURRENT_SETPOINT_REGISTER (770)
#define SOA4_TEMP_CNTRL_USER_SETPOINT_REGISTER (771)
#define SOA4_TEC_CURRENT_MONITOR_REGISTER (772)
#define SOA4_TEC_VOLTAGE_MONITOR_REGISTER (773)
#define SOA4_TEMPERATURE_MONITOR_REGISTER (774)
#define SOA4_TEMP_CNTRL_H_REGISTER (775)
#define SOA4_TEMP_CNTRL_K_REGISTER (776)
#define SOA4_TEMP_CNTRL_TI_REGISTER (777)
#define SOA4_TEMP_CNTRL_TD_REGISTER (778)
#define SOA4_TEMP_CNTRL_B_REGISTER (779)
#define SOA4_TEMP_CNTRL_C_REGISTER (780)
#define SOA4_TEMP_CNTRL_N_REGISTER (781)
#define SOA4_TEMP_CNTRL_S_REGISTER (782)
#define SOA4_TEMP_CNTRL_AMIN_REGISTER (783)
#define SOA4_TEMP_CNTRL_AMAX_REGISTER (784)
#define SOA4_TEMP_CNTRL_IMAX_REGISTER (785)
#define SOA4_TEC_PRBS_GENPOLY_REGISTER (786)
#define SOA4_TEC_PRBS_AMPLITUDE_REGISTER (787)
#define SOA4_TEC_PRBS_MEAN_REGISTER (788)
#define SOA_ENABLE_MASK_REGISTER (789)
#define PZT_CNTRL_STATE_REGISTER (790)
#define PZT_CNTRL_WLM_ANGLE_MODULUS (791)
#define PZT_CNTRL_UPDATE_TIME_CONSTANT (792)
#define PZT_CNTRL_SCALE_FACTOR (793)
#define PZT_CNTRL_UPDATE_CLAMP (794)
#define PZT_CNTRL_FLATTENING_FACTOR (795)
#define PZT_CNTRL_REFERENCE_CENTERING_FACTOR (796)
#define PZT_CNTRL_SHIFT (797)
