...
#define INTERFACE_NUMBER_OF_REGISTERS (569)
...
#define CONVERSION_CAVITY2_THERM1_CONSTB_REGISTER (267)
#define CONVERSION_CAVITY2_THERM1_CONSTC_REGISTER (268)
#define CAVITY2_RESISTANCE1_REGISTER (269)
#define CAVITY2_TEMPERATURE1_REGISTER (270)
#define CAVITY2_THERMISTOR1_SERIES_RESISTANCE_REGISTER (271)
#define CONVERSION_CAVITY2_THERM2_CONSTA_REGISTER (272)
#define CONVERSION_CAVITY2_THERM2_CONSTB_REGISTER (273)
#define CONVERSION_CAVITY2_THERM2_CONSTC_REGISTER (274)
#define CAVITY2_RESISTANCE2_REGISTER (275)
#define CAVITY2_TEMPERATURE2_REGISTER (276)
#define CAVITY2_THERMISTOR2_SERIES_RESISTANCE_REGISTER (277)
#define CONVERSION_CAVITY2_THERM3_CONSTA_REGISTER (278)
#define CONVERSION_CAVITY2_THERM3_CONSTB_REGISTER (279)
#define CONVERSION_CAVITY2_THERM3_CONSTC_REGISTER (280)
#define CAVITY2_RESISTANCE3_REGISTER (281)
#define CAVITY2_TEMPERATURE3_REGISTER (282)
#define CAVITY2_THERMISTOR3_SERIES_RESISTANCE_REGISTER (283)
#define CONVERSION_CAVITY2_THERM4_CONSTA_REGISTER (284)
#define CONVERSION_CAVITY2_THERM4_CONSTB_REGISTER (285)
#define CONVERSION_CAVITY2_THERM4_CONSTC_REGISTER (286)
#define CAVITY2_RESISTANCE4_REGISTER (287)
#define CAVITY2_TEMPERATURE4_REGISTER (288)
#define CAVITY2_THERMISTOR4_SERIES_RESISTANCE_REGISTER (289)
#define CAVITY_TEC_REGISTER (290)
#define CAVITY_MANUAL_TEC_REGISTER (291)
#define CAVITY_TEMP_CNTRL_STATE_REGISTER (292)
#define CAVITY_TEMP_CNTRL_SETPOINT_REGISTER (293)
#define CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER (294)
#define CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER (295)
#define CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER (296)
#define CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER (297)
#define CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER (298)
#define CAVITY_TEMP_CNTRL_H_REGISTER (299)
#define CAVITY_TEMP_CNTRL_K_REGISTER (300)
#define CAVITY_TEMP_CNTRL_TI_REGISTER (301)
#define CAVITY_TEMP_CNTRL_TD_REGISTER (302)
#define CAVITY_TEMP_CNTRL_B_REGISTER (303)
#define CAVITY_TEMP_CNTRL_C_REGISTER (304)
#define CAVITY_TEMP_CNTRL_N_REGISTER (305)
#define CAVITY_TEMP_CNTRL_S_REGISTER (306)
#define CAVITY_TEMP_CNTRL_FFWD_REGISTER (307)
#define CAVITY_TEMP_CNTRL_AMIN_REGISTER (308)
#define CAVITY_TEMP_CNTRL_AMAX_REGISTER (309)
#define CAVITY_TEMP_CNTRL_IMAX_REGISTER (310)
#define CAVITY_TEC_PRBS_GENPOLY_REGISTER (311)
#define CAVITY_TEC_PRBS_AMPLITUDE_REGISTER (312)
#define CAVITY_TEC_PRBS_MEAN_REGISTER (313)
#define CAVITY_MAX_HEATSINK_TEMP_REGISTER (314)
#define HEATER_MARK_REGISTER (315)
#define HEATER_MANUAL_MARK_REGISTER (316)
#define HEATER_TEMP_CNTRL_STATE_REGISTER (317)
#define HEATER_TEMP_CNTRL_SETPOINT_REGISTER (318)
#define HEATER_TEMP_CNTRL_USER_SETPOINT_REGISTER (319)
#define HEATER_TEMP_CNTRL_TOLERANCE_REGISTER (320)
#define HEATER_TEMP_CNTRL_SWEEP_MAX_REGISTER (321)
#define HEATER_TEMP_CNTRL_SWEEP_MIN_REGISTER (322)
#define HEATER_TEMP_CNTRL_SWEEP_INCR_REGISTER (323)
#define HEATER_TEMP_CNTRL_H_REGISTER (324)
#define HEATER_TEMP_CNTRL_K_REGISTER (325)
#define HEATER_TEMP_CNTRL_TI_REGISTER (326)
#define HEATER_TEMP_CNTRL_TD_REGISTER (327)
#define HEATER_TEMP_CNTRL_B_REGISTER (328)
#define HEATER_TEMP_CNTRL_C_REGISTER (329)
#define HEATER_TEMP_CNTRL_N_REGISTER (330)
#define HEATER_TEMP_CNTRL_S_REGISTER (331)
#define HEATER_TEMP_CNTRL_AMIN_REGISTER (332)
#define HEATER_TEMP_CNTRL_AMAX_REGISTER (333)
#define HEATER_TEMP_CNTRL_IMAX_REGISTER (334)
#define HEATER_PRBS_GENPOLY_REGISTER (335)
#define HEATER_PRBS_AMPLITUDE_REGISTER (336)
#define HEATER_PRBS_MEAN_REGISTER (337)
#define HEATER_CUTOFF_REGISTER (338)
#define CONVERSION_FILTER_HEATER_THERM_CONSTA_REGISTER (339)
#define CONVERSION_FILTER_HEATER_THERM_CONSTB_REGISTER (340)
#define CONVERSION_FILTER_HEATER_THERM_CONSTC_REGISTER (341)
#define FILTER_HEATER_RESISTANCE_REGISTER (342)
#define FILTER_HEATER_TEMPERATURE_REGISTER (343)
#define FILTER_HEATER_THERMISTOR_SERIES_RESISTANCE_REGISTER (344)
#define FILTER_HEATER_REGISTER (345)
#define FILTER_HEATER_MANUAL_REGISTER (346)
#define FILTER_HEATER_TEMP_CNTRL_STATE_REGISTER (347)
#define FILTER_HEATER_TEMP_CNTRL_SETPOINT_REGISTER (348)
#define FILTER_HEATER_TEMP_CNTRL_USER_SETPOINT_REGISTER (349)
#define FILTER_HEATER_TEMP_CNTRL_TOLERANCE_REGISTER (350)
#define FILTER_HEATER_TEMP_CNTRL_SWEEP_MAX_REGISTER (351)
#define FILTER_HEATER_TEMP_CNTRL_SWEEP_MIN_REGISTER (352)
#define FILTER_HEATER_TEMP_CNTRL_SWEEP_INCR_REGISTER (353)
#define FILTER_HEATER_TEMP_CNTRL_H_REGISTER (354)
#define FILTER_HEATER_TEMP_CNTRL_K_REGISTER (355)
#define FILTER_HEATER_TEMP_CNTRL_TI_REGISTER (356)
#define FILTER_HEATER_TEMP_CNTRL_TD_REGISTER (357)
#define FILTER_HEATER_TEMP_CNTRL_B_REGISTER (358)
#define FILTER_HEATER_TEMP_CNTRL_C_REGISTER (359)
#define FILTER_HEATER_TEMP_CNTRL_N_REGISTER (360)
#define FILTER_HEATER_TEMP_CNTRL_S_REGISTER (361)
#define FILTER_HEATER_TEMP_CNTRL_FFWD_REGISTER (362)
#define FILTER_HEATER_TEMP_CNTRL_AMIN_REGISTER (363)
#define FILTER_HEATER_TEMP_CNTRL_AMAX_REGISTER (364)
#define FILTER_HEATER_TEMP_CNTRL_IMAX_REGISTER (365)
#define FILTER_HEATER_PRBS_GENPOLY_REGISTER (366)
#define FILTER_HEATER_PRBS_AMPLITUDE_REGISTER (367)
#define FILTER_HEATER_PRBS_MEAN_REGISTER (368)
#define FILTER_HEATER_MONITOR_REGISTER (369)
#define CAVITY_PRESSURE_ADC_REGISTER (370)
#define CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER (371)
#define CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER (372)
#define CAVITY_PRESSURE_REGISTER (373)
#define AMBIENT_PRESSURE_ADC_REGISTER (374)
#define CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER (375)
#define CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER (376)
#define AMBIENT_PRESSURE_REGISTER (377)
#define CAVITY2_PRESSURE_ADC_REGISTER (378)
#define CONVERSION_CAVITY2_PRESSURE_SCALING_REGISTER (379)
#define CONVERSION_CAVITY2_PRESSURE_OFFSET_REGISTER (380)
#define CAVITY2_PRESSURE_REGISTER (381)
#define AMBIENT2_PRESSURE_ADC_REGISTER (382)
#define CONVERSION_AMBIENT2_PRESSURE_SCALING_REGISTER (383)
#define CONVERSION_AMBIENT2_PRESSURE_OFFSET_REGISTER (384)
#define AMBIENT2_PRESSURE_REGISTER (385)
#define ANALYZER_TUNING_MODE_REGISTER (386)
#define TUNER_SWEEP_RAMP_HIGH_REGISTER (387)
#define TUNER_SWEEP_RAMP_LOW_REGISTER (388)
#define TUNER_WINDOW_RAMP_HIGH_REGISTER (389)
#define TUNER_WINDOW_RAMP_LOW_REGISTER (390)
#define TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER (391)
#define TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER (392)
#define TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER (393)
#define TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER (394)
#define TUNER_DITHER_MEDIAN_COUNT_REGISTER (395)
#define RDFITTER_MINLOSS_REGISTER (396)
#define RDFITTER_MAXLOSS_REGISTER (397)
#define RDFITTER_LATEST_LOSS_REGISTER (398)
#define RDFITTER_IMPROVEMENT_STEPS_REGISTER (399)
#define RDFITTER_START_SAMPLE_REGISTER (400)
#define RDFITTER_FRACTIONAL_THRESHOLD_REGISTER (401)
#define RDFITTER_ABSOLUTE_THRESHOLD_REGISTER (402)
#define RDFITTER_NUMBER_OF_POINTS_REGISTER (403)
#define RDFITTER_MAX_E_FOLDINGS_REGISTER (404)
#define RDFITTER_META_BACKOFF_REGISTER (405)
#define RDFITTER_META_SAMPLES_REGISTER (406)
#define SPECT_CNTRL_STATE_REGISTER (407)
#define SPECT_CNTRL_MODE_REGISTER (408)
#define SPECT_CNTRL_ACTIVE_SCHEME_REGISTER (409)
#define SPECT_CNTRL_NEXT_SCHEME_REGISTER (410)
#define SPECT_CNTRL_SCHEME_ITER_REGISTER (411)
#define SPECT_CNTRL_SCHEME_ROW_REGISTER (412)
#define SPECT_CNTRL_DWELL_COUNT_REGISTER (413)
#define SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER (414)
#define SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER (415)
#define SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER (416)
#define VIRTUAL_LASER_REGISTER (417)
#define PZT_INCR_PER_CAVITY_FSR (418)
#define PZT_OFFSET_UPDATE_FACTOR (419)
#define PZT_OFFSET_VIRTUAL_LASER1 (420)
#define PZT_OFFSET_VIRTUAL_LASER2 (421)
#define PZT_OFFSET_VIRTUAL_LASER3 (422)
#define PZT_OFFSET_VIRTUAL_LASER4 (423)
#define PZT_OFFSET_VIRTUAL_LASER5 (424)
#define PZT_OFFSET_VIRTUAL_LASER6 (425)
#define PZT_OFFSET_VIRTUAL_LASER7 (426)
#define PZT_OFFSET_VIRTUAL_LASER8 (427)
#define SCHEME_OFFSET_VIRTUAL_LASER1 (428)
#define SCHEME_OFFSET_VIRTUAL_LASER2 (429)
#define SCHEME_OFFSET_VIRTUAL_LASER3 (430)
#define SCHEME_OFFSET_VIRTUAL_LASER4 (431)
#define SCHEME_OFFSET_VIRTUAL_LASER5 (432)
#define SCHEME_OFFSET_VIRTUAL_LASER6 (433)
#define SCHEME_OFFSET_VIRTUAL_LASER7 (434)
#define SCHEME_OFFSET_VIRTUAL_LASER8 (435)
#define VALVE_CNTRL_STATE_REGISTER (436)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (437)
#define VALVE_CNTRL_USER_INLET_VALVE_REGISTER (438)
#define VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER (439)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (440)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (441)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (442)
#define VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER (443)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (444)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (445)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (446)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (447)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (448)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (449)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (450)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (451)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (452)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (453)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (454)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (455)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (456)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (457)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (458)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (459)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (460)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (461)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (462)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (463)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (464)
#define VALVE_CNTRL_MPV_POSITION_REGISTER (465)
#define TEC_CNTRL_REGISTER (466)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (467)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (468)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (469)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (470)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (471)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (472)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (473)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (474)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (475)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (476)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (477)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (478)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (479)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (480)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (481)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (482)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (483)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (484)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (485)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (486)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (487)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (488)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (489)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (490)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (491)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (492)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (493)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (494)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (495)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (496)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (497)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (498)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (499)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (500)
#define SENTRY_FILTER_HEATER_TEMPERATURE_MIN_REGISTER (501)
#define SENTRY_FILTER_HEATER_TEMPERATURE_MAX_REGISTER (502)
#define FAN_CNTRL_STATE_REGISTER (503)
#define FAN_CNTRL_TEMPERATURE_REGISTER (504)
#define KEEP_ALIVE_REGISTER (505)
#define LOSS_BUFFER_0_REGISTER (506)
#define LOSS_BUFFER_1_REGISTER (507)
#define LOSS_BUFFER_2_REGISTER (508)
#define LOSS_BUFFER_3_REGISTER (509)
#define LOSS_BUFFER_4_REGISTER (510)
#define LOSS_BUFFER_5_REGISTER (511)
#define LOSS_BUFFER_6_REGISTER (512)
#define LOSS_BUFFER_7_REGISTER (513)
#define PROCESSED_LOSS_1_REGISTER (514)
#define PROCESSED_LOSS_2_REGISTER (515)
#define PROCESSED_LOSS_3_REGISTER (516)
#define PROCESSED_LOSS_4_REGISTER (517)
#define PEAK_DETECT_CNTRL_STATE_REGISTER (518)
#define PEAK_DETECT_CNTRL_BACKGROUND_SAMPLES_REGISTER (519)
#define PEAK_DETECT_CNTRL_BACKGROUND_REGISTER (520)
#define PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER (521)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER (522)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER (523)
#define PEAK_DETECT_CNTRL_THRESHOLD_FACTOR_REGISTER (524)
#define PEAK_DETECT_CNTRL_ACTIVE_SIZE_REGISTER (525)
#define PEAK_DETECT_CNTRL_POST_PEAK_SAMPLES_REGISTER (526)
#define PEAK_DETECT_CNTRL_CANCELLING_SAMPLES_REGISTER (527)
#define PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER (528)
#define PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER (529)
#define PEAK_DETECT_CNTRL_TRIGGERED_DURATION_REGISTER (530)
#define PEAK_DETECT_CNTRL_TRANSITIONING_DURATION_REGISTER (531)
#define PEAK_DETECT_CNTRL_TRANSITIONING_HOLDOFF_REGISTER (532)
#define PEAK_DETECT_CNTRL_HOLDING_MAX_LOSS_REGISTER (533)
#define PEAK_DETECT_CNTRL_HOLDING_DURATION_REGISTER (534)
#define PEAK_DETECT_CNTRL_PRIMING_DURATION_REGISTER (535)
#define PEAK_DETECT_CNTRL_PURGING_DURATION_REGISTER (536)
#define PEAK_DETECT_CNTRL_REMAINING_SAMPLES_REGISTER (537)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (538)
#define PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER (539)
#define PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER (540)
#define PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER (541)
#define PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER (542)
#define PEAK_DETECT_CNTRL_HOLDING_VALVE_MASK_AND_VALUE_REGISTER (543)
#define PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER (544)
#define PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER (545)
#define PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER (546)
#define PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER (547)
#define PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER (548)
#define FLOW1_REGISTER (549)
#define CONVERSION_FLOW1_SCALE_REGISTER (550)
#define CONVERSION_FLOW1_OFFSET_REGISTER (551)
#define RDD_BALANCE_REGISTER (552)
#define RDD_GAIN_REGISTER (553)
#define FLOW_CNTRL_STATE_REGISTER (554)
#define FLOW_CNTRL_SETPOINT_REGISTER (555)
#define FLOW_CNTRL_GAIN_REGISTER (556)
#define FLOW_0_SETPOINT_REGISTER (557)
#define FLOW_1_SETPOINT_REGISTER (558)
#define FLOW_2_SETPOINT_REGISTER (559)
#define FLOW_3_SETPOINT_REGISTER (560)
#define BATTERY_MONITOR_STATUS_REGISTER (561)
#define BATTERY_MONITOR_CHARGE_REGISTER (562)
#define BATTERY_MONITOR_VOLTAGE_REGISTER (563)
#define BATTERY_MONITOR_CURRENT_REGISTER (564)
#define BATTERY_MONITOR_TEMPERATURE_REGISTER (565)
#define ACCELEROMETER_X_REGISTER (566)
#define ACCELEROMETER_Y_REGISTER (567)
#define ACCELEROMETER_Z_REGISTER (568)
