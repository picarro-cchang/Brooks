...
#define INTERFACE_NUMBER_OF_REGISTERS (677)
...
#define SGDBR_C_CNTRL_STATE_REGISTER (631)
#define SGDBR_C_CNTRL_FRONT_MIRROR_REGISTER (632)
#define SGDBR_C_CNTRL_BACK_MIRROR_REGISTER (633)
#define SGDBR_C_CNTRL_GAIN_REGISTER (634)
#define SGDBR_C_CNTRL_SOA_REGISTER (635)
#define SGDBR_C_CNTRL_COARSE_PHASE_REGISTER (636)
#define SGDBR_C_CNTRL_FINE_PHASE_REGISTER (637)
#define SGDBR_C_CNTRL_CHIRP_REGISTER (638)
#define SGDBR_C_CNTRL_SPARE_DAC_REGISTER (639)
#define SGDBR_C_CNTRL_RD_CONFIG_REGISTER (640)
#define SGDBR_C_CNTRL_PULSE_FRONT_STEP_REGISTER (641)
#define SGDBR_C_CNTRL_PULSE_BACK_STEP_REGISTER (642)
#define SGDBR_C_CNTRL_PULSE_PHASE_STEP_REGISTER (643)
#define SGDBR_C_CNTRL_PULSE_SOA_STEP_REGISTER (644)
#define SGDBR_C_CNTRL_PULSE_SEMI_PERIOD_REGISTER (645)
#define SGDBR_C_CNTRL_PULSE_TEMP_AMPLITUDE_REGISTER (646)
#define SGDBR_C_CNTRL_PULSE_TEMP_PEAK_TO_PEAK_REGISTER (647)
#define SGDBR_C_CNTRL_FRONT_TO_SOA_COEFF_REGISTER (648)
#define SGDBR_C_CNTRL_BACK_TO_SOA_COEFF_REGISTER (649)
#define SGDBR_C_CNTRL_PHASE_TO_SOA_COEFF_REGISTER (650)
#define SGDBR_C_CNTRL_MIRROR_DEAD_ZONE_REGISTER (651)
#define SGDBR_C_CNTRL_MINIMUM_SOA_REGISTER (652)
#define SGDBR_D_CNTRL_STATE_REGISTER (653)
#define SGDBR_D_CNTRL_FRONT_MIRROR_REGISTER (654)
#define SGDBR_D_CNTRL_BACK_MIRROR_REGISTER (655)
#define SGDBR_D_CNTRL_GAIN_REGISTER (656)
#define SGDBR_D_CNTRL_SOA_REGISTER (657)
#define SGDBR_D_CNTRL_COARSE_PHASE_REGISTER (658)
#define SGDBR_D_CNTRL_FINE_PHASE_REGISTER (659)
#define SGDBR_D_CNTRL_CHIRP_REGISTER (660)
#define SGDBR_D_CNTRL_SPARE_DAC_REGISTER (661)
#define SGDBR_D_CNTRL_RD_CONFIG_REGISTER (662)
#define SGDBR_D_CNTRL_PULSE_FRONT_STEP_REGISTER (663)
#define SGDBR_D_CNTRL_PULSE_BACK_STEP_REGISTER (664)
#define SGDBR_D_CNTRL_PULSE_PHASE_STEP_REGISTER (665)
#define SGDBR_D_CNTRL_PULSE_SOA_STEP_REGISTER (666)
#define SGDBR_D_CNTRL_PULSE_SEMI_PERIOD_REGISTER (667)
#define SGDBR_D_CNTRL_PULSE_TEMP_AMPLITUDE_REGISTER (668)
#define SGDBR_D_CNTRL_PULSE_TEMP_PEAK_TO_PEAK_REGISTER (669)
#define SGDBR_D_CNTRL_FRONT_TO_SOA_COEFF_REGISTER (670)
#define SGDBR_D_CNTRL_BACK_TO_SOA_COEFF_REGISTER (671)
#define SGDBR_D_CNTRL_PHASE_TO_SOA_COEFF_REGISTER (672)
#define SGDBR_D_CNTRL_MIRROR_DEAD_ZONE_REGISTER (673)
#define SGDBR_D_CNTRL_MINIMUM_SOA_REGISTER (674)
#define PZT_UPDATE_MODE_REGISTER (675)
#define SGDBR_FILTER_BY_TRAJECTORY_REGISTER (676)
