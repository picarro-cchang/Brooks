...
#define VALVE_CNTRL_STATE_REGISTER (437)
#define VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER (438)
#define VALVE_CNTRL_USER_INLET_VALVE_REGISTER (439)
#define VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER (440)
#define VALVE_CNTRL_INLET_VALVE_REGISTER (441)
#define VALVE_CNTRL_OUTLET_VALVE_REGISTER (442)
#define VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER (443)
#define VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER (444)
#define VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER (445)
#define VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER (446)
#define VALVE_CNTRL_INLET_VALVE_MIN_REGISTER (447)
#define VALVE_CNTRL_INLET_VALVE_MAX_REGISTER (448)
#define VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER (449)
#define VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER (450)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER (451)
#define VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER (452)
#define VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER (453)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER (454)
#define VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER (455)
#define VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER (456)
#define VALVE_CNTRL_THRESHOLD_STATE_REGISTER (457)
#define VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER (458)
#define VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER (459)
#define VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER (460)
#define VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER (461)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER (462)
#define VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER (463)
#define VALVE_CNTRL_SEQUENCE_STEP_REGISTER (464)
#define VALVE_CNTRL_SOLENOID_VALVES_REGISTER (465)
#define VALVE_CNTRL_MPV_POSITION_REGISTER (466)
#define TEC_CNTRL_REGISTER (467)
#define SENTRY_UPPER_LIMIT_TRIPPED_REGISTER (468)
#define SENTRY_LOWER_LIMIT_TRIPPED_REGISTER (469)
#define SENTRY_LASER1_TEMPERATURE_MIN_REGISTER (470)
#define SENTRY_LASER1_TEMPERATURE_MAX_REGISTER (471)
#define SENTRY_LASER2_TEMPERATURE_MIN_REGISTER (472)
#define SENTRY_LASER2_TEMPERATURE_MAX_REGISTER (473)
#define SENTRY_LASER3_TEMPERATURE_MIN_REGISTER (474)
#define SENTRY_LASER3_TEMPERATURE_MAX_REGISTER (475)
#define SENTRY_LASER4_TEMPERATURE_MIN_REGISTER (476)
#define SENTRY_LASER4_TEMPERATURE_MAX_REGISTER (477)
#define SENTRY_ETALON_TEMPERATURE_MIN_REGISTER (478)
#define SENTRY_ETALON_TEMPERATURE_MAX_REGISTER (479)
#define SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER (480)
#define SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER (481)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (482)
#define SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (483)
#define SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER (484)
#define SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER (485)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER (486)
#define SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER (487)
#define SENTRY_DAS_TEMPERATURE_MIN_REGISTER (488)
#define SENTRY_DAS_TEMPERATURE_MAX_REGISTER (489)
#define SENTRY_LASER1_CURRENT_MIN_REGISTER (490)
#define SENTRY_LASER1_CURRENT_MAX_REGISTER (491)
#define SENTRY_LASER2_CURRENT_MIN_REGISTER (492)
#define SENTRY_LASER2_CURRENT_MAX_REGISTER (493)
#define SENTRY_LASER3_CURRENT_MIN_REGISTER (494)
#define SENTRY_LASER3_CURRENT_MAX_REGISTER (495)
#define SENTRY_LASER4_CURRENT_MIN_REGISTER (496)
#define SENTRY_LASER4_CURRENT_MAX_REGISTER (497)
#define SENTRY_CAVITY_PRESSURE_MIN_REGISTER (498)
#define SENTRY_CAVITY_PRESSURE_MAX_REGISTER (499)
#define SENTRY_AMBIENT_PRESSURE_MIN_REGISTER (500)
#define SENTRY_AMBIENT_PRESSURE_MAX_REGISTER (501)
#define SENTRY_FILTER_HEATER_TEMPERATURE_MIN_REGISTER (502)
#define SENTRY_FILTER_HEATER_TEMPERATURE_MAX_REGISTER (503)
#define FAN_CNTRL_STATE_REGISTER (504)
#define FAN_CNTRL_TEMPERATURE_REGISTER (505)
#define KEEP_ALIVE_REGISTER (506)
#define LOSS_BUFFER_0_REGISTER (507)
#define LOSS_BUFFER_1_REGISTER (508)
#define LOSS_BUFFER_2_REGISTER (509)
#define LOSS_BUFFER_3_REGISTER (510)
#define LOSS_BUFFER_4_REGISTER (511)
#define LOSS_BUFFER_5_REGISTER (512)
#define LOSS_BUFFER_6_REGISTER (513)
#define LOSS_BUFFER_7_REGISTER (514)
#define PROCESSED_LOSS_1_REGISTER (515)
#define PROCESSED_LOSS_2_REGISTER (516)
#define PROCESSED_LOSS_3_REGISTER (517)
#define PROCESSED_LOSS_4_REGISTER (518)
#define PEAK_DETECT_CNTRL_STATE_REGISTER (519)
#define PEAK_DETECT_CNTRL_BACKGROUND_SAMPLES_REGISTER (520)
#define PEAK_DETECT_CNTRL_BACKGROUND_REGISTER (521)
#define PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER (522)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER (523)
#define PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER (524)
#define PEAK_DETECT_CNTRL_THRESHOLD_FACTOR_REGISTER (525)
#define PEAK_DETECT_CNTRL_ACTIVE_SIZE_REGISTER (526)
#define PEAK_DETECT_CNTRL_POST_PEAK_SAMPLES_REGISTER (527)
#define PEAK_DETECT_CNTRL_CANCELLING_SAMPLES_REGISTER (528)
#define PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER (529)
#define PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER (530)
#define PEAK_DETECT_CNTRL_TRIGGERED_DURATION_REGISTER (531)
#define PEAK_DETECT_CNTRL_TRANSITIONING_DURATION_REGISTER (532)
#define PEAK_DETECT_CNTRL_TRANSITIONING_HOLDOFF_REGISTER (533)
#define PEAK_DETECT_CNTRL_HOLDING_MAX_LOSS_REGISTER (534)
#define PEAK_DETECT_CNTRL_HOLDING_DURATION_REGISTER (535)
#define PEAK_DETECT_CNTRL_PRIMING_DURATION_REGISTER (536)
#define PEAK_DETECT_CNTRL_PURGING_DURATION_REGISTER (537)
#define PEAK_DETECT_CNTRL_REMAINING_SAMPLES_REGISTER (538)
#define PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER (539)
#define PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER (540)
#define PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER (541)
#define PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER (542)
#define PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER (543)
#define PEAK_DETECT_CNTRL_HOLDING_VALVE_MASK_AND_VALUE_REGISTER (544)
#define PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER (545)
#define PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER (546)
#define PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER (547)
#define PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER (548)
#define PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER (549)
#define FLOW1_REGISTER (550)
#define CONVERSION_FLOW1_SCALE_REGISTER (551)
#define CONVERSION_FLOW1_OFFSET_REGISTER (552)
#define RDD_BALANCE_REGISTER (553)
#define RDD_GAIN_REGISTER (554)
#define FLOW_CNTRL_STATE_REGISTER (555)
#define FLOW_CNTRL_SETPOINT_REGISTER (556)
#define FLOW_CNTRL_GAIN_REGISTER (557)
#define FLOW_0_SETPOINT_REGISTER (558)
#define FLOW_1_SETPOINT_REGISTER (559)
#define FLOW_2_SETPOINT_REGISTER (560)
#define FLOW_3_SETPOINT_REGISTER (561)
#define BATTERY_MONITOR_STATUS_REGISTER (562)
#define BATTERY_MONITOR_CHARGE_REGISTER (563)
#define BATTERY_MONITOR_VOLTAGE_REGISTER (564)
#define BATTERY_MONITOR_CURRENT_REGISTER (565)
#define BATTERY_MONITOR_TEMPERATURE_REGISTER (566)
