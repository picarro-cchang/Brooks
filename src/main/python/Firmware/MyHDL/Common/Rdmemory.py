...
def Rdmemory(clk, reset, dsp_addr, dsp_data_out, dsp_data_in, dsp_wr, bank,
             data_addr, data, wr_data, data_we, meta_addr, meta, wr_meta,
             meta_we, param_addr, param, wr_param, param_we):
    ...
    data_mem = DualPortRamRw(clockA=clk,
                             enableA=enA_data,
                             wr_enableA=wr_enable,
                             addressA=data_addrA,
                             rd_dataA=rd_dataA,
                             wr_dataA=wr_dataA,
                             clockB=clk,
    ...
    meta_mem = DualPortRamRw(clockA=clk,
                             enableA=enA_meta,
                             wr_enableA=wr_enable,
                             addressA=meta_addrA,
                             rd_dataA=rd_metaA,
    ...
    param_mem = DualPortRamRw(clockA=clk,
                              enableA=enA_param,
                              wr_enableA=wr_enable,
                              addressA=param_addrA,
                              rd_dataA=rd_paramA,
                              wr_dataA=wr_paramA,
                              clockB=clk,
                              enableB=enB_param,
                              wr_enableB=param_we,
                              addressB=param_addrB,
                              rd_dataB=param,
                              wr_dataB=wr_param,
    ...
    def comb():
        ...
        sel_data_and_metadata = dsp_addr[:
                                         RDMEM_RESERVED_BANK_ADDR_WIDTH] == 6 or dsp_addr[:
                                                                                          RDMEM_RESERVED_BANK_ADDR_WIDTH] == 2
        wr_enable.next = dsp_wr and not sel_data_and_metadata

        enB_data.next = 1
        sel_data = dsp_addr[:
                            RDMEM_RESERVED_BANK_ADDR_WIDTH] == 4 or dsp_addr[:
        ...
        enB_meta.next = 1
        sel_meta = dsp_addr[:
                            RDMEM_RESERVED_BANK_ADDR_WIDTH] == 5 or dsp_addr[:
        ...
        enB_param.next = 1
        sel_param = dsp_addr[:
                             RDMEM_RESERVED_BANK_ADDR_WIDTH] == 7 or dsp_addr[:
        ...
        if sel_data_and_metadata:
            ...
            dsp_data_in.next[EMIF_DATA_WIDTH:
                             FPGA_REG_WIDTH] = rd_metaA[FPGA_REG_WIDTH:]
        elif sel_data:
