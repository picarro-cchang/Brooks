...
from Host.autogen.interface import (
    SGDBRMANAGER_CONFIG_MODE_B,
    SGDBRMANAGER_CONFIG_MODE_W,
)
from Host.autogen.interface import (
    SGDBRMANAGER_CONFIG_SELECT_B,
    SGDBRMANAGER_CONFIG_SELECT_W,
)
from Host.autogen.interface import (
    SGDBRMANAGER_SGDBR_PRESENT_SGDBR_A_PRESENT_B,
    SGDBRMANAGER_SGDBR_PRESENT_SGDBR_A_PRESENT_W,
)
from Host.autogen.interface import (
    SGDBRMANAGER_SGDBR_PRESENT_SGDBR_B_PRESENT_B,
    SGDBRMANAGER_SGDBR_PRESENT_SGDBR_B_PRESENT_W,
)
