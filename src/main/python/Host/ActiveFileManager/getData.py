...
class ActiveFileManagerProxy(SharedTypes.Singleton):
    ...
    def __init__(self):
        if not self.initialized:
            ...
            serverURI = "http://%s:%d" % (self.hostaddr, SharedTypes.RPC_PORT_ACTIVE_FILE_MANAGER)
...
if __name__ == "__main__":
    ...
    result = AFM.getDmData('pressure_cal_mode', 'analyze_PressureCal', now + 10000, now + 20000,
                           ['unixTime', 'y_parameter', 'cavity_pressure'])
