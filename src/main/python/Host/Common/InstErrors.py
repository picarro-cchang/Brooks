...
error_info.append(
    ErrorInfo(SHUTDOWN_INST, "INST_ERROR_INVALID_SAMPLE_MGR_MODE", "Invalid Sample Manager mode", RPC_PORT_INSTR_MANAGER))
INST_ERROR_INVALID_MEAS_SYS_MODE = -2
error_info.append(
    ErrorInfo(SHUTDOWN_INST, "INST_ERROR_INVALID_MEAS_SYS_MODE", "Invalid Measurement System mode", RPC_PORT_INSTR_MANAGER))
...
error_info.append(ErrorInfo(SHUTDOWN_INST, "INST_ERROR_BAD_CALIBRATION_FILE", "Calibration file is invalid",
                            RPC_PORT_INSTR_MANAGER))
INST_ERROR_CAVITY_TEMP_CONTROL_ENABLE_FAILED = -6
error_info.append(
    ErrorInfo(RESTART_INST, "INST_ERROR_CAVITY_TEMP_CONTROL_ENABLE_FAILED", "Cavity Temperature Control Enable failed",
              RPC_PORT_INSTR_MANAGER))
INST_ERROR_WARM_CHAMBER_TEMP_CONTROL_ENABLE_FAILED = -7
error_info.append(
    ErrorInfo(RESTART_INST, "INST_ERROR_WARM_CHAMBER_TEMP_CONTROL_ENABLE_FAILED", "Warm Chamber Temperature Control Enable failed",
              RPC_PORT_INSTR_MANAGER))
INST_ERROR_LASER_TEMP_CONTROL_ENABLE_FAILED = -8
error_info.append(
    ErrorInfo(RESTART_INST, "INST_ERROR_LASER_TEMP_CONTROL_ENABLE_FAILED", "Laser Temperature Control Enable failed",
              RPC_PORT_INSTR_MANAGER))
INST_ERROR_HEATER_CONTROL_ENABLE_FAILED = -9
error_info.append(
    ErrorInfo(RESTART_INST, "INST_ERROR_HEATER_CONTROL_ENABLE_FAILED", "Heater Control Enable failed", RPC_PORT_INSTR_MANAGER))
INST_ERROR_LASER_I_CONTROL_ENABLE_FAILED = -10
error_info.append(
    ErrorInfo(RESTART_INST, "INST_ERROR_LASER_I_CONTROL_ENABLE_FAILED", "Laser Current Control Enable failed",
              RPC_PORT_INSTR_MANAGER))
...
error_info.append(
    ErrorInfo(SHUTDOWN_INST, "INST_ERROR_TEMP_LOCK_TIMEOUT", "Temperature Lock Timeout occurred", RPC_PORT_INSTR_MANAGER))
INST_ERROR_PRESSURE_LOCK_TIMEOUT = -14
error_info.append(
    ErrorInfo(SHUTDOWN_INST, "INST_ERROR_PRESSURE_LOCK_TIMEOUT", "Pressure Lock Timeout occurred", RPC_PORT_INSTR_MANAGER))
