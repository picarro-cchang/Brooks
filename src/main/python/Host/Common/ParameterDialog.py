...
if __name__ == "__main__":
    ...
    myRegValues = {
        RDCNTRL_ETALON_DARK_READING1_REGISTER: 200,
    ...
    p = []
    p.append(('dsp', 'choices', RDCNTRL_CMD_REGISTER, 'Set ringdown mode', None, [
        (RDCNTRL_Disable, 'Disable ringdowns'),
        (RDCNTRL_EnableClt, 'Enable ringdowns with laser wavelength locking'),
        (RDCNTRL_EnableWt, 'Enable ringdowns without laser wavelength locking'),
        (RDCNTRL_EnterOsc, 'Enable oscilloscope mode'),
        (RDCNTRL_EnterManual, 'Enter manual mode'),
    ], 0, 1))
    ...
    bitfields = [(RDCNTRL_AutoRdwnEnableMask, "Ringdown sequencer", [(0, "Manual"), (RDCNTRL_AutoRdwnEnableMask, "Automatic")]),
                 (RDCNTRL_CavityLengthTuningMask, "Laser wavelength locking", [(0, "Disabled"),
                                                                               (RDCNTRL_CavityLengthTuningMask, "Enabled")]),
                 (RDCNTRL_WaveLengthTuningMask, "Wait for wavelength locking", [(0, "Enabled"),
                                                                                (RDCNTRL_WaveLengthTuningMask, "Bypass")]),
                 (RDCNTRL_ForceAbortMask, "Abort ringdown cycle", [(0, "Disabled"), (RDCNTRL_ForceAbortMask, "Abort")]),
                 (RDCNTRL_TunerUpSlopeEnableMask, "Allow ringdowns on positive slope", [(0, "No"),
                                                                                        (RDCNTRL_TunerUpSlopeEnableMask, "Yes")]),
                 (RDCNTRL_TunerDownSlopeEnableMask, "Allow ringdowns on negative slope", [(0, "No"),
                                                                                          (RDCNTRL_TunerDownSlopeEnableMask, "Yes")
                                                                                          ])]
