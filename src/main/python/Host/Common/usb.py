...
class usb_string_descriptor(Structure):
    _fields_ = [("bLength", c_ubyte), ("bDescriptorType", c_ubyte), ("wData", c_ushort * 1)]


# HID descriptor
class usb_hid_descriptor(Structure):
    _fields_ = [("bLength", c_ubyte), ("bDescriptorType", c_ubyte), ("bcdHID", c_ushort), ("bCountryCode", c_ubyte),
...
class usb_endpoint_descriptor(Structure):
    _fields_ = [("bLength", c_ubyte), ("bDescriptorType", c_ubyte), ("bEndpointAddress", c_ubyte), ("bmAttributes", c_ubyte),
                ("wMaxPacketSize", c_ushort), ("bInterval", c_ubyte), ("bRefresh", c_ubyte), ("bSynchAddress", c_ubyte),
                ("extra", c_char_p), ("extralen", c_int)]
...
class usb_interface_descriptor(Structure):
    _fields_ = [("bLength", c_ubyte), ("bDescriptorType", c_ubyte), ("bInterfaceNumber", c_ubyte), ("bAlternateSetting", c_ubyte),
                ("bNumEndpoints", c_ubyte), ("bInterfaceClass", c_ubyte), ("bInterfaceSubClass", c_ubyte),
                ("bInterfaceProtocol", c_ubyte), ("iInterface", c_ubyte), ("endpoint", POINTER(usb_endpoint_descriptor)),
                ("extra", c_char_p), ("extralen", c_int)]
...
class usb_interface(Structure):
    _fields_ = [("altsetting", POINTER(usb_interface_descriptor)), ("num_altsetting", c_int)]
...
class usb_config_descriptor(Structure):
    _fields_ = [("bLength", c_ubyte), ("bDescriptorType", c_ubyte), ("wTotalLength", c_ushort), ("bNumInterfaces", c_ubyte),
                ("bConfigurationValue", c_ubyte), ("iConfiguration", c_ubyte), ("bmAttributes", c_ubyte), ("MaxPower", c_ubyte),
                ("interface", usb_interface), ("extra", c_char_p), ("extralen", c_int)]
...
class usb_device_descriptor(Structure):
    _fields_ = [("bLength", c_ubyte), ("bDescriptorType", c_ubyte), ("bcdUSB", c_ushort), ("bDeviceClass", c_ubyte),
                ("bDeviceSubClass", c_ubyte), ("bDeviceProtocol", c_ubyte), ("bMaxPacketSize0", c_ubyte), ("idVendor", c_ushort),
                ("idProduct", c_ushort), ("bcdDevice", c_ushort), ("iManufacturer", c_ubyte), ("iProduct", c_ubyte),
                ("iSerialNumber", c_ubyte), ("bNumConfigurations", c_ubyte)]


class usb_ctrl_setup(Structure):
    _fields_ = [("bRequestType", c_ubyte), ("bRequest", c_ubyte), ("wValue", c_ushort), ("wIndex", c_ushort), ("wLength", c_ushort)]
...
usb_device._fields_ = [("next", POINTER(usb_device)), ("prev", POINTER(usb_device)), ("filename", c_char * LIBUSB_PATH_MAX),
                       ("bus", POINTER(usb_bus)), ("descriptor", usb_device_descriptor), ("config", POINTER(usb_config_descriptor)),
                       ("dev", c_void_p), ("devnum", c_ubyte), ("num_children", c_ubyte),
                       ("children", POINTER(POINTER(usb_device)))]

usb_bus._fields_ = [("next", POINTER(usb_bus)), ("prev", POINTER(usb_bus)), ("dirname", c_char * LIBUSB_PATH_MAX),
                    ("devices", POINTER(usb_device)), ("location", c_ulong), ("root_dev", POINTER(usb_device))]
