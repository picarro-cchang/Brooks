...
class HotBoxPanelGui(wx.Panel):
    ...
    def __do_layout(self):
        ...
        sizer_3_copy2 = wx.BoxSizer(wx.VERTICAL)
        sizer_3 = wx.BoxSizer(wx.VERTICAL)
        sizer_1.Add(self.temperatureGraph, 1, wx.EXPAND, 0)
        sizer_1.Add(self.tecGraph, 1, wx.EXPAND, 0)
        ...
        sizer_3_copy2.Add(self.cavity2TemperatureCheckbox_1, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_3_copy2.Add(self.cavity2TemperatureCheckbox_2, 0, wx.BOTTOM | wx.FIXED_MINSIZE | wx.LEFT | wx.TOP, 5)
        sizer_3_copy2.Add(self.cavity2TemperatureCheckbox_3, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_3_copy2.Add(self.cavity2TemperatureCheckbox_4, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_2.Add(sizer_3_copy, 1, 0, 0)
        sizer_2.Add(sizer_3_copy2, 1, 0, 0)
        self.panel_1.SetSizer(sizer_2)
...
class PressurePanelGui(wx.Panel):
    ...
    def __do_layout(self):
        ...
        sizer_3_copy.Add(self.ambient2PressureCheckbox, 0, wx.ALIGN_CENTER_VERTICAL | wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_3_copy.Add(self.cavity2PressureCheckbox, 0, wx.ALIGN_CENTER_VERTICAL | wx.BOTTOM | wx.LEFT | wx.TOP, 5)
