#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Wed Jun 27 17:04:12 2012
...
class ProcessedLossPanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = wx.TAB_TRAVERSAL
        wx.Panel.__init__(self, *args, **kwds)
        self.processedLossGraph = GraphPanel(self, -1)
        self.panel_1 = wx.Panel(self, -1)
        self.clearButton = wx.Button(self.panel_1, wx.ID_CLEAR, "")
        self.processedLoss1Checkbox = wx.CheckBox(self.panel_1, -1, "Processed Loss 1")
        self.processedLoss2Checkbox = wx.CheckBox(self.panel_1, -1, "Processed Loss 2")
        self.processedLoss3Checkbox = wx.CheckBox(self.panel_1, -1, "Processed Loss 3")
        self.processedLoss4Checkbox = wx.CheckBox(self.panel_1, -1, "Processed Loss 4")
    ...
    def __do_layout(self):
        ...
        sizer_2.Add(self.clearButton, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 15)
        sizer_3.Add(self.processedLoss1Checkbox, 0, wx.LEFT|wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_3.Add(self.processedLoss2Checkbox, 0, wx.LEFT|wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_3.Add(self.processedLoss3Checkbox, 0, wx.LEFT|wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_3.Add(self.processedLoss4Checkbox, 0, wx.LEFT|wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_2.Add(sizer_3, 0, wx.EXPAND, 0)
        sizer_2.Add((20, 20), 1, wx.EXPAND, 0)
        self.panel_1.SetSizer(sizer_2)
        sizer_1.Add(self.panel_1, 0, wx.EXPAND, 0)
...
class PressurePanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.flowRateCheckbox = wx.CheckBox(self.panel_1, -1, "Flow Rate")
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.flowRateCheckbox, 0, wx.LEFT|wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_2.Add(sizer_3, 0, wx.EXPAND, 0)
