...
# -*- coding: ISO-8859-15 -*-
#
# generated by wxGlade 0.7.1 on Wed Apr 12 18:31:12 2023
#
...
class CommandLogPanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.sizer_11_staticbox = wx.StaticBox(self, wx.ID_ANY, "Log")
...
class HotBoxPanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.panel_1 = wx.Panel(self, wx.ID_ANY)
        self.clearButton = wx.Button(self.panel_1, wx.ID_CLEAR, "")
        self.cavityTemperatureCheckbox = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 1 Temperature")
        self.cavity2TemperatureCheckbox = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 2 Temperature")
        ...
        self.cavityTemperatureCheckbox_1 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 1 temperature 1")
        self.cavityTemperatureCheckbox_2 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 1 temperature 2")
        self.cavityTemperatureCheckbox_3 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 1 temperature 3")
        self.cavityTemperatureCheckbox_4 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 1 temperature 4")
        self.cavity2TemperatureCheckbox_1 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 2 temperature 1")
        self.cavity2TemperatureCheckbox_2 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 2 temperature 2")
        self.cavity2TemperatureCheckbox_3 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 2 temperature 3")
        self.cavity2TemperatureCheckbox_4 = wx.CheckBox(self.panel_1, wx.ID_ANY, "Cavity 2 temperature 4")
    ...
    def __do_layout(self):
        ...
        sizer_4.Add(self.cavityTemperatureCheckbox_1, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_4.Add(self.cavityTemperatureCheckbox_2, 0, wx.BOTTOM | wx.FIXED_MINSIZE | wx.LEFT | wx.TOP, 5)
        sizer_4.Add(self.cavityTemperatureCheckbox_3, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_4.Add(self.cavityTemperatureCheckbox_4, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_2.Add(sizer_4, 1, 0, 0)
        sizer_5.Add(self.cavity2TemperatureCheckbox_1, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_5.Add(self.cavity2TemperatureCheckbox_2, 0, wx.BOTTOM | wx.FIXED_MINSIZE | wx.LEFT | wx.TOP, 5)
        sizer_5.Add(self.cavity2TemperatureCheckbox_3, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
        sizer_5.Add(self.cavity2TemperatureCheckbox_4, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
...
class RingdownPanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.graphTypeRadioBox = wx.RadioBox(self.panel_1, wx.ID_ANY, "Select Graph Type", choices=["Loss vs Wavenumber", "Loss vs Time", "Loss vs Ratio 1", "Loss vs Ratio 2", "Ratio vs Wavenumber", "Tuner vs Wavenumber", "Tuner vs Time", "Tuner vs Ratio 1", "Tuner vs Ratio 2", "PZT vs Wavenumber", "PZT vs Time", "PZT vs Ratio 1", "PZT vs Ratio 2", "Wavenumber vs Time", "IL(fine) vs Wavenumber", "IL(fine) vs Time", "Loss vs IL(fine)", "SGDBR currents vs Wavenumber", "SGDBR currents vs Time", "Wavenumber setpoint diff vs Time", "WlmAngle setpoint diff vs Time", "WlmAngle reference vs Wavenumber", "WlmAngle reference vs Time"], majorDimension=5, style=wx.RA_SPECIFY_ROWS)
...
class StatsPanelGui(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.label_ringdowns = wx.StaticText(self.panel_1, wx.ID_ANY, "Ringdowns")
...
class SoaPanelGui(wx.Panel):
    ...
    def __set_properties(self):
        # begin wxGlade: SoaPanelGui.__set_properties
        pass
        # end wxGlade

    def __do_layout(self):
        # begin wxGlade: SoaPanelGui.__do_layout
        sizer_1 = wx.BoxSizer(wx.VERTICAL)
        sizer_2 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_1.Add(self.temperatureGraph, 1, wx.EXPAND, 0)
