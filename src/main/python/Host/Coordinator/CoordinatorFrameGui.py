...
class CoordinatorFrameGui(wx.Frame):
    def __init__(self, hasSampleDescr, hasSampleNum, useSeptum, hasPause, paramTupleList, numDispParams, *args, **kwds):
        ...
        for idx in range(min(numDispParams, len(paramTupleList))):
            ...
            self.paramTextCtrlList.append(
                wx.TextCtrl(self.panel_1, -1, paramTupleList[idx][2], style=wx.TE_PROCESS_ENTER | wx.TE_CENTRE))
    ...
    def __do_layout(self):
        ...
        for idx in range(len(self.paramLabelList)):
            ...
            sizerParam.Add(self.paramLabelList[idx], 0,
        ...
        if self.hasSampleNum:
            ...
            sizerChangeSampleNum.Add(self.labelChangeSampleNum, 0,
                                     wx.LEFT | wx.RIGHT | wx.TOP | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 10)
