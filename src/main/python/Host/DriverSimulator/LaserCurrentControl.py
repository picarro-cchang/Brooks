...
class Laser1CurrentControl(LaserCurrentControl):
    ...
    manual_coarse = prop_das(interface.LASER1_MANUAL_COARSE_CURRENT_REGISTER)
    manual_fine = prop_das(interface.LASER1_MANUAL_FINE_CURRENT_REGISTER)
    ...
    fpga_coarse = prop_fpga(interface.FPGA_INJECT, interface.INJECT_LASER1_COARSE_CURRENT)
    fpga_fine = prop_fpga(interface.FPGA_INJECT, interface.INJECT_LASER1_FINE_CURRENT)
...
class Laser2CurrentControl(LaserCurrentControl):
    ...
    manual_coarse = prop_das(interface.LASER2_MANUAL_COARSE_CURRENT_REGISTER)
    manual_fine = prop_das(interface.LASER2_MANUAL_FINE_CURRENT_REGISTER)
    ...
    automatic = prop_fpga(interface.FPGA_INJECT, interface.INJECT_CONTROL, interface.INJECT_CONTROL_MODE_B, interface.INJECT_CONTROL_MODE_W)
    fpga_coarse = prop_fpga(interface.FPGA_INJECT, interface.INJECT_LASER2_COARSE_CURRENT)
    fpga_fine = prop_fpga(interface.FPGA_INJECT, interface.INJECT_LASER2_FINE_CURRENT)
...
class Laser3CurrentControl(LaserCurrentControl):
    ...
    manual_coarse = prop_das(interface.LASER3_MANUAL_COARSE_CURRENT_REGISTER)
    manual_fine = prop_das(interface.LASER3_MANUAL_FINE_CURRENT_REGISTER)
    ...
    automatic = prop_fpga(interface.FPGA_INJECT, interface.INJECT_CONTROL, interface.INJECT_CONTROL_MODE_B, interface.INJECT_CONTROL_MODE_W)
    fpga_coarse = prop_fpga(interface.FPGA_INJECT, interface.INJECT_LASER3_COARSE_CURRENT)
    fpga_fine = prop_fpga(interface.FPGA_INJECT, interface.INJECT_LASER3_FINE_CURRENT)
...
class Laser4CurrentControl(LaserCurrentControl):
    ...
    manual_coarse = prop_das(interface.LASER4_MANUAL_COARSE_CURRENT_REGISTER)
    manual_fine = prop_das(interface.LASER4_MANUAL_FINE_CURRENT_REGISTER)
    ...
    automatic = prop_fpga(interface.FPGA_INJECT, interface.INJECT_CONTROL, interface.INJECT_CONTROL_MODE_B, interface.INJECT_CONTROL_MODE_W)
    fpga_coarse = prop_fpga(interface.FPGA_INJECT, interface.INJECT_LASER4_COARSE_CURRENT)
    fpga_fine = prop_fpga(interface.FPGA_INJECT, interface.INJECT_LASER4_FINE_CURRENT)
