...
d.defineFitData(freq=d.groupMeans["waveNumber"],
                ...
                sdev=1 / numpy.sqrt(d.groupSizes))
...
RESULT = {
    ...
    'amp_ripp_3': amp_ripp_3,
    'phase_ripp_1': phase_ripp_1,
    'phase_ripp_2': phase_ripp_2,
    'phase_ripp_3': phase_ripp_3,
    'freq_ripp_1': freq_ripp_1,
    'freq_ripp_2': freq_ripp_2,
    'freq_ripp_3': freq_ripp_3,
    'base0': base0,
    'base1': base1,
    'base3': base3,
    'h2o_spline_amp': h2o_spline_amp,
    'splinemax': splinemax,
    'h2o_ppmv': h2o_ppmv,
