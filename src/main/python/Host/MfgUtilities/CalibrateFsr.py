    ...
    def run(self):
        ...
        try:
            ...
            regVault = Driver.saveRegValues([
                "LASER%d_TEMP_CNTRL_SWEEP_MAX_REGISTER" % aLaserNum,
                ...
                "LASER%d_TEMP_CNTRL_STATE_REGISTER" % aLaserNum, "ANALYZER_TUNING_MODE_REGISTER", "TUNER_SWEEP_RAMP_HIGH_REGISTER",
                "TUNER_SWEEP_RAMP_LOW_REGISTER", "TUNER_WINDOW_RAMP_HIGH_REGISTER", "TUNER_WINDOW_RAMP_LOW_REGISTER",
                ("FPGA_TWGEN", "TWGEN_SLOPE_UP"), ("FPGA_TWGEN", "TWGEN_SLOPE_DOWN"),
                ("FPGA_TWGEN", "TWGEN_CS"), "SPECT_CNTRL_MODE_REGISTER", ("FPGA_RDMAN", "RDMAN_OPTIONS"),
                ("FPGA_INJECT", "INJECT_CONTROL"), "RDFITTER_META_BACKOFF_REGISTER", "RDFITTER_META_SAMPLES_REGISTER",
                "VIRTUAL_LASER_REGISTER", ("FPGA_LASERLOCKER", "LASERLOCKER_OPTIONS"),
