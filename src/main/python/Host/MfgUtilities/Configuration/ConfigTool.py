...
def Log(*a, **k):
    if a[0] not in [
            'Connection by Controller event log listener to port 40010 failed.',
...
Data_analyse_iH2O_Keys = [
    'AmbientPressure', 'CavityPressure', 'CavityTemp', 'DasTemp', 'Etalon1', 'Etalon2', 'EtalonTemp', 'HotBoxHeater',
    'HotBoxHeatsinkTemp', 'HotBoxTec', 'InletValve', 'Laser1Current', 'Laser1Tec', 'Laser1Temp', 'Laser2Current', 'Laser2Tec',
    'Laser2Temp', 'Laser3Current', 'Laser3Tec', 'Laser3Temp', 'Laser4Current', 'Laser4Tec', 'Laser4Temp', 'MPVPosition',
    'OutletValve', 'Ratio1', 'Ratio2', 'Reference1', 'Reference2', 'SchemeID', 'SensorTime', 'SpectrumID', 'Time_s', 'ValveMask',
    'WarmBoxHeatsinkTemp', 'WarmBoxTec', 'WarmBoxTemp', 'cal_enabled', 'cavity_pressure', 'cavity_temperature', 'delta_18_16',
    'delta_18_16_2min', 'delta_18_16_30s', 'delta_18_16_5min', 'delta_D_H', 'delta_D_H_2min', 'delta_D_H_30s', 'delta_D_H_5min',
    'galpeak77', 'galpeak77_offsetonly', 'galpeak79', 'galpeak82', 'galpeak82_offsetonly', 'h2o_adjust', 'h2o_conc', 'h2o_ppmv',
    'h2o_shift', 'h2o_spline_amp', 'h2o_spline_max', 'h2o_squish_a', 'h2o_y_eff', 'h2o_y_eff_a', 'hms', 'interval', 'n2_flag',
    'organic_77', 'organic_82', 'organic_MeOHampl', 'organic_base', 'organic_ch4conc', 'organic_res', 'organic_shift',
    'organic_slope', 'organic_splinemax', 'organic_squish', 'organic_y', 'prefit_base', 'prefit_res', 'prefit_shift',
    'prefit_slope', 'prefit_squish', 'pzt_ave', 'pzt_stdev', 'species', 'standard_base', 'standard_residuals', 'standard_slope',
    'time', 'timestamp', 'wlm1_offset', 'ymd'
]

DataKeys = [
    'MPVPosition', 'InletValve', 'Laser1Current', 'WarmBoxTemp', 'AmbientPressure', 'HotBoxHeater', 'Etalon2', 'CavityTemp',
    'Etalon1', 'Reference2', 'Reference1', 'DasTemp', 'Laser1Tec', 'Laser1Temp', 'ValveMask', 'OutletValve', 'CavityPressure',
    'HotBoxHeatsinkTemp', 'Ratio1', 'HotBoxTec', 'Ratio2', 'WarmBoxHeatsinkTemp', 'WarmBoxTec', 'EtalonTemp'
]

SensorStreamKeys = [
    "Laser1Temp", "Laser2Temp", "Laser3Temp", "Laser4Temp", "EtalonTemp", "WarmBoxTemp", "WarmBoxHeatsinkTemp", "CavityTemp",
    "HotBoxHeatsinkTemp", "DASTemp", "Etalon1", "Reference1", "Etalon2", "Reference2", "Ratio1", "Ratio2", "Laser1Current",
    "Laser2Current", "Laser3Current", "Laser4Current", "CavityPressure", "AmbientPressure", "Laser1TEC", "Laser2TEC", "Laser3TEC",
    "Laser4TEC", "WarmBoxTec", "HotBoxTec", "HotBoxHeater", "InletValve", "OutletValve", "ValveMask"
]

DASRegisterList = [
    'DAS_STATUS_REGISTER', 'SCHEDULER_CONTROL_REGISTER', 'RD_IRQ_COUNT_REGISTER', 'ACQ_DONE_COUNT_REGISTER',
    'LASER1_TEMP_CNTRL_STATE_REGISTER', 'LASER1_TEMP_CNTRL_USER_SETPOINT_REGISTER', 'LASER1_TEMP_CNTRL_TOLERANCE_REGISTER',
    'LASER1_TEMP_CNTRL_SWEEP_MAX_REGISTER', 'LASER1_TEMP_CNTRL_SWEEP_MIN_REGISTER', 'LASER1_TEMP_CNTRL_SWEEP_INCR_REGISTER',
    'LASER1_TEMP_CNTRL_H_REGISTER', 'LASER1_TEMP_CNTRL_K_REGISTER', 'LASER1_TEMP_CNTRL_TI_REGISTER',
    'LASER1_TEMP_CNTRL_TD_REGISTER', 'LASER1_TEMP_CNTRL_B_REGISTER', 'LASER1_TEMP_CNTRL_C_REGISTER', 'LASER1_TEMP_CNTRL_N_REGISTER',
    'LASER1_TEMP_CNTRL_S_REGISTER', 'LASER1_TEMP_CNTRL_AMIN_REGISTER', 'LASER1_TEMP_CNTRL_AMAX_REGISTER',
    'LASER1_TEMP_CNTRL_IMAX_REGISTER', 'LASER1_TEMP_CNTRL_FFWD_REGISTER', 'LASER1_TEC_PRBS_GENPOLY_REGISTER',
    'LASER1_TEC_PRBS_AMPLITUDE_REGISTER', 'LASER1_TEC_PRBS_MEAN_REGISTER', 'LASER1_MANUAL_TEC_REGISTER',
    'LASER1_CURRENT_CNTRL_STATE_REGISTER', 'LASER1_MANUAL_COARSE_CURRENT_REGISTER', 'LASER1_MANUAL_FINE_CURRENT_REGISTER',
    'LASER1_CURRENT_SWEEP_MIN_REGISTER', 'LASER1_CURRENT_SWEEP_MAX_REGISTER', 'LASER1_CURRENT_SWEEP_INCR_REGISTER',
    'LASER2_TEMP_CNTRL_STATE_REGISTER', 'LASER2_TEMP_CNTRL_USER_SETPOINT_REGISTER', 'LASER2_TEMP_CNTRL_TOLERANCE_REGISTER',
    'LASER2_TEMP_CNTRL_SWEEP_MAX_REGISTER', 'LASER2_TEMP_CNTRL_SWEEP_MIN_REGISTER', 'LASER2_TEMP_CNTRL_SWEEP_INCR_REGISTER',
    'LASER2_TEMP_CNTRL_H_REGISTER', 'LASER2_TEMP_CNTRL_K_REGISTER', 'LASER2_TEMP_CNTRL_TI_REGISTER',
    'LASER2_TEMP_CNTRL_TD_REGISTER', 'LASER2_TEMP_CNTRL_B_REGISTER', 'LASER2_TEMP_CNTRL_C_REGISTER', 'LASER2_TEMP_CNTRL_N_REGISTER',
    'LASER2_TEMP_CNTRL_S_REGISTER', 'LASER2_TEMP_CNTRL_AMIN_REGISTER', 'LASER2_TEMP_CNTRL_AMAX_REGISTER',
    'LASER2_TEMP_CNTRL_IMAX_REGISTER', 'LASER2_TEMP_CNTRL_FFWD_REGISTER', 'LASER2_TEC_PRBS_GENPOLY_REGISTER',
    'LASER2_TEC_PRBS_AMPLITUDE_REGISTER', 'LASER2_TEC_PRBS_MEAN_REGISTER', 'LASER2_MANUAL_TEC_REGISTER',
    'LASER2_CURRENT_CNTRL_STATE_REGISTER', 'LASER2_MANUAL_COARSE_CURRENT_REGISTER', 'LASER2_MANUAL_FINE_CURRENT_REGISTER',
    'LASER2_CURRENT_SWEEP_MIN_REGISTER', 'LASER2_CURRENT_SWEEP_MAX_REGISTER', 'LASER2_CURRENT_SWEEP_INCR_REGISTER',
    'LASER3_TEMP_CNTRL_STATE_REGISTER', 'LASER3_TEMP_CNTRL_USER_SETPOINT_REGISTER', 'LASER3_TEMP_CNTRL_TOLERANCE_REGISTER',
    'LASER3_TEMP_CNTRL_SWEEP_MAX_REGISTER', 'LASER3_TEMP_CNTRL_SWEEP_MIN_REGISTER', 'LASER3_TEMP_CNTRL_SWEEP_INCR_REGISTER',
    'LASER3_TEMP_CNTRL_H_REGISTER', 'LASER3_TEMP_CNTRL_K_REGISTER', 'LASER3_TEMP_CNTRL_TI_REGISTER',
    'LASER3_TEMP_CNTRL_TD_REGISTER', 'LASER3_TEMP_CNTRL_B_REGISTER', 'LASER3_TEMP_CNTRL_C_REGISTER', 'LASER3_TEMP_CNTRL_N_REGISTER',
    'LASER3_TEMP_CNTRL_S_REGISTER', 'LASER3_TEMP_CNTRL_AMIN_REGISTER', 'LASER3_TEMP_CNTRL_AMAX_REGISTER',
    'LASER3_TEMP_CNTRL_IMAX_REGISTER', 'LASER3_TEMP_CNTRL_FFWD_REGISTER', 'LASER3_TEC_PRBS_GENPOLY_REGISTER',
    'LASER3_TEC_PRBS_AMPLITUDE_REGISTER', 'LASER3_TEC_PRBS_MEAN_REGISTER', 'LASER3_MANUAL_TEC_REGISTER',
    'LASER3_CURRENT_CNTRL_STATE_REGISTER', 'LASER3_MANUAL_COARSE_CURRENT_REGISTER', 'LASER3_MANUAL_FINE_CURRENT_REGISTER',
    'LASER3_CURRENT_SWEEP_MIN_REGISTER', 'LASER3_CURRENT_SWEEP_MAX_REGISTER', 'LASER3_CURRENT_SWEEP_INCR_REGISTER',
    'LASER4_TEMP_CNTRL_STATE_REGISTER', 'LASER4_TEMP_CNTRL_USER_SETPOINT_REGISTER', 'LASER4_TEMP_CNTRL_TOLERANCE_REGISTER',
    'LASER4_TEMP_CNTRL_SWEEP_MAX_REGISTER', 'LASER4_TEMP_CNTRL_SWEEP_MIN_REGISTER', 'LASER4_TEMP_CNTRL_SWEEP_INCR_REGISTER',
    'LASER4_TEMP_CNTRL_H_REGISTER', 'LASER4_TEMP_CNTRL_K_REGISTER', 'LASER4_TEMP_CNTRL_TI_REGISTER',
    'LASER4_TEMP_CNTRL_TD_REGISTER', 'LASER4_TEMP_CNTRL_B_REGISTER', 'LASER4_TEMP_CNTRL_C_REGISTER', 'LASER4_TEMP_CNTRL_N_REGISTER',
    'LASER4_TEMP_CNTRL_S_REGISTER', 'LASER4_TEMP_CNTRL_AMIN_REGISTER', 'LASER4_TEMP_CNTRL_AMAX_REGISTER',
    'LASER4_TEMP_CNTRL_IMAX_REGISTER', 'LASER4_TEMP_CNTRL_FFWD_REGISTER', 'LASER4_TEC_PRBS_GENPOLY_REGISTER',
    'LASER4_TEC_PRBS_AMPLITUDE_REGISTER', 'LASER4_TEC_PRBS_MEAN_REGISTER', 'LASER4_MANUAL_TEC_REGISTER',
    'LASER4_CURRENT_CNTRL_STATE_REGISTER', 'LASER4_MANUAL_COARSE_CURRENT_REGISTER', 'LASER4_MANUAL_FINE_CURRENT_REGISTER',
    'LASER4_CURRENT_SWEEP_MIN_REGISTER', 'LASER4_CURRENT_SWEEP_MAX_REGISTER', 'LASER4_CURRENT_SWEEP_INCR_REGISTER',
    'WARM_BOX_TEMP_CNTRL_STATE_REGISTER', 'TEC_CNTRL_REGISTER', 'WARM_BOX_TEMP_CNTRL_USER_SETPOINT_REGISTER',
    'WARM_BOX_TEMP_CNTRL_TOLERANCE_REGISTER', 'WARM_BOX_TEMP_CNTRL_SWEEP_MAX_REGISTER', 'WARM_BOX_TEMP_CNTRL_SWEEP_MIN_REGISTER',
    'WARM_BOX_TEMP_CNTRL_SWEEP_INCR_REGISTER', 'WARM_BOX_TEMP_CNTRL_H_REGISTER', 'WARM_BOX_TEMP_CNTRL_K_REGISTER',
    'WARM_BOX_TEMP_CNTRL_TI_REGISTER', 'WARM_BOX_TEMP_CNTRL_TD_REGISTER', 'WARM_BOX_TEMP_CNTRL_B_REGISTER',
    'WARM_BOX_TEMP_CNTRL_C_REGISTER', 'WARM_BOX_TEMP_CNTRL_N_REGISTER', 'WARM_BOX_TEMP_CNTRL_S_REGISTER',
    'WARM_BOX_TEMP_CNTRL_AMIN_REGISTER', 'WARM_BOX_TEMP_CNTRL_AMAX_REGISTER', 'WARM_BOX_TEMP_CNTRL_IMAX_REGISTER',
    'WARM_BOX_TEMP_CNTRL_FFWD_REGISTER', 'WARM_BOX_TEC_PRBS_GENPOLY_REGISTER', 'WARM_BOX_TEC_PRBS_AMPLITUDE_REGISTER',
    'WARM_BOX_TEC_PRBS_MEAN_REGISTER', 'WARM_BOX_MANUAL_TEC_REGISTER', 'WARM_BOX_MAX_HEATSINK_TEMP_REGISTER',
    'CAVITY_TEMP_CNTRL_STATE_REGISTER', 'TEC_CNTRL_REGISTER', 'CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER',
    'CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER', 'CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER', 'CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER',
    'CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER', 'CAVITY_TEMP_CNTRL_H_REGISTER', 'CAVITY_TEMP_CNTRL_K_REGISTER',
    'CAVITY_TEMP_CNTRL_TI_REGISTER', 'CAVITY_TEMP_CNTRL_TD_REGISTER', 'CAVITY_TEMP_CNTRL_B_REGISTER',
    'CAVITY_TEMP_CNTRL_C_REGISTER', 'CAVITY_TEMP_CNTRL_N_REGISTER', 'CAVITY_TEMP_CNTRL_S_REGISTER',
    'CAVITY_TEMP_CNTRL_AMIN_REGISTER', 'CAVITY_TEMP_CNTRL_AMAX_REGISTER', 'CAVITY_TEMP_CNTRL_IMAX_REGISTER',
    'CAVITY_TEMP_CNTRL_FFWD_REGISTER', 'CAVITY_TEC_PRBS_GENPOLY_REGISTER', 'CAVITY_TEC_PRBS_AMPLITUDE_REGISTER',
    'CAVITY_TEC_PRBS_MEAN_REGISTER', 'CAVITY_MANUAL_TEC_REGISTER', 'CAVITY_MAX_HEATSINK_TEMP_REGISTER',
    'HEATER_CNTRL_STATE_REGISTER', 'HEATER_CNTRL_GAIN_REGISTER', 'HEATER_CNTRL_QUANTIZE_REGISTER',
    'HEATER_CNTRL_UBIAS_SLOPE_REGISTER', 'HEATER_CNTRL_UBIAS_OFFSET_REGISTER', 'HEATER_CNTRL_MARK_MIN_REGISTER',
    'HEATER_CNTRL_MARK_MAX_REGISTER', 'HEATER_CNTRL_MANUAL_MARK_REGISTER', 'VALVE_CNTRL_STATE_REGISTER',
    'VALVE_CNTRL_SOLENOID_VALVES_REGISTER', 'VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER',
    'VALVE_CNTRL_USER_INLET_VALVE_REGISTER', 'VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER',
    'VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER', 'VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER',
    'VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER', 'VALVE_CNTRL_INLET_VALVE_MIN_REGISTER', 'VALVE_CNTRL_INLET_VALVE_MAX_REGISTER',
    'VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER', 'VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER',
    'VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER', 'VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER', 'VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER',
    'VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER', 'VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER',
    'VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER', 'VALVE_CNTRL_THRESHOLD_STATE_REGISTER',
    'VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER', 'VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER',
    'VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER', 'VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER',
    'VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER', 'VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER',
    'VALVE_CNTRL_SEQUENCE_STEP_REGISTER', 'ANALYZER_TUNING_MODE_REGISTER', 'TUNER_SWEEP_RAMP_HIGH_REGISTER',
    'TUNER_SWEEP_RAMP_LOW_REGISTER', 'TUNER_WINDOW_RAMP_HIGH_REGISTER', 'TUNER_WINDOW_RAMP_LOW_REGISTER',
    'TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER', 'TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER', 'TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER',
    'TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER', 'PZT_OFFSET_VIRTUAL_LASER1', 'PZT_OFFSET_VIRTUAL_LASER2',
    'PZT_OFFSET_VIRTUAL_LASER3', 'PZT_OFFSET_VIRTUAL_LASER4', 'PZT_OFFSET_VIRTUAL_LASER5', 'PZT_OFFSET_VIRTUAL_LASER6',
    'PZT_OFFSET_VIRTUAL_LASER7', 'PZT_OFFSET_VIRTUAL_LASER8', 'VIRTUAL_LASER_REGISTER', 'SPECT_CNTRL_STATE_REGISTER',
    'SPECT_CNTRL_MODE_REGISTER', 'SPECT_CNTRL_ACTIVE_SCHEME_REGISTER', 'SPECT_CNTRL_NEXT_SCHEME_REGISTER',
    'SPECT_CNTRL_SCHEME_ITER_REGISTER', 'SPECT_CNTRL_SCHEME_ROW_REGISTER', 'SPECT_CNTRL_DWELL_COUNT_REGISTER',
    'SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER', 'SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER', 'SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER',
    'RDFITTER_MINLOSS_REGISTER', 'RDFITTER_MAXLOSS_REGISTER', 'RDFITTER_LATEST_LOSS_REGISTER',
    'RDFITTER_IMPROVEMENT_STEPS_REGISTER', 'RDFITTER_START_SAMPLE_REGISTER', 'RDFITTER_FRACTIONAL_THRESHOLD_REGISTER',
    'RDFITTER_ABSOLUTE_THRESHOLD_REGISTER', 'RDFITTER_NUMBER_OF_POINTS_REGISTER', 'RDFITTER_MAX_E_FOLDINGS_REGISTER',
    'RDFITTER_META_BACKOFF_REGISTER', 'RDFITTER_META_SAMPLES_REGISTER', 'SENTRY_LOWER_LIMIT_TRIPPED_REGISTER',
    'SENTRY_UPPER_LIMIT_TRIPPED_REGISTER', 'SENTRY_LASER1_TEMPERATURE_MIN_REGISTER', 'SENTRY_LASER1_TEMPERATURE_MAX_REGISTER',
    'SENTRY_LASER2_TEMPERATURE_MIN_REGISTER', 'SENTRY_LASER2_TEMPERATURE_MAX_REGISTER', 'SENTRY_LASER3_TEMPERATURE_MIN_REGISTER',
    'SENTRY_LASER3_TEMPERATURE_MAX_REGISTER', 'SENTRY_LASER4_TEMPERATURE_MIN_REGISTER', 'SENTRY_LASER4_TEMPERATURE_MAX_REGISTER',
    'SENTRY_ETALON_TEMPERATURE_MIN_REGISTER', 'SENTRY_ETALON_TEMPERATURE_MAX_REGISTER', 'SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER',
    'SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER', 'SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER',
    'SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER', 'SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER',
    'SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER', 'SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER',
    'SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER', 'SENTRY_DAS_TEMPERATURE_MIN_REGISTER',
    'SENTRY_DAS_TEMPERATURE_MAX_REGISTER', 'SENTRY_LASER1_CURRENT_MIN_REGISTER', 'SENTRY_LASER1_CURRENT_MAX_REGISTER',
    'SENTRY_LASER2_CURRENT_MIN_REGISTER', 'SENTRY_LASER2_CURRENT_MAX_REGISTER', 'SENTRY_LASER3_CURRENT_MIN_REGISTER',
    'SENTRY_LASER3_CURRENT_MAX_REGISTER', 'SENTRY_LASER4_CURRENT_MIN_REGISTER', 'SENTRY_LASER4_CURRENT_MAX_REGISTER',
    'SENTRY_CAVITY_PRESSURE_MIN_REGISTER', 'SENTRY_CAVITY_PRESSURE_MAX_REGISTER', 'SENTRY_AMBIENT_PRESSURE_MIN_REGISTER',
...
class SandboxFrame(SandboxGUI):
    def __init__(self, *a, **k):
        ...
        self.graphPanel1.SetGraphProperties(xlabel='waveNumber',
                                            timeAxes=(False, False),
                                            ylabel='uncorrectedAbsorbance',
                                            grid=True,
        ...
        self.TestGraph1.SetGraphProperties(xlabel='X',
                                           timeAxes=(False, False),
                                           ylabel='Y',
                                           grid=True,
                                           frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
        ...
        self.keys = sorted([
            ...
            'cavityPressure', 'subschemeId', 'lockerOffset', 'count', 'coarseLaserCurrent', 'waveNumber', 'laserUsed',
            'sRDchemeRow', 'fineLaserCurrent', 'lockerError'
        ])
        ...
        self.analyzeGraph1.SetGraphProperties(xlabel='',
                                              timeAxes=(True, False),
                                              ylabel='',
                                              grid=True,
                                              frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                              backgroundColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE))
        self.analyzeGraph1.AddSeriesAsPoints(self.waveformAnalysis1,
                                             colour='blue',
                                             fillcolour='blue',
                                             marker='square',
                                             size=1,
        ...
        self.analyzeGraph2.SetGraphProperties(xlabel='',
                                              timeAxes=(True, False),
                                              ylabel='',
                                              grid=True,
                                              frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                              backgroundColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE))
        self.analyzeGraph2.AddSeriesAsPoints(self.waveformAnalysis2,
                                             colour='blue',
                                             fillcolour='blue',
                                             marker='square',
                                             size=1,
        ...
        self.logListener = TextListener(None,
                                        port=SharedTypes.BROADCAST_PORT_EVENTLOG,
                                        retry=True,
                                        name="Controller event log listener",
                                        streamFilter=self.logFilter,
                                        logFunc=Log)
        self.RDlistener = Listener(None,
                                   SharedTypes.BROADCAST_PORT_RD_RECALC,
                                   ProcessedRingdownEntryType,
                                   self.rdFilter,
                                   retry=True)
        self.dataListener = Listener(None,
        ...
        self.SensorChart1.SetGraphProperties(xlabel='',
                                             timeAxes=(True, False),
                                             ylabel='',
                                             grid=True,
                                             frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                             backgroundColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE))
        self.SensorChart2.SetGraphProperties(xlabel='',
                                             timeAxes=(True, False),
                                             ylabel='',
                                             grid=True,
                                             frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                             backgroundColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE))
        self.SensorChart1.AddSeriesAsPoints(self.waveformSensor1,
                                            colour='blue',
                                            fillcolour='blue',
                                            marker='square',
                                            size=1,
                                            width=1)
        self.SensorChart2.AddSeriesAsPoints(self.waveformSensor2,
                                            colour='blue',
                                            fillcolour='blue',
                                            marker='square',
                                            size=1,
    ...
    def OnListBoxYSelected(self, event):
        ...
        self.graphPanel1.SetGraphProperties(xlabel=self.keyX,
                                            timeAxes=(xtime, ytime),
                                            ylabel=self.keyY,
                                            grid=True,
                                            frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                            backgroundColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE))
        ...
        if num == 1:
            ...
            for i in range(numEntries):
                ...
                if id in [106, 4202, 36970, 32874, 1, 156, 4252, 32924, 8298, 41066, 8348, 12444, 41116]:
                    waveNum = peakCH4 + FSR * round((waveNum - peakCH4) / FSR)
                if id in [
                        105, 4201, 36969, 32873, 4096, 0, 32768, 32923, 32873, 155, 32923, 8347, 12443, 41115, 8192, 8297, 12443,
                        40960, 41115, 41065
                ]:
                    waveNum = peakCO2 + FSR * round((waveNum - peakCO2) / FSR)
    ...
    def SMFSRSquish(self):
        ...
        if (self.state == 'Start'):
            ...
            savedSchemeName = 'C:\Picarro\G2000\InstrConfig\Integration\FSRSquish\HBDS%s_Nominal_wCal_Quad_Fast_v36.sch_saved_%s' % (
                systemNum, startTime)
            ...
            self.Output(s)
            if len(self.SMStatic) > minimumSquishReadingsPerPass and len(
                    tail) >= numSquishReadingsToCalculateDeltaFrom and deltaSquish <= squishStabilizationGate:
            ...
            systemNum = self.getSystemNum()
            startScheme = 'C:\Picarro\G2000\InstrConfig\Schemes\HBDS%s_Nominal_wCal_Quad_Fast_v36.sch' % systemNum
            savedSchemeName = 'C:\Picarro\G2000\InstrConfig\Integration\FSRSquish\HBDS%s_Nominal_wCal_Quad_Fast_v36.sch_calculated_%s' % (
                systemNum, endTime)
            shutil.copy(startScheme, savedSchemeName)
            ...
            if len(self.SMStatic) > minimumSquishReadingsPerPass and len(
                ...
                pylab.title(title)
                endTime = time.strftime('%m%d%y_%H%M%S')
                outGraphName = 'C:\Picarro\G2000\InstrConfig\Integration\FSRSquish\h2O_squish_aGraph_%s_%s.png' % (systemNum,
                                                                                                                   endTime)
    ...
    def OnThresStatsbutton(self, event):
        ...
        if num == 1:
            ...
            os.system(
                'ThresholdStats.py 642CBDS2093 2000 16000 500 C:/Picarro/G2000/InstrConfig/Schemes/CBDSxx_Baseline.sch > BL_TStats.txt'
            )
            self.TestResulttext_ctrl.AppendText(
                'ThresholdStats.py 642CBDS2093 2000 16000 500 C:/Picarro/G2000/InstrConfig/Schemes/CBDSxx_Baseline.sch > BL_TStats.txt\r\n'
            )
            os.system(
                'ThresholdStats.py 642CBDS2093 2000 16000 500 C:/Picarro/G2000/InstrConfig/Schemes/CBDSxx_C12Peak.sch > C12_TStats.txt'
            )
            self.TestResulttext_ctrl.AppendText(
                'ThresholdStats.py 642CBDS2093 2000 16000 500 C:/Picarro/G2000/InstrConfig/Schemes/CBDSxx_C12Peak.sch > C12_TStats.txt\r\n'
            )
            os.system(
                'ThresholdStats.py 642CBDS2093 2000 16000 500 C:/Picarro/G2000/InstrConfig/Schemes/CBDSxx_C13Peak.sch > C13_TStats.txt'
            )
            self.TestResulttext_ctrl.AppendText(
                'ThresholdStats.py 642CBDS2093 2000 16000 500 C:/Picarro/G2000/InstrConfig/Schemes/CBDSxx_C13Peak.sch > C13_TStats.txt\r\n'
            )
