...
if __name__ == "__main__":
    try:
        ...
        thetaCal = unwrap(arctan2(ratio1Scale * Y - ratio2Scale * X * sin(phase), ratio2Scale * X * cos(phase)))
        ...
        X = (meta[0, :] / 32768.0) - ratio1Center
        Y = (meta[1, :] / 32768.0) - ratio2Center
        thetaCalNew = unwrap(arctan2(ratio1Scale * Y - ratio2Scale * X * sin(phase), ratio2Scale * X * cos(phase)))
        ...
        saveVars = [
            "num1", "den1", "num2", "den2", "ratio1Center", "ratio1Scale", "ratio2Center", "ratio2Scale", "phase", "thetaCal",
            "fineCurrent"
        ]
