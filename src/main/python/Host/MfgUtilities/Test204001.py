...
#
# FILE:
#   Test204001.py tests the G2000 logic board laser current drive for laser 4
#
# DESCRIPTION:
#
# SEE ALSO:
...
from Host.MfgUtilities.TestLogicBoardLaserDriver import *
...
if __name__ == "__main__":
    ...
    tst = TestLogicBoardLaserDriver(tp,4)
    tst.run()
    tp.appendReport()
    tp.makeHTML()