...
class ModeViewFrame(ModeViewGUI):
    ...
    mainPos = 500.0
    mainSep = 3000.0
    guiSave = {'text_ctrl': ['min_1', 'max_1'], 'combo_box': [], 'checkbox': ['autoscale_1']}
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.graph_panel_1.SetGraphProperties(xlabel='PZT Position',
    ...
    def onTimer(self, evt=None):
        ...
        ccorr = fftshift(xcorr(concatenate((self.ref, self.ref[0] * ones(N + 2))), concatenate((d, d[0] * ones(N + 2)))))
