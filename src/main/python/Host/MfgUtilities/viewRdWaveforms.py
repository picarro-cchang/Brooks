...
class RingdownGrabber(HasTraits):
    ...
    traits_view = View(
        VGroup(Item("loss"), Item("a"), Item("b"), Item("fitFile"), Item("fitStart"), Item("fitEnd"), Item("thresholdPercent"),
               Item("lowerThreshold")))
...
if __name__ == "__main__":
    ...
    viewer = View(HGroup(
        ...
        VGroup(
            ...
            VGroup(Item("ringdownFile"), HGroup(Item("run"), Item("showRes"), Item("showAvg")),
                   Item("fCutoff", editor=TextEditor(auto_set=False, enter_set=True)), Item("resScale"),
                   Item("nStats", style="readonly"), Item("meanLoss", style="readonly", format_str="%.4f"),
