...
class TestValveExplorer(object):
    ...
    def testValveSequenceOneStep(self):
        ...
        assert self.v.valveSeq == [[0xFF, 0x0, 0], [0x0, 0x0, 0], [0x0, 0x0, 5], [0x0, 0x0, 0]]
    ...
    def testValveSequenceMultiStep(self):
        ...
        assert self.v.valveSeq == [[0xFF, 0x0, 0], [0x0, 0x0, 0], [0x0, 0x0, 5], [0x1, 0x0, 10], [0x3, 0x0, 15], [0x7, 0x0, 21],
                                   [0x7, 0x7, 25], [0x7, 0x5, 30], [0x4, 0x4, 35], [0x0, 0x0, 0]]
