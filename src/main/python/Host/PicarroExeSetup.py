...
data_files = [(".", ["pydCaller/Warning_16x16_32.ico",
                   "pydCaller/Info_16x16_32.ico",
                   "pydCaller/Critical_16x16_32.ico",
                   "pydCaller/LEDgreen.ico",
                   "pydCaller/LEDgreen2.ico",
                   "pydCaller/LEDoff.ico",
                   "pydCaller/LEDoff2.ico",
...
# pydCaller
consoleList = [    
    "pydCaller/AlarmSystem.py",
    "pydCaller/Archiver.py",
    ...
    Fitter,
    "pydCaller/InstMgr.py",
    "pydCaller/MeasSystem.py",
    "pydCaller/PortListerner.py",
    "pydCaller/RDFrequencyConverter.py",
    "pydCaller/rdReprocessor.py",
...
windowsList = [
    QuickGui, Coordinator, Controller,
    "pydCaller/StopSupervisor.py",
    "IPV/IPV.py",
    "IPV/IPVLicense.py",
