...
if d["spectrumId"] in [23, 24]:
    ...
    if (len(Ich4) == maxIlas):
        if (ch4_count % clusterCount == 0):
            ...
            good_cluster = ((ch4_max_loss < 5000) or
                            (ch4_peakPoints > 0 and ch4_max_gap < 6)) and (max(diff(Ic[1:])) < 2 * ch4_dImin) and (DP < 0.2)
        ...
        d.defineFitData(freq=d.groupMeans["pztValue"],
                        loss=1000 * d.groupMeans["uncorrectedAbsorbance"],
                        sdev=1 / sqrt(d.groupSizes))
...
if d["spectrumId"] == 170:
    ...
    if (len(Ic2h6) == maxIlas):
        if (c2h6_count % clusterCount == 0):
            ...
            good_cluster = ((c2h6_max_loss < 5000) or
                            (c2h6_peakPoints > 0 and c2h6_max_gap < 6)) and (max(diff(Ic[1:])) < 2 * c2h6_dImin) and (DP < 0.2)
...
if (len(Ich4) == maxIlas) or (len(Ic2h6) == maxIlas):
    ...
    if goodC2H6 and goodCH4:
        RESULT = {
            "ch4_res": ch4_res,
            "ch4_conc_raw": ch4_conc_raw,
            "goodCH4": goodCH4,
            "str10": str10,
            "peak_10": peak10,
            "y10": y10,
            "str10_norm": str10_norm,
            "ch4_base": ch4_base,
            "ch4_slope": ch4_slope,
            "ch4_gaps": ch4_gaps,
            "ch4_max_gap": ch4_max_gap,
            "ch4_shift": ch4_shift,
            "ch4_freq_locked": ch4_freq_locked,
            "ch4_dImin": ch4_dImin,
            "ch4_peakPoints": ch4_peakPoints,
            "shift31": shift31,
            "ch4_fit_time": ch4_fit_time,
            "ch4_interval": ch4_interval,
            "ch4_pointsInRange": ch4_pointsInRange,
            "h2o_conc_raw": h2o_conc_raw,
            "str31": str31,
            "peak31": peak31,
            "y31": y31,
            "ch4_i2f_cubic": ch4_coef[0],
            "ch4_i2f_quad": ch4_coef[1],
            "ch4_i2f_lin": ch4_coef[2],
            "ch4_i2f_offset": ch4_offset,
            "h2o_peak": h2o_peak,
            "str_1": str_1,
            "y_h2o": y_h2o,
            "vy_h2o": vy_h2o,
            "h2o_from_c2h6": h2o_from_c2h6,
            "ch4_from_c2h6": ch4_from_c2h6,
            "c2h6_conc": c2h6_conc,
            "c2ratio": c2ratio,
            "c2h6_res": c2h6_res,
            "goodC2H6": goodC2H6,
            "c2h6_base": c2h6_base,
            "c2h6_slope": c2h6_slope,
            "c2h6_gaps": c2h6_gaps,
            "c2h6_max_gap": c2h6_max_gap,
            "c2h6_shift": c2h6_shift,
            "c2h6_freq_locked": c2h6_freq_locked,
            "c2h6_peakPoints": c2h6_peakPoints,
            "c2h6_dImin": c2h6_dImin,
            "c2h6_fit_time": c2h6_fit_time,
            "c2h6_pointsInRange": c2h6_pointsInRange,
            "c2h6_i2f_cubic": c2h6_coef[0],
            "c2h6_i2f_quad": c2h6_coef[1],
            "c2h6_i2f_lin": c2h6_coef[2],
            "c2h6_i2f_offset": c2h6_offset,
            "ch4_fineLaserCurrent": ch4_fineLaserCurrent,
            "c2h6_fineLaserCurrent": c2h6_fineLaserCurrent,
            "groups": d["ngroups"],
            "rds": d["datapoints"],
