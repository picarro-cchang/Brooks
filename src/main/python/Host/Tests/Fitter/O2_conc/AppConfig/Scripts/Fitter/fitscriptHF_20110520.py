...
if INIT:
    ...
    anHF.append(Analysis(os.path.join(BASEPATH, r"./MADS/H2O - HF doublet VC VY77 v1_0 20080616.ini")))
...
if (ignore_count == 0):
    RESULT = {
        ...
        "str_82": str_82,
        "base_82": base_82,
        "h2o_conc_60": h2o_conc_60,
        "h2o_conc_61": h2o_conc_61,
        "o2_conc": o2_conc,
        "hf_ppbv": hf_ppbv,
        "hf_ppbv_ave": hf_ppbv_ave,
    ...
    RESULT.update({
        "species": d["spectrumId"],
        "fittime": time.time() - tstart,
        "cavity_pressure": P,
        "cavity_temperature": T,
        "solenoid_valves": solValves,
        "das_temp": dasTemp
    })
