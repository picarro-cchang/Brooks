...
if __name__ == "__main__":
    ...
    subprocess.call([
        "DatEchoP3.exe", "--listen-path", abs_name, "--data-type", dat_type, "--analyzer-name", anz, "--log-metadata-url",
        log_metadata_url, "--ticket-url", ticket_url, "--ip-req-url", ip_req_url, "--push-url", push_url, "--sys", psys,
        "--identity", identity, "--history-range", history_range, "-c", "50601", "--nbr-lines", lines
    ])
