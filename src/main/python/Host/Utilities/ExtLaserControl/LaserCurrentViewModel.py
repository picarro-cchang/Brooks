...
class LaserCurrentViewModel(object):
    ...
    def update_view(self):
        widget_lookup = {
            "updated_level": {
                "control": self.view.text_ctrl_updated_level
            },
            "slope_factor": {
                "control": self.view.text_ctrl_slope_factor
            },
            "time_between_steps": {
                "control": self.view.text_ctrl_time_between_steps
            },
            "upper_window": {
                "control": self.view.text_ctrl_upper_window
            },
            "lower_window": {
                "control": self.view.text_ctrl_lower_window
            },
            "binning_rd": {
                "control": self.view.text_ctrl_binning_rd
            },
            "levels": {
                "control": self.view.list_box_levels,
                "set_value": fill_list_box_with_diff
            },
            "update_levels": {
                "control": self.view.checkbox_update_levels,
                "set_value": fill_checkbox
            },
            "update_waveform": {
                "control": self.view.checkbox_update_waveform,
                "set_value": fill_checkbox
            },
        }
