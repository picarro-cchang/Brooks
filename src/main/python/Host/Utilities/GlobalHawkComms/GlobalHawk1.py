...
class GlobalHawk(Singleton):
    ...
    def run(self):
        ...
        self.setSensorStreams([
            interface.STREAM_AmbientPressure, interface.STREAM_CavityPressure, interface.STREAM_CavityTemp,
            interface.STREAM_WarmBoxTemp, interface.STREAM_DasTemp, interface.STREAM_InletValve, interface.STREAM_OutletValve,
            interface.STREAM_HotBoxTec, interface.STREAM_WarmBoxTec, interface.STREAM_Laser1Temp, interface.STREAM_Laser2Temp,
            interface.STREAM_Laser3Temp, interface.STREAM_Laser4Temp
        ])
        reportData = [
            'AmbientPressure', 'cavity_pressure', 'cavity_temperature', 'WarmBoxTemp', 'DasTemp', 'InletValve', 'CH4', 'CO2', 'H2O',
