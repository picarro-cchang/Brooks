"""
File Name: ReceiverTcp.py
Purpose: This receives data from the Global Hawk aircraft network using the TCP data service
...
class ReceiverFrame(ReceiverFrameGui):
    ...
    def __init__(self, *a, **k):
        ...
        try:
            ...
            wx.MessageBox('TCP connection cannot be made. Check address and port.', 'Error', wx.OK | wx.ICON_ERROR)
            self.Close()
        self.seq = 0
        self.data = ""
        ...
        try:
            ...
            while True:
                ...
                if sep > 0:
                    ...
                    while len(data) < self.MAX_DATA + 3:
                        data.append("")  # Ensure that data has enough columns
                    if data:
