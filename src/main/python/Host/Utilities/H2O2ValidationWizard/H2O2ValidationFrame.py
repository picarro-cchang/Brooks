...
class H2O2ValidationFrame(QMainWindow):
    ...
    def create_widgets(self):
        ...
        self.report.setFixedHeight(600)
        ...
        self.table_cylinder_list.setColumnWidth(0, 180)
        self.table_cylinder_list.setColumnWidth(1, 245)
        self.table_cylinder_list.setColumnWidth(2, 200)
        self.table_cylinder_list.setColumnWidth(3, 170)
        self.label_cylinder_ident = QLabel("")
        ...
        info_layout.addRow("Identification", self.label_cylinder_ident)
        ...
        # add cylinder
        self.add_cylinder_frame = QWidget()
        self.input_add_cylinder_ident = QLineEdit()
        self.input_add_cylinder_ch4 = QLineEdit()
        self.input_add_cylinder_uncertainty = QLineEdit()
        self.button_add_cylinder_ok = QPushButton("OK")
        self.button_add_cylinder_cancel = QPushButton("Cancel")
        control_layout = QHBoxLayout()
    ...
    def set_connections(self):
        ...
        self.button_update_cylinder.clicked.connect(self.update_cylinder)
        ...
        self.button_add_cylinder_ok.clicked.connect(self.add_cylinder_ok)
        self.button_add_cylinder_cancel.clicked.connect(self.add_cylinder_cancel)