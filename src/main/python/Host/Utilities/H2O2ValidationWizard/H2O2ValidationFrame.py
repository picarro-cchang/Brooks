...
class H2O2ValidationFrame(QMainWindow):
    ...
    def create_widgets(self):
        ...
        self.table_cylinder_list.setMinimumSize(QSize(675, 300))
        ...
        self.table_cylinder_list.setColumnWidth(0, 150)
        self.table_cylinder_list.setColumnWidth(1, 220)
        self.table_cylinder_list.setColumnWidth(2, 180)
        self.table_cylinder_list.setColumnWidth(3, 120)
