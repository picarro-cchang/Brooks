...
def read_First_Three_Gas_measurement(unit_number):
    ...
    print(
        "Analyzer" + str(unit_number) +
        ":(Timestamp , H2O2 , H2O2_ID , H2O2_30S, H2O2_2min, H2O2_5min, H2O2_Maximum, H2O2_Minimum, H2O , H2O_ID , H2O_30S, H2O_2min, H2O_5min, H2O_Maximum, H2O_Minimum, CH4 , CH4_ID , CH4_30S, CH4_2min, CH4_5min, CH4_Maximum, Ch4_Minimum)"
    )
...
def read_Sesor_Data(unit_number):
    ...
    print(
        "Analyzer" + str(unit_number) +
        ":(CavityPressure, CavityTemp, DasTemp, EtalonTemp, WarmBoxTemp, OutletValve, H202 Inst Offfset, H2O2 Inst slope, H2O2 user Slope, H2O2 user offset, H20 Inst Offfset, H2O Inst slope, H2O user Slope, H2O user offset, CH4 Inst Offfset, CH4 Inst slope, CH4 user Slope, CH4 user offset)"
    )
