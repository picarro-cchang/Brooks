...
class RingdownParamsType(Structure):
    _fields_ = [("injectionSettings", c_uint), ("laserTemperature", c_float), ("coarseLaserCurrent", c_uint),
                ...
                ("tunerAtRingdown", c_uint), ("addressAtRingdown", c_uint)]
...
LASER2_THERMISTOR_SERIES_RESISTANCE_REGISTER = 63
...
LASER3_THERMISTOR_SERIES_RESISTANCE_REGISTER = 103
...
LASER4_THERMISTOR_SERIES_RESISTANCE_REGISTER = 143
...
ETALON_THERMISTOR_SERIES_RESISTANCE_REGISTER = 181
...
WARM_BOX_THERMISTOR_SERIES_RESISTANCE_REGISTER = 187
...
WARM_BOX_HEATSINK_THERMISTOR_SERIES_RESISTANCE_REGISTER = 218
...
HOT_BOX_HEATSINK_THERMISTOR_SERIES_RESISTANCE_REGISTER = 224
...
CAVITY_THERMISTOR_SERIES_RESISTANCE_REGISTER = 230
...
__p.append(('fpga', 'mask', FPGA_INJECT + INJECT_CONTROL2, [(1, u'Fiber amplifier present', [(0, u'No'),
                                                                                             (1, u'Yes')])], None, None, 1, 1))
...
__p.append(('fpga', 'mask', FPGA_DYNAMICPWM_INLET + DYNAMICPWM_CS, [(1, u'Stop/Run', [(0, u'Stop'), (1, u'Run')]),
                                                                    ...
                                                                    (16, u'PWM output', [(0, u'Low'),
                                                                                         (16, u'High')])], None, None, 1, 1))
...
__p.append(
    ('fpga', 'mask', FPGA_DYNAMICPWM_OUTLET + DYNAMICPWM_CS, [(1, u'Stop/Run', [(0, u'Stop'), (1, u'Run')]),
                                                              (2, u'Single/Continuous', [(0, u'Single'), (2, u'Continuous')]),
                                                              (4, u'PWM enable', [(0, u'Disable'), (4, u'Enable')]),
                                                              (8, u'Use comparator', [(0, u'No'), (8, u'Yes')]),
                                                              (16, u'PWM output', [(0, u'Low'), (16, u'High')])], None, None, 1, 1))
