...
class DataType(Union):
    _fields_ = [("asFloat", c_float), ("asUint", c_uint), ("asInt", c_int)]


class DIAG_EventLogStruct(Structure):
    _fields_ = [("time", c_uint), ("cause", c_uint), ("etalonPd1Current", c_uint), ("refPd1Current", c_uint),
                ("etalonPd2Current", c_uint), ("refPd2Current", c_uint), ("etalonTemp", c_uint), ("cavityTemp", c_uint),
                ("warmBoxTemp", c_uint), ("hotBoxTecHeatsinkTemp", c_uint), ("warmBoxTecHeatsinkTemp", c_uint),
                ("laser1Temp", c_uint), ("laser2Temp", c_uint), ("laserCurrent", c_uint), ("cavityPressure", c_uint),
                ("inletPressure", c_uint), ("outletPressure", c_uint), ("customDataArray", c_ushort * 16)]


class RingdownMetadataType(Structure):
    _fields_ = [("ratio1", c_uint), ("ratio2", c_uint), ("pztValue", c_uint), ("lockerOffset", c_uint),
                ("fineLaserCurrent", c_uint), ("lockerError", c_int)]


class RingdownMetadataDoubleType(Structure):
    _fields_ = [("ratio1", c_double), ("ratio2", c_double), ("pztValue", c_double), ("lockerOffset", c_double),
                ("fineLaserCurrent", c_double), ("lockerError", c_double)]


class RingdownParamsType(Structure):
    _fields_ = [("injectionSettings", c_uint), ("laserTemperature", c_float), ("coarseLaserCurrent", c_uint),
                ("etalonTemperature", c_float), ("cavityPressure", c_float), ("ambientPressure", c_float),
                ("schemeTableAndRow", c_uint), ("countAndSubschemeId", c_uint), ("ringdownThreshold", c_uint), ("status", c_uint),
                ("tunerAtRingdown", c_uint), ("addressAtRingdown", c_uint), ("extLaserLevelCounter", c_uint),
                ("extLaserSequenceId", c_uint)]


class RingdownBufferType(Structure):
    _fields_ = [("ringdownWaveform", c_uint * 4096), ("parameters", RingdownParamsType)]


class RingdownEntryType(Structure):
    _fields_ = [("timestamp", c_longlong), ("wlmAngle", c_float), ("uncorrectedAbsorbance", c_float),
                ("correctedAbsorbance", c_float), ("status", c_ushort), ("count", c_ushort), ("tunerValue", c_ushort),
                ("pztValue", c_ushort), ("laserUsed", c_ushort), ("ringdownThreshold", c_ushort), ("subschemeId", c_ushort),
                ("schemeVersionAndTable", c_ushort), ("schemeRow", c_ushort), ("ratio1", c_ushort), ("ratio2", c_ushort),
                ("fineLaserCurrent", c_ushort), ("coarseLaserCurrent", c_ushort), ("fitAmplitude", c_ushort),
                ("fitBackground", c_ushort), ("fitRmsResidual", c_ushort), ("laserTemperature", c_float),
                ("etalonTemperature", c_float), ("cavityPressure", c_float)]


class ProcessedRingdownEntryType(Structure):
    _fields_ = [("timestamp", c_longlong), ("wlmAngle", c_float), ("waveNumber", c_double), ("waveNumberSetpoint", c_double),
                ("uncorrectedAbsorbance", c_float), ("correctedAbsorbance", c_float), ("status", c_ushort), ("count", c_ushort),
                ("tunerValue", c_ushort), ("pztValue", c_ushort), ("laserUsed", c_ushort), ("ringdownThreshold", c_ushort),
                ("subschemeId", c_ushort), ("schemeVersionAndTable", c_ushort), ("schemeRow", c_ushort), ("ratio1", c_ushort),
                ("ratio2", c_ushort), ("fineLaserCurrent", c_ushort), ("coarseLaserCurrent", c_ushort), ("fitAmplitude", c_ushort),
                ("fitBackground", c_ushort), ("fitRmsResidual", c_ushort), ("laserTemperature", c_float),
                ("etalonTemperature", c_float), ("cavityPressure", c_float), ("extra1", c_uint), ("extra2", c_uint),
                ("extra3", c_uint), ("extra4", c_uint)]


class SensorEntryType(Structure):
    _fields_ = [("timestamp", c_longlong), ("streamNum", c_uint), ("value", c_float)]


class OscilloscopeTraceType(Structure):
    _fields_ = [("data", c_ushort * 4096)]


class ValveSequenceEntryType(Structure):
    _fields_ = [("maskAndValue", c_ushort), ("dwell", c_ushort)]


class CheckEnvType(Structure):
    _fields_ = [("var1", c_int), ("var2", c_int)]


class PulseGenEnvType(Structure):
    _fields_ = [("counter", c_uint)]


class FilterEnvType(Structure):
    _fields_ = [("offset", c_float), ("num", c_float * 9), ("den", c_float * 9), ("state", c_float * 8)]


class InterpolatorEnvType(Structure):
    _fields_ = [("target", c_float), ("current", c_float), ("steps", c_uint)]


class Byte4EnvType(Structure):
    _fields_ = [("buffer", c_uint * 1)]


class Byte16EnvType(Structure):
    _fields_ = [("buffer", c_uint * 4)]


class Byte64EnvType(Structure):
    _fields_ = [("buffer", c_uint * 16)]


class SchemeRowType(Structure):
    _fields_ = [("setpoint", c_float), ("dwellCount", c_ushort), ("subschemeId", c_ushort), ("virtualLaser", c_ushort),
                ("threshold", c_ushort), ("pztSetpoint", c_ushort), ("laserTemp", c_ushort)]


class SchemeTableHeaderType(Structure):
    _fields_ = [("numRepeats", c_uint), ("numRows", c_uint)]


class SchemeTableType(Structure):
    _fields_ = [("numRepeats", c_uint), ("numRows", c_uint), ("rows", SchemeRowType * 8192)]


class VirtualLaserParamsType(Structure):
    _fields_ = [("actualLaser", c_uint), ("tempSensitivity", c_float), ("ratio1Center", c_float), ("ratio2Center", c_float),
                ("ratio1Scale", c_float), ("ratio2Scale", c_float), ("phase", c_float), ("calTemp", c_float),
                ("calPressure", c_float), ("pressureC0", c_float), ("pressureC1", c_float), ("pressureC2", c_float),
                ("pressureC3", c_float)]


class WLMCalRowType(Structure):
    _fields_ = [("waveNumberAsUint", c_uint), ("ratio1", c_float), ("ratio2", c_float)]


class WLMHeaderType(Structure):
    _fields_ = [("identifier", c_ubyte * 32), ("etalon_temperature", c_float), ("etalon1_offset", c_float),
                ("reference1_offset", c_float), ("etalon2_offset", c_float), ("reference2_offset", c_float),
                ("padding", c_ubyte * 12)]


class WLMCalibrationType(Structure):
    _fields_ = [("header", WLMHeaderType), ("wlmCalRows", WLMCalRowType * 336)]
...
CONVERSION_CAVITY2_THERM1_CONSTA_REGISTER = 267
CONVERSION_CAVITY2_THERM1_CONSTB_REGISTER = 268
CONVERSION_CAVITY2_THERM1_CONSTC_REGISTER = 269
CAVITY2_RESISTANCE1_REGISTER = 270
CAVITY2_TEMPERATURE1_REGISTER = 271
CAVITY2_THERMISTOR1_SERIES_RESISTANCE_REGISTER = 272
CONVERSION_CAVITY2_THERM2_CONSTA_REGISTER = 273
CONVERSION_CAVITY2_THERM2_CONSTB_REGISTER = 274
CONVERSION_CAVITY2_THERM2_CONSTC_REGISTER = 275
CAVITY2_RESISTANCE2_REGISTER = 276
CAVITY2_TEMPERATURE2_REGISTER = 277
CAVITY2_THERMISTOR2_SERIES_RESISTANCE_REGISTER = 278
CONVERSION_CAVITY2_THERM3_CONSTA_REGISTER = 279
CONVERSION_CAVITY2_THERM3_CONSTB_REGISTER = 280
CONVERSION_CAVITY2_THERM3_CONSTC_REGISTER = 281
CAVITY2_RESISTANCE3_REGISTER = 282
CAVITY2_TEMPERATURE3_REGISTER = 283
CAVITY2_THERMISTOR3_SERIES_RESISTANCE_REGISTER = 284
CONVERSION_CAVITY2_THERM4_CONSTA_REGISTER = 285
CONVERSION_CAVITY2_THERM4_CONSTB_REGISTER = 286
CONVERSION_CAVITY2_THERM4_CONSTC_REGISTER = 287
CAVITY2_RESISTANCE4_REGISTER = 288
CAVITY2_TEMPERATURE4_REGISTER = 289
CAVITY2_THERMISTOR4_SERIES_RESISTANCE_REGISTER = 290
CAVITY_TEC_REGISTER = 291
CAVITY_MANUAL_TEC_REGISTER = 292
CAVITY_TEMP_CNTRL_STATE_REGISTER = 293
CAVITY_TEMP_CNTRL_SETPOINT_REGISTER = 294
CAVITY_TEMP_CNTRL_USER_SETPOINT_REGISTER = 295
CAVITY_TEMP_CNTRL_TOLERANCE_REGISTER = 296
CAVITY_TEMP_CNTRL_SWEEP_MAX_REGISTER = 297
CAVITY_TEMP_CNTRL_SWEEP_MIN_REGISTER = 298
CAVITY_TEMP_CNTRL_SWEEP_INCR_REGISTER = 299
CAVITY_TEMP_CNTRL_H_REGISTER = 300
CAVITY_TEMP_CNTRL_K_REGISTER = 301
CAVITY_TEMP_CNTRL_TI_REGISTER = 302
CAVITY_TEMP_CNTRL_TD_REGISTER = 303
CAVITY_TEMP_CNTRL_B_REGISTER = 304
CAVITY_TEMP_CNTRL_C_REGISTER = 305
CAVITY_TEMP_CNTRL_N_REGISTER = 306
CAVITY_TEMP_CNTRL_S_REGISTER = 307
CAVITY_TEMP_CNTRL_FFWD_REGISTER = 308
CAVITY_TEMP_CNTRL_AMIN_REGISTER = 309
CAVITY_TEMP_CNTRL_AMAX_REGISTER = 310
CAVITY_TEMP_CNTRL_IMAX_REGISTER = 311
CAVITY_TEC_PRBS_GENPOLY_REGISTER = 312
CAVITY_TEC_PRBS_AMPLITUDE_REGISTER = 313
CAVITY_TEC_PRBS_MEAN_REGISTER = 314
CAVITY_MAX_HEATSINK_TEMP_REGISTER = 315
HEATER_MARK_REGISTER = 316
HEATER_MANUAL_MARK_REGISTER = 317
HEATER_TEMP_CNTRL_STATE_REGISTER = 318
HEATER_TEMP_CNTRL_SETPOINT_REGISTER = 319
HEATER_TEMP_CNTRL_USER_SETPOINT_REGISTER = 320
HEATER_TEMP_CNTRL_TOLERANCE_REGISTER = 321
HEATER_TEMP_CNTRL_SWEEP_MAX_REGISTER = 322
HEATER_TEMP_CNTRL_SWEEP_MIN_REGISTER = 323
HEATER_TEMP_CNTRL_SWEEP_INCR_REGISTER = 324
HEATER_TEMP_CNTRL_H_REGISTER = 325
HEATER_TEMP_CNTRL_K_REGISTER = 326
HEATER_TEMP_CNTRL_TI_REGISTER = 327
HEATER_TEMP_CNTRL_TD_REGISTER = 328
HEATER_TEMP_CNTRL_B_REGISTER = 329
HEATER_TEMP_CNTRL_C_REGISTER = 330
HEATER_TEMP_CNTRL_N_REGISTER = 331
HEATER_TEMP_CNTRL_S_REGISTER = 332
HEATER_TEMP_CNTRL_AMIN_REGISTER = 333
HEATER_TEMP_CNTRL_AMAX_REGISTER = 334
HEATER_TEMP_CNTRL_IMAX_REGISTER = 335
HEATER_PRBS_GENPOLY_REGISTER = 336
HEATER_PRBS_AMPLITUDE_REGISTER = 337
HEATER_PRBS_MEAN_REGISTER = 338
HEATER_CUTOFF_REGISTER = 339
CONVERSION_FILTER_HEATER_THERM_CONSTA_REGISTER = 340
CONVERSION_FILTER_HEATER_THERM_CONSTB_REGISTER = 341
CONVERSION_FILTER_HEATER_THERM_CONSTC_REGISTER = 342
FILTER_HEATER_RESISTANCE_REGISTER = 343
FILTER_HEATER_TEMPERATURE_REGISTER = 344
FILTER_HEATER_THERMISTOR_SERIES_RESISTANCE_REGISTER = 345
FILTER_HEATER_REGISTER = 346
FILTER_HEATER_MANUAL_REGISTER = 347
FILTER_HEATER_TEMP_CNTRL_STATE_REGISTER = 348
FILTER_HEATER_TEMP_CNTRL_SETPOINT_REGISTER = 349
FILTER_HEATER_TEMP_CNTRL_USER_SETPOINT_REGISTER = 350
FILTER_HEATER_TEMP_CNTRL_TOLERANCE_REGISTER = 351
FILTER_HEATER_TEMP_CNTRL_SWEEP_MAX_REGISTER = 352
FILTER_HEATER_TEMP_CNTRL_SWEEP_MIN_REGISTER = 353
FILTER_HEATER_TEMP_CNTRL_SWEEP_INCR_REGISTER = 354
FILTER_HEATER_TEMP_CNTRL_H_REGISTER = 355
FILTER_HEATER_TEMP_CNTRL_K_REGISTER = 356
FILTER_HEATER_TEMP_CNTRL_TI_REGISTER = 357
FILTER_HEATER_TEMP_CNTRL_TD_REGISTER = 358
FILTER_HEATER_TEMP_CNTRL_B_REGISTER = 359
FILTER_HEATER_TEMP_CNTRL_C_REGISTER = 360
FILTER_HEATER_TEMP_CNTRL_N_REGISTER = 361
FILTER_HEATER_TEMP_CNTRL_S_REGISTER = 362
FILTER_HEATER_TEMP_CNTRL_FFWD_REGISTER = 363
FILTER_HEATER_TEMP_CNTRL_AMIN_REGISTER = 364
FILTER_HEATER_TEMP_CNTRL_AMAX_REGISTER = 365
FILTER_HEATER_TEMP_CNTRL_IMAX_REGISTER = 366
FILTER_HEATER_PRBS_GENPOLY_REGISTER = 367
FILTER_HEATER_PRBS_AMPLITUDE_REGISTER = 368
FILTER_HEATER_PRBS_MEAN_REGISTER = 369
FILTER_HEATER_MONITOR_REGISTER = 370
CAVITY_PRESSURE_ADC_REGISTER = 371
CONVERSION_CAVITY_PRESSURE_SCALING_REGISTER = 372
CONVERSION_CAVITY_PRESSURE_OFFSET_REGISTER = 373
CAVITY_PRESSURE_REGISTER = 374
AMBIENT_PRESSURE_ADC_REGISTER = 375
CONVERSION_AMBIENT_PRESSURE_SCALING_REGISTER = 376
CONVERSION_AMBIENT_PRESSURE_OFFSET_REGISTER = 377
AMBIENT_PRESSURE_REGISTER = 378
CAVITY2_PRESSURE_ADC_REGISTER = 379
CONVERSION_CAVITY2_PRESSURE_SCALING_REGISTER = 380
CONVERSION_CAVITY2_PRESSURE_OFFSET_REGISTER = 381
CAVITY2_PRESSURE_REGISTER = 382
AMBIENT2_PRESSURE_ADC_REGISTER = 383
CONVERSION_AMBIENT2_PRESSURE_SCALING_REGISTER = 384
CONVERSION_AMBIENT2_PRESSURE_OFFSET_REGISTER = 385
AMBIENT2_PRESSURE_REGISTER = 386
ANALYZER_TUNING_MODE_REGISTER = 387
TUNER_SWEEP_RAMP_HIGH_REGISTER = 388
TUNER_SWEEP_RAMP_LOW_REGISTER = 389
TUNER_WINDOW_RAMP_HIGH_REGISTER = 390
TUNER_WINDOW_RAMP_LOW_REGISTER = 391
TUNER_SWEEP_DITHER_HIGH_OFFSET_REGISTER = 392
TUNER_SWEEP_DITHER_LOW_OFFSET_REGISTER = 393
TUNER_WINDOW_DITHER_HIGH_OFFSET_REGISTER = 394
TUNER_WINDOW_DITHER_LOW_OFFSET_REGISTER = 395
TUNER_DITHER_MEDIAN_COUNT_REGISTER = 396
RDFITTER_MINLOSS_REGISTER = 397
RDFITTER_MAXLOSS_REGISTER = 398
RDFITTER_LATEST_LOSS_REGISTER = 399
RDFITTER_IMPROVEMENT_STEPS_REGISTER = 400
RDFITTER_START_SAMPLE_REGISTER = 401
RDFITTER_FRACTIONAL_THRESHOLD_REGISTER = 402
RDFITTER_ABSOLUTE_THRESHOLD_REGISTER = 403
RDFITTER_NUMBER_OF_POINTS_REGISTER = 404
RDFITTER_MAX_E_FOLDINGS_REGISTER = 405
RDFITTER_META_BACKOFF_REGISTER = 406
RDFITTER_META_SAMPLES_REGISTER = 407
SPECT_CNTRL_STATE_REGISTER = 408
SPECT_CNTRL_MODE_REGISTER = 409
SPECT_CNTRL_ACTIVE_SCHEME_REGISTER = 410
SPECT_CNTRL_NEXT_SCHEME_REGISTER = 411
SPECT_CNTRL_SCHEME_ITER_REGISTER = 412
SPECT_CNTRL_SCHEME_ROW_REGISTER = 413
SPECT_CNTRL_DWELL_COUNT_REGISTER = 414
SPECT_CNTRL_DEFAULT_THRESHOLD_REGISTER = 415
SPECT_CNTRL_DITHER_MODE_TIMEOUT_REGISTER = 416
SPECT_CNTRL_RAMP_MODE_TIMEOUT_REGISTER = 417
VIRTUAL_LASER_REGISTER = 418
PZT_INCR_PER_CAVITY_FSR = 419
PZT_OFFSET_UPDATE_FACTOR = 420
PZT_OFFSET_VIRTUAL_LASER1 = 421
PZT_OFFSET_VIRTUAL_LASER2 = 422
PZT_OFFSET_VIRTUAL_LASER3 = 423
PZT_OFFSET_VIRTUAL_LASER4 = 424
PZT_OFFSET_VIRTUAL_LASER5 = 425
PZT_OFFSET_VIRTUAL_LASER6 = 426
PZT_OFFSET_VIRTUAL_LASER7 = 427
PZT_OFFSET_VIRTUAL_LASER8 = 428
SCHEME_OFFSET_VIRTUAL_LASER1 = 429
SCHEME_OFFSET_VIRTUAL_LASER2 = 430
SCHEME_OFFSET_VIRTUAL_LASER3 = 431
SCHEME_OFFSET_VIRTUAL_LASER4 = 432
SCHEME_OFFSET_VIRTUAL_LASER5 = 433
SCHEME_OFFSET_VIRTUAL_LASER6 = 434
SCHEME_OFFSET_VIRTUAL_LASER7 = 435
SCHEME_OFFSET_VIRTUAL_LASER8 = 436
VALVE_CNTRL_STATE_REGISTER = 437
VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER = 438
VALVE_CNTRL_USER_INLET_VALVE_REGISTER = 439
VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER = 440
VALVE_CNTRL_INLET_VALVE_REGISTER = 441
VALVE_CNTRL_OUTLET_VALVE_REGISTER = 442
VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER = 443
VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER = 444
VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER = 445
VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER = 446
VALVE_CNTRL_INLET_VALVE_MIN_REGISTER = 447
VALVE_CNTRL_INLET_VALVE_MAX_REGISTER = 448
VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER = 449
VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER = 450
VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER = 451
VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER = 452
VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER = 453
VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER = 454
VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER = 455
VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER = 456
VALVE_CNTRL_THRESHOLD_STATE_REGISTER = 457
VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER = 458
VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER = 459
VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER = 460
VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER = 461
VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER = 462
VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER = 463
VALVE_CNTRL_SEQUENCE_STEP_REGISTER = 464
VALVE_CNTRL_SOLENOID_VALVES_REGISTER = 465
VALVE_CNTRL_MPV_POSITION_REGISTER = 466
TEC_CNTRL_REGISTER = 467
SENTRY_UPPER_LIMIT_TRIPPED_REGISTER = 468
SENTRY_LOWER_LIMIT_TRIPPED_REGISTER = 469
SENTRY_LASER1_TEMPERATURE_MIN_REGISTER = 470
SENTRY_LASER1_TEMPERATURE_MAX_REGISTER = 471
SENTRY_LASER2_TEMPERATURE_MIN_REGISTER = 472
SENTRY_LASER2_TEMPERATURE_MAX_REGISTER = 473
SENTRY_LASER3_TEMPERATURE_MIN_REGISTER = 474
SENTRY_LASER3_TEMPERATURE_MAX_REGISTER = 475
SENTRY_LASER4_TEMPERATURE_MIN_REGISTER = 476
SENTRY_LASER4_TEMPERATURE_MAX_REGISTER = 477
SENTRY_ETALON_TEMPERATURE_MIN_REGISTER = 478
SENTRY_ETALON_TEMPERATURE_MAX_REGISTER = 479
SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER = 480
SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER = 481
SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER = 482
SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER = 483
SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER = 484
SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER = 485
SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER = 486
SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER = 487
SENTRY_DAS_TEMPERATURE_MIN_REGISTER = 488
SENTRY_DAS_TEMPERATURE_MAX_REGISTER = 489
SENTRY_LASER1_CURRENT_MIN_REGISTER = 490
SENTRY_LASER1_CURRENT_MAX_REGISTER = 491
SENTRY_LASER2_CURRENT_MIN_REGISTER = 492
SENTRY_LASER2_CURRENT_MAX_REGISTER = 493
SENTRY_LASER3_CURRENT_MIN_REGISTER = 494
SENTRY_LASER3_CURRENT_MAX_REGISTER = 495
SENTRY_LASER4_CURRENT_MIN_REGISTER = 496
SENTRY_LASER4_CURRENT_MAX_REGISTER = 497
SENTRY_CAVITY_PRESSURE_MIN_REGISTER = 498
SENTRY_CAVITY_PRESSURE_MAX_REGISTER = 499
SENTRY_AMBIENT_PRESSURE_MIN_REGISTER = 500
SENTRY_AMBIENT_PRESSURE_MAX_REGISTER = 501
SENTRY_FILTER_HEATER_TEMPERATURE_MIN_REGISTER = 502
SENTRY_FILTER_HEATER_TEMPERATURE_MAX_REGISTER = 503
FAN_CNTRL_STATE_REGISTER = 504
FAN_CNTRL_TEMPERATURE_REGISTER = 505
KEEP_ALIVE_REGISTER = 506
LOSS_BUFFER_0_REGISTER = 507
LOSS_BUFFER_1_REGISTER = 508
LOSS_BUFFER_2_REGISTER = 509
LOSS_BUFFER_3_REGISTER = 510
LOSS_BUFFER_4_REGISTER = 511
LOSS_BUFFER_5_REGISTER = 512
LOSS_BUFFER_6_REGISTER = 513
LOSS_BUFFER_7_REGISTER = 514
PROCESSED_LOSS_1_REGISTER = 515
PROCESSED_LOSS_2_REGISTER = 516
PROCESSED_LOSS_3_REGISTER = 517
PROCESSED_LOSS_4_REGISTER = 518
PEAK_DETECT_CNTRL_STATE_REGISTER = 519
PEAK_DETECT_CNTRL_BACKGROUND_SAMPLES_REGISTER = 520
PEAK_DETECT_CNTRL_BACKGROUND_REGISTER = 521
PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER = 522
PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER = 523
PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER = 524
PEAK_DETECT_CNTRL_THRESHOLD_FACTOR_REGISTER = 525
PEAK_DETECT_CNTRL_ACTIVE_SIZE_REGISTER = 526
PEAK_DETECT_CNTRL_POST_PEAK_SAMPLES_REGISTER = 527
PEAK_DETECT_CNTRL_CANCELLING_SAMPLES_REGISTER = 528
PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER = 529
PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER = 530
PEAK_DETECT_CNTRL_TRIGGERED_DURATION_REGISTER = 531
PEAK_DETECT_CNTRL_TRANSITIONING_DURATION_REGISTER = 532
PEAK_DETECT_CNTRL_TRANSITIONING_HOLDOFF_REGISTER = 533
PEAK_DETECT_CNTRL_HOLDING_MAX_LOSS_REGISTER = 534
PEAK_DETECT_CNTRL_HOLDING_DURATION_REGISTER = 535
PEAK_DETECT_CNTRL_PRIMING_DURATION_REGISTER = 536
PEAK_DETECT_CNTRL_PURGING_DURATION_REGISTER = 537
PEAK_DETECT_CNTRL_REMAINING_SAMPLES_REGISTER = 538
PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER = 539
PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER = 540
PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER = 541
PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER = 542
PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER = 543
PEAK_DETECT_CNTRL_HOLDING_VALVE_MASK_AND_VALUE_REGISTER = 544
PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER = 545
PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER = 546
PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER = 547
PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER = 548
PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER = 549
FLOW1_REGISTER = 550
CONVERSION_FLOW1_SCALE_REGISTER = 551
CONVERSION_FLOW1_OFFSET_REGISTER = 552
RDD_BALANCE_REGISTER = 553
RDD_GAIN_REGISTER = 554
FLOW_CNTRL_STATE_REGISTER = 555
FLOW_CNTRL_SETPOINT_REGISTER = 556
FLOW_CNTRL_GAIN_REGISTER = 557
FLOW_0_SETPOINT_REGISTER = 558
FLOW_1_SETPOINT_REGISTER = 559
FLOW_2_SETPOINT_REGISTER = 560
FLOW_3_SETPOINT_REGISTER = 561
BATTERY_MONITOR_STATUS_REGISTER = 562
BATTERY_MONITOR_CHARGE_REGISTER = 563
BATTERY_MONITOR_VOLTAGE_REGISTER = 564
BATTERY_MONITOR_CURRENT_REGISTER = 565
BATTERY_MONITOR_TEMPERATURE_REGISTER = 566
...
registerByName[
    "PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER"] = PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER
...
registerByName[
    "PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER"] = PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER
...
registerByName[
    "PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER"] = PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER
...
registerByName[
    "PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER"] = PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER
...
registerByName[
    "PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER"] = PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER
...
registerByName[
    "PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER"] = PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER
...
persistent_fpga_registers.append((u'FPGA_KERNEL', [
    u'KERNEL_CONFIG', u'KERNEL_INTRONIX_CLKSEL', u'KERNEL_INTRONIX_1', u'KERNEL_INTRONIX_2', u'KERNEL_INTRONIX_3',
    u'KERNEL_SEL_DETECTOR_MODE'
]))
persistent_fpga_registers.append(
    (u'FPGA_RDSIM',
     [u'RDSIM_OPTIONS', u'RDSIM_PZT_WINDOW_HALF_WIDTH', u'RDSIM_FILLING_RATE', u'RDSIM_DECAY_IN_SHIFT', u'RDSIM_DECAY_IN_OFFSET']))
persistent_fpga_registers.append((u'FPGA_LASERLOCKER', [
    u'LASERLOCKER_OPTIONS', u'LASERLOCKER_ETA1_OFFSET', u'LASERLOCKER_REF1_OFFSET', u'LASERLOCKER_ETA2_OFFSET',
    u'LASERLOCKER_REF2_OFFSET', u'LASERLOCKER_TUNING_OFFSET', u'LASERLOCKER_WM_LOCK_WINDOW', u'LASERLOCKER_WM_INT_GAIN',
    u'LASERLOCKER_WM_PROP_GAIN', u'LASERLOCKER_WM_DERIV_GAIN'
]))
persistent_fpga_registers.append((u'FPGA_RDMAN', [
    u'RDMAN_OPTIONS', u'RDMAN_DIVISOR', u'RDMAN_NUM_SAMP', u'RDMAN_THRESHOLD', u'RDMAN_LOCK_DURATION', u'RDMAN_PRECONTROL_DURATION',
    u'RDMAN_OFF_DURATION', u'RDMAN_EXTRA_DURATION'
]))
persistent_fpga_registers.append((u'FPGA_TWGEN', [u'TWGEN_SLOPE_DOWN', u'TWGEN_SLOPE_UP']))
persistent_fpga_registers.append((u'FPGA_INJECT', [
    u'INJECT_CONTROL', u'INJECT_CONTROL2', u'INJECT_LASER1_FINE_CURRENT_RANGE', u'INJECT_LASER2_FINE_CURRENT_RANGE',
    u'INJECT_LASER3_FINE_CURRENT_RANGE', u'INJECT_LASER4_FINE_CURRENT_RANGE'
]))
persistent_fpga_registers.append((u'FPGA_WLMSIM', [
    u'WLMSIM_OPTIONS', u'WLMSIM_RFAC', u'WLMSIM_WFAC', u'WLMSIM_ETA1_OFFSET', u'WLMSIM_REF1_OFFSET', u'WLMSIM_ETA2_OFFSET',
    u'WLMSIM_REF2_OFFSET'
]))
...
persistent_fpga_registers.append((u'FPGA_LASERCURRENTGENERATOR', [
    u'LASERCURRENTGENERATOR_CONTROL_STATUS', u'LASERCURRENTGENERATOR_SLOW_SLOPE', u'LASERCURRENTGENERATOR_FAST_SLOPE',
    u'LASERCURRENTGENERATOR_FIRST_OFFSET', u'LASERCURRENTGENERATOR_SECOND_OFFSET', u'LASERCURRENTGENERATOR_FIRST_BREAKPOINT',
    u'LASERCURRENTGENERATOR_SECOND_BREAKPOINT', u'LASERCURRENTGENERATOR_TRANSITION_COUNTER_LIMIT',
    u'LASERCURRENTGENERATOR_PERIOD_COUNTER_LIMIT', u'LASERCURRENTGENERATOR_LOWER_WINDOW', u'LASERCURRENTGENERATOR_UPPER_WINDOW'
]))
...
__p.append(('fpga', 'mask', FPGA_KERNEL + KERNEL_CONTROL, [(1, u'Reset Cypress FX2 and FPGA', [(0, u'Idle'), (1, u'Reset')]),
                                                           (2, u'Reset overload register', [(0, u'Idle'), (2, u'Reset')]),
                                                           (4, u'Reset i2c multiplexers', [(0, u'Idle'), (4, u'Reset')]),
                                                           (8, u'Manually set FPGA digital outputs', [(0, u'Automatic control'),
                                                                                                      (8, u'Manual control')])],
            None, None, 1, 1))
__p.append(('fpga', 'mask', FPGA_KERNEL + KERNEL_CONFIG, [(1, u'Auxiliary PZT Enable', [(0, u'Disable'), (1, u'Enable')]),
                                                          (2, u'Engine 1 TEC Enable', [(0, u'Disable'), (2, u'Enable')]),
                                                          (4, u'Engine 2 TEC Enable', [(0, u'Disable'),
                                                                                       (4, u'Enable')])], None, None, 1, 1))
...
__p.append(
    ('fpga', 'mask', FPGA_KERNEL + KERNEL_INTRONIX_CLKSEL, [(31, u'Intronix sampling rate', [(0, u'20 ns'), (1, u'40 ns'),
                                                                                             (2, u'80 ns'), (3, u'160 ns'),
                                                                                             (4, u'320 ns'), (5, u'640 ns'),
                                                                                             (6, u'1.28 us'), (7, u'2.56 us'),
                                                                                             (8, u'5.12 us'), (9, u'10.24 us'),
                                                                                             (10, u'20.48 us'), (11, u'40.96 us'),
                                                                                             (12, u'81.92 us'), (13, u'163.8 us'),
                                                                                             (14, u'327.7 us'), (15, u'655.4 us'),
                                                                                             (16, u'1.311 ms'), (17, u'2.621 ms'),
                                                                                             (18, u'5.243 ms'), (19, u'10.49 ms'),
                                                                                             (20, u'20.97 ms'), (21, u'41.94 ms'),
                                                                                             (22, u'83.39 ms'), (23, u'167.8 ms'),
                                                                                             (24, u'335.5 ms'), (25, u'671.1 ms'),
                                                                                             (26, u'1.342 s'), (27, u'2.684 s'),
                                                                                             (28, u'5.368 s')])], None, None, 1, 1))
__p.append(('fpga', 'mask', FPGA_KERNEL + KERNEL_INTRONIX_1, [(255, u'Intronix display 1 channel',
                                                               [(0, u'Tuner waveform (LS)'), (1, u'Tuner waveform (MS)'),
                                                                (2, u'Ringdown ADC waveform (LS)'),
                                                                (3, u'Ringdown ADC waveform (MS)'),
                                                                (4, u'Ringdown simulator waveform (LS)'),
                                                                (5, u'Ringdown simulator waveform (MS)'),
                                                                (6, u'Laser fine current (LS)'), (7, u'Laser fine current (MS)'),
                                                                (8, u'Locker error (LS)'), (9, u'Locker error (MS)'),
                                                                (10, u'Ratio 1 (LS)'), (11, u'Ratio 1 (MS)'), (12, u'Ratio 2 (LS)'),
                                                                (13, u'Ratio 2 (MS)'), (14, u'PZT (LS)'), (15, u'PZT (MS)'),
                                                                (16, u'Etalon 1 ADC (LS)'), (17, u'Etalon 1 ADC (MS)'),
                                                                (18, u'Reference 1 ADC (LS)'), (19, u'Reference 1 ADC (MS)'),
                                                                (20, u'Etalon 2 ADC (LS)'), (21, u'Etalon 2 ADC (MS)'),
                                                                (22, u'Reference 2 ADC (LS)'), (23, u'Reference 2 ADC (MS)'),
                                                                (24, u'WLM ADC signals'), (25, u'System clocks'),
                                                                (26, u'PWM signals'), (27, u'I2C signals')])], None, None, 1, 1))
__p.append(('fpga', 'mask', FPGA_KERNEL + KERNEL_INTRONIX_2, [(255, u'Intronix display 2 channel',
                                                               [(0, u'Tuner waveform (LS)'), (1, u'Tuner waveform (MS)'),
                                                                (2, u'Ringdown ADC waveform (LS)'),
                                                                (3, u'Ringdown ADC waveform (MS)'),
                                                                (4, u'Ringdown simulator waveform (LS)'),
                                                                ...
                                                                (24, u'WLM ADC signals'), (25, u'System clocks'),
                                                                (26, u'PWM signals'), (27, u'I2C signals')])], None, None, 1, 1))
__p.append(('fpga', 'mask', FPGA_KERNEL + KERNEL_INTRONIX_3, [(255, u'Intronix display 3 channel',
                                                               [(0, u'Tuner waveform (LS)'), (1, u'Tuner waveform (MS)'),
                                                                (2, u'Ringdown ADC waveform (LS)'),
                                                                (3, u'Ringdown ADC waveform (MS)'),
                                                                (4, u'Ringdown simulator waveform (LS)'),
                                                                ...
                                                                (26, u'PWM signals'), (27, u'I2C signals')])], None, None, 1, 1))
__p.append(
    ('fpga', 'mask', FPGA_KERNEL + KERNEL_STATUS_LED, [(1, u'State of Red LED', [(0, u'Red LED OFF'), (1, u'Red LED ON')]),
                                                       (2, u'State of green LED', [(0, u'Green LED OFF'),
                                                                                   (2, u'Green LED ON')])], None, None, 1, 1))
__p.append(('fpga', 'mask', FPGA_KERNEL + KERNEL_FAN, [(1, u'State of fan1', [(0, u'Fan1 OFF'), (1, u'Fan1 ON')]),
                                                       (2, u'State of fan2', [(0, u'Fan2 OFF'),
                                                                              (2, u'Fan2 ON')])], None, None, 1, 1))
__p.append(
    ('fpga', 'mask', FPGA_KERNEL + KERNEL_SEL_DETECTOR_MODE, [(15, u'', [(0, u'All lasers on first detector'),
                                                                         (14, u'Laser  1 on first detector'),
                                                                         (12, u'Lasers 1, 2 on first detector'),
                                                                         (8, u'Lasers 1, 2, 3 on first detector'),
                                                                         (15, u'All lasers on second detector'),
                                                                         (1, u'Lasers 2, 3, 4 on first detector'),
                                                                         (2, u'Lasers 1, 3, 4 on first detector'),
                                                                         (3, u'Lasers 3, 4 on first detector'),
                                                                         (4, u'Lasers 1, 2, 4 on first detector'),
                                                                         (5, u'Lasers 2, 4 on first detector'),
                                                                         (6, u'Lasers 1, 4 on first detector'),
                                                                         (7, u'Laser  4 on first detector'),
                                                                         (9, u'Lasers 2, 3 on first detector'),
                                                                         (10, u'Lasers 1, 3 on first detector'),
                                                                         (11, u'Laser  3 on first detector'),
                                                                         (13, u'Laser  2 on first detector')])], None, None, 1, 1))
...
__p.append(('dsp', 'choices', LASER1_TEMP_CNTRL_STATE_REGISTER, 'Temperature Controller Mode', '', [
    (TEMP_CNTRL_DisabledState, "Controller Disabled"),
    (TEMP_CNTRL_EnabledState, "Controller Enabled"),
    (TEMP_CNTRL_SuspendedState, "Controller Suspended"),
    (TEMP_CNTRL_SweepingState, "Continuous Sweeping"),
    (TEMP_CNTRL_SendPrbsState, "Sending PRBS"),
    (TEMP_CNTRL_ManualState, "Manual Control"),
    (TEMP_CNTRL_AutomaticState, "Automatic Control"),
], 1, 1))
...
__p.append(('dsp', 'choices', LASER1_CURRENT_CNTRL_STATE_REGISTER, 'Current Controller Mode', '', [
    (LASER_CURRENT_CNTRL_DisabledState, "Controller Disabled"),
    (LASER_CURRENT_CNTRL_AutomaticState, "Automatic Control"),
    (LASER_CURRENT_CNTRL_SweepingState, "Continuous Sweeping"),
    (LASER_CURRENT_CNTRL_ManualState, "Manual Control"),
], 1, 1))
...
__p.append(('fpga', 'uint16', FPGA_INJECT + INJECT_LASER1_FINE_CURRENT_RANGE, 'Laser 1 fine current range (auto mode)', 'digU',
            '%d', 1, 1))
...
__p.append(
    ('dsp', 'float', LASER1_EXTRA_COARSE_SCALE_REGISTER, 'Extra Current Mode Coarse Scale Factor (0 to 2)', '', '%.5f', 1, 1))
...
__p.append(('dsp', 'choices', LASER2_TEMP_CNTRL_STATE_REGISTER, 'Temperature Controller Mode', '', [
    (TEMP_CNTRL_DisabledState, "Controller Disabled"),
    (TEMP_CNTRL_EnabledState, "Controller Enabled"),
    (TEMP_CNTRL_SuspendedState, "Controller Suspended"),
    (TEMP_CNTRL_SweepingState, "Continuous Sweeping"),
...
__p.append(('dsp', 'choices', LASER2_CURRENT_CNTRL_STATE_REGISTER, 'Current Controller Mode', '', [
    (LASER_CURRENT_CNTRL_DisabledState, "Controller Disabled"),
    (LASER_CURRENT_CNTRL_AutomaticState, "Automatic Control"),
    (LASER_CURRENT_CNTRL_SweepingState, "Continuous Sweeping"),
    (LASER_CURRENT_CNTRL_ManualState, "Manual Control"),
...
__p.append(('fpga', 'uint16', FPGA_INJECT + INJECT_LASER2_FINE_CURRENT_RANGE, 'Laser 2 fine current range (auto mode)', 'digU',
            '%d', 1, 1))
...
__p.append(
    ('dsp', 'float', LASER2_EXTRA_COARSE_SCALE_REGISTER, 'Extra Current Mode Coarse Scale Factor (0 to 2)', '', '%.5f', 1, 1))
...
__p.append(('dsp', 'choices', LASER3_TEMP_CNTRL_STATE_REGISTER, 'Temperature Controller Mode', '', [
    (TEMP_CNTRL_DisabledState, "Controller Disabled"),
    (TEMP_CNTRL_EnabledState, "Controller Enabled"),
    (TEMP_CNTRL_SuspendedState, "Controller Suspended"),
    (TEMP_CNTRL_SweepingState, "Continuous Sweeping"),
...
__p.append(('fpga', 'uint16', FPGA_INJECT + INJECT_LASER3_FINE_CURRENT_RANGE, 'Laser 3 fine current range (auto mode)', 'digU',
            '%d', 1, 1))
__p.append(('dsp', 'choices', LASER3_CURRENT_CNTRL_STATE_REGISTER, 'Current Controller Mode', '', [
    (LASER_CURRENT_CNTRL_DisabledState, "Controller Disabled"),
    (LASER_CURRENT_CNTRL_AutomaticState, "Automatic Control"),
    (LASER_CURRENT_CNTRL_SweepingState, "Continuous Sweeping"),
    (LASER_CURRENT_CNTRL_ManualState, "Manual Control"),
...
__p.append(
    ('dsp', 'float', LASER3_EXTRA_COARSE_SCALE_REGISTER, 'Extra Current Mode Coarse Scale Factor (0 to 2)', '', '%.5f', 1, 1))
...
__p.append(('dsp', 'choices', LASER4_TEMP_CNTRL_STATE_REGISTER, 'Temperature Controller Mode', '', [
    (TEMP_CNTRL_DisabledState, "Controller Disabled"),
    (TEMP_CNTRL_EnabledState, "Controller Enabled"),
    (TEMP_CNTRL_SuspendedState, "Controller Suspended"),
    (TEMP_CNTRL_SweepingState, "Continuous Sweeping"),
...
__p.append(('fpga', 'uint16', FPGA_INJECT + INJECT_LASER4_FINE_CURRENT_RANGE, 'Laser 4 fine current range (auto mode)', 'digU',
            '%d', 1, 1))
__p.append(('dsp', 'choices', LASER4_CURRENT_CNTRL_STATE_REGISTER, 'Current Controller Mode', '', [
    (LASER_CURRENT_CNTRL_DisabledState, "Controller Disabled"),
    (LASER_CURRENT_CNTRL_AutomaticState, "Automatic Control"),
    (LASER_CURRENT_CNTRL_SweepingState, "Continuous Sweeping"),
    (LASER_CURRENT_CNTRL_ManualState, "Manual Control"),
...
__p.append(
    ('dsp', 'float', LASER4_EXTRA_COARSE_SCALE_REGISTER, 'Extra Current Mode Coarse Scale Factor (0 to 2)', '', '%.5f', 1, 1))
...
__p.append(('dsp', 'choices', WARM_BOX_TEMP_CNTRL_STATE_REGISTER, 'Temperature Controller Mode', '', [
    (TEMP_CNTRL_DisabledState, "Controller Disabled"),
    (TEMP_CNTRL_EnabledState, "Controller Enabled"),
    (TEMP_CNTRL_SuspendedState, "Controller Suspended"),
    (TEMP_CNTRL_SweepingState, "Continuous Sweeping"),
...
__p.append(('dsp', 'choices', TEC_CNTRL_REGISTER, 'Warm and hot box TEC', '', [
    (TEC_CNTRL_Disabled, "Disabled"),
    (TEC_CNTRL_Enabled, "Enabled"),
], 1, 1))
...
__p.append(('dsp', 'choices', CAVITY_TEMP_CNTRL_STATE_REGISTER, 'Temperature Controller Mode', '', [
    (TEMP_CNTRL_DisabledState, "Controller Disabled"),
    (TEMP_CNTRL_EnabledState, "Controller Enabled"),
    (TEMP_CNTRL_SuspendedState, "Controller Suspended"),
    (TEMP_CNTRL_SweepingState, "Continuous Sweeping"),
...
__p.append(('dsp', 'choices', HEATER_TEMP_CNTRL_STATE_REGISTER, 'Heater Controller Mode', '', [
    (TEMP_CNTRL_DisabledState, "Controller Disabled"),
    (TEMP_CNTRL_EnabledState, "Controller Enabled"),
    (TEMP_CNTRL_SuspendedState, "Controller Suspended"),
    (TEMP_CNTRL_SweepingState, "Continuous Sweeping"),
...
__p.append(('dsp', 'float', HEATER_TEMP_CNTRL_USER_SETPOINT_REGISTER, 'Target temperature difference between heatsink and cavity',
            'degC', '%.3f', 1, 1))
...
__p.append(('dsp', 'choices', FILTER_HEATER_TEMP_CNTRL_STATE_REGISTER, 'Temperature Controller Mode', '', [
    (TEMP_CNTRL_DisabledState, "Controller Disabled"),
    (TEMP_CNTRL_EnabledState, "Controller Enabled"),
    (TEMP_CNTRL_SuspendedState, "Controller Suspended"),
    (TEMP_CNTRL_SweepingState, "Continuous Sweeping"),
...
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_USER_SETPOINT_REGISTER, 'Setpoint', 'degC', '%.3f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_TOLERANCE_REGISTER, 'Lock tolerance', 'degC', '%.3f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_SWEEP_MAX_REGISTER, 'Max sweep value', 'degC', '%.3f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_SWEEP_MIN_REGISTER, 'Min sweep value', 'degC', '%.3f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_SWEEP_INCR_REGISTER, 'Sweep increment', 'degC/sample', '%.4f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_H_REGISTER, 'Sample interval', 's', '%.3f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_K_REGISTER, 'Loop proportional gain (K)', '', '%.2f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_TI_REGISTER, 'Integration time (Ti)', 's', '%.2f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_TD_REGISTER, 'Derivative time (Td)', 's', '%.2f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_B_REGISTER, 'Proportional setpoint gain (b)', '', '%.3f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_C_REGISTER, 'Derivative setpoint gain (c)', '', '%.3f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_N_REGISTER, 'Derivative regularization (N)', '', '%.2f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_S_REGISTER, 'Saturation regularization (S)', '', '%.2f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_AMIN_REGISTER, 'Minimum heater value (Amin)', '', '%.0f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_AMAX_REGISTER, 'Maximum heater value (Amax)', '', '%.0f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_IMAX_REGISTER, 'Maximum actuator increment (Imax)', '', '%.1f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_TEMP_CNTRL_FFWD_REGISTER, 'DAS temperature feed forward coefficient', '', '%.3f', 1, 1))
__p.append(('dsp', 'uint32', FILTER_HEATER_PRBS_GENPOLY_REGISTER, 'PRBS generator', '', '$%X', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_PRBS_AMPLITUDE_REGISTER, 'PRBS amplitude', '', '%.1f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_PRBS_MEAN_REGISTER, 'PRBS mean', '', '%.1f', 1, 1))
__p.append(('dsp', 'float', FILTER_HEATER_MANUAL_REGISTER, 'Manual TEC Value', 'digU', '%.0f', 1, 1))
...
__p.append(('dsp', 'choices', FAN_CNTRL_STATE_REGISTER, 'Fan State', '', [
    (FAN_CNTRL_OffState, "Fans off"),
    (FAN_CNTRL_OnState, "Fans on"),
], 1, 1))
...
__p.append(('dsp', 'choices', VALVE_CNTRL_STATE_REGISTER, 'Valve Controller Mode', '', [
    (VALVE_CNTRL_DisabledState, "Disabled"),
    (VALVE_CNTRL_OutletControlState, "Outlet control"),
    (VALVE_CNTRL_InletControlState, "Inlet control"),
    (VALVE_CNTRL_ManualControlState, "Manual control"),
    (VALVE_CNTRL_SaveAndCloseValvesState, "Save valve settings and close valves"),
    (VALVE_CNTRL_RestoreValvesState, "Restore valve settings and saved state"),
    (VALVE_CNTRL_OutletOnlyControlState, "Outlet only (no inlet valve) control, normal operation"),
    (VALVE_CNTRL_OutletOnlyRecoveryState, "Outlet only (no inlet valve) control, pump disconnected"),
], 1, 1))
...
__p.append(('dsp', 'float', VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER, 'Rate of cavity pressure change to disable controller',
            'torr/s', '%.3f', 1, 1))
__p.append(('dsp', 'float', VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER, 'Cavity pressure maximum rate of change', 'torr/s',
            '%.3f', 1, 1))
...
__p.append(('dsp', 'float', VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER, 'Inlet valve maximum change between samples', 'digU',
            '%.1f', 1, 1))
...
__p.append(('dsp', 'float', VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER, 'Outlet valve maximum change between samples', 'digU',
            '%.1f', 1, 1))
__p.append(('dsp', 'float', VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER, 'Outlet valve dither (p-p)', 'digU', '%.1f', 1, 1))
__p.append(('dsp', 'choices', VALVE_CNTRL_THRESHOLD_STATE_REGISTER, 'Loss-based Triggering', '', [
    (VALVE_CNTRL_THRESHOLD_DisabledState, "Disabled"),
    (VALVE_CNTRL_THRESHOLD_ArmedState, "Armed"),
    (VALVE_CNTRL_THRESHOLD_TriggeredState, "Triggered"),
], 1, 1))
__p.append(('dsp', 'float', VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER, 'Loss threshold for trigger', 'ppb/cm', '%.0f', 1, 1))
__p.append(('dsp', 'float', VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER, 'Rate of change of loss for trigger', 'ppb/cm/s',
            '%.0f', 1, 1))
...
__p.append(('dsp', 'uint32', VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER, 'Bit mask to select solenoid valves affected by trigger',
            '', '$%X', 1, 1))
__p.append(
    ('dsp', 'uint32', VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER, 'Solenoid valve states when triggered', '', '$%X', 1, 1))
__p.append(('dsp', 'int32', VALVE_CNTRL_SEQUENCE_STEP_REGISTER, 'Valve sequence step (-1 to disable)', '', '%d', 1, 1))
__p.append(('dsp', 'choices', FLOW_CNTRL_STATE_REGISTER, 'Flow Controller Mode', '', [
    (FLOW_CNTRL_DisabledState, "Disabled"),
    (FLOW_CNTRL_EnabledState, "Enabled"),
], 1, 1))
...
__p.append(('dsp', 'choices', PEAK_DETECT_CNTRL_STATE_REGISTER, 'Peak Detection Controller Mode', '', [
    (PEAK_DETECT_CNTRL_IdleState, "Idle"),
    (PEAK_DETECT_CNTRL_ArmedState, "Armed"),
    (PEAK_DETECT_CNTRL_TriggerPendingState, "Trigger Pending"),
    (PEAK_DETECT_CNTRL_TriggeredState, "Triggered"),
    (PEAK_DETECT_CNTRL_InactiveState, "Inactive"),
    (PEAK_DETECT_CNTRL_CancellingState, "Cancelling"),
    (PEAK_DETECT_CNTRL_PrimingState, "Priming"),
    (PEAK_DETECT_CNTRL_PurgingState, "Purging"),
    (PEAK_DETECT_CNTRL_InjectionPendingState, "Injection Pending"),
    (PEAK_DETECT_CNTRL_TransitioningState, "Transitioning"),
    (PEAK_DETECT_CNTRL_HoldingState, "Holding"),
], 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_BACKGROUND_SAMPLES_REGISTER, 'Number of samples for calculating background',
            'samples', '%d', 1, 1))
__p.append(('dsp', 'float', PEAK_DETECT_CNTRL_BACKGROUND_REGISTER, 'Background loss', 'ppm/cm', '%.3f', 1, 1))
__p.append(('dsp', 'float', PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER, 'Upper threshold (relative to background)', 'ppm/cm',
            '%.3f', 1, 1))
__p.append(('dsp', 'float', PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER, 'Lower Threshold 1 (relative to background)', 'ppm/cm',
            '%.3f', 1, 1))
__p.append(('dsp', 'float', PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER, 'Lower Threshold 2 (relative to background)', 'ppm/cm',
            '%.3f', 1, 1))
...
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER, 'Trigger delay (after trigger condition met)', 'samples',
            '%d', 1, 1))
__p.append(
    ('dsp', 'uint32', PEAK_DETECT_CNTRL_TRIGGERED_DURATION_REGISTER, 'Triggered duration (in samples)', 'samples', '%d', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_TRANSITIONING_DURATION_REGISTER, 'Transitioning duration (in samples)', 'samples',
            '%d', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_TRANSITIONING_HOLDOFF_REGISTER, 'Transitioning holdoff duration (in samples)',
            'samples', '%d', 1, 1))
__p.append(
    ('dsp', 'float', PEAK_DETECT_CNTRL_HOLDING_MAX_LOSS_REGISTER, 'Maximum loss during holding state', 'ppm/cm', '%.3f', 1, 1))
...
__p.append(
    ('dsp', 'uint32', PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER, 'Idle state valve mask and values', '', '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER, 'Armed state valve mask and values', '',
            '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER,
            'Trigger pending state valve mask and values', '', '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER, 'Triggered state valve mask and values', '',
            '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER,
            'Transitioning state valve mask and values', '', '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_HOLDING_VALVE_MASK_AND_VALUE_REGISTER, 'Holding state valve mask and values', '',
            '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER, 'Inactive state valve mask and values', '',
            '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER, 'Cancelling state valve mask and values',
            '', '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER, 'Priming state valve mask and values', '',
            '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER, 'Purging state valve mask and values', '',
            '$%04X', 1, 1))
__p.append(('dsp', 'uint32', PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER,
            'Injection pending state valve mask and values', '', '$%04X', 1, 1))
...
__p.append(('dsp', 'choices', ANALYZER_TUNING_MODE_REGISTER, 'Analyzer tuning mode', '', [
    (ANALYZER_TUNING_CavityLengthTuningMode, "Cavity Length Tuning"),
    (ANALYZER_TUNING_LaserCurrentTuningMode, "Laser Current Tuning"),
    (ANALYZER_TUNING_FsrHoppingTuningMode, "Fsr Hopping Tuning"),
], 1, 1))
__p.append(('fpga', 'mask', FPGA_TWGEN + TWGEN_CS, [(1, u'Stop/Run', [(0, u'Stop'), (1, u'Run')]),
                                                    (2, u'Single/Continuous', [(0, u'Single'), (2, u'Continuous')]),
                                                    (4, u'Reset generator', [(0, u'Idle'), (4, u'Reset')]),
                                                    (8, u'Tune PZT', [(0, u'No'), (8, u'Yes')])], None, None, 1, 1))
...
__p.append(('dsp', 'choices', TUNER_DITHER_MEDIAN_COUNT_REGISTER, 'Number of ringdowns to use for centering dither', '', [
    (TUNER_DITHER_MEDIAN_1, "1"),
    (TUNER_DITHER_MEDIAN_3, "3"),
    (TUNER_DITHER_MEDIAN_5, "5"),
    (TUNER_DITHER_MEDIAN_7, "7"),
    (TUNER_DITHER_MEDIAN_9, "9"),
], 1, 1))
...
__p.append(('dsp', 'choices', VIRTUAL_LASER_REGISTER, 'Virtual laser', '', [
    (VIRTUAL_LASER_1, "Virtual laser 1"),
    (VIRTUAL_LASER_2, "Virtual laser 2"),
    (VIRTUAL_LASER_3, "Virtual laser 3"),
    (VIRTUAL_LASER_4, "Virtual laser 4"),
    (VIRTUAL_LASER_5, "Virtual laser 5"),
    (VIRTUAL_LASER_6, "Virtual laser 6"),
    (VIRTUAL_LASER_7, "Virtual laser 7"),
    (VIRTUAL_LASER_8, "Virtual laser 8"),
], 1, 1))
__p.append(('fpga', 'mask', FPGA_INJECT + INJECT_CONTROL,
            [(1, u'Manual/Automatic mode', [(0, u'Manual'), (1, u'Automatic')]),
             (6, u'Laser selected', [(0, u'Laser 1'), (2, u'Laser 2'), (4, u'Laser 3'), (6, u'Laser 4')]),
             (120, u'Laser current enable', []), (8, u'Laser 1 current source', []), (16, u'Laser 2 current source', []),
             (32, u'Laser 3 current source', []), (64, u'Laser 4 current source', []),
             (1920, u'Deasserts short across laser in manual mode', []), (128, u'Laser 1 current (in manual mode)', []),
             (256, u'Laser 2 current (in manual mode)', []), (512, u'Laser 3 current (in manual mode)', []),
             (1024, u'Laser 4 current (in manual mode)', []),
             (2048, u'Enable SOA current (in manual mode)', [(0, u'Off'), (2048, u'On')]),
             (4096, u'Enables laser shutdown (in automatic mode)', [(0, u'Disabled'), (4096, u'Enabled')]),
             (8192, u'Enables SOA shutdown (in automatic mode)', [(0, u'Disabled'), (8192, u'Enabled')]),
             (16384, u'Select optical switch type', [(0, u'2-way'), (16384, u'4-way')]),
             (32768, u'SOA or fiber amplifier present', [(0, u'No'), (32768, u'Yes')])], None, None, 1, 1))
__p.append(
    ('fpga', 'mask', FPGA_INJECT + INJECT_CONTROL2, [(1, u'Fiber amplifier present', [(0, u'No'), (1, u'Yes')]),
                                                     (2, u'Turn off deselected lasers', [(0, u'No'), (2, u'Yes')]),
                                                     (4, u'How is extra laser current controlled?', [(0, u'Input port'),
                                                                                                     (4, u'Bit in register')]),
                                                     (8, u'Bit for controlling extra laser current', [(0, u'Normal current'),
                                                                                                      (8, u'Extra current')]),
                                                     (16, u'Use extended laser current control', [(0, u'Disable'),
                                                                                                  (16, u'Enable')]),
                                                     (480, u'Disable SOA for some lasers', []),
                                                     (32, u'Disable SOA for laser 1', [(0, u'No'), (32, u'Yes')]),
                                                     (64, u'Disable SOA for laser 2', [(0, u'No'), (64, u'Yes')]),
                                                     (128, u'Disable SOA for laser 3', [(0, u'No'), (128, u'Yes')]),
                                                     (256, u'Disable SOA for laser 4', [(0, u'No'),
                                                                                        (256, u'Yes')])], None, None, 1, 1))
...
__p.append(('dsp', 'choices', SPECT_CNTRL_STATE_REGISTER, 'Spectrum Controller State', '', [
    (SPECT_CNTRL_IdleState, "Not acquiring"),
    (SPECT_CNTRL_StartingState, "Start acquisition"),
    (SPECT_CNTRL_StartManualState, "Start acquisition with manual temperature control"),
    (SPECT_CNTRL_RunningState, "Acquisition in progress"),
    (SPECT_CNTRL_PausedState, "Acquisition paused"),
    (SPECT_CNTRL_ErrorState, "Error state"),
    (SPECT_CNTRL_DiagnosticState, "Diagnostic state"),
], 1, 1))
__p.append(('dsp', 'choices', SPECT_CNTRL_MODE_REGISTER, 'Spectrum Controller Mode', '', [
    (SPECT_CNTRL_SchemeSingleMode, "Perform single scheme"),
    (SPECT_CNTRL_SchemeMultipleMode, "Perform multiple schemes"),
    (SPECT_CNTRL_SchemeMultipleNoRepeatMode, "Multiple schemes no repeats"),
    (SPECT_CNTRL_ContinuousMode, "Continuous acquisition"),
    (SPECT_CNTRL_ContinuousManualTempMode, "Continuous acquisition with manual temperature control"),
], 1, 1))
...
__p.append(('fpga', 'mask', FPGA_RDSIM + RDSIM_OPTIONS, [(1, u'Source of decay and tuner center parameters', [(0, u'Registers'),
                                                                                                              (1, u'Input ports')])
                                                         ], None, None, 1, 1))
__p.append(('fpga', 'uint16', FPGA_RDSIM + RDSIM_PZT_CENTER, 'PZT value (mod 16384) around which cavity fills', '', '%d', 1, 1))
__p.append(('fpga', 'uint16', FPGA_RDSIM + RDSIM_PZT_WINDOW_HALF_WIDTH, 'Half-width of PZT window within which cavity fills', '',
            '%d', 1, 1))
__p.append(
    ('fpga', 'uint16', FPGA_RDSIM + RDSIM_FILLING_RATE, 'Rate of increase of accumulator value during filling', '', '%d', 1, 1))
...
__p.append(('fpga', 'mask', FPGA_RDMAN + RDMAN_CONTROL, [(1, u'Stop/Run', [(0, u'Stop'), (1, u'Run')]),
                                                         (2, u'Single/Continuous', [(0, u'Single'), (2, u'Continuous')]),
                                                         (4, u'Start ringdown cycle', [(0, u'Idle'), (4, u'Start')]),
                                                         (8, u'Abort ringdown', [(0, u'Idle'), (8, u'Abort')]),
                                                         (16, u'Reset ringdown manager', [(0, u'Idle'), (16, u'Reset')]),
                                                         (32, u'Mark bank 0 available for write', [(0, u'Idle'),
                                                                                                   (32, u'Mark available')]),
                                                         (64, u'Mark bank 1 available for write', [(0, u'Idle'),
                                                                                                   (64, u'Mark available')]),
                                                         (128, u'Acknowledge ring-down interrupt', [(0, u'Idle'),
                                                                                                    (128, u'Acknowledge')]),
                                                         (256, u'Acknowledge data acquired interrupt', [(0, u'Idle'),
                                                                                                        (256, u'Acknowledge')]),
                                                         (512, u'Tuner waveform mode', [(0, u'Ramp'),
                                                                                        (512, u'Dither')])], None, None, 1, 1))
__p.append(
    ('fpga', 'mask', FPGA_RDMAN + RDMAN_OPTIONS, [(1, u'Enable frequency locking', [(0, u'Disable'), (1, u'Enable')]),
                                                  (2, u'Allow ring-down on positive tuner slope', [(0, u'No'), (2, u'Yes')]),
                                                  (4, u'Allow ring-down on negative tuner slope', [(0, u'No'), (4, u'Yes')]),
                                                  (8, u'Allow transition to dither mode', [(0, u'Disallow'), (8, u'Allow')]),
                                                  (16, u'Ringdown data source', [(0, u'Simulator'), (16, u'Actual ADC')]),
                                                  (32, u'Oscilloscope mode', [(0, u'Disabled'), (32, u'Enabled')]),
                                                  (64, u'Tuner slope to trigger scope', [(0, u'Falling'),
                                                                                         (64, u'Rising')])], None, None, 1, 1))
...
__p.append(
    ('dsp', 'uint32', RDFITTER_IMPROVEMENT_STEPS_REGISTER, 'Number of iterations of ringdown fit improvement', '', '%d', 1, 1))
__p.append(('dsp', 'uint32', RDFITTER_START_SAMPLE_REGISTER, 'Initial ringdown samples to ignore', '', '%d', 1, 1))
__p.append(
    ('dsp', 'float', RDFITTER_FRACTIONAL_THRESHOLD_REGISTER, 'Fractional threshold for fit window determination', '', '%.2f', 1, 1))
__p.append(
    ('dsp', 'float', RDFITTER_ABSOLUTE_THRESHOLD_REGISTER, 'Absolute threshold for fit window determination', '', '%.0f', 1, 1))
...
__p.append(('fpga', 'mask', FPGA_WLMSIM + WLMSIM_OPTIONS, [(1, u'Input select', [(0, u'Register'),
                                                                                 (1, u'Input port')])], None, None, 1, 1))
...
__p.append(('fpga', 'mask', FPGA_LASERLOCKER + LASERLOCKER_CS,
            [(1, u'Stop/Run', [(0, u'Stop'), (1, u'Run')]), (2, u'Single/Continuous', [(0, u'Single'), (2, u'Continuous')]),
             (4, u'Generate PRBS', [(0, u'Idle'), (4, u'Send PRBS')]),
             (8, u'Enable fine current acc', [(0, u'Reset'), (8, u'Accumulate')]),
             (16, u'Sample dark currents', [(0, u'Idle'), (16, u'Sample')]),
             (32, u'Load WLM ADC values', [(0, u'Idle'), (32, u'Load')]),
             (64, u'Tuner offset source', [(0, u'Register'), (64, u'Input port')]),
             (128, u'Laser frequency in window', [(0, u'Out of range'), (128, u'In Window')]),
             (256, u'Fine current calculation', [(0, u'In progress'), (256, u'Complete')])], None, None, 1, 1))
__p.append(('fpga', 'mask', FPGA_LASERLOCKER + LASERLOCKER_OPTIONS, [(1, u'Wavelength Monitor Data Source', [(0, u'Simulator'),
                                                                                                             (1, u'Actual WLM')]),
                                                                     (2, u'Route tuner input to fine current output', [(0, u'No'),
                                                                                                                       (2, u'Yes')])
                                                                     ], None, None, 1, 1))
...
__p.append(
    ('fpga', 'uint16', FPGA_LASERLOCKER + LASERLOCKER_TUNING_OFFSET, 'Tuning offset for frequency shift', 'digU', '%d', 1, 1))
...
__p.append(('fpga', 'mask', FPGA_DYNAMICPWM_INLET + DYNAMICPWM_CS, [(1, u'Stop/Run', [(0, u'Stop'), (1, u'Run')]),
                                                                    (2, u'Single/Continuous', [(0, u'Single'), (2, u'Continuous')]),
                                                                    (4, u'PWM enable', [(0, u'Disable'), (4, u'Enable')]),
                                                                    (8, u'Use comparator', [(0, u'No'), (8, u'Yes')]),
                                                                    (16, u'PWM output', [(0, u'Low'), (16, u'High')]),
                                                                    (32, u'Invert polarity of PWM signal', [(0, u'Normal'),
                                                                                                            (32, u'Inverted')])],
            None, None, 1, 1))
...
__p.append(('fpga', 'mask', FPGA_DYNAMICPWM_OUTLET + DYNAMICPWM_CS,
            [(1, u'Stop/Run', [(0, u'Stop'), (1, u'Run')]), (2, u'Single/Continuous', [(0, u'Single'), (2, u'Continuous')]),
             (4, u'PWM enable', [(0, u'Disable'), (4, u'Enable')]), (8, u'Use comparator', [(0, u'No'), (8, u'Yes')]),
             (16, u'PWM output', [(0, u'Low'), (16, u'High')]),
             (32, u'Invert polarity of PWM signal', [(0, u'Normal'), (32, u'Inverted')])], None, None, 1, 1))
...
__p.append(('dsp', 'float', SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER, 'Warm box heatsink minimum temperature', 'degC',
            '%.1f', 1, 1))
__p.append(('dsp', 'float', SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER, 'Warm box heatsink maximum temperature', 'degC',
            '%.1f', 1, 1))
...
__p.append(('dsp', 'float', SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER, 'Hot box heatsink minimum temperature', 'degC',
            '%.1f', 1, 1))
__p.append(('dsp', 'float', SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER, 'Hot box heatsink maximum temperature', 'degC',
            '%.1f', 1, 1))
__p.append(('dsp', 'float', SENTRY_FILTER_HEATER_TEMPERATURE_MIN_REGISTER, 'Filter heater minimum temperature sentry', 'degC',
            '%.1f', 1, 1))
__p.append(('dsp', 'float', SENTRY_FILTER_HEATER_TEMPERATURE_MAX_REGISTER, 'Filter heater maximum temperature sentry', 'degC',
            '%.1f', 1, 1))
