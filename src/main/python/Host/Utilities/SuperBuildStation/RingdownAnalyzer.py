...
class RingdownAnalyzer(object):
    def __init__(self, frame, config):
        ...
        self.frame.graph_panel_spectrum.SetGraphProperties(xlabel='Wavenumber',
                                                           timeAxes=(False, False),
                                                           ylabel='Ripple (ppb/cm)',
                                                           grid=True,
        ...
        self.frame.graph_panel_spectrum.AddSeriesAsPoints(self.spectrumWaveformGood,
                                                          colour='blue',
                                                          fillcolour='blue',
                                                          marker='square',
                                                          size=1,
                                                          width=1)
        self.frame.graph_panel_spectrum.AddSeriesAsPoints(self.spectrumWaveformBad,
                                                          colour='red',
                                                          fillcolour='red',
                                                          marker='square',
                                                          size=1,
                                                          width=1)
        self.frame.graph_panel_ripple.SetGraphProperties(xlabel='Ripple Period',
                                                         timeAxes=(False, False),
                                                         ylabel='Ripple Amplitude (ppb/cm)',
                                                         grid=True,
                                                         frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                                         backgroundColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                                         XSpec=(0.0, 2.0))
    ...
    def graphAgainstRingdown(self):
        self.frame.graph_panel_1.SetGraphProperties(xlabel='Ringdown',
                                                    timeAxes=(False, False),
                                                    ylabel='Ringdown Index',
                                                    grid=True,
                                                    frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                                    backgroundColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE))
        self.frame.graph_panel_1.AddSeriesAsPoints(self.graph1Waveform,
                                                   colour='red',
                                                   fillcolour='red',
                                                   marker='square',
                                                   size=1,
                                                   width=1)
        self.frame.graph_panel_2.SetGraphProperties(xlabel='Ringdown',
                                                    timeAxes=(False, False),
                                                    ylabel='Shot to shot (%)',
                                                    grid=True,
                                                    frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
                                                    backgroundColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE))
        self.frame.graph_panel_2.AddSeriesAsPoints(self.graph2Waveform,
                                                   colour='red',
                                                   fillcolour='red',
                                                   marker='square',
                                                   size=1,
    ...
    def graphAgainstTime(self):
        self.frame.graph_panel_1.SetGraphProperties(xlabel='Time',
                                                    timeAxes=(True, False),
                                                    ylabel='RD Time (us)',
                                                    grid=True,
                                                    frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
        ...
        self.frame.graph_panel_1.AddSeriesAsPoints(self.graph1Waveform,
                                                   ...
                                                   size=1,
                                                   width=1)
        self.frame.graph_panel_2.SetGraphProperties(xlabel='Time',
                                                    timeAxes=(True, False),
                                                    ylabel='Shot to shot (%)',
                                                    grid=True,
                                                    frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
    ...
    def graphAgainstWavenumber(self):
        self.frame.graph_panel_1.SetGraphProperties(xlabel='Wavenumber',
                                                    timeAxes=(False, False),
                                                    ylabel='RD Time (us)',
                                                    grid=True,
                                                    frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
        ...
        self.frame.graph_panel_1.AddSeriesAsPoints(self.graph1Waveform,
                                                   ...
                                                   size=1,
                                                   width=1)
        self.frame.graph_panel_2.SetGraphProperties(xlabel='Wavenumber',
                                                    timeAxes=(False, False),
                                                    ylabel='Shot to shot (%)',
                                                    grid=True,
                                                    frameColour=wx.SystemSettings_GetColour(wx.SYS_COLOUR_3DFACE),
    ...
    def clearBuffers(self):
        ...
        self.varSum = zeros(3, dtype=float)
        self.varSumSq = zeros(3, dtype=float)
        while len(self.varDeque) > 0:
            self.varDeque.popleft()
