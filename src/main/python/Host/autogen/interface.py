...
THRESHOLD_FACTOR_VIRTUAL_LASER1 = 437
THRESHOLD_FACTOR_VIRTUAL_LASER2 = 438
THRESHOLD_FACTOR_VIRTUAL_LASER3 = 439
THRESHOLD_FACTOR_VIRTUAL_LASER4 = 440
THRESHOLD_FACTOR_VIRTUAL_LASER5 = 441
THRESHOLD_FACTOR_VIRTUAL_LASER6 = 442
THRESHOLD_FACTOR_VIRTUAL_LASER7 = 443
THRESHOLD_FACTOR_VIRTUAL_LASER8 = 444
SCHEME_THRESHOLD_BASE = 445
VALVE_CNTRL_STATE_REGISTER = 446
VALVE_CNTRL_CAVITY_PRESSURE_SETPOINT_REGISTER = 447
VALVE_CNTRL_USER_INLET_VALVE_REGISTER = 448
VALVE_CNTRL_USER_OUTLET_VALVE_REGISTER = 449
VALVE_CNTRL_INLET_VALVE_REGISTER = 450
VALVE_CNTRL_OUTLET_VALVE_REGISTER = 451
VALVE_CNTRL_CAVITY_PRESSURE_MAX_RATE_REGISTER = 452
VALVE_CNTRL_CAVITY_PRESSURE_RATE_ABORT_REGISTER = 453
VALVE_CNTRL_INLET_VALVE_GAIN1_REGISTER = 454
VALVE_CNTRL_INLET_VALVE_GAIN2_REGISTER = 455
VALVE_CNTRL_INLET_VALVE_MIN_REGISTER = 456
VALVE_CNTRL_INLET_VALVE_MAX_REGISTER = 457
VALVE_CNTRL_INLET_VALVE_MAX_CHANGE_REGISTER = 458
VALVE_CNTRL_INLET_VALVE_DITHER_REGISTER = 459
VALVE_CNTRL_OUTLET_VALVE_GAIN1_REGISTER = 460
VALVE_CNTRL_OUTLET_VALVE_GAIN2_REGISTER = 461
VALVE_CNTRL_OUTLET_VALVE_MIN_REGISTER = 462
VALVE_CNTRL_OUTLET_VALVE_MAX_REGISTER = 463
VALVE_CNTRL_OUTLET_VALVE_MAX_CHANGE_REGISTER = 464
VALVE_CNTRL_OUTLET_VALVE_DITHER_REGISTER = 465
VALVE_CNTRL_THRESHOLD_STATE_REGISTER = 466
VALVE_CNTRL_RISING_LOSS_THRESHOLD_REGISTER = 467
VALVE_CNTRL_RISING_LOSS_RATE_THRESHOLD_REGISTER = 468
VALVE_CNTRL_TRIGGERED_INLET_VALVE_VALUE_REGISTER = 469
VALVE_CNTRL_TRIGGERED_OUTLET_VALVE_VALUE_REGISTER = 470
VALVE_CNTRL_TRIGGERED_SOLENOID_MASK_REGISTER = 471
VALVE_CNTRL_TRIGGERED_SOLENOID_STATE_REGISTER = 472
VALVE_CNTRL_SEQUENCE_STEP_REGISTER = 473
VALVE_CNTRL_SOLENOID_VALVES_REGISTER = 474
VALVE_CNTRL_MPV_POSITION_REGISTER = 475
TEC_CNTRL_REGISTER = 476
SENTRY_UPPER_LIMIT_TRIPPED_REGISTER = 477
SENTRY_LOWER_LIMIT_TRIPPED_REGISTER = 478
SENTRY_LASER1_TEMPERATURE_MIN_REGISTER = 479
SENTRY_LASER1_TEMPERATURE_MAX_REGISTER = 480
SENTRY_LASER2_TEMPERATURE_MIN_REGISTER = 481
SENTRY_LASER2_TEMPERATURE_MAX_REGISTER = 482
SENTRY_LASER3_TEMPERATURE_MIN_REGISTER = 483
SENTRY_LASER3_TEMPERATURE_MAX_REGISTER = 484
SENTRY_LASER4_TEMPERATURE_MIN_REGISTER = 485
SENTRY_LASER4_TEMPERATURE_MAX_REGISTER = 486
SENTRY_ETALON_TEMPERATURE_MIN_REGISTER = 487
SENTRY_ETALON_TEMPERATURE_MAX_REGISTER = 488
SENTRY_WARM_BOX_TEMPERATURE_MIN_REGISTER = 489
SENTRY_WARM_BOX_TEMPERATURE_MAX_REGISTER = 490
SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER = 491
SENTRY_WARM_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER = 492
SENTRY_CAVITY_TEMPERATURE_MIN_REGISTER = 493
SENTRY_CAVITY_TEMPERATURE_MAX_REGISTER = 494
SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MIN_REGISTER = 495
SENTRY_HOT_BOX_HEATSINK_TEMPERATURE_MAX_REGISTER = 496
SENTRY_DAS_TEMPERATURE_MIN_REGISTER = 497
SENTRY_DAS_TEMPERATURE_MAX_REGISTER = 498
SENTRY_LASER1_CURRENT_MIN_REGISTER = 499
SENTRY_LASER1_CURRENT_MAX_REGISTER = 500
SENTRY_LASER2_CURRENT_MIN_REGISTER = 501
SENTRY_LASER2_CURRENT_MAX_REGISTER = 502
SENTRY_LASER3_CURRENT_MIN_REGISTER = 503
SENTRY_LASER3_CURRENT_MAX_REGISTER = 504
SENTRY_LASER4_CURRENT_MIN_REGISTER = 505
SENTRY_LASER4_CURRENT_MAX_REGISTER = 506
SENTRY_CAVITY_PRESSURE_MIN_REGISTER = 507
SENTRY_CAVITY_PRESSURE_MAX_REGISTER = 508
SENTRY_AMBIENT_PRESSURE_MIN_REGISTER = 509
SENTRY_AMBIENT_PRESSURE_MAX_REGISTER = 510
SENTRY_FILTER_HEATER_TEMPERATURE_MIN_REGISTER = 511
SENTRY_FILTER_HEATER_TEMPERATURE_MAX_REGISTER = 512
FAN_CNTRL_STATE_REGISTER = 513
FAN_CNTRL_TEMPERATURE_REGISTER = 514
KEEP_ALIVE_REGISTER = 515
LOSS_BUFFER_0_REGISTER = 516
LOSS_BUFFER_1_REGISTER = 517
LOSS_BUFFER_2_REGISTER = 518
LOSS_BUFFER_3_REGISTER = 519
LOSS_BUFFER_4_REGISTER = 520
LOSS_BUFFER_5_REGISTER = 521
LOSS_BUFFER_6_REGISTER = 522
LOSS_BUFFER_7_REGISTER = 523
PROCESSED_LOSS_1_REGISTER = 524
PROCESSED_LOSS_2_REGISTER = 525
PROCESSED_LOSS_3_REGISTER = 526
PROCESSED_LOSS_4_REGISTER = 527
PEAK_DETECT_CNTRL_STATE_REGISTER = 528
PEAK_DETECT_CNTRL_BACKGROUND_SAMPLES_REGISTER = 529
PEAK_DETECT_CNTRL_BACKGROUND_REGISTER = 530
PEAK_DETECT_CNTRL_UPPER_THRESHOLD_REGISTER = 531
PEAK_DETECT_CNTRL_LOWER_THRESHOLD_1_REGISTER = 532
PEAK_DETECT_CNTRL_LOWER_THRESHOLD_2_REGISTER = 533
PEAK_DETECT_CNTRL_THRESHOLD_FACTOR_REGISTER = 534
PEAK_DETECT_CNTRL_ACTIVE_SIZE_REGISTER = 535
PEAK_DETECT_CNTRL_POST_PEAK_SAMPLES_REGISTER = 536
PEAK_DETECT_CNTRL_CANCELLING_SAMPLES_REGISTER = 537
PEAK_DETECT_CNTRL_TRIGGER_CONDITION_REGISTER = 538
PEAK_DETECT_CNTRL_TRIGGER_DELAY_REGISTER = 539
PEAK_DETECT_CNTRL_TRIGGERED_DURATION_REGISTER = 540
PEAK_DETECT_CNTRL_TRANSITIONING_DURATION_REGISTER = 541
PEAK_DETECT_CNTRL_TRANSITIONING_HOLDOFF_REGISTER = 542
PEAK_DETECT_CNTRL_HOLDING_MAX_LOSS_REGISTER = 543
PEAK_DETECT_CNTRL_HOLDING_DURATION_REGISTER = 544
PEAK_DETECT_CNTRL_PRIMING_DURATION_REGISTER = 545
PEAK_DETECT_CNTRL_PURGING_DURATION_REGISTER = 546
PEAK_DETECT_CNTRL_REMAINING_SAMPLES_REGISTER = 547
PEAK_DETECT_CNTRL_IDLE_VALVE_MASK_AND_VALUE_REGISTER = 548
PEAK_DETECT_CNTRL_ARMED_VALVE_MASK_AND_VALUE_REGISTER = 549
PEAK_DETECT_CNTRL_TRIGGER_PENDING_VALVE_MASK_AND_VALUE_REGISTER = 550
PEAK_DETECT_CNTRL_TRIGGERED_VALVE_MASK_AND_VALUE_REGISTER = 551
PEAK_DETECT_CNTRL_TRANSITIONING_VALVE_MASK_AND_VALUE_REGISTER = 552
PEAK_DETECT_CNTRL_HOLDING_VALVE_MASK_AND_VALUE_REGISTER = 553
PEAK_DETECT_CNTRL_INACTIVE_VALVE_MASK_AND_VALUE_REGISTER = 554
PEAK_DETECT_CNTRL_CANCELLING_VALVE_MASK_AND_VALUE_REGISTER = 555
PEAK_DETECT_CNTRL_PRIMING_VALVE_MASK_AND_VALUE_REGISTER = 556
PEAK_DETECT_CNTRL_PURGING_VALVE_MASK_AND_VALUE_REGISTER = 557
PEAK_DETECT_CNTRL_INJECTION_PENDING_VALVE_MASK_AND_VALUE_REGISTER = 558
FLOW1_REGISTER = 559
CONVERSION_FLOW1_SCALE_REGISTER = 560
CONVERSION_FLOW1_OFFSET_REGISTER = 561
RDD_BALANCE_REGISTER = 562
RDD_GAIN_REGISTER = 563
FLOW_CNTRL_STATE_REGISTER = 564
FLOW_CNTRL_SETPOINT_REGISTER = 565
FLOW_CNTRL_GAIN_REGISTER = 566
FLOW_0_SETPOINT_REGISTER = 567
FLOW_1_SETPOINT_REGISTER = 568
FLOW_2_SETPOINT_REGISTER = 569
FLOW_3_SETPOINT_REGISTER = 570
BATTERY_MONITOR_STATUS_REGISTER = 571
BATTERY_MONITOR_CHARGE_REGISTER = 572
BATTERY_MONITOR_VOLTAGE_REGISTER = 573
BATTERY_MONITOR_CURRENT_REGISTER = 574
BATTERY_MONITOR_TEMPERATURE_REGISTER = 575
ACCELEROMETER_X_REGISTER = 576
...
__p.append(('dsp','choices',FILTER_HEATER_TEMP_CNTRL_STATE_REGISTER,'Temperature Controller Mode','',[(TEMP_CNTRL_DisabledState,"Controller Disabled"),(TEMP_CNTRL_EnabledState,"Controller Enabled"),(TEMP_CNTRL_SuspendedState,"Controller Suspended"),(TEMP_CNTRL_SweepingState,"Continuous Sweeping"),(TEMP_CNTRL_SendPrbsState,"Sending PRBS"),(TEMP_CNTRL_ManualState,"Manual Control"),(TEMP_CNTRL_AutomaticState,"Automatic Control"),],1,1))
...
__p.append(('dsp','float',SENTRY_FILTER_HEATER_TEMPERATURE_MIN_REGISTER,'Filter heater minimum temperature sentry','degC','%.1f',1,1))
__p.append(('dsp','float',SENTRY_FILTER_HEATER_TEMPERATURE_MAX_REGISTER,'Filter heater maximum temperature sentry','degC','%.1f',1,1))
