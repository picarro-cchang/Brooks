# setupWin7UserMigrationTools.py
...
def _getBuildVersion():
    try:
        ...
        try:
            # this script uses the version defined in Win7UserMigrationToolsDefs.py
...
if "PYTHONPATH" not in os.environ:
    ...
    print "Run 'python buildWin7UserMigrationTools.py' instead to build migration apps from the command line."
    sys.exit(1)
...
if pythonVer == "2.5":
    ...
    setup(version = versionStr,
          description = "Picarro Windows 7 User Migration Software",
          name = "Picarro User Win7Migration",
